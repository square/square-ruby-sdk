...
module SquareApiClient
  ...
  unless timeout_in_seconds.nil?
    ...
    def get_headers
      headers = { "X-Fern-Language": 'Ruby', "X-Fern-SDK-Name": 'square_rb', "X-Fern-SDK-Version": '44.0.0.20250820' }
...
#  SDK.
  ...
  # @return [Long] 
    ...
    # @param timeout_in_seconds [Long] 
    # @return [SquareApiClient::RequestOptions]
    def initialize(base_url: nil, token: nil, version: nil, additional_headers: nil, additional_query_parameters: nil, additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @token = token
      @version = version
...
#  SDK.
  ...
  # @return [Long] 
    ...
    # @param additional_body_parameters [Hash{String => Object}] 
    # @param timeout_in_seconds [Long] 
    # @return [SquareApiClient::IdempotencyRequestOptions]
    def initialize(base_url: nil, token: nil, version: nil, additional_headers: nil, additional_query_parameters: nil, additional_body_parameters: nil, timeout_in_seconds: nil)
      @base_url = base_url
      @token = token
      @version = version
