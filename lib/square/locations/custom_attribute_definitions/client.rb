...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
      ...
      # @return [SquareApiClient::ListLocationCustomAttributeDefinitionsResponse]
      # @example
...
#  api.locations.custom_attribute_definitions.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/custom-attribute-definitions"
        ...
        SquareApiClient::ListLocationCustomAttributeDefinitionsResponse.from_json(json_object: response.body)
      end
...
#  - `name` is required unless `visibility` is set to `VISIBILITY_HIDDEN`.Request of type SquareApiClient::CustomAttributeDefinition, as a Hash
      #   * :key (String) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CreateLocationCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.locations.custom_attribute_definitions.create(custom_attribute_definition: { key: "bestseller", schema: { "ref": "https://developer-production-s.squarecdn.com/schemas/v1/common.json#squareup.common.String" }, name: "Bestseller", description: "Bestselling item at location", visibility: VISIBILITY_READ_WRITE_VALUES })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/custom-attribute-definitions"
        ...
        SquareApiClient::CreateLocationCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  is higher than the current version, Square returns a `BAD_REQUEST` error.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::RetrieveLocationCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.locations.custom_attribute_definitions.get(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::RetrieveLocationCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  If this is not important for your application, `version` can be set to -1.Request of type SquareApiClient::CustomAttributeDefinition, as a Hash
      #   * :key (String) 
      #   * :schema (Hash{String => Object}) 
      #   * :name (String) 
      #   * :description (String) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpdateLocationCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.locations.custom_attribute_definitions.update(key: "key", custom_attribute_definition: { description: "Update the description as desired.", visibility: VISIBILITY_READ_ONLY })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::UpdateLocationCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  Only the definition owner can delete a custom attribute definition.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteLocationCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.locations.custom_attribute_definitions.delete(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::DeleteLocationCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Locations::AsyncCustomAttributeDefinitionsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Lists the location-related [custom attribute
