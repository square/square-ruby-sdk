...
module square.rb
  ...
  # @return [square.rb::Locations::CustomAttributesClient] 
  ...
  # @return [square.rb::Locations::TransactionsClient] 
    ...
    def initialize(request_client:)
      ...
      @custom_attribute_definitions = square.rb::Locations::CustomAttributeDefinitionsClient.new(request_client: request_client)
      @custom_attributes = square.rb::Locations::CustomAttributesClient.new(request_client: request_client)
      @transactions = square.rb::Locations::TransactionsClient.new(request_client: request_client)
    end
...
#  `name`.
    ...
    # @return [square.rb::ListLocationsResponse]
    # @example
...
#  api.locations.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations"
      ...
      square.rb::ListLocationsResponse.from_json(json_object: response.body)
    end
...
#  ion](https://developer.squareup.com/docs/locations-api#about-the-main-location).Request of type square.rb::Location, as a Hash
    #   * :id (String) 
    #   * :name (String) 
    #   * :address (Hash)
    ...
    #     * :last_name (String) 
    #   * :timezone (String) 
    #   * :capabilities (Array<square.rb::LocationCapability>) 
    #   * :status (square.rb::LocationStatus) 
    #   * :created_at (String) 
    #   * :merchant_id (String) 
    #   * :country (square.rb::Country) 
    ...
    #   * :type (square.rb::LocationType) 
    #   * :website_url (String) 
    #   * :business_hours (Hash)
    #     * :periods (Array<square.rb::BusinessHoursPeriod>) 
    ...
    #     * :jp_qii (String) 
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::CreateLocationResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.locations.create(location: { name: "Midtown", address: { address_line_1: "1234 Peachtree St. NE", locality: "Atlanta", administrative_district_level_1: "GA", postal_code: "30309" }, description: "Midtown Atlanta store" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations"
      ...
      square.rb::CreateLocationResponse.from_json(json_object: response.body)
    end
...
#  "main" to return the main location.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::GetLocationResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.locations.get(location_id: "location_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/#{location_id}"
      ...
      square.rb::GetLocationResponse.from_json(json_object: response.body)
    end
# Updates a [location](https://developer.squareup.com/docs/locations-api).
    #
    # @param location_id [String] The ID of the location to update.
    # @param location [Hash] The `Location` object with only the fields to update.Request of type square.rb::Location, as a Hash
    #   * :id (String) 
    #   * :name (String) 
    #   * :address (Hash)
    #     * :address_line_1 (String) 
    ...
    #     * :jp_qii (String) 
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::UpdateLocationResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.locations.update(location_id: "location_id", location: { business_hours: { periods: [{ day_of_week: FRI, start_local_time: "07:00", end_local_time: "18:00" }, { day_of_week: SAT, start_local_time: "07:00", end_local_time: "18:00" }, { day_of_week: SUN, start_local_time: "09:00", end_local_time: "15:00" }] }, description: "Midtown Atlanta store - Open weekends" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/#{location_id}"
      ...
      square.rb::UpdateLocationResponse.from_json(json_object: response.body)
    end
...
#  Idempotency](https://developer.squareup.com/docs/working-with-apis/idempotency).
    # @param order [Hash] The order including line items to be checked out.Request of type square.rb::CreateOrderRequest, as a Hash
    #   * :order (Hash)
    #     * :id (String) 
    #     * :location_id (String) 
    #     * :reference_id (String) 
...
#  Default: none; only exists if explicitly set.Request of type square.rb::Address, as a Hash
    #   * :address_line_1 (String) 
    #   * :address_line_2 (String) 
    #   * :address_line_3 (String) 
    #   * :locality (String) 
...
#  This field is currently not supported in the Square Sandbox.Request of type Array<square.rb::ChargeRequestAdditionalRecipient>, as a Hash
    #   * :location_id (String) 
    #   * :description (String) 
    #   * :amount_money (Hash)
    #     * :amount (Long) 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/#{location_id}/checkouts"
      ...
      square.rb::CreateCheckoutResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [square.rb::Locations::TransactionsClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @custom_attribute_definitions = square.rb::Locations::AsyncCustomAttributeDefinitionsClient.new(request_client: request_client)
      @custom_attributes = square.rb::Locations::AsyncCustomAttributesClient.new(request_client: request_client)
      @transactions = square.rb::Locations::AsyncTransactionsClient.new(request_client: request_client)
    end
# Provides details about all of the seller's
#  [locations](https://developer.squareup.com/docs/locations-api),
#  including those with an inactive status. Locations are listed alphabetically by
