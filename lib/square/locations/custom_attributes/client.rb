...
#  `VISIBILITY_READ_WRITE_VALUES`.
      #
      # @param values [Hash{String => square.rb::BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest}] The data used to update the `CustomAttribute` objects.
...
#  api.locations.custom_attributes.batch_delete(values: { "id1": { key: "bestseller" }, "id2": { key: "bestseller" }, "id3": { key: "phone-number" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/custom-attributes/bulk-delete"
        ...
        square.rb::BulkDeleteLocationCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  must be `VISIBILITY_READ_WRITE_VALUES`.
      #
      # @param values [Hash{String => square.rb::BulkUpsertLocationCustomAttributesRequestLocationCustomAttributeUpsertRequest}] A map containing 1 to 25 individual upsert requests. For each request, provide
#  an
#  arbitrary ID that is unique for this `BulkUpsertLocationCustomAttributes`
#  request and the
#  information needed to create or update a custom attribute.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::BulkUpsertLocationCustomAttributesResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.locations.custom_attributes.batch_upsert(values: { "id1": { location_id: "L0TBCBTB7P8RQ", custom_attribute: { key: "bestseller", value: "hot cocoa" } }, "id2": { location_id: "L9XMD04V3STJX", custom_attribute: { key: "bestseller", value: "berry smoothie" } }, "id3": { location_id: "L0TBCBTB7P8RQ", custom_attribute: { key: "phone-number", value: "+12223334444" } } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/custom-attributes/bulk-upsert"
        ...
        square.rb::BulkUpsertLocationCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  default value is `false`.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::ListLocationCustomAttributesResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.locations.custom_attributes.list(location_id: "location_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/#{location_id}/custom-attributes"
        ...
        square.rb::ListLocationCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  higher than the current version, Square returns a `BAD_REQUEST` error.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::RetrieveLocationCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.locations.custom_attributes.get(location_id: "location_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/#{location_id}/custom-attributes/#{key}"
        ...
        square.rb::RetrieveLocationCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  attribute.
#  If this is not important for your application, version can be set to -1.Request of type square.rb::CustomAttribute, as a Hash
      #   * :key (String) 
      #   * :value (Object) 
      #   * :version (Integer) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::UpsertLocationCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/#{location_id}/custom-attributes/#{key}"
        ...
        square.rb::UpsertLocationCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  definition owner, you must use the qualified key.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::DeleteLocationCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.locations.custom_attributes.delete(location_id: "location_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/locations/#{location_id}/custom-attributes/#{key}"
        ...
        square.rb::DeleteLocationCustomAttributeResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Locations::AsyncCustomAttributesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Deletes [custom attributes](entity:CustomAttribute) for locations as a bulk
