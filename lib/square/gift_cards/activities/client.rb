...
#  - `DESC` - Newest to oldest (default).
      ...
      # @return [square.rb::ListGiftCardActivitiesResponse]
      # @example
...
#  api.gift_cards.activities.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards/activities"
        ...
        square.rb::ListGiftCardActivitiesResponse.from_json(json_object: response.body)
      end
...
#  `type` along with the corresponding activity details.Request of type square.rb::GiftCardActivity, as a Hash
      #   * :id (String) 
      #   * :type (square.rb::GiftCardActivityType) 
      #   * :location_id (String) 
      #   * :created_at (String) 
      #   * :gift_card_id (String) 
      ...
      #     * :payment_id (String) 
      #     * :reference_id (String) 
      #     * :status (square.rb::GiftCardActivityRedeemStatus) 
      #   * :clear_balance_activity_details (Hash)
      #     * :reason (square.rb::GiftCardActivityClearBalanceReason) 
      #   * :deactivate_activity_details (Hash)
      #     * :reason (square.rb::GiftCardActivityDeactivateReason) 
      #   * :adjust_increment_activity_details (Hash)
      #     * :amount_money (Hash)
      #       * :amount (Long) 
      #       * :currency (square.rb::Currency) 
      #     * :reason (square.rb::GiftCardActivityAdjustIncrementReason) 
      #   * :adjust_decrement_activity_details (Hash)
      #     * :amount_money (Hash)
      #       * :amount (Long) 
      #       * :currency (square.rb::Currency) 
      #     * :reason (square.rb::GiftCardActivityAdjustDecrementReason) 
      ...
      #     * :reason (square.rb::GIFT_CARD_ACTIVITY_BLOCK_REASON) 
      #   * :unblock_activity_details (Hash)
      #     * :reason (square.rb::GIFT_CARD_ACTIVITY_UNBLOCK_REASON) 
      ...
      #       * :currency (square.rb::Currency) 
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::CreateGiftCardActivityResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.gift_cards.activities.create(idempotency_key: "U16kfr-kA70er-q4Rsym-7U7NnY", gift_card_activity: { type: ACTIVATE, location_id: "81FN9BNFZTKS4", gift_card_id: "gftc:6d55a72470d940c6ba09c0ab8ad08d20", activate_activity_details: { order_id: "jJNGHm4gLI6XkFbwtiSLqK72KkAZY", line_item_uid: "eIWl7X0nMuO9Ewbh0ChIx" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards/activities"
        ...
        square.rb::CreateGiftCardActivityResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::GiftCards::AsyncActivitiesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Lists gift card activities. By default, you get gift card activities for all
