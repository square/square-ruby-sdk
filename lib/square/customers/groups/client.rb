...
#  api.customers.groups.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/groups"
        ...
        SquareApiClient::ListCustomerGroupsResponse.from_json(json_object: response.body)
      end
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param group [Hash] The customer group to create.Request of type SquareApiClient::CustomerGroup, as a Hash
      #   * :id (String) 
      #   * :name (String) 
      #   * :created_at (String) 
      #   * :updated_at (String) 
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CreateCustomerGroupResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.groups.create(group: { name: "Loyal Customers" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/groups"
        ...
        SquareApiClient::CreateCustomerGroupResponse.from_json(json_object: response.body)
      end
# Retrieves a specific customer group as identified by the `group_id` value.
      #
      # @param group_id [String] The ID of the customer group to retrieve.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetCustomerGroupResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.groups.get(group_id: "group_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/groups/#{group_id}"
        ...
        SquareApiClient::GetCustomerGroupResponse.from_json(json_object: response.body)
      end
# Updates a customer group as identified by the `group_id` value.
      #
      # @param group_id [String] The ID of the customer group to update.
      # @param group [Hash] The `CustomerGroup` object including all the updates you want to make.Request of type SquareApiClient::CustomerGroup, as a Hash
      #   * :id (String) 
      #   * :name (String) 
      #   * :created_at (String) 
      #   * :updated_at (String) 
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpdateCustomerGroupResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.groups.update(group_id: "group_id", group: { name: "Loyal Customers" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/groups/#{group_id}"
        ...
        SquareApiClient::UpdateCustomerGroupResponse.from_json(json_object: response.body)
      end
# Deletes a customer group as identified by the `group_id` value.
      #
      # @param group_id [String] The ID of the customer group to delete.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteCustomerGroupResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.groups.delete(group_id: "group_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/groups/#{group_id}"
        ...
        SquareApiClient::DeleteCustomerGroupResponse.from_json(json_object: response.body)
      end
...
#  and the customer group is identified by the `group_id` value.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::AddGroupToCustomerResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.groups.add(customer_id: "customer_id", group_id: "group_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/groups/#{group_id}"
        ...
        SquareApiClient::AddGroupToCustomerResponse.from_json(json_object: response.body)
      end
...
#  and the customer group is identified by the `group_id` value.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::RemoveGroupFromCustomerResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.groups.remove(customer_id: "customer_id", group_id: "group_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/groups/#{group_id}"
        ...
        SquareApiClient::RemoveGroupFromCustomerResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Customers::AsyncGroupsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Retrieves the list of customer groups of a business.
