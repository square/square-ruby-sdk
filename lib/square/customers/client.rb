...
module square.rb
  ...
  # @return [square.rb::Customers::CustomAttributesClient] 
    ...
    def initialize(request_client:)
      ...
      @custom_attribute_definitions = square.rb::Customers::CustomAttributeDefinitionsClient.new(request_client: request_client)
      @groups = square.rb::Customers::GroupsClient.new(request_client: request_client)
      @segments = square.rb::Customers::SegmentsClient.new(request_client: request_client)
      @cards = square.rb::Customers::CardsClient.new(request_client: request_client)
      @custom_attributes = square.rb::Customers::CustomAttributesClient.new(request_client: request_client)
    end
...
#  For more information, see
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
    # @param sort_field [square.rb::CustomerSortField] Indicates how customers should be sorted.
#  The default value is `DEFAULT`.
    # @param sort_order [square.rb::SortOrder] Indicates whether customers should be sorted in ascending (`ASC`) or
...
#  The default value is `false`.
    ...
    # @return [square.rb::ListCustomersResponse]
    # @example
...
#  api.customers.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers"
      ...
      square.rb::ListCustomersResponse.from_json(json_object: response.body)
    end
...
#  request.Request of type square.rb::Address, as a Hash
...
#  see [Customer tax
#  ttps://developer.squareup.com/docs/customers-api/what-it-does#customer-tax-ids).Request of type square.rb::CustomerTaxIds, as a Hash
    #   * :eu_vat (String) 
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::CreateCustomerResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers"
      ...
      square.rb::CreateCustomerResponse.from_json(json_object: response.body)
    end
...
#  - `phone_number`
    #
    # @param customers [Hash{String => square.rb::BulkCreateCustomerData}] A map of 1 to 100 individual create requests, represented by `idempotency key: {
#  customer data }`
#  key-value pairs.
...
#  customer profile.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::BulkCreateCustomersResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.customers.batch_create(customers: { "8bb76c4f-e35d-4c5b-90de-1194cd9179f0": { given_name: "Amelia", family_name: "Earhart", email_address: "Amelia.Earhart@example.com", address: { address_line_1: "500 Electric Ave", address_line_2: "Suite 600", locality: "New York", administrative_district_level_1: "NY", postal_code: "10003", country: US }, phone_number: "+1-212-555-4240", reference_id: "YOUR_REFERENCE_ID", note: "a customer" }, "d1689f23-b25d-4932-b2f0-aed00f5e2029": { given_name: "Marie", family_name: "Curie", email_address: "Marie.Curie@example.com", address: { address_line_1: "500 Electric Ave", address_line_2: "Suite 601", locality: "New York", administrative_district_level_1: "NY", postal_code: "10003", country: US }, phone_number: "+1-212-444-4240", reference_id: "YOUR_REFERENCE_ID", note: "another customer" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/bulk-create"
      ...
      square.rb::BulkCreateCustomersResponse.from_json(json_object: response.body)
    end
...
#  The endpoint takes a list of customer IDs and returns a map of responses.
    ...
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::BulkDeleteCustomersResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.customers.bulk_delete_customers(customer_ids: ["8DDA5NZVBZFGAX0V3HPF81HHE0", "N18CPRVXR5214XPBBA6BZQWF3C", "2GYD7WNXF7BJZW1PMGNXZ3Y8M8"])
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/bulk-delete"
      ...
      square.rb::BulkDeleteCustomersResponse.from_json(json_object: response.body)
    end
...
#  This endpoint takes a list of customer IDs and returns a map of responses.
    ...
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::BulkRetrieveCustomersResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.customers.bulk_retrieve_customers(customer_ids: ["8DDA5NZVBZFGAX0V3HPF81HHE0", "N18CPRVXR5214XPBBA6BZQWF3C", "2GYD7WNXF7BJZW1PMGNXZ3Y8M8"])
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/bulk-retrieve"
      ...
      square.rb::BulkRetrieveCustomersResponse.from_json(json_object: response.body)
    end
# Updates multiple customer profiles.
#  This endpoint takes a map of individual update requests and returns a map of
#  responses.
    #
    # @param customers [Hash{String => square.rb::BulkUpdateCustomerData}] A map of 1 to 100 individual update requests, represented by `customer ID: {
#  customer data }`
#  key-value pairs.
...
#  update a field, specify the new value. To remove a field, specify `null`.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::BulkUpdateCustomersResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.customers.bulk_update_customers(customers: { "8DDA5NZVBZFGAX0V3HPF81HHE0": { email_address: "New.Amelia.Earhart@example.com", note: "updated customer note", version: 2 }, "N18CPRVXR5214XPBBA6BZQWF3C": { given_name: "Marie", family_name: "Curie", version: 0 } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/bulk-update"
      ...
      square.rb::BulkUpdateCustomersResponse.from_json(json_object: response.body)
    end
...
#  `family_name`.Request of type square.rb::CustomerQuery, as a Hash
    #   * :filter (Hash)
    #     * :creation_source (Hash)
    #       * :values (Array<square.rb::CustomerCreationSource>) 
    #       * :rule (square.rb::CustomerInclusionExclusion) 
    #     * :created_at (Hash)
    #       * :start_at (String) 
    #       * :end_at (String) 
    #     * :updated_at (Hash)
    ...
    #       * :filters (Array<square.rb::CustomerCustomAttributeFilter>) 
    #     * :segment_ids (Hash)
    #       * :all (Array<String>) 
    #       * :any (Array<String>) 
    #       * :none (Array<String>) 
    #   * :sort (Hash)
    #     * :field (square.rb::CustomerSortField) 
...
#  api.customers.search(limit: 2, query: { filter: { creation_source: { values: [THIRD_PARTY], rule: INCLUDE }, created_at: { start_at: "2018-01-01T00:00:00-00:00", end_at: "2018-02-01T00:00:00-00:00" }, email_address: { fuzzy: "example.com" }, group_ids: { all: ["545AXB44B4XXWMVQ4W8SBT3HHF"] } }, sort: { field: CREATED_AT, order: ASC } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/search"
      ...
      square.rb::SearchCustomersResponse.from_json(json_object: response.body)
    end
# Returns details for a single customer.
    #
    # @param customer_id [String] The ID of the customer to retrieve.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::GetCustomerResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.customers.get(customer_id: "customer_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}"
      ...
      square.rb::GetCustomerResponse.from_json(json_object: response.body)
    end
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}"
      ...
      square.rb::UpdateCustomerResponse.from_json(json_object: response.body)
    end
...
#  uareup.com/docs/customers-api/use-the-api/keep-records#delete-customer-profile).
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::DeleteCustomerResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.customers.delete(customer_id: "customer_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}"
      ...
      square.rb::DeleteCustomerResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [square.rb::Customers::CustomAttributesClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @custom_attribute_definitions = square.rb::Customers::AsyncCustomAttributeDefinitionsClient.new(request_client: request_client)
      @groups = square.rb::Customers::AsyncGroupsClient.new(request_client: request_client)
      @segments = square.rb::Customers::AsyncSegmentsClient.new(request_client: request_client)
      @cards = square.rb::Customers::AsyncCardsClient.new(request_client: request_client)
      @custom_attributes = square.rb::Customers::AsyncCustomAttributesClient.new(request_client: request_client)
    end
# Lists customer profiles associated with a Square account.
#  Under normal operating conditions, newly created or updated customer profiles
#  become available
