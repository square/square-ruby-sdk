...
module square.rb
  ...
  # @return [square.rb::BankAccount] The verified bank account.
  ...
  # @return [Object] 
    ...
    # @param bank_account [square.rb::BankAccount] The verified bank account.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::BankAccountVerifiedEventObject]
