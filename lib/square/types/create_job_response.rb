...
module square.rb
# Represents a [CreateJob](api-endpoint:Team-CreateJob) response. Either `job` or
#  `errors`
#  is present in the response.
  class CreateJobResponse
  # @return [square.rb::Job] The new job.
    attr_reader :job
  ...
  # @return [Object] 
    ...
    # @param job [square.rb::Job] The new job.
...
# Deserialize a JSON object to an instance of CreateJobResponse
    #
...
# Serialize an instance of CreateJobResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
