...
#  the reminder should be sent 3 days before the payment request `due_date`.
  ...
  # @return [String] The reminder message.
    attr_reader :message
  # @return [square.rb::InvoicePaymentReminderStatus] The status of the reminder.
...
#  the reminder should be sent 3 days before the payment request `due_date`.
    ...
    # @param status [square.rb::InvoicePaymentReminderStatus] The status of the reminder.
#  See [InvoicePaymentReminderStatus](#type-invoicepaymentreminderstatus) for
#  possible values
    # @param sent_at [String] If sent, the timestamp when the reminder was sent, in RFC 3339 format.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::InvoicePaymentReminder]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(square.rb::InvoicePaymentReminderStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
