...
module square.rb
  ...
  # @return [square.rb::Booking] The booking that was updated.
    attr_reader :booking
  ...
  # @return [Object] 
    ...
    # @param booking [square.rb::Booking] The booking that was updated.
...
# Deserialize a JSON object to an instance of UpdateBookingResponse
    #
...
# Serialize an instance of UpdateBookingResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
