...
# A collection of various money amounts.
  ...
  # @return [SquareApiClient::Money] The total money.
    attr_reader :total_money
  # @return [SquareApiClient::Money] The money associated with taxes.
    attr_reader :tax_money
  # @return [SquareApiClient::Money] The money associated with discounts.
    attr_reader :discount_money
  # @return [SquareApiClient::Money] The money associated with tips.
    attr_reader :tip_money
  # @return [SquareApiClient::Money] The money associated with service charges.
  ...
  # @return [Object] 
    ...
    # @param total_money [SquareApiClient::Money] The total money.
    # @param tax_money [SquareApiClient::Money] The money associated with taxes.
    # @param discount_money [SquareApiClient::Money] The money associated with discounts.
    # @param tip_money [SquareApiClient::Money] The money associated with tips.
    # @param service_charge_money [SquareApiClient::Money] The money associated with service charges.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderMoneyAmounts]
...
# Deserialize a JSON object to an instance of OrderMoneyAmounts
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["tax_money"].nil?
        ...
        tax_money = SquareApiClient::Money.from_json(json_object: tax_money)
      else
        tax_money = nil
      end
      unless parsed_json["discount_money"].nil?
        discount_money = parsed_json["discount_money"].to_json
        discount_money = SquareApiClient::Money.from_json(json_object: discount_money)
      else
        discount_money = nil
      end
      ...
      unless parsed_json["service_charge_money"].nil?
        ...
        service_charge_money = SquareApiClient::Money.from_json(json_object: service_charge_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.tax_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.tax_money)
      obj.discount_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.discount_money)
      obj.tip_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.tip_money)
      obj.service_charge_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.service_charge_money)
    end
  end
end