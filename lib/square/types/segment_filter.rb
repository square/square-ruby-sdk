...
#  representing the service booked in this segment.
  ...
  # @return [SquareApiClient::FilterValue] A query filter to search for buyer-accessible appointment segments with
...
#  representing the service booked in this segment.
    # @param team_member_id_filter [SquareApiClient::FilterValue] A query filter to search for buyer-accessible appointment segments with
#  service-providing team members matching the specified list of team member IDs.
#  Supported query expressions are
#  - `ANY`: return the appointment segments with team members whose IDs match any
#  member in this list.
...
#  to fulfill the Booking.
    ...
    # @return [SquareApiClient::SegmentFilter]
...
# Deserialize a JSON object to an instance of SegmentFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["team_member_id_filter"].nil?
        ...
        team_member_id_filter = SquareApiClient::FilterValue.from_json(json_object: team_member_id_filter)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.team_member_id_filter.nil? || SquareApiClient::FilterValue.validate_raw(obj: obj.team_member_id_filter)
    end
  end
end