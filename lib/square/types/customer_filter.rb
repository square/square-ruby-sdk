...
#  [SearchCustomers](api-endpoint:Customers-SearchCustomers) results.
  ...
  # @return [SquareApiClient::CustomerCreationSourceFilter] A filter to select customers based on their creation source.
    attr_reader :creation_source
  # @return [SquareApiClient::TimeRange] A filter to select customers based on when they were created.
    attr_reader :created_at
  # @return [SquareApiClient::TimeRange] A filter to select customers based on when they were last updated.
    attr_reader :updated_at
  # @return [SquareApiClient::CustomerTextFilter] A filter to [select customers by their email
...
#  irrespective of the token order.
  ...
  # @return [SquareApiClient::CustomerTextFilter] A filter to [select customers by their phone
...
#  tokens in the search query, irrespective of the token order.
  ...
  # @return [SquareApiClient::CustomerTextFilter] A filter to [select customers by their reference
...
#  and `NYC_27_MURRAY`.
  ...
  # @return [SquareApiClient::FilterValue] A filter to select customers based on the [groups](entity:CustomerGroup) they
#  belong to.
...
#  the result is an empty object (`{}`).
  ...
  # @return [SquareApiClient::CustomerCustomAttributeFilters] A filter to select customers based on one or more custom attributes.
...
#  using a customer ID from the result set.
  ...
  # @return [SquareApiClient::FilterValue] A filter to select customers based on the [segments](entity:CustomerSegment)
#  they belong to.
...
#  and returns a `400 BAD_REQUEST` error that includes the segment ID.
  ...
  # @return [Object] 
    ...
    # @param creation_source [SquareApiClient::CustomerCreationSourceFilter] A filter to select customers based on their creation source.
    # @param created_at [SquareApiClient::TimeRange] A filter to select customers based on when they were created.
    # @param updated_at [SquareApiClient::TimeRange] A filter to select customers based on when they were last updated.
    # @param email_address [SquareApiClient::CustomerTextFilter] A filter to [select customers by their email
#  eup.com/docs/customers-api/use-the-api/search-customers#search-by-email-address)
#  visible to the seller.
#  This filter is case-insensitive.
#  For [exact
...
#  found if a tokenized email address contains all the tokens in the search query,
#  irrespective of the token order.
    # @param phone_number [SquareApiClient::CustomerTextFilter] A filter to [select customers by their phone
#  reup.com/docs/customers-api/use-the-api/search-customers#search-by-phone-number)
#  visible to the seller.
#  For [exact
#  m/docs/customers-api/use-the-api/search-customers#exact-search-by-phone-number),
...
#  `+1-212-415-1200`. A match is found if a tokenized phone number contains all the
#  tokens in the search query, irrespective of the token order.
    # @param reference_id [SquareApiClient::CustomerTextFilter] A filter to [select customers by their reference
#  eup.com/docs/customers-api/use-the-api/search-customers#search-by-reference-id).
#  This filter is case-insensitive.
#  [Exact
#  om/docs/customers-api/use-the-api/search-customers#exact-search-by-reference-id)
...
#  `NYC_M_35_JOHNSON`
#  and `NYC_27_MURRAY`.
    # @param group_ids [SquareApiClient::FilterValue] A filter to select customers based on the [groups](entity:CustomerGroup) they
#  belong to.
#  Group membership is controlled by sellers and developers.
#  The `group_ids` filter has the following syntax:
#  ```
...
#  non-existent group ID is provided,
#  the result is an empty object (`{}`).
    # @param custom_attribute [SquareApiClient::CustomerCustomAttributeFilters] A filter to select customers based on one or more custom attributes.
#  This filter can contain up to 10 custom attribute filters. Each custom attribute
#  filter specifies filtering criteria for a target custom
#  attribute. If multiple custom attribute filters are provided, they are combined
#  as an `AND` operation.
...
#  ttribute](api-endpoint:CustomerCustomAttributes-RetrieveCustomerCustomAttribute)
#  using a customer ID from the result set.
    # @param segment_ids [SquareApiClient::FilterValue] A filter to select customers based on the [segments](entity:CustomerSegment)
#  they belong to.
#  Segment membership is dynamic and adjusts automatically based on whether
#  customers meet the segment criteria.
#  You can provide up to three segment IDs in the filter, using any combination of
...
#  and returns a `400 BAD_REQUEST` error that includes the segment ID.
    ...
    # @return [SquareApiClient::CustomerFilter]
...
# Deserialize a JSON object to an instance of CustomerFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["creation_source"].nil?
        ...
        creation_source = SquareApiClient::CustomerCreationSourceFilter.from_json(json_object: creation_source)
      else
        creation_source = nil
      end
      ...
      unless parsed_json["email_address"].nil?
        ...
        email_address = SquareApiClient::CustomerTextFilter.from_json(json_object: email_address)
      else
        email_address = nil
      end
      unless parsed_json["phone_number"].nil?
        phone_number = parsed_json["phone_number"].to_json
        phone_number = SquareApiClient::CustomerTextFilter.from_json(json_object: phone_number)
      else
        phone_number = nil
      end
      unless parsed_json["reference_id"].nil?
        reference_id = parsed_json["reference_id"].to_json
        reference_id = SquareApiClient::CustomerTextFilter.from_json(json_object: reference_id)
      else
        reference_id = nil
      end
      unless parsed_json["group_ids"].nil?
        group_ids = parsed_json["group_ids"].to_json
        group_ids = SquareApiClient::FilterValue.from_json(json_object: group_ids)
      else
        group_ids = nil
      end
      unless parsed_json["custom_attribute"].nil?
        custom_attribute = parsed_json["custom_attribute"].to_json
        custom_attribute = SquareApiClient::CustomerCustomAttributeFilters.from_json(json_object: custom_attribute)
      else
        custom_attribute = nil
      end
      unless parsed_json["segment_ids"].nil?
        segment_ids = parsed_json["segment_ids"].to_json
        segment_ids = SquareApiClient::FilterValue.from_json(json_object: segment_ids)
      else
        segment_ids = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.creation_source.nil? || SquareApiClient::CustomerCreationSourceFilter.validate_raw(obj: obj.creation_source)
      ...
      obj.email_address.nil? || SquareApiClient::CustomerTextFilter.validate_raw(obj: obj.email_address)
      obj.phone_number.nil? || SquareApiClient::CustomerTextFilter.validate_raw(obj: obj.phone_number)
      obj.reference_id.nil? || SquareApiClient::CustomerTextFilter.validate_raw(obj: obj.reference_id)
      obj.group_ids.nil? || SquareApiClient::FilterValue.validate_raw(obj: obj.group_ids)
      obj.custom_attribute.nil? || SquareApiClient::CustomerCustomAttributeFilters.validate_raw(obj: obj.custom_attribute)
      obj.segment_ids.nil? || SquareApiClient::FilterValue.validate_raw(obj: obj.segment_ids)
    end
  end
end