...
module Square
  module Types
    ...
    class V1Order < Internal::Types::Model
      ...
      field :state, -> { Square::Types::V1OrderState }, optional: true, nullable: false
      field :shipping_address, -> { Square::Types::Address }, optional: true, nullable: false
      field :subtotal_money, -> { Square::Types::V1Money }, optional: true, nullable: false
      field :total_shipping_money, -> { Square::Types::V1Money }, optional: true, nullable: false
      field :total_tax_money, -> { Square::Types::V1Money }, optional: true, nullable: false
      field :total_price_money, -> { Square::Types::V1Money }, optional: true, nullable: false
      field :total_discount_money, -> { Square::Types::V1Money }, optional: true, nullable: false
