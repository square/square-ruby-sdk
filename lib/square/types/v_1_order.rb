...
# V1Order
  ...
  # @return [square.rb::V1OrderState] Whether the tax is an ADDITIVE tax or an INCLUSIVE tax.
#  See [V1OrderState](#type-v1orderstate) for possible values
    attr_reader :state
  # @return [square.rb::Address] The address to ship the order to.
    attr_reader :shipping_address
  # @return [square.rb::V1Money] The amount of all items purchased in the order, before taxes and shipping.
    attr_reader :subtotal_money
  # @return [square.rb::V1Money] The shipping cost for the order.
    attr_reader :total_shipping_money
  # @return [square.rb::V1Money] The total of all taxes applied to the order.
    attr_reader :total_tax_money
  # @return [square.rb::V1Money] The total cost of the order.
    attr_reader :total_price_money
  # @return [square.rb::V1Money] The total of all discounts applied to the order.
...
#  any.
  ...
  # @return [square.rb::V1Tender] The tender used to pay for the order.
    attr_reader :tender
  # @return [Array<square.rb::V1OrderHistoryEntry>] The history of actions associated with the order.
...
#  satoshi equals 1 BTC).
  ...
  # @return [Object] 
    ...
    # @param state [square.rb::V1OrderState] Whether the tax is an ADDITIVE tax or an INCLUSIVE tax.
#  See [V1OrderState](#type-v1orderstate) for possible values
    # @param shipping_address [square.rb::Address] The address to ship the order to.
    # @param subtotal_money [square.rb::V1Money] The amount of all items purchased in the order, before taxes and shipping.
    # @param total_shipping_money [square.rb::V1Money] The shipping cost for the order.
    # @param total_tax_money [square.rb::V1Money] The total of all taxes applied to the order.
    # @param total_price_money [square.rb::V1Money] The total cost of the order.
    # @param total_discount_money [square.rb::V1Money] The total of all discounts applied to the order.
...
#  any.
    # @param tender [square.rb::V1Tender] The tender used to pay for the order.
    # @param order_history [Array<square.rb::V1OrderHistoryEntry>] The history of actions associated with the order.
...
# Deserialize a JSON object to an instance of V1Order
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["total_discount_money"].nil?
        ...
        total_discount_money = square.rb::V1Money.from_json(json_object: total_discount_money)
      else
      ...
      unless parsed_json["tender"].nil?
        ...
        tender = square.rb::V1Tender.from_json(json_object: tender)
      else
        tender = nil
      end
      order_history = parsed_json["order_history"]&.map do | item |
  item = item.to_json
  square.rb::V1OrderHistoryEntry.from_json(json_object: item)
end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.state&.is_a?(square.rb::V1OrderState) != false || raise("Passed value for field obj.state is not the expected type, validation failed.")
      obj.shipping_address.nil? || square.rb::Address.validate_raw(obj: obj.shipping_address)
      obj.subtotal_money.nil? || square.rb::V1Money.validate_raw(obj: obj.subtotal_money)
      obj.total_shipping_money.nil? || square.rb::V1Money.validate_raw(obj: obj.total_shipping_money)
      obj.total_tax_money.nil? || square.rb::V1Money.validate_raw(obj: obj.total_tax_money)
      obj.total_price_money.nil? || square.rb::V1Money.validate_raw(obj: obj.total_price_money)
      obj.total_discount_money.nil? || square.rb::V1Money.validate_raw(obj: obj.total_discount_money)
      ...
      obj.tender.nil? || square.rb::V1Tender.validate_raw(obj: obj.tender)
