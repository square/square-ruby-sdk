...
#  owned by the subscribing app is deleted.
  class OrderCustomAttributeOwnedDeletedEvent
  # @return [String] The ID of the target seller associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"order.custom_attribute.owned.deleted"`.
    attr_reader :type
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"order.custom_attribute.owned.deleted"`.
    ...
    # @return [square.rb::OrderCustomAttributeOwnedDeletedEvent]
...
# Serialize an instance of OrderCustomAttributeOwnedDeletedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
