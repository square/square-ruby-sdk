...
#  the response contains a set of `Error` objects.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::GiftCardActivity>] The requested gift card activities or an empty object if none are found.
...
#  [Pagination](https://developer.squareup.com/docs/working-with-apis/pagination).
  ...
  # @return [Object] 
    ...
    # @param gift_card_activities [Array<square.rb::GiftCardActivity>] The requested gift card activities or an empty object if none are found.
...
# Deserialize a JSON object to an instance of ListGiftCardActivitiesResponse
  ...
  item = item.to_json
  square.rb::GiftCardActivity.from_json(json_object: item)
end
