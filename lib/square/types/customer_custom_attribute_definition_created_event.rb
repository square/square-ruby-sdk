...
#  tion.owned.created](webhook:customer.custom_attribute_definition.owned.created).
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionCreatedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionCreatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
