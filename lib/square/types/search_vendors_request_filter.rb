...
# Defines supported query expressions to search for vendors by.
  ...
  # @return [Array<String>] The names of the [Vendor](entity:Vendor) objects to retrieve.
    attr_reader :name
  # @return [Array<square.rb::VendorStatus>] The statuses of the [Vendor](entity:Vendor) objects to retrieve.
#  See [VendorStatus](#type-vendorstatus) for possible values
  ...
  # @return [Object] 
    ...
    # @param status [Array<square.rb::VendorStatus>] The statuses of the [Vendor](entity:Vendor) objects to retrieve.
#  See [VendorStatus](#type-vendorstatus) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchVendorsRequestFilter]
