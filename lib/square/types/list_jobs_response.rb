...
#  field is also present.
  ...
  # @return [Array<SquareApiClient::Job>] The retrieved jobs. A single paged response contains up to 100 jobs.
    attr_reader :jobs
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param jobs [Array<SquareApiClient::Job>] The retrieved jobs. A single paged response contains up to 100 jobs.
...
# Deserialize a JSON object to an instance of ListJobsResponse
  ...
  item = item.to_json
  SquareApiClient::Job.from_json(json_object: item)
end
