...
#  that is visible to the subscribing application is updated. A custom attribute
...
#  definition or when another application updates a custom attribute definition
#  whose `visibility` is
#  `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class LocationCustomAttributeDefinitionVisibleUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::LocationCustomAttributeDefinitionVisibleUpdatedEvent]
...
# Serialize an instance of LocationCustomAttributeDefinitionVisibleUpdatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
