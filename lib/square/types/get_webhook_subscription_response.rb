...
#  a request to the
#  hookSubscription](api-endpoint:WebhookSubscriptions-RetrieveWebhookSubscription)
#  endpoint.
#  Note: if there are errors processing the request, the
#  [Subscription](entity:WebhookSubscription) will not be
#  present.
  class GetWebhookSubscriptionResponse
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::WebhookSubscription] The requested [Subscription](entity:WebhookSubscription).
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::WebhookSubscription] The requested [Subscription](entity:WebhookSubscription).
...
# Deserialize a JSON object to an instance of GetWebhookSubscriptionResponse
    #
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["subscription"].nil?
        ...
        subscription = square.rb::WebhookSubscription.from_json(json_object: subscription)
      else
        subscription = nil
      end
      new(
...
# Serialize an instance of GetWebhookSubscriptionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.subscription.nil? || square.rb::WebhookSubscription.validate_raw(obj: obj.subscription)
    end
  end
end