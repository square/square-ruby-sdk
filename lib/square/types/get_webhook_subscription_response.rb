...
#  present.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::WebhookSubscription] The requested [Subscription](entity:WebhookSubscription).
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::WebhookSubscription] The requested [Subscription](entity:WebhookSubscription).
