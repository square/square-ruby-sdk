...
module SquareApiClient
  class PaymentBalanceActivitySquarePayrollTransferDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivitySquarePayrollTransferDetail]
...
# Serialize an instance of PaymentBalanceActivitySquarePayrollTransferDetail to a
#  JSON object
    #
    # @return [String]
    def to_json
