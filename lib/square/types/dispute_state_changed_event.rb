...
require_relative "dispute_state_changed_event_data"
require "ostruct"
require "json"
...
#  data includes details of what changed.
  class DisputeStateChangedEvent
  ...
  # @return [SquareApiClient::DisputeStateChangedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::DisputeStateChangedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputeStateChangedEvent]
...
# Deserialize a JSON object to an instance of DisputeStateChangedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::DisputeStateChangedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of DisputeStateChangedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::DisputeStateChangedEventData.validate_raw(obj: obj.data)
    end
  end
end