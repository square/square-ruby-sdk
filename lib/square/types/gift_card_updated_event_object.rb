...
#  event.
  ...
  # @return [square.rb::GiftCard] The gift card with the updated `balance_money`, `state`, or `customer_ids`
#  field.
#  Some events can affect both `balance_money` and `state`.
  ...
  # @return [Object] 
    ...
    # @param gift_card [square.rb::GiftCard] The gift card with the updated `balance_money`, `state`, or `customer_ids`
#  field.
#  Some events can affect both `balance_money` and `state`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::GiftCardUpdatedEventObject]
