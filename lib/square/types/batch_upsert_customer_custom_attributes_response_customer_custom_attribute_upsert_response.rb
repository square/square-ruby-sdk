...
#  operation.
  class BatchUpsertCustomerCustomAttributesResponseCustomerCustomAttributeUpsertResponse
  # @return [String] The ID of the customer profile associated with the custom attribute.
  ...
  # @return [Object] 
    ...
    # @param customer_id [String] The ID of the customer profile associated with the custom attribute.
    ...
    # @return [SquareApiClient::BatchUpsertCustomerCustomAttributesResponseCustomerCustomAttributeUpsertResponse]
    def initialize(customer_id: OMIT, custom_attribute: OMIT, errors: OMIT, additional_properties: nil)
      @customer_id = customer_id if customer_id != OMIT
      @custom_attribute = custom_attribute if custom_attribute != OMIT
      @errors = errors if errors != OMIT
      @additional_properties = additional_properties
      @_field_set = { "customer_id": customer_id, "custom_attribute": custom_attribute, "errors": errors }.reject do | _k, v |
  v == OMIT
end
    end
