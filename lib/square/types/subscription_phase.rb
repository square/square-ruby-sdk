...
#  after a `SubscriptionPhase` is created.
    attr_reader :uid
  # @return [SquareApiClient::SubscriptionCadence] The billing cadence of the phase. For example, weekly or monthly. This field
...
#  `SubscriptionPhase` is created.
    attr_reader :periods
  # @return [SquareApiClient::Money] The amount to bill for each `cadence`. Failure to specify this field results in
...
#  created.
    attr_reader :ordinal
  # @return [SquareApiClient::SubscriptionPricing] The subscription pricing.
    attr_reader :pricing
...
#  after a `SubscriptionPhase` is created.
    # @param cadence [SquareApiClient::SubscriptionCadence] The billing cadence of the phase. For example, weekly or monthly. This field
#  cannot be changed after a `SubscriptionPhase` is created.
#  See [SubscriptionCadence](#type-subscriptioncadence) for possible values
    # @param periods [Integer] The number of `cadence`s the phase lasts. If not set, the phase never ends. Only
#  the last phase can be indefinite. This field cannot be changed after a
#  `SubscriptionPhase` is created.
    # @param recurring_price_money [SquareApiClient::Money] The amount to bill for each `cadence`. Failure to specify this field results in
#  a `MISSING_REQUIRED_PARAMETER` error at runtime.
    # @param ordinal [Long] The position this phase appears in the sequence of phases defined for the plan,
#  indexed from 0. This field cannot be changed after a `SubscriptionPhase` is
#  created.
    # @param pricing [SquareApiClient::SubscriptionPricing] The subscription pricing.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::SubscriptionPhase]
...
# Deserialize a JSON object to an instance of SubscriptionPhase
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["recurring_price_money"].nil?
        ...
        recurring_price_money = SquareApiClient::Money.from_json(json_object: recurring_price_money)
      else
      ...
      unless parsed_json["pricing"].nil?
        ...
        pricing = SquareApiClient::SubscriptionPricing.from_json(json_object: pricing)
      else
        pricing = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.cadence.is_a?(SquareApiClient::SubscriptionCadence) != false || raise("Passed value for field obj.cadence is not the expected type, validation failed.")
      obj.periods&.is_a?(Integer) != false || raise("Passed value for field obj.periods is not the expected type, validation failed.")
      obj.recurring_price_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.recurring_price_money)
      obj.ordinal&.is_a?(Long) != false || raise("Passed value for field obj.ordinal is not the expected type, validation failed.")
      obj.pricing.nil? || SquareApiClient::SubscriptionPricing.validate_raw(obj: obj.pricing)
    end
  end
end