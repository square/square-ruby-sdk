...
module square.rb
  ...
  # @return [square.rb::Card] The card's non-confidential details.
    attr_reader :card
...
#  `KEYED`, `SWIPED`, `EMV`, `ON_FILE`, or `CONTACTLESS`.
  ...
  # @return [Object] 
    ...
    # @param card [square.rb::Card] The card's non-confidential details.
...
#  `KEYED`, `SWIPED`, `EMV`, `ON_FILE`, or `CONTACTLESS`.
    ...
    # @return [square.rb::DestinationDetailsCardRefundDetails]
