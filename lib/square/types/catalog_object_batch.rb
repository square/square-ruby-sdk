...
# A batch of catalog objects.
  ...
  # @return [Array<SquareApiClient::CatalogObject>] A list of CatalogObjects belonging to this batch.
    attr_reader :objects
  ...
  # @return [Object] 
    ...
    # @param objects [Array<SquareApiClient::CatalogObject>] A list of CatalogObjects belonging to this batch.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogObjectBatch]
