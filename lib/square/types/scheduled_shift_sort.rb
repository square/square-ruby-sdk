...
#  request.
  ...
  # @return [SquareApiClient::ScheduledShiftSortField] The field to sort on. The default value is `START_AT`.
#  See [ScheduledShiftSortField](#type-scheduledshiftsortfield) for possible values
    attr_reader :field
  # @return [SquareApiClient::SortOrder] The order in which results are returned. The default value is `ASC`.
#  See [SortOrder](#type-sortorder) for possible values
  ...
  # @return [Object] 
    ...
    # @param field [SquareApiClient::ScheduledShiftSortField] The field to sort on. The default value is `START_AT`.
#  See [ScheduledShiftSortField](#type-scheduledshiftsortfield) for possible values
    # @param order [SquareApiClient::SortOrder] The order in which results are returned. The default value is `ASC`.
#  See [SortOrder](#type-sortorder) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::ScheduledShiftSort]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.field&.is_a?(SquareApiClient::ScheduledShiftSortField) != false || raise("Passed value for field obj.field is not the expected type, validation failed.")
