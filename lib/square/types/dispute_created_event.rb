...
# Published when a [Dispute](entity:Dispute) is created.
  ...
  # @return [square.rb::DisputeCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::DisputeCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DisputeCreatedEvent]
...
# Deserialize a JSON object to an instance of DisputeCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::DisputeCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::DisputeCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end