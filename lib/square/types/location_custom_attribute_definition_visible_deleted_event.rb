...
#  definition can only
#  be deleted by the application that created it. A notification is sent when your
#  application deletes
...
#  `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class LocationCustomAttributeDefinitionVisibleDeletedEvent
...
#  3339 format.
    ...
    # @return [square.rb::LocationCustomAttributeDefinitionVisibleDeletedEvent]
...
# Serialize an instance of LocationCustomAttributeDefinitionVisibleDeletedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
