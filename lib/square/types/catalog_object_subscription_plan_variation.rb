...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogSubscriptionPlanVariation] Structured data for a `CatalogSubscriptionPlanVariation`, set for CatalogObjects
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param subscription_plan_variation_data [SquareApiClient::CatalogSubscriptionPlanVariation] Structured data for a `CatalogSubscriptionPlanVariation`, set for CatalogObjects
#  of type `SUBSCRIPTION_PLAN_VARIATION`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectSubscriptionPlanVariation]
...
#  CatalogObjectSubscriptionPlanVariation
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["subscription_plan_variation_data"].nil?
        ...
        subscription_plan_variation_data = SquareApiClient::CatalogSubscriptionPlanVariation.from_json(json_object: subscription_plan_variation_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.subscription_plan_variation_data.nil? || SquareApiClient::CatalogSubscriptionPlanVariation.validate_raw(obj: obj.subscription_plan_variation_data)
