...
#  app is updated.
  class OrderCustomAttributeDefinitionOwnedUpdatedEvent
...
#  `"order.custom_attribute_definition.owned.updated"`.
    ...
    # @return [square.rb::OrderCustomAttributeDefinitionOwnedUpdatedEvent]
...
# Serialize an instance of OrderCustomAttributeDefinitionOwnedUpdatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
