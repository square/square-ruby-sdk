...
require_relative "card_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [card](entity:Card) is updated by the seller in the Square
#  Dashboard.
  class CardUpdatedEvent
  # @return [String] The ID of the target seller associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"card.updated"`.
    attr_reader :type
  ...
  # @return [SquareApiClient::CardUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"card.updated"`.
    ...
    # @param data [SquareApiClient::CardUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardUpdatedEvent]
...
# Deserialize a JSON object to an instance of CardUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CardUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CardUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CardUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end