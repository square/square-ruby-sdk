...
module square.rb
  ...
  # @return [square.rb::OrderUpdated] Information about the updated order.
  ...
  # @return [Object] 
    ...
    # @param order_updated [square.rb::OrderUpdated] Information about the updated order.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderUpdatedObject]
...
# Deserialize a JSON object to an instance of OrderUpdatedObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["order_updated"].nil?
        ...
        order_updated = square.rb::OrderUpdated.from_json(json_object: order_updated)
      else
        order_updated = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.order_updated.nil? || square.rb::OrderUpdated.validate_raw(obj: obj.order_updated)
    end
  end
end