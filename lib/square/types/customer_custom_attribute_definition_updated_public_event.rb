...
#  that is visible to all applications is updated. A notification is sent when any
...
#  .visible.updated](webhook:customer.custom_attribute_definition.visible.updated),
#  which applies to custom attribute definitions that are visible to the
#  subscribing application.
  class CustomerCustomAttributeDefinitionUpdatedPublicEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionUpdatedPublicEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionUpdatedPublicEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
