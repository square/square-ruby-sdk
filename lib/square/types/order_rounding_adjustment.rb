...
#  denomination of the currency.
  ...
  # @return [String] The name of the rounding adjustment from the original sale order.
    attr_reader :name
  # @return [SquareApiClient::Money] The actual rounding adjustment amount.
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The actual rounding adjustment amount.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderRoundingAdjustment]
