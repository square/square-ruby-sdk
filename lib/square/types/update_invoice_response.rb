...
# Describes a `UpdateInvoice` response.
  ...
  # @return [square.rb::Invoice] The updated invoice.
    attr_reader :invoice
  ...
  # @return [Object] 
    ...
    # @param invoice [square.rb::Invoice] The updated invoice.
...
# Deserialize a JSON object to an instance of UpdateInvoiceResponse
    #
...
# Serialize an instance of UpdateInvoiceResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
