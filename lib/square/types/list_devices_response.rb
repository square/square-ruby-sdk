...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Information about errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::Device>] The requested list of `Device` objects.
    attr_reader :devices
...
#  for more information.
  ...
  # @return [Object] 
    ...
    # @param errors [Array<square.rb::Error>] Information about errors that occurred during the request.
    # @param devices [Array<square.rb::Device>] The requested list of `Device` objects.
...
#  for more information.
    ...
    # @return [square.rb::ListDevicesResponse]
...
# Deserialize a JSON object to an instance of ListDevicesResponse
  ...
  item = item.to_json
  square.rb::Device.from_json(json_object: item)
end
