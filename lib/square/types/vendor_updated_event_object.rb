...
module SquareApiClient
  ...
  # @return [SquareApiClient::VENDOR_UPDATED_EVENT_OBJECT_OPERATION] The operation on the vendor that caused the event to be published. The value is
#  `UPDATED`.
#  See [Operation](#type-operation) for possible values
    attr_reader :operation
  # @return [SquareApiClient::Vendor] The updated vendor as the result of the specified operation.
    attr_reader :vendor
  ...
  # @return [Object] 
    ...
    # @param operation [SquareApiClient::VENDOR_UPDATED_EVENT_OBJECT_OPERATION] The operation on the vendor that caused the event to be published. The value is
#  `UPDATED`.
#  See [Operation](#type-operation) for possible values
    # @param vendor [SquareApiClient::Vendor] The updated vendor as the result of the specified operation.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::VendorUpdatedEventObject]
