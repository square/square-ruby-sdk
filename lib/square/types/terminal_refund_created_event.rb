...
# Published when a Terminal API refund is created.
  ...
  # @return [square.rb::TerminalRefundCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::TerminalRefundCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TerminalRefundCreatedEvent]
...
# Deserialize a JSON object to an instance of TerminalRefundCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::TerminalRefundCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::TerminalRefundCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end