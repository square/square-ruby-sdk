...
# A range of purchase price that qualifies.
  ...
  # @return [Object] 
    ...
    # @param min [SquareApiClient::Money] 
    # @param max [SquareApiClient::Money] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange]
...
#  CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["min"].nil?
        ...
        min = SquareApiClient::Money.from_json(json_object: min)
      else
        min = nil
      end
      unless parsed_json["max"].nil?
        max = parsed_json["max"].to_json
        max = SquareApiClient::Money.from_json(json_object: max)
      else
        max = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      SquareApiClient::Money.validate_raw(obj: obj.min)
      SquareApiClient::Money.validate_raw(obj: obj.max)
    end
  end
end