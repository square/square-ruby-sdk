...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::CatalogObject] The successfully created or updated CatalogObject.
  ...
  # @return [Object] 
    ...
    # @param catalog_object [square.rb::CatalogObject] The successfully created or updated CatalogObject.
...
# Deserialize a JSON object to an instance of UpsertCatalogObjectResponse
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["catalog_object"].nil?
        ...
        catalog_object = square.rb::CatalogObject.from_json(json_object: catalog_object)
      else
        catalog_object = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.catalog_object.nil? || square.rb::CatalogObject.validate_raw(obj: obj.catalog_object)
