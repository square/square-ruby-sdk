...
# The query used to search for buyer-accessible availabilities of bookings.
  ...
  # @return [square.rb::SearchAvailabilityFilter] The query filter to search for buyer-accessible availabilities of existing
#  bookings.
    attr_reader :filter
  ...
  # @return [Object] 
    ...
    # @param filter [square.rb::SearchAvailabilityFilter] The query filter to search for buyer-accessible availabilities of existing
#  bookings.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchAvailabilityQuery]
...
# Deserialize a JSON object to an instance of SearchAvailabilityQuery
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["filter"].nil?
        ...
        filter = square.rb::SearchAvailabilityFilter.from_json(json_object: filter)
      else
        filter = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      square.rb::SearchAvailabilityFilter.validate_raw(obj: obj.filter)
    end
  end
end