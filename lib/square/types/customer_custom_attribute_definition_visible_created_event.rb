...
#  `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class CustomerCustomAttributeDefinitionVisibleCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionVisibleCreatedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionVisibleCreatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
