...
#  tributes](https://developer.squareup.com/docs/catalog-api/add-custom-attributes)
  ...
  # @return [square.rb::CatalogCustomAttributeDefinitionType] The type of this custom attribute. Cannot be modified after creation.
#  Required.
#  See
...
#  tooltip in Square UIs.
  ...
  # @return [square.rb::SourceApplication] __Read only.__ Contains information about the application that
#  created this custom attribute definition.
    attr_reader :source_application
  # @return [Array<square.rb::CatalogObjectType>] The set of `CatalogObject` types that this custom atttribute may be applied to.
...
#  See [CatalogObjectType](#type-catalogobjecttype) for possible values
  ...
  # @return [square.rb::CatalogCustomAttributeDefinitionSellerVisibility] The visibility of a custom attribute in seller-facing UIs (including Square
#  Point
...
#  for possible values
  ...
  # @return [square.rb::CatalogCustomAttributeDefinitionAppVisibility] The visibility of a custom attribute to applications other than the application
...
#  for possible values
  ...
  # @return [square.rb::CatalogCustomAttributeDefinitionStringConfig] Optionally, populated when `type` = `STRING`, unset otherwise.
    attr_reader :string_config
  # @return [square.rb::CatalogCustomAttributeDefinitionNumberConfig] Optionally, populated when `type` = `NUMBER`, unset otherwise.
    attr_reader :number_config
  # @return [square.rb::CatalogCustomAttributeDefinitionSelectionConfig] Populated when `type` is set to `SELECTION`, unset otherwise.
...
#  `[a-zA-Z0-9_-]`.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::CatalogCustomAttributeDefinitionType] The type of this custom attribute. Cannot be modified after creation.
#  Required.
#  See
#  atalogCustomAttributeDefinitionType](#type-catalogcustomattributedefinitiontype)
#  for possible values
...
#  any constraints that the seller should observe, etc. May be displayed as a
#  tooltip in Square UIs.
    # @param source_application [square.rb::SourceApplication] __Read only.__ Contains information about the application that
#  created this custom attribute definition.
    # @param allowed_object_types [Array<square.rb::CatalogObjectType>] The set of `CatalogObject` types that this custom atttribute may be applied to.
#  Currently, only `ITEM`, `ITEM_VARIATION`, `MODIFIER`, `MODIFIER_LIST`, and
#  `CATEGORY` are allowed. At least one type must be included.
#  See [CatalogObjectType](#type-catalogobjecttype) for possible values
    # @param seller_visibility [square.rb::CatalogCustomAttributeDefinitionSellerVisibility] The visibility of a custom attribute in seller-facing UIs (including Square
#  Point
#  of Sale applications and Square Dashboard). May be modified.
#  See
#  initionSellerVisibility](#type-catalogcustomattributedefinitionsellervisibility)
#  for possible values
    # @param app_visibility [square.rb::CatalogCustomAttributeDefinitionAppVisibility] The visibility of a custom attribute to applications other than the application
#  that created the attribute.
#  See
#  uteDefinitionAppVisibility](#type-catalogcustomattributedefinitionappvisibility)
#  for possible values
    # @param string_config [square.rb::CatalogCustomAttributeDefinitionStringConfig] Optionally, populated when `type` = `STRING`, unset otherwise.
    # @param number_config [square.rb::CatalogCustomAttributeDefinitionNumberConfig] Optionally, populated when `type` = `NUMBER`, unset otherwise.
    # @param selection_config [square.rb::CatalogCustomAttributeDefinitionSelectionConfig] Populated when `type` is set to `SELECTION`, unset otherwise.
...
#  `[a-zA-Z0-9_-]`.
    ...
    # @return [square.rb::CatalogCustomAttributeDefinition]
...
# Deserialize a JSON object to an instance of CatalogCustomAttributeDefinition
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["source_application"].nil?
        ...
        source_application = square.rb::SourceApplication.from_json(json_object: source_application)
      else
      ...
      unless parsed_json["string_config"].nil?
        ...
        string_config = square.rb::CatalogCustomAttributeDefinitionStringConfig.from_json(json_object: string_config)
      else
        string_config = nil
      end
      unless parsed_json["number_config"].nil?
        number_config = parsed_json["number_config"].to_json
        number_config = square.rb::CatalogCustomAttributeDefinitionNumberConfig.from_json(json_object: number_config)
      else
        number_config = nil
      end
      unless parsed_json["selection_config"].nil?
        selection_config = parsed_json["selection_config"].to_json
        selection_config = square.rb::CatalogCustomAttributeDefinitionSelectionConfig.from_json(json_object: selection_config)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type.is_a?(square.rb::CatalogCustomAttributeDefinitionType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.name.is_a?(String) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
      obj.description&.is_a?(String) != false || raise("Passed value for field obj.description is not the expected type, validation failed.")
      obj.source_application.nil? || square.rb::SourceApplication.validate_raw(obj: obj.source_application)
      ...
      obj.seller_visibility&.is_a?(square.rb::CatalogCustomAttributeDefinitionSellerVisibility) != false || raise("Passed value for field obj.seller_visibility is not the expected type, validation failed.")
      obj.app_visibility&.is_a?(square.rb::CatalogCustomAttributeDefinitionAppVisibility) != false || raise("Passed value for field obj.app_visibility is not the expected type, validation failed.")
      obj.string_config.nil? || square.rb::CatalogCustomAttributeDefinitionStringConfig.validate_raw(obj: obj.string_config)
      obj.number_config.nil? || square.rb::CatalogCustomAttributeDefinitionNumberConfig.validate_raw(obj: obj.number_config)
      obj.selection_config.nil? || square.rb::CatalogCustomAttributeDefinitionSelectionConfig.validate_raw(obj: obj.selection_config)
