...
# Published when an [Invoice](entity:Invoice) is canceled.
  ...
  # @return [square.rb::InvoiceCanceledEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::InvoiceCanceledEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::InvoiceCanceledEvent]
...
# Deserialize a JSON object to an instance of InvoiceCanceledEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::InvoiceCanceledEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::InvoiceCanceledEventData.validate_raw(obj: obj.data)
    end
  end
end