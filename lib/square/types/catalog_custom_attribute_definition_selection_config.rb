...
#  handle custom attributes with more selected values than allowed by this limit.
  ...
  # @return [Array<square.rb::CatalogCustomAttributeDefinitionSelectionConfigCustomAttributeSelection>] The set of valid `CatalogCustomAttributeSelections`. Up to a maximum of 100
...
#  affect existing custom attribute values on objects. Clients need to
#  handle custom attributes with more selected values than allowed by this limit.
    # @param allowed_selections [Array<square.rb::CatalogCustomAttributeDefinitionSelectionConfigCustomAttributeSelection>] The set of valid `CatalogCustomAttributeSelections`. Up to a maximum of 100
#  selections can be defined. Can be modified.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CatalogCustomAttributeDefinitionSelectionConfig]
...
#  CatalogCustomAttributeDefinitionSelectionConfig
  ...
  item = item.to_json
  square.rb::CatalogCustomAttributeDefinitionSelectionConfigCustomAttributeSelection.from_json(json_object: item)
end
      new(
