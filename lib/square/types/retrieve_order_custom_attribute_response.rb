...
# Represents a response from getting an order custom attribute.
  ...
  # @return [SquareApiClient::CustomAttribute] The retrieved custom attribute. If `with_definition` was set to `true` in the
#  request, the custom attribute definition is returned in the `definition field.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute [SquareApiClient::CustomAttribute] The retrieved custom attribute. If `with_definition` was set to `true` in the
#  request, the custom attribute definition is returned in the `definition field.
