...
#  [BulkRetrieveVendors](api-endpoint:Vendors-BulkRetrieveVendors).
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Hash{String => SquareApiClient::GetVendorResponse}] The set of [RetrieveVendorResponse](entity:RetrieveVendorResponse) objects
...
#  a collection of `Vendor`-ID/`Vendor`-object or `Vendor`-ID/error-object pairs.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => SquareApiClient::GetVendorResponse}] The set of [RetrieveVendorResponse](entity:RetrieveVendorResponse) objects
#  encapsulating successfully retrieved [Vendor](entity:Vendor)
#  objects or error responses for failed attempts. The set is represented by
#  a collection of `Vendor`-ID/`Vendor`-object or `Vendor`-ID/error-object pairs.
...
# Deserialize a JSON object to an instance of BatchGetVendorsResponse
  ...
  value = value.to_json
  SquareApiClient::GetVendorResponse.from_json(json_object: value)
end
      new(
        errors: errors,
        responses: responses,
