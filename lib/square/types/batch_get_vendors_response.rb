...
#  [BulkRetrieveVendors](api-endpoint:Vendors-BulkRetrieveVendors).
  class BatchGetVendorsResponse
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Hash{String => square.rb::GetVendorResponse}] The set of [RetrieveVendorResponse](entity:RetrieveVendorResponse) objects
#  encapsulating successfully retrieved [Vendor](entity:Vendor)
...
#  a collection of `Vendor`-ID/`Vendor`-object or `Vendor`-ID/error-object pairs.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => square.rb::GetVendorResponse}] The set of [RetrieveVendorResponse](entity:RetrieveVendorResponse) objects
#  encapsulating successfully retrieved [Vendor](entity:Vendor)
#  objects or error responses for failed attempts. The set is represented by
#  a collection of `Vendor`-ID/`Vendor`-object or `Vendor`-ID/error-object pairs.
...
# Deserialize a JSON object to an instance of BatchGetVendorsResponse
    #
  ...
  value = value.to_json
  square.rb::GetVendorResponse.from_json(json_object: value)
end
      new(
        errors: errors,
        responses: responses,
...
# Serialize an instance of BatchGetVendorsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
