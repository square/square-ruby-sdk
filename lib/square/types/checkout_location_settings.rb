...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::CheckoutLocationSettingsPolicy>] Policy information is displayed at the bottom of the checkout pages.
#  You can set a maximum of two policies.
    attr_reader :policies
  # @return [SquareApiClient::CheckoutLocationSettingsBranding] The branding settings for this location.
    attr_reader :branding
  # @return [SquareApiClient::CheckoutLocationSettingsTipping] The tip settings for this location.
    attr_reader :tipping
  # @return [SquareApiClient::CheckoutLocationSettingsCoupons] The coupon settings for this location.
    attr_reader :coupons
...
#  Pacific Standard Time with UTC offset: 2020-01-25T18:25:34-08:00
  ...
  # @return [Object] 
    ...
    # @param policies [Array<SquareApiClient::CheckoutLocationSettingsPolicy>] Policy information is displayed at the bottom of the checkout pages.
#  You can set a maximum of two policies.
    # @param branding [SquareApiClient::CheckoutLocationSettingsBranding] The branding settings for this location.
    # @param tipping [SquareApiClient::CheckoutLocationSettingsTipping] The tip settings for this location.
    # @param coupons [SquareApiClient::CheckoutLocationSettingsCoupons] The coupon settings for this location.
    # @param updated_at [String] The timestamp when the settings were last updated, in RFC 3339 format.
#  Examples for January 25th, 2020 6:25:34pm Pacific Standard Time:
#  UTC: 2020-01-26T02:25:34Z
#  Pacific Standard Time with UTC offset: 2020-01-25T18:25:34-08:00
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CheckoutLocationSettings]
...
# Deserialize a JSON object to an instance of CheckoutLocationSettings
  ...
  item = item.to_json
  SquareApiClient::CheckoutLocationSettingsPolicy.from_json(json_object: item)
end
      unless parsed_json["branding"].nil?
        branding = parsed_json["branding"].to_json
        branding = SquareApiClient::CheckoutLocationSettingsBranding.from_json(json_object: branding)
      else
        branding = nil
      end
      unless parsed_json["tipping"].nil?
        tipping = parsed_json["tipping"].to_json
        tipping = SquareApiClient::CheckoutLocationSettingsTipping.from_json(json_object: tipping)
      else
        tipping = nil
      end
      unless parsed_json["coupons"].nil?
        coupons = parsed_json["coupons"].to_json
        coupons = SquareApiClient::CheckoutLocationSettingsCoupons.from_json(json_object: coupons)
      else
        coupons = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.branding.nil? || SquareApiClient::CheckoutLocationSettingsBranding.validate_raw(obj: obj.branding)
      obj.tipping.nil? || SquareApiClient::CheckoutLocationSettingsTipping.validate_raw(obj: obj.tipping)
      obj.coupons.nil? || SquareApiClient::CheckoutLocationSettingsCoupons.validate_raw(obj: obj.coupons)
