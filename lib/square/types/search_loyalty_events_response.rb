...
#  criteria, in order by the `created_at` date.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::LoyaltyEvent>] The loyalty events that satisfy the search criteria.
    attr_reader :events
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param events [Array<square.rb::LoyaltyEvent>] The loyalty events that satisfy the search criteria.
