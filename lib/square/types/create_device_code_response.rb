...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::DeviceCode] The created DeviceCode object containing the device code string.
  ...
  # @return [Object] 
    ...
    # @param device_code [SquareApiClient::DeviceCode] The created DeviceCode object containing the device code string.
