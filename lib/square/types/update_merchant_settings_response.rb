...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred when updating the merchant settings.
    attr_reader :errors
  ...
  # @return [Object] 
    ...
    # @param errors [Array<square.rb::Error>] Any errors that occurred when updating the merchant settings.
