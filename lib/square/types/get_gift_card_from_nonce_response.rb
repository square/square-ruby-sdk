...
#  the response contains a set of `Error` objects.
  class GetGiftCardFromNonceResponse
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::GiftCard] The retrieved gift card.
  ...
  # @return [Object] 
    ...
    # @param gift_card [SquareApiClient::GiftCard] The retrieved gift card.
...
# Deserialize a JSON object to an instance of GetGiftCardFromNonceResponse
    #
...
# Serialize an instance of GetGiftCardFromNonceResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
