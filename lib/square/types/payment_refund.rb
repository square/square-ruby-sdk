...
#  `EXTERNAL`, and `SQUARE_ACCOUNT`.
  ...
  # @return [square.rb::DestinationDetails] Contains information about the refund destination. This field is populated only
#  if
#  `destination_id` is defined in the `RefundPayment` request.
    attr_reader :destination_details
  # @return [square.rb::Money] The amount of money refunded. This amount is specified in the smallest
#  denomination
#  of the applicable currency (for example, US dollar amounts are specified in
#  cents).
    attr_reader :amount_money
  # @return [square.rb::Money] The amount of money the application developer contributed to help cover the
#  refunded amount.
...
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
  ...
  # @return [Array<square.rb::ProcessingFee>] Processing fees and fee adjustments assessed by Square for this refund.
...
#  `CASH`,
#  `EXTERNAL`, and `SQUARE_ACCOUNT`.
    # @param destination_details [square.rb::DestinationDetails] Contains information about the refund destination. This field is populated only
#  if
#  `destination_id` is defined in the `RefundPayment` request.
    # @param amount_money [square.rb::Money] The amount of money refunded. This amount is specified in the smallest
#  denomination
#  of the applicable currency (for example, US dollar amounts are specified in
#  cents).
    # @param app_fee_money [square.rb::Money] The amount of money the application developer contributed to help cover the
#  refunded amount.
#  This amount is specified in the smallest denomination of the applicable currency
#  (for example,
#  US dollar amounts are specified in cents). For more information, see
#  [Working with Monetary
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
    # @param processing_fee [Array<square.rb::ProcessingFee>] Processing fees and fee adjustments assessed by Square for this refund.
    ...
    # @return [square.rb::PaymentRefund]
...
# Deserialize a JSON object to an instance of PaymentRefund
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["destination_details"].nil?
        ...
        destination_details = square.rb::DestinationDetails.from_json(json_object: destination_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.destination_details.nil? || square.rb::DestinationDetails.validate_raw(obj: obj.destination_details)
