...
#  `payment_id`.
  ...
  # @return [square.rb::Money] The amount of money, inclusive of `tax_money`, that the `TerminalRefund` should
#  return.
...
#  `COMPLETED`.
    attr_reader :status
  # @return [square.rb::ActionCancelReason] Present if the status is `CANCELED`.
...
#  `payment_id`.
    # @param amount_money [square.rb::Money] The amount of money, inclusive of `tax_money`, that the `TerminalRefund` should
#  return.
#  This value is limited to the amount taken in the original payment minus any
#  completed or
#  pending refunds.
...
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, or
#  `COMPLETED`.
    # @param cancel_reason [square.rb::ActionCancelReason] Present if the status is `CANCELED`.
#  See [ActionCancelReason](#type-actioncancelreason) for possible values
    ...
    # @return [square.rb::TerminalRefund]
