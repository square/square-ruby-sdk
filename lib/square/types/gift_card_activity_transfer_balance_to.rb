...
#  type](entity:GiftCardActivityType).
  ...
  # @return [square.rb::Money] The amount added to the gift card balance for the transfer. This value is a
#  positive integer.
  ...
  # @return [Object] 
    ...
    # @param amount_money [square.rb::Money] The amount added to the gift card balance for the transfer. This value is a
#  positive integer.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::GiftCardActivityTransferBalanceTo]
