...
# The payment the cardholder disputed.
  ...
  # @return [String] Square-generated unique ID of the payment being disputed.
  ...
  # @return [Object] 
    ...
    # @param payment_id [String] Square-generated unique ID of the payment being disputed.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputedPayment]
...
# Deserialize a JSON object to an instance of DisputedPayment
    #
...
# Serialize an instance of DisputedPayment to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
