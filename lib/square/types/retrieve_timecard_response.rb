...
#  the request resulted in errors.
  class RetrieveTimecardResponse
  # @return [square.rb::Timecard] The requested `Timecard`.
  ...
  # @return [Object] 
    ...
    # @param timecard [square.rb::Timecard] The requested `Timecard`.
...
# Deserialize a JSON object to an instance of RetrieveTimecardResponse
    #
...
# Serialize an instance of RetrieveTimecardResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
