...
# Represents an action as a pending change to a subscription.
  ...
  # @return [String] The ID of an action scoped to a subscription.
    attr_reader :id
  # @return [square.rb::SubscriptionActionType] The type of the action.
...
#  `SWAP_PLAN` action.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::SubscriptionActionType] The type of the action.
#  See [SubscriptionActionType](#type-subscriptionactiontype) for possible values
...
#  `SWAP_PLAN` action.
    ...
    # @return [square.rb::SubscriptionAction]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(square.rb::SubscriptionActionType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
