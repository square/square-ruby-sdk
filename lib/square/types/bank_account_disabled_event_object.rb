...
module SquareApiClient
  class BankAccountDisabledEventObject
  # @return [SquareApiClient::BankAccount] The disabled bank account.
  ...
  # @return [Object] 
    ...
    # @param bank_account [SquareApiClient::BankAccount] The disabled bank account.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BankAccountDisabledEventObject]
...
# Deserialize a JSON object to an instance of BankAccountDisabledEventObject
    #
...
# Serialize an instance of BankAccountDisabledEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
