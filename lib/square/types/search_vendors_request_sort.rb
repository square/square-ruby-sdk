...
#  [SearchVendors](api-endpoint:Vendors-SearchVendors).
  ...
  # @return [square.rb::SearchVendorsRequestSortField] Specifies the sort key to sort the returned vendors.
#  See [Field](#type-field) for possible values
    attr_reader :field
  # @return [square.rb::SortOrder] Specifies the sort order for the returned vendors.
#  See [SortOrder](#type-sortorder) for possible values
  ...
  # @return [Object] 
    ...
    # @param field [square.rb::SearchVendorsRequestSortField] Specifies the sort key to sort the returned vendors.
#  See [Field](#type-field) for possible values
    # @param order [square.rb::SortOrder] Specifies the sort order for the returned vendors.
#  See [SortOrder](#type-sortorder) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchVendorsRequestSort]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.field&.is_a?(square.rb::SearchVendorsRequestSortField) != false || raise("Passed value for field obj.field is not the expected type, validation failed.")
