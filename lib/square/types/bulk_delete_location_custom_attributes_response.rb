...
#  request.
  ...
  # @return [Hash{String => SquareApiClient::BulkDeleteLocationCustomAttributesResponseLocationCustomAttributeDeleteResponse}] A map of responses that correspond to individual delete requests. Each response
#  has the
#  same key as the corresponding request.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => SquareApiClient::BulkDeleteLocationCustomAttributesResponseLocationCustomAttributeDeleteResponse}] A map of responses that correspond to individual delete requests. Each response
#  has the
#  same key as the corresponding request.
...
#  BulkDeleteLocationCustomAttributesResponse
  ...
  value = value.to_json
  SquareApiClient::BulkDeleteLocationCustomAttributesResponseLocationCustomAttributeDeleteResponse.from_json(json_object: value)
end
