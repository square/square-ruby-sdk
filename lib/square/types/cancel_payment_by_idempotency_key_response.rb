...
#  elPaymentByIdempotencyKey](api-endpoint:Payments-CancelPaymentByIdempotencyKey).
...
# Serialize an instance of CancelPaymentByIdempotencyKeyResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
