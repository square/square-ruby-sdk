...
#  object or error messages.
  ...
  # @return [square.rb::TeamMember] The successfully updated `TeamMember` object.
  ...
  # @return [Object] 
    ...
    # @param team_member [square.rb::TeamMember] The successfully updated `TeamMember` object.
...
# Deserialize a JSON object to an instance of UpdateTeamMemberResponse
    #
...
# Serialize an instance of UpdateTeamMemberResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
