...
# Describes delivery details of an order fulfillment.
  ...
  # @return [square.rb::FulfillmentRecipient] The contact information for the person to receive the fulfillment.
    attr_reader :recipient
  # @return [square.rb::FulfillmentDeliveryDetailsOrderFulfillmentDeliveryDetailsScheduleType] Indicates the fulfillment delivery schedule type. If `SCHEDULED`, then
...
#  we may not receive all recipient information for PII purposes.
  ...
  # @return [Object] 
    ...
    # @param recipient [square.rb::FulfillmentRecipient] The contact information for the person to receive the fulfillment.
    # @param schedule_type [square.rb::FulfillmentDeliveryDetailsOrderFulfillmentDeliveryDetailsScheduleType] Indicates the fulfillment delivery schedule type. If `SCHEDULED`, then
#  `deliver_at` is required. If `ASAP`, then `prep_time_duration` is required. The
#  default is `SCHEDULED`.
#  See
#  tDeliveryDetailsScheduleType](#type-orderfulfillmentdeliverydetailsscheduletype)
...
#  we may not receive all recipient information for PII purposes.
    ...
    # @return [square.rb::FulfillmentDeliveryDetails]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.schedule_type&.is_a?(square.rb::FulfillmentDeliveryDetailsOrderFulfillmentDeliveryDetailsScheduleType) != false || raise("Passed value for field obj.schedule_type is not the expected type, validation failed.")
