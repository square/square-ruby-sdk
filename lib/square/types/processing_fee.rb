...
#  `ADJUSTMENT`.
    attr_reader :type
  # @return [square.rb::Money] The fee amount, which might be negative, that is assessed or adjusted by Square.
...
#  `ADJUSTMENT`.
    # @param amount_money [square.rb::Money] The fee amount, which might be negative, that is assessed or adjusted by Square.
#  Positive values represent funds being assessed, while negative values represent
#  funds being returned.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::ProcessingFee]
