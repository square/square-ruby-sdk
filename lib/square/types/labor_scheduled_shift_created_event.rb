...
require_relative "labor_scheduled_shift_created_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [ScheduledShift](entity:ScheduledShift) is created.
  class LaborScheduledShiftCreatedEvent
  # @return [String] The ID of the merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The ID of the location associated with the event.
    attr_reader :location_id
  # @return [String] The type of event. For this event, the value is `labor.scheduled_shift.created`.
    attr_reader :type
  ...
  # @return [SquareApiClient::LaborScheduledShiftCreatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param location_id [String] The ID of the location associated with the event.
    # @param type [String] The type of event. For this event, the value is `labor.scheduled_shift.created`.
    ...
    # @param data [SquareApiClient::LaborScheduledShiftCreatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborScheduledShiftCreatedEvent]
...
# Deserialize a JSON object to an instance of LaborScheduledShiftCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborScheduledShiftCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborScheduledShiftCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborScheduledShiftCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end