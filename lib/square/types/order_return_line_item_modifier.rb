...
#  original sale of this line item modifier.
  ...
  # @return [String] The name of the item modifier.
    attr_reader :name
  # @return [SquareApiClient::Money] The base price for the modifier.
...
#  overrides the predefined [CatalogModifier](entity:CatalogModifier) price.
  ...
  # @return [SquareApiClient::Money] The total price of the item modifier for its line item.
...
#  original sale of this line item modifier.
    ...
    # @param base_price_money [SquareApiClient::Money] The base price for the modifier.
#  `base_price_money` is required for ad hoc modifiers.
#  If both `catalog_object_id` and `base_price_money` are set, `base_price_money`
#  overrides the predefined [CatalogModifier](entity:CatalogModifier) price.
    # @param total_price_money [SquareApiClient::Money] The total price of the item modifier for its line item.
#  This is the modifier's `base_price_money` multiplied by the line item's
#  quantity.
...
#  any cheese, the modifier quantity is set to 0.
    ...
    # @return [SquareApiClient::OrderReturnLineItemModifier]
...
# Deserialize a JSON object to an instance of OrderReturnLineItemModifier
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["total_price_money"].nil?
        ...
        total_price_money = SquareApiClient::Money.from_json(json_object: total_price_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.total_price_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.total_price_money)
