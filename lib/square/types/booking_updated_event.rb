...
#  `APPOINTMENTS_ALL_READ` and `APPOINTMENTS_READ` set for the OAuth scope.
  ...
  # @return [square.rb::BookingUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::BookingUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::BookingUpdatedEvent]
...
# Deserialize a JSON object to an instance of BookingUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::BookingUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::BookingUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end