...
require_relative "booking_updated_event_data"
require "ostruct"
require "json"
...
#  `APPOINTMENTS_ALL_READ` and `APPOINTMENTS_READ` set for the OAuth scope.
  ...
  # @return [String] The type of this event. The value is `"booking.updated"`.
    attr_reader :type
  ...
  # @return [SquareApiClient::BookingUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"booking.updated"`.
    ...
    # @param data [SquareApiClient::BookingUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BookingUpdatedEvent]
...
# Deserialize a JSON object to an instance of BookingUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::BookingUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of BookingUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::BookingUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end