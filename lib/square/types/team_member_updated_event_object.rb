...
module square.rb
  ...
  # @return [square.rb::TeamMember] The updated team member.
  ...
  # @return [Object] 
    ...
    # @param team_member [square.rb::TeamMember] The updated team member.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TeamMemberUpdatedEventObject]
