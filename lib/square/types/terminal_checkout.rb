...
# Represents a checkout processed by the Square Terminal.
  ...
  # @return [String] A unique ID for this `TerminalCheckout`.
    attr_reader :id
  # @return [SquareApiClient::Money] The amount of money (including the tax amount) that the Square Terminal device
...
#  Note: maximum 500 characters
  ...
  # @return [SquareApiClient::PaymentOptions] Payment-specific options for the checkout request.
    attr_reader :payment_options
  # @return [SquareApiClient::DeviceCheckoutOptions] Options to control the display and behavior of the Square Terminal device.
...
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
    attr_reader :status
  # @return [SquareApiClient::ActionCancelReason] The reason why `TerminalCheckout` is canceled. Present if the status is
#  `CANCELED`.
#  See [ActionCancelReason](#type-actioncancelreason) for possible values
  ...
  # @return [SquareApiClient::CheckoutOptionsPaymentType] The type of payment the terminal should attempt to capture from. Defaults to
#  `CARD_PRESENT`.
...
#  or short description that uniquely identifies the purchase.
  ...
  # @return [SquareApiClient::Money] The amount designated as a tip, in addition to `amount_money`. This may only be
#  set for a
#  checkout that has tipping disabled (`tip_settings.allow_tipping` is `false`).
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The amount of money (including the tax amount) that the Square Terminal device
#  should try to collect.
...
#  Note: maximum 500 characters
    ...
    # @param payment_options [SquareApiClient::PaymentOptions] Payment-specific options for the checkout request.
    # @param device_options [SquareApiClient::DeviceCheckoutOptions] Options to control the display and behavior of the Square Terminal device.
...
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
    # @param cancel_reason [SquareApiClient::ActionCancelReason] The reason why `TerminalCheckout` is canceled. Present if the status is
#  `CANCELED`.
#  See [ActionCancelReason](#type-actioncancelreason) for possible values
    ...
    # @param payment_type [SquareApiClient::CheckoutOptionsPaymentType] The type of payment the terminal should attempt to capture from. Defaults to
#  `CARD_PRESENT`.
#  See [CheckoutOptionsPaymentType](#type-checkoutoptionspaymenttype) for possible
#  values
...
#  ticket number,
#  or short description that uniquely identifies the purchase.
    # @param tip_money [SquareApiClient::Money] The amount designated as a tip, in addition to `amount_money`. This may only be
#  set for a
#  checkout that has tipping disabled (`tip_settings.allow_tipping` is `false`).
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalCheckout]
...
# Deserialize a JSON object to an instance of TerminalCheckout
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["payment_options"].nil?
        ...
        payment_options = SquareApiClient::PaymentOptions.from_json(json_object: payment_options)
      else
        payment_options = nil
      end
      unless parsed_json["device_options"].nil?
        device_options = parsed_json["device_options"].to_json
        device_options = SquareApiClient::DeviceCheckoutOptions.from_json(json_object: device_options)
      else
        device_options = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.payment_options.nil? || SquareApiClient::PaymentOptions.validate_raw(obj: obj.payment_options)
      SquareApiClient::DeviceCheckoutOptions.validate_raw(obj: obj.device_options)
      ...
      obj.payment_type&.is_a?(SquareApiClient::CheckoutOptionsPaymentType) != false || raise("Passed value for field obj.payment_type is not the expected type, validation failed.")
