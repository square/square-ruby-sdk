...
# Defines the fields in a `ListDisputeEvidence` response.
  ...
  # @return [Array<SquareApiClient::DisputeEvidence>] The list of evidence previously uploaded to the specified dispute.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param evidence [Array<SquareApiClient::DisputeEvidence>] The list of evidence previously uploaded to the specified dispute.
...
# Deserialize a JSON object to an instance of ListDisputeEvidenceResponse
  ...
  item = item.to_json
  SquareApiClient::DisputeEvidence.from_json(json_object: item)
end
