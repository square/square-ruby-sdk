...
#  "Food Delivery Service".
  ...
  # @return [square.rb::Money] The fees paid to the source. The `amount_money` minus this field is
...
#  "Food Delivery Service".
    ...
    # @param source_fee_money [square.rb::Money] The fees paid to the source. The `amount_money` minus this field is
#  the net amount seller receives.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::ExternalPaymentDetails]
...
# Deserialize a JSON object to an instance of ExternalPaymentDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["source_fee_money"].nil?
        ...
        source_fee_money = square.rb::Money.from_json(json_object: source_fee_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.source_fee_money.nil? || square.rb::Money.validate_raw(obj: obj.source_fee_money)
    end
  end
end