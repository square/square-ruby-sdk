...
#  position. On reads, the value is not guaranteed to be sequential or unique.
    attr_reader :ordinal
  # @return [SquareApiClient::CatalogPricingType] Indicates whether the item variation's price is fixed or determined at the time
#  of sale.
#  See [CatalogPricingType](#type-catalogpricingtype) for possible values
    attr_reader :pricing_type
  # @return [SquareApiClient::Money] The item variation's price, if fixed pricing is used.
    attr_reader :price_money
  # @return [Array<SquareApiClient::ItemVariationLocationOverrides>] Per-location price and inventory overrides.
  ...
  # @return [SquareApiClient::InventoryAlertType] Indicates whether the item variation displays an alert when its inventory
...
#  for booking.
  ...
  # @return [Array<SquareApiClient::CatalogItemOptionValueForItemVariation>] List of item option values associated with this item variation. Listed
...
#  variations of type `APPOINTMENTS_SERVICE`.
  ...
  # @return [SquareApiClient::CatalogStockConversion] The unit conversion rule, as prescribed by the
...
#  item variations's
#  position. On reads, the value is not guaranteed to be sequential or unique.
    # @param pricing_type [SquareApiClient::CatalogPricingType] Indicates whether the item variation's price is fixed or determined at the time
#  of sale.
#  See [CatalogPricingType](#type-catalogpricingtype) for possible values
    # @param price_money [SquareApiClient::Money] The item variation's price, if fixed pricing is used.
    # @param location_overrides [Array<SquareApiClient::ItemVariationLocationOverrides>] Per-location price and inventory overrides.
    # @param track_inventory [Boolean] If `true`, inventory tracking is active for the variation.
    # @param inventory_alert_type [SquareApiClient::InventoryAlertType] Indicates whether the item variation displays an alert when its inventory
#  quantity is less than or equal
#  to its `inventory_alert_threshold`.
#  See [InventoryAlertType](#type-inventoryalerttype) for possible values
...
#  `APPOINTMENTS_SERVICE`, a bool representing whether this service is available
#  for booking.
    # @param item_option_values [Array<SquareApiClient::CatalogItemOptionValueForItemVariation>] List of item option values associated with this item variation. Listed
#  in the same order as the item options of the parent item.
...
#  Only valid for
#  variations of type `APPOINTMENTS_SERVICE`.
    # @param stockable_conversion [SquareApiClient::CatalogStockConversion] The unit conversion rule, as prescribed by the
#  [CatalogStockConversion](entity:CatalogStockConversion) type,
#  that describes how this non-stockable (i.e., sellable/receivable) item variation
#  is converted
#  to/from the stockable item variation sharing the same parent item. With the
...
#  another unit.
    ...
    # @return [SquareApiClient::CatalogItemVariation]
...
# Deserialize a JSON object to an instance of CatalogItemVariation
  ...
  item = item.to_json
  SquareApiClient::ItemVariationLocationOverrides.from_json(json_object: item)
end
  ...
  item = item.to_json
  SquareApiClient::CatalogItemOptionValueForItemVariation.from_json(json_object: item)
end
      ...
      unless parsed_json["stockable_conversion"].nil?
        ...
        stockable_conversion = SquareApiClient::CatalogStockConversion.from_json(json_object: stockable_conversion)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.stockable_conversion.nil? || SquareApiClient::CatalogStockConversion.validate_raw(obj: obj.stockable_conversion)
    end
  end
end