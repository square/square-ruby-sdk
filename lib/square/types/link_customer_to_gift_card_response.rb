...
#  the response contains a set of `Error` objects.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::GiftCard] The gift card with the ID of the linked customer listed in the `customer_ids`
#  field.
  ...
  # @return [Object] 
    ...
    # @param gift_card [square.rb::GiftCard] The gift card with the ID of the linked customer listed in the `customer_ids`
#  field.
