...
#  ](https://developer.squareup.com/docs/payments-api/take-payments/cash-payments).
  ...
  # @return [square.rb::Money] The amount and currency of the money supplied by the buyer.
    attr_reader :buyer_supplied_money
  # @return [square.rb::Money] The amount of change due back to the buyer.
...
#  from the `amount_money` and `buyer_supplied_money` fields.
  ...
  # @return [Object] 
    ...
    # @param buyer_supplied_money [square.rb::Money] The amount and currency of the money supplied by the buyer.
    # @param change_back_money [square.rb::Money] The amount of change due back to the buyer.
#  This read-only field is calculated
#  from the `amount_money` and `buyer_supplied_money` fields.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CashPaymentDetails]
...
# Deserialize a JSON object to an instance of CashPaymentDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["buyer_supplied_money"].nil?
        ...
        buyer_supplied_money = square.rb::Money.from_json(json_object: buyer_supplied_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      square.rb::Money.validate_raw(obj: obj.buyer_supplied_money)
