...
#  query filter.
  class CatalogQuery
  # @return [square.rb::CatalogQuerySortedAttribute] A query expression to sort returned query result by the given attribute.
    attr_reader :sorted_attribute_query
  # @return [square.rb::CatalogQueryExact] An exact query expression to return objects with attribute name and value
#  matching the specified attribute name and value exactly. Value matching is case
#  insensitive.
    attr_reader :exact_query
  # @return [square.rb::CatalogQuerySet] A set query expression to return objects with attribute name and value
#  matching the specified attribute name and any of the specified attribute values
#  exactly.
#  Value matching is case insensitive.
    attr_reader :set_query
  # @return [square.rb::CatalogQueryPrefix] A prefix query expression to return objects with attribute values
#  that have a prefix matching the specified string value. Value matching is case
#  insensitive.
    attr_reader :prefix_query
  # @return [square.rb::CatalogQueryRange] A range query expression to return objects with numeric values
#  that lie in the specified range.
    attr_reader :range_query
  # @return [square.rb::CatalogQueryText] A text query expression to return objects whose searchable attributes contain
#  all of the given
...
#  returns this item.
  ...
  # @return [square.rb::CatalogQueryItemsForTax] A query expression to return items that have any of the specified taxes (as
#  identified by the corresponding `CatalogTax` object IDs) enabled.
    attr_reader :items_for_tax_query
  # @return [square.rb::CatalogQueryItemsForModifierList] A query expression to return items that have any of the given modifier list (as
#  identified by the corresponding `CatalogModifierList`s IDs) enabled.
    attr_reader :items_for_modifier_list_query
  # @return [square.rb::CatalogQueryItemsForItemOptions] A query expression to return items that contains the specified item options (as
#  identified the corresponding `CatalogItemOption` IDs).
    attr_reader :items_for_item_options_query
  # @return [square.rb::CatalogQueryItemVariationsForItemOptionValues] A query expression to return item variations (of the
...
#  contain all of the specified `CatalogItemOption` IDs.
  ...
  # @return [Object] 
    ...
    # @param sorted_attribute_query [square.rb::CatalogQuerySortedAttribute] A query expression to sort returned query result by the given attribute.
    # @param exact_query [square.rb::CatalogQueryExact] An exact query expression to return objects with attribute name and value
#  matching the specified attribute name and value exactly. Value matching is case
#  insensitive.
    # @param set_query [square.rb::CatalogQuerySet] A set query expression to return objects with attribute name and value
#  matching the specified attribute name and any of the specified attribute values
#  exactly.
#  Value matching is case insensitive.
    # @param prefix_query [square.rb::CatalogQueryPrefix] A prefix query expression to return objects with attribute values
#  that have a prefix matching the specified string value. Value matching is case
#  insensitive.
    # @param range_query [square.rb::CatalogQueryRange] A range query expression to return objects with numeric values
#  that lie in the specified range.
    # @param text_query [square.rb::CatalogQueryText] A text query expression to return objects whose searchable attributes contain
#  all of the given
#  keywords, irrespective of their order. For example, if a `CatalogItem` contains
#  custom attribute values of
#  `{"name": "t-shirt"}` and `{"description": "Small, Purple"}`, the query filter
#  of `{"keywords": ["shirt", "sma", "purp"]}`
#  returns this item.
    # @param items_for_tax_query [square.rb::CatalogQueryItemsForTax] A query expression to return items that have any of the specified taxes (as
#  identified by the corresponding `CatalogTax` object IDs) enabled.
    # @param items_for_modifier_list_query [square.rb::CatalogQueryItemsForModifierList] A query expression to return items that have any of the given modifier list (as
#  identified by the corresponding `CatalogModifierList`s IDs) enabled.
    # @param items_for_item_options_query [square.rb::CatalogQueryItemsForItemOptions] A query expression to return items that contains the specified item options (as
#  identified the corresponding `CatalogItemOption` IDs).
    # @param item_variations_for_item_option_values_query [square.rb::CatalogQueryItemVariationsForItemOptionValues] A query expression to return item variations (of the
#  [CatalogItemVariation](entity:CatalogItemVariation) type) that
#  contain all of the specified `CatalogItemOption` IDs.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CatalogQuery]
...
# Deserialize a JSON object to an instance of CatalogQuery
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["sorted_attribute_query"].nil?
        ...
        sorted_attribute_query = square.rb::CatalogQuerySortedAttribute.from_json(json_object: sorted_attribute_query)
      else
        sorted_attribute_query = nil
      end
      unless parsed_json["exact_query"].nil?
        exact_query = parsed_json["exact_query"].to_json
        exact_query = square.rb::CatalogQueryExact.from_json(json_object: exact_query)
      else
        exact_query = nil
      end
      unless parsed_json["set_query"].nil?
        set_query = parsed_json["set_query"].to_json
        set_query = square.rb::CatalogQuerySet.from_json(json_object: set_query)
      else
        set_query = nil
      end
      unless parsed_json["prefix_query"].nil?
        prefix_query = parsed_json["prefix_query"].to_json
        prefix_query = square.rb::CatalogQueryPrefix.from_json(json_object: prefix_query)
      else
        prefix_query = nil
      end
      unless parsed_json["range_query"].nil?
        range_query = parsed_json["range_query"].to_json
        range_query = square.rb::CatalogQueryRange.from_json(json_object: range_query)
      else
        range_query = nil
      end
      unless parsed_json["text_query"].nil?
        text_query = parsed_json["text_query"].to_json
        text_query = square.rb::CatalogQueryText.from_json(json_object: text_query)
      else
        text_query = nil
      end
      unless parsed_json["items_for_tax_query"].nil?
        items_for_tax_query = parsed_json["items_for_tax_query"].to_json
        items_for_tax_query = square.rb::CatalogQueryItemsForTax.from_json(json_object: items_for_tax_query)
      else
      ...
      unless parsed_json["items_for_modifier_list_query"].nil?
        ...
        items_for_modifier_list_query = square.rb::CatalogQueryItemsForModifierList.from_json(json_object: items_for_modifier_list_query)
      else
      ...
      unless parsed_json["items_for_item_options_query"].nil?
        ...
        items_for_item_options_query = square.rb::CatalogQueryItemsForItemOptions.from_json(json_object: items_for_item_options_query)
      else
      ...
      unless parsed_json["item_variations_for_item_option_values_query"].nil?
        ...
        item_variations_for_item_option_values_query = square.rb::CatalogQueryItemVariationsForItemOptionValues.from_json(json_object: item_variations_for_item_option_values_query)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.sorted_attribute_query.nil? || square.rb::CatalogQuerySortedAttribute.validate_raw(obj: obj.sorted_attribute_query)
      obj.exact_query.nil? || square.rb::CatalogQueryExact.validate_raw(obj: obj.exact_query)
      obj.set_query.nil? || square.rb::CatalogQuerySet.validate_raw(obj: obj.set_query)
      obj.prefix_query.nil? || square.rb::CatalogQueryPrefix.validate_raw(obj: obj.prefix_query)
      obj.range_query.nil? || square.rb::CatalogQueryRange.validate_raw(obj: obj.range_query)
      obj.text_query.nil? || square.rb::CatalogQueryText.validate_raw(obj: obj.text_query)
      obj.items_for_tax_query.nil? || square.rb::CatalogQueryItemsForTax.validate_raw(obj: obj.items_for_tax_query)
      obj.items_for_modifier_list_query.nil? || square.rb::CatalogQueryItemsForModifierList.validate_raw(obj: obj.items_for_modifier_list_query)
      obj.items_for_item_options_query.nil? || square.rb::CatalogQueryItemsForItemOptions.validate_raw(obj: obj.items_for_item_options_query)
      obj.item_variations_for_item_option_values_query.nil? || square.rb::CatalogQueryItemVariationsForItemOptionValues.validate_raw(obj: obj.item_variations_for_item_option_values_query)
    end
  end
end