...
# Published when a Team Member is created.
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"team_member.created"`.
    ...
    # @param data [SquareApiClient::TeamMemberCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TeamMemberCreatedEvent]
...
# Deserialize a JSON object to an instance of TeamMemberCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::TeamMemberCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of TeamMemberCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::TeamMemberCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end