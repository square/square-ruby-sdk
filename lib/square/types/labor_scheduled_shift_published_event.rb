...
require_relative "labor_scheduled_shift_published_event_data"
require "ostruct"
require "json"
...
# Published when a [ScheduledShift](entity:ScheduledShift) is published.
  ...
  # @return [String] The type of event. For this event, the value is
#  `labor.scheduled_shift.published`.
  ...
  # @return [SquareApiClient::LaborScheduledShiftPublishedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this event, the value is
#  `labor.scheduled_shift.published`.
    ...
    # @param data [SquareApiClient::LaborScheduledShiftPublishedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborScheduledShiftPublishedEvent]
...
# Deserialize a JSON object to an instance of LaborScheduledShiftPublishedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborScheduledShiftPublishedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborScheduledShiftPublishedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborScheduledShiftPublishedEventData.validate_raw(obj: obj.data)
    end
  end
end