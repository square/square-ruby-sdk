...
#  `labor.scheduled_shift.published`.
  ...
  # @return [square.rb::LaborScheduledShiftPublishedEventData] The data associated with the event.
    attr_reader :data
...
#  `labor.scheduled_shift.published`.
    ...
    # @param data [square.rb::LaborScheduledShiftPublishedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborScheduledShiftPublishedEvent]
...
# Deserialize a JSON object to an instance of LaborScheduledShiftPublishedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::LaborScheduledShiftPublishedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::LaborScheduledShiftPublishedEventData.validate_raw(obj: obj.data)
    end
  end
end