...
module SquareApiClient
  class PaymentBalanceActivitySquareCapitalPaymentDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivitySquareCapitalPaymentDetail]
...
# Serialize an instance of PaymentBalanceActivitySquareCapitalPaymentDetail to a
#  JSON object
    #
    # @return [String]
    def to_json
