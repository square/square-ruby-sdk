...
#  `"online_checkout.merchant_settings.updated"`.
  ...
  # @return [square.rb::MerchantSettingsUpdatedEventData] Data associated with the event.
    attr_reader :data
...
#  `"online_checkout.merchant_settings.updated"`.
    ...
    # @param data [square.rb::MerchantSettingsUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::MerchantSettingsUpdatedEvent]
...
# Deserialize a JSON object to an instance of MerchantSettingsUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::MerchantSettingsUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::MerchantSettingsUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end