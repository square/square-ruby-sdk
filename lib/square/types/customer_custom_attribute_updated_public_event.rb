...
#  m_attribute.visible.updated](webhook:customer.custom_attribute.visible.updated),
#  which applies to custom attributes that are visible to the subscribing
#  application.
  class CustomerCustomAttributeUpdatedPublicEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeUpdatedPublicEvent]
...
# Serialize an instance of CustomerCustomAttributeUpdatedPublicEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
