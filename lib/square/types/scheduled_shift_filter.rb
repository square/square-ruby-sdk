...
module Square
    module Types
        ...
        class ScheduledShiftFilter < Square::Internal::Types::Model
            ...
            field :scheduled_shift_statuses, Square::Internal::Types::Array[Square::ScheduledShiftFilterScheduledShiftStatus], optional: true, nullable: false
        end
    end
end
