...
require_relative "terminal_action_created_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a TerminalAction is created.
  class TerminalActionCreatedEvent
  # @return [String] The ID of the target merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event this represents, `"terminal.action.created"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] RFC 3339 timestamp of when the event was created.
    attr_reader :created_at
  # @return [SquareApiClient::TerminalActionCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"terminal.action.created"`.
    # @param event_id [String] A unique ID for the event.
    # @param created_at [String] RFC 3339 timestamp of when the event was created.
    # @param data [SquareApiClient::TerminalActionCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalActionCreatedEvent]
...
# Deserialize a JSON object to an instance of TerminalActionCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::TerminalActionCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of TerminalActionCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::TerminalActionCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end