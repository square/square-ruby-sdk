...
# Published when a TerminalAction is created.
  ...
  # @return [square.rb::TerminalActionCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::TerminalActionCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TerminalActionCreatedEvent]
...
# Deserialize a JSON object to an instance of TerminalActionCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::TerminalActionCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::TerminalActionCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end