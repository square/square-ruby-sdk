...
require_relative "refund_created_event_data"
require "ostruct"
require "json"
...
# Published when a [Refund](entity:PaymentRefund) is created.
  ...
  # @return [String] The type of event this represents, `"refund.created"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::RefundCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"refund.created"`.
    ...
    # @param data [SquareApiClient::RefundCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::RefundCreatedEvent]
...
# Deserialize a JSON object to an instance of RefundCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::RefundCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of RefundCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::RefundCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end