...
# Published when a [Refund](entity:PaymentRefund) is created.
  ...
  # @return [square.rb::RefundCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::RefundCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::RefundCreatedEvent]
...
# Deserialize a JSON object to an instance of RefundCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::RefundCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::RefundCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end