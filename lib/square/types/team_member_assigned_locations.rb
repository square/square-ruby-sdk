...
# An object that represents a team member's assignment to locations.
  ...
  # @return [SquareApiClient::TeamMemberAssignedLocationsAssignmentType] The current assignment type of the team member.
#  See
...
#  for possible values
  ...
  # @return [Object] 
    ...
    # @param assignment_type [SquareApiClient::TeamMemberAssignedLocationsAssignmentType] The current assignment type of the team member.
#  See
#  ssignedLocationsAssignmentType](#type-teammemberassignedlocationsassignmenttype)
#  for possible values
    # @param location_ids [Array<String>] The explicit locations that the team member is assigned to.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TeamMemberAssignedLocations]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.assignment_type&.is_a?(SquareApiClient::TeamMemberAssignedLocationsAssignmentType) != false || raise("Passed value for field obj.assignment_type is not the expected type, validation failed.")
