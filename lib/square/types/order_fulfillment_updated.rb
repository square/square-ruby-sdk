...
#  See [OrderState](#type-orderstate) for possible values
  ...
  # @return [Array<square.rb::OrderFulfillmentUpdatedUpdate>] The fulfillments that were updated with this version change.
...
#  See [OrderState](#type-orderstate) for possible values
    ...
    # @param fulfillment_update [Array<square.rb::OrderFulfillmentUpdatedUpdate>] The fulfillments that were updated with this version change.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderFulfillmentUpdated]
...
# Deserialize a JSON object to an instance of OrderFulfillmentUpdated
  ...
  item = item.to_json
  square.rb::OrderFulfillmentUpdatedUpdate.from_json(json_object: item)
end
      new(
        order_id: order_id,
        version: version,
