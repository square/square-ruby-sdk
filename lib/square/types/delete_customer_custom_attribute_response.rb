...
# Represents a
#  mAttribute](api-endpoint:CustomerCustomAttributes-DeleteCustomerCustomAttribute)
#  response.
#  Either an empty object `{}` (for a successful deletion) or `errors` is present
#  in the response.
  class DeleteCustomerCustomAttributeResponse
...
# Serialize an instance of DeleteCustomerCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
