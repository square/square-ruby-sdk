...
module SquareApiClient
  class PaymentBalanceActivityReleaseAdjustmentDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivityReleaseAdjustmentDetail]
...
# Serialize an instance of PaymentBalanceActivityReleaseAdjustmentDetail to a JSON
#  object
    #
    # @return [String]
    def to_json
