...
#  booking.
  ...
  # @return [Array<square.rb::AppointmentSegment>] The list of appointment segments available for booking
...
#  booking.
    ...
    # @param appointment_segments [Array<square.rb::AppointmentSegment>] The list of appointment segments available for booking
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::Availability]
