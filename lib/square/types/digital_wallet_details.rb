...
#  `RAKUTEN_PAY`, `AU_PAY`, `D_BARAI`, `MERPAY`, `WECHAT_PAY` or `UNKNOWN`.
    attr_reader :brand
  # @return [SquareApiClient::CashAppDetails] Brand-specific details for payments with the `brand` of `CASH_APP`.
...
#  `ALIPAY`,
#  `RAKUTEN_PAY`, `AU_PAY`, `D_BARAI`, `MERPAY`, `WECHAT_PAY` or `UNKNOWN`.
    # @param cash_app_details [SquareApiClient::CashAppDetails] Brand-specific details for payments with the `brand` of `CASH_APP`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DigitalWalletDetails]
...
# Deserialize a JSON object to an instance of DigitalWalletDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["cash_app_details"].nil?
        ...
        cash_app_details = SquareApiClient::CashAppDetails.from_json(json_object: cash_app_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.cash_app_details.nil? || SquareApiClient::CashAppDetails.validate_raw(obj: obj.cash_app_details)
    end
  end
end