...
#  endpoint returns in a response.
  ...
  # @return [Array<square.rb::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Location] The requested location.
  ...
  # @return [Object] 
    ...
    # @param location [square.rb::Location] The requested location.
...
# Deserialize a JSON object to an instance of GetLocationResponse
    #
...
# Serialize an instance of GetLocationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
