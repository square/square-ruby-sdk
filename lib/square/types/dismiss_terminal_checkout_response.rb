...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::TerminalCheckout] Current state of the checkout to be dismissed.
  ...
  # @return [Object] 
    ...
    # @param checkout [square.rb::TerminalCheckout] Current state of the checkout to be dismissed.
...
# Deserialize a JSON object to an instance of DismissTerminalCheckoutResponse
    #
...
# Serialize an instance of DismissTerminalCheckoutResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
