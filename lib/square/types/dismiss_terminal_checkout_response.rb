...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::TerminalCheckout] Current state of the checkout to be dismissed.
  ...
  # @return [Object] 
    ...
    # @param checkout [SquareApiClient::TerminalCheckout] Current state of the checkout to be dismissed.
