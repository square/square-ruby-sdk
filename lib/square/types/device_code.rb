...
#  paired up.
  ...
  # @return [SquareApiClient::PRODUCT_TYPE] The targeting product type of the device code.
    attr_reader :product_type
  # @return [String] The location assigned to this code.
    attr_reader :location_id
  # @return [SquareApiClient::DeviceCodeStatus] The pairing status of the device code.
...
#  paired up.
    # @param product_type [SquareApiClient::PRODUCT_TYPE] The targeting product type of the device code.
    # @param location_id [String] The location assigned to this code.
    # @param status [SquareApiClient::DeviceCodeStatus] The pairing status of the device code.
#  See [DeviceCodeStatus](#type-devicecodestatus) for possible values
...
#  format.
    ...
    # @return [SquareApiClient::DeviceCode]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::DeviceCodeStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
