...
#  for more exposed details of a bank account payment.
  ...
  # @return [square.rb::TenderBankAccountDetailsStatus] The bank account payment's current state.
#  See
...
#  possible values
  ...
  # @return [Object] 
    ...
    # @param status [square.rb::TenderBankAccountDetailsStatus] The bank account payment's current state.
#  See
#  [TenderBankAccountPaymentDetailsStatus](entity:TenderBankAccountDetailsStatus)
#  for possible values.
#  See [TenderBankAccountDetailsStatus](#type-tenderbankaccountdetailsstatus) for
#  possible values
    ...
    # @return [square.rb::TenderBankAccountDetails]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.status&.is_a?(square.rb::TenderBankAccountDetailsStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end