...
# Provides information about the subscription event.
  ...
  # @return [String] A human-readable explanation for the event.
    attr_reader :detail
  # @return [square.rb::SubscriptionEventInfoCode] An info code indicating the subscription event that occurred.
#  See [InfoCode](#type-infocode) for possible values
  ...
  # @return [Object] 
    ...
    # @param code [square.rb::SubscriptionEventInfoCode] An info code indicating the subscription event that occurred.
#  See [InfoCode](#type-infocode) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SubscriptionEventInfo]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.code&.is_a?(square.rb::SubscriptionEventInfoCode) != false || raise("Passed value for field obj.code is not the expected type, validation failed.")
    end
  end
end