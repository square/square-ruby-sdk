...
# A record representing an individual team member for a business.
  ...
  # @return [square.rb::TeamMemberStatus] Describes the status of the team member.
...
#  +551155256325 - the country code is 55 for BR
  ...
  # @return [square.rb::TeamMemberAssignedLocations] Describes the team member's assigned locations.
    attr_reader :assigned_locations
  # @return [square.rb::WageSetting] Information about the team member's overtime exemption status, job assignments,
#  and compensation.
  ...
  # @return [Object] 
    ...
    # @param status [square.rb::TeamMemberStatus] Describes the status of the team member.
#  See [TeamMemberStatus](#type-teammemberstatus) for possible values
...
#  +551155256325 - the country code is 55 for BR
    ...
    # @param assigned_locations [square.rb::TeamMemberAssignedLocations] Describes the team member's assigned locations.
    # @param wage_setting [square.rb::WageSetting] Information about the team member's overtime exemption status, job assignments,
#  and compensation.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TeamMember]
...
# Deserialize a JSON object to an instance of TeamMember
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["assigned_locations"].nil?
        ...
        assigned_locations = square.rb::TeamMemberAssignedLocations.from_json(json_object: assigned_locations)
      else
        assigned_locations = nil
      end
      unless parsed_json["wage_setting"].nil?
        wage_setting = parsed_json["wage_setting"].to_json
        wage_setting = square.rb::WageSetting.from_json(json_object: wage_setting)
      else
        wage_setting = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(square.rb::TeamMemberStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.assigned_locations.nil? || square.rb::TeamMemberAssignedLocations.validate_raw(obj: obj.assigned_locations)
      obj.wage_setting.nil? || square.rb::WageSetting.validate_raw(obj: obj.wage_setting)
    end
  end
end