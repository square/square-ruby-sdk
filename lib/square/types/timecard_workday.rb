...
#  a `Timecard` must start or end in before passing the filter condition.
  ...
  # @return [SquareApiClient::DateRange] Dates for fetching the timecards.
    attr_reader :date_range
  # @return [SquareApiClient::TimecardWorkdayMatcher] The strategy on which the dates are applied.
...
#  identifier for the relevant timezone.
  ...
  # @return [Object] 
    ...
    # @param date_range [SquareApiClient::DateRange] Dates for fetching the timecards.
    # @param match_timecards_by [SquareApiClient::TimecardWorkdayMatcher] The strategy on which the dates are applied.
#  See [TimecardWorkdayMatcher](#type-timecardworkdaymatcher) for possible values
...
#  identifier for the relevant timezone.
    ...
    # @return [SquareApiClient::TimecardWorkday]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.match_timecards_by&.is_a?(SquareApiClient::TimecardWorkdayMatcher) != false || raise("Passed value for field obj.match_timecards_by is not the expected type, validation failed.")
