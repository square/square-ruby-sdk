...
#  present, or it might be present with a status of `FAILED`.
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Payment] The newly created payment.
    attr_reader :payment
  ...
  # @return [Object] 
    ...
    # @param payment [SquareApiClient::Payment] The newly created payment.
...
# Deserialize a JSON object to an instance of CreatePaymentResponse
    #
...
# Serialize an instance of CreatePaymentResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
