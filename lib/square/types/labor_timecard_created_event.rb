...
# Published when a worker starts a [Timecard](entity:Timecard).
  ...
  # @return [square.rb::LaborTimecardCreatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::LaborTimecardCreatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborTimecardCreatedEvent]
...
# Deserialize a JSON object to an instance of LaborTimecardCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::LaborTimecardCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::LaborTimecardCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end