...
#  [SearchOrdersRequest](api-endpoint:Orders-SearchOrders).
  ...
  # @return [Array<square.rb::OrderEntry>] A list of [OrderEntries](entity:OrderEntry) that fit the query
#  conditions. The list is populated only if `return_entries` is set to `true` in
#  the request.
    attr_reader :order_entries
  # @return [Array<square.rb::Order>] A list of
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
    attr_reader :cursor
  # @return [Array<square.rb::Error>] [Errors](entity:Error) encountered during the search.
    attr_reader :errors
  ...
  # @return [Object] 
    ...
    # @param order_entries [Array<square.rb::OrderEntry>] A list of [OrderEntries](entity:OrderEntry) that fit the query
#  conditions. The list is populated only if `return_entries` is set to `true` in
#  the request.
    # @param orders [Array<square.rb::Order>] A list of
#  [Order](entity:Order) objects that match the query conditions. The list is
#  populated only if
#  `return_entries` is set to `false` in the request.
...
#  For more information, see
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
    # @param errors [Array<square.rb::Error>] [Errors](entity:Error) encountered during the search.
...
# Deserialize a JSON object to an instance of SearchOrdersResponse
  ...
  item = item.to_json
  square.rb::OrderEntry.from_json(json_object: item)
end
