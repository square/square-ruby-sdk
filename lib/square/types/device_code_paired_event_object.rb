...
module square.rb
  ...
  # @return [square.rb::DeviceCode] The created terminal checkout
  ...
  # @return [Object] 
    ...
    # @param device_code [square.rb::DeviceCode] The created terminal checkout
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DeviceCodePairedEventObject]
