...
#  rewards](https://developer.squareup.com/docs/loyalty-api/loyalty-rewards).
  ...
  # @return [String] The Square-assigned ID of the loyalty reward.
    attr_reader :id
  # @return [square.rb::LoyaltyRewardStatus] The status of a loyalty reward.
...
#  attached.
  ...
  # @return [Object] 
    ...
    # @param status [square.rb::LoyaltyRewardStatus] The status of a loyalty reward.
#  See [LoyaltyRewardStatus](#type-loyaltyrewardstatus) for possible values
...
#  attached.
    ...
    # @return [square.rb::LoyaltyReward]
