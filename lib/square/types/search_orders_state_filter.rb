...
# Filter by the current order `state`.
  ...
  # @return [Array<square.rb::OrderState>] States to filter for.
#  See [OrderState](#type-orderstate) for possible values
  ...
  # @return [Object] 
    ...
    # @param states [Array<square.rb::OrderState>] States to filter for.
#  See [OrderState](#type-orderstate) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchOrdersStateFilter]
