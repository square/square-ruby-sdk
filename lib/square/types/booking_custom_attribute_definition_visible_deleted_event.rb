...
#  booking custom attribute definition.
  class BookingCustomAttributeDefinitionVisibleDeletedEvent
...
#  3339 format.
    ...
    # @return [square.rb::BookingCustomAttributeDefinitionVisibleDeletedEvent]
...
# Serialize an instance of BookingCustomAttributeDefinitionVisibleDeletedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
