...
#  the application that created it.
  class CustomerCustomAttributeDefinitionOwnedDeletedEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionOwnedDeletedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionOwnedDeletedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
