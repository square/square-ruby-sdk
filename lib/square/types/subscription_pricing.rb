...
# Describes the pricing for the subscription.
  ...
  # @return [square.rb::SubscriptionPricingType] RELATIVE or STATIC
#  See [SubscriptionPricingType](#type-subscriptionpricingtype) for possible values
  ...
  # @return [square.rb::Money] The price of the subscription, if STATIC
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::SubscriptionPricingType] RELATIVE or STATIC
#  See [SubscriptionPricingType](#type-subscriptionpricingtype) for possible values
    # @param discount_ids [Array<String>] The ids of the discount catalog objects
    # @param price_money [square.rb::Money] The price of the subscription, if STATIC
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SubscriptionPricing]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type&.is_a?(square.rb::SubscriptionPricingType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
