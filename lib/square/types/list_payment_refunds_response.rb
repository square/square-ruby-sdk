...
#  Either `errors` or `refunds` is present in a given response (never both).
  ...
  # @return [Array<square.rb::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [Array<square.rb::PaymentRefund>] The list of requested refunds.
    attr_reader :refunds
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param refunds [Array<square.rb::PaymentRefund>] The list of requested refunds.
...
# Deserialize a JSON object to an instance of ListPaymentRefundsResponse
    #
  ...
  item = item.to_json
  square.rb::PaymentRefund.from_json(json_object: item)
end
...
# Serialize an instance of ListPaymentRefundsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
