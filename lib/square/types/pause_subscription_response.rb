...
#  [PauseSubscription](api-endpoint:Subscriptions-PauseSubscription) endpoint.
  ...
  # @return [Array<square.rb::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Subscription] The subscription to be paused by the scheduled `PAUSE` action.
    attr_reader :subscription
  # @return [Array<square.rb::SubscriptionAction>] The list of a `PAUSE` action and a possible `RESUME` action created by the
#  request.
    attr_reader :actions
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::Subscription] The subscription to be paused by the scheduled `PAUSE` action.
    # @param actions [Array<square.rb::SubscriptionAction>] The list of a `PAUSE` action and a possible `RESUME` action created by the
#  request.
