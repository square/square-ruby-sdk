...
# The response to a request to delete a `Shift`. The response might contain a set
#  of
...
# Deserialize a JSON object to an instance of DeleteShiftResponse
    #
...
# Serialize an instance of DeleteShiftResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
