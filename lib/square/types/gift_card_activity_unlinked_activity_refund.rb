...
#  type](entity:GiftCardActivityType).
  ...
  # @return [SquareApiClient::Money] The amount added to the gift card for the refund. This value is a positive
#  integer.
...
#  version 2022-06-16.
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The amount added to the gift card for the refund. This value is a positive
#  integer.
...
#  version 2022-06-16.
    ...
    # @return [SquareApiClient::GiftCardActivityUnlinkedActivityRefund]
