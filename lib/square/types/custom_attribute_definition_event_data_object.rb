...
module SquareApiClient
  ...
  # @return [SquareApiClient::CustomAttributeDefinition] The custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [SquareApiClient::CustomAttributeDefinition] The custom attribute definition.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CustomAttributeDefinitionEventDataObject]
