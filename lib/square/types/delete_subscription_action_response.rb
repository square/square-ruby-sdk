...
#  endpoint.
  ...
  # @return [Array<square.rb::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Subscription] The subscription that has the specified action deleted.
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::Subscription] The subscription that has the specified action deleted.
