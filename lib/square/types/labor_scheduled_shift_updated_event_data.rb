...
#  `scheduled_shift`.
  ...
  # @return [String] The ID of the affected `ScheduledShift`.
    attr_reader :id
  # @return [square.rb::LaborScheduledShiftUpdatedEventObject] An object containing the affected `ScheduledShift`.
    attr_reader :object
...
#  `scheduled_shift`.
    ...
    # @param object [square.rb::LaborScheduledShiftUpdatedEventObject] An object containing the affected `ScheduledShift`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborScheduledShiftUpdatedEventData]
...
# Deserialize a JSON object to an instance of LaborScheduledShiftUpdatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = square.rb::LaborScheduledShiftUpdatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || square.rb::LaborScheduledShiftUpdatedEventObject.validate_raw(obj: obj.object)
    end
  end
end