...
# Represents one upsert within the bulk operation.
  ...
  # @return [square.rb::CustomAttribute] The custom attribute to create or update, with the following fields:
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
  ...
  # @return [Object] 
    ...
    # @param custom_attribute [square.rb::CustomAttribute] The custom attribute to create or update, with the following fields:
#  - `value`. This value must conform to the `schema` specified by the definition.
#  For more information, see [Value data
#  eup.com/docs/customer-custom-attributes-api/custom-attributes#value-data-types).
#  - `version`. To enable [optimistic
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
    ...
    # @return [square.rb::BulkUpsertOrderCustomAttributesRequestUpsertCustomAttribute]
