...
module SquareApiClient
  class InvoiceCreatedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::InvoiceCreatedEventObject]
...
# Deserialize a JSON object to an instance of InvoiceCreatedEventObject
    #
...
# Serialize an instance of InvoiceCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
