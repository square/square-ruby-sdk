...
#  manage-orders/search-orders#important-note-about-filtering-orders-by-time-range)
  ...
  # @return [square.rb::TimeRange] The time range for filtering on the `created_at` timestamp. If you use this
#  value, you must set the `sort_field` in the `OrdersSearchSort` object to
#  `CREATED_AT`.
    attr_reader :created_at
  # @return [square.rb::TimeRange] The time range for filtering on the `updated_at` timestamp. If you use this
#  value, you must set the `sort_field` in the `OrdersSearchSort` object to
#  `UPDATED_AT`.
    attr_reader :updated_at
  # @return [square.rb::TimeRange] The time range for filtering on the `closed_at` timestamp. If you use this
#  value, you must set the `sort_field` in the `OrdersSearchSort` object to
#  `CLOSED_AT`.
  ...
  # @return [Object] 
    ...
    # @param created_at [square.rb::TimeRange] The time range for filtering on the `created_at` timestamp. If you use this
#  value, you must set the `sort_field` in the `OrdersSearchSort` object to
#  `CREATED_AT`.
    # @param updated_at [square.rb::TimeRange] The time range for filtering on the `updated_at` timestamp. If you use this
#  value, you must set the `sort_field` in the `OrdersSearchSort` object to
#  `UPDATED_AT`.
    # @param closed_at [square.rb::TimeRange] The time range for filtering on the `closed_at` timestamp. If you use this
#  value, you must set the `sort_field` in the `OrdersSearchSort` object to
#  `CLOSED_AT`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchOrdersDateTimeFilter]
...
# Deserialize a JSON object to an instance of SearchOrdersDateTimeFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["closed_at"].nil?
        ...
        closed_at = square.rb::TimeRange.from_json(json_object: closed_at)
      else
        closed_at = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.closed_at.nil? || square.rb::TimeRange.validate_raw(obj: obj.closed_at)
    end
  end
end