...
#  request.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::LoyaltyEvent] The resulting event data for the adjustment.
    attr_reader :event
  ...
  # @return [Object] 
    ...
    # @param event [SquareApiClient::LoyaltyEvent] The resulting event data for the adjustment.
