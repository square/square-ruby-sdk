...
#  `loyalty.program.updated` event.
  ...
  # @return [square.rb::LoyaltyProgram] The loyalty program that was updated.
  ...
  # @return [Object] 
    ...
    # @param loyalty_program [square.rb::LoyaltyProgram] The loyalty program that was updated.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyProgramUpdatedEventObject]
