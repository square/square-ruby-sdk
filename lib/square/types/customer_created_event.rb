...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
  ...
  # @return [square.rb::CustomerCreatedEventData] The data associated with the event.
    attr_reader :data
...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
    ...
    # @param data [square.rb::CustomerCreatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CustomerCreatedEvent]
...
# Deserialize a JSON object to an instance of CustomerCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::CustomerCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::CustomerCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end