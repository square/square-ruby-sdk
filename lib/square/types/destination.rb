...
# Information about the destination against which the payout was made.
  class Destination
  # @return [SquareApiClient::DestinationType] Type of the destination such as a bank account or debit card.
...
#  destination.
  ...
  # @return [Object] 
    ...
    # @param type [SquareApiClient::DestinationType] Type of the destination such as a bank account or debit card.
#  See [DestinationType](#type-destinationtype) for possible values
    # @param id [String] Square issued unique ID (also known as the instrument ID) associated with this
#  destination.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Destination]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type&.is_a?(SquareApiClient::DestinationType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
