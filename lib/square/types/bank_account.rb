...
#  [Bank Accounts API](https://developer.squareup.com/docs/bank-accounts-api).
  ...
  # @return [square.rb::Country] The ISO 3166 Alpha-2 country code where the bank account is based.
#  See [Country](#type-country) for possible values
    attr_reader :country
  # @return [square.rb::Currency] The 3-character ISO 4217 currency code indicating the operating
#  currency of the bank account. For example, the currency code for US dollars
#  is `USD`.
#  See [Currency](#type-currency) for possible values
    attr_reader :currency
  # @return [square.rb::BankAccountType] The financial purpose of the associated bank account.
...
#  identifier).
  ...
  # @return [square.rb::BankAccountStatus] Read-only. The current verification status of this BankAccount object.
...
#  For example "Bank of America".
  ...
  # @return [Object] 
    ...
    # @param country [square.rb::Country] The ISO 3166 Alpha-2 country code where the bank account is based.
#  See [Country](#type-country) for possible values
    # @param currency [square.rb::Currency] The 3-character ISO 4217 currency code indicating the operating
#  currency of the bank account. For example, the currency code for US dollars
#  is `USD`.
#  See [Currency](#type-currency) for possible values
    # @param account_type [square.rb::BankAccountType] The financial purpose of the associated bank account.
#  See [BankAccountType](#type-bankaccounttype) for possible values
...
#  identifier).
    ...
    # @param status [square.rb::BankAccountStatus] Read-only. The current verification status of this BankAccount object.
#  See [BankAccountStatus](#type-bankaccountstatus) for possible values
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.account_type.is_a?(square.rb::BankAccountType) != false || raise("Passed value for field obj.account_type is not the expected type, validation failed.")
      ...
      obj.status.is_a?(square.rb::BankAccountStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
