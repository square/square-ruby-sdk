...
#  present in the last page of results.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::CashDrawerShiftSummary>] A collection of CashDrawerShiftSummary objects for shifts that match
#  the query.
...
#  present in the last page of results.
    ...
    # @param cash_drawer_shifts [Array<SquareApiClient::CashDrawerShiftSummary>] A collection of CashDrawerShiftSummary objects for shifts that match
#  the query.
...
# Deserialize a JSON object to an instance of ListCashDrawerShiftsResponse
  ...
  item = item.to_json
  SquareApiClient::CashDrawerShiftSummary.from_json(json_object: item)
end
      new(
        cursor: cursor,
        errors: errors,
