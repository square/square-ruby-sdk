...
#  visible to the subscribing app is updated.
  class OrderCustomAttributeVisibleUpdatedEvent
  # @return [String] The ID of the target seller associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"order.custom_attribute.visible.updated"`.
    attr_reader :type
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"order.custom_attribute.visible.updated"`.
    ...
    # @return [square.rb::OrderCustomAttributeVisibleUpdatedEvent]
...
# Serialize an instance of OrderCustomAttributeVisibleUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
