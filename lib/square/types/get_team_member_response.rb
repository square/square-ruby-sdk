...
#  or error messages.
  ...
  # @return [square.rb::TeamMember] The successfully retrieved `TeamMember` object.
  ...
  # @return [Object] 
    ...
    # @param team_member [square.rb::TeamMember] The successfully retrieved `TeamMember` object.
