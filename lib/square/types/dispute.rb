...
#  cardholder initiated with their bank.
  ...
  # @return [String] The unique ID for this `Dispute`, generated by Square.
    attr_reader :id
  # @return [square.rb::Money] The disputed amount, which can be less than the total transaction amount.
...
#  a dispute over some of the items.
  ...
  # @return [square.rb::DisputeReason] The reason why the cardholder initiated the dispute.
#  See [DisputeReason](#type-disputereason) for possible values
    attr_reader :reason
  # @return [square.rb::DisputeState] The current state of this dispute.
...
#  /developer.squareup.com/docs/build-basics/common-data-types/working-with-dates).
    attr_reader :due_at
  # @return [square.rb::DisputedPayment] The payment challenged in this dispute.
  ...
  # @return [square.rb::CardBrand] The card brand used in the disputed payment.
#  See [CardBrand](#type-cardbrand) for possible values
  ...
  # @return [Object] 
    ...
    # @param amount_money [square.rb::Money] The disputed amount, which can be less than the total transaction amount.
#  For instance, if multiple items were purchased but the cardholder only initiates
#  a dispute over some of the items.
    # @param reason [square.rb::DisputeReason] The reason why the cardholder initiated the dispute.
#  See [DisputeReason](#type-disputereason) for possible values
    # @param state [square.rb::DisputeState] The current state of this dispute.
#  See [DisputeState](#type-disputestate) for possible values
    # @param due_at [String] The deadline by which the seller must respond to the dispute, in [RFC 3339
#  /developer.squareup.com/docs/build-basics/common-data-types/working-with-dates).
    # @param disputed_payment [square.rb::DisputedPayment] The payment challenged in this dispute.
    # @param evidence_ids [Array<String>] The IDs of the evidence associated with the dispute.
    # @param card_brand [square.rb::CardBrand] The card brand used in the disputed payment.
#  See [CardBrand](#type-cardbrand) for possible values
...
# Deserialize a JSON object to an instance of Dispute
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["disputed_payment"].nil?
        ...
        disputed_payment = square.rb::DisputedPayment.from_json(json_object: disputed_payment)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.reason&.is_a?(square.rb::DisputeReason) != false || raise("Passed value for field obj.reason is not the expected type, validation failed.")
      obj.state&.is_a?(square.rb::DisputeState) != false || raise("Passed value for field obj.state is not the expected type, validation failed.")
      obj.due_at&.is_a?(String) != false || raise("Passed value for field obj.due_at is not the expected type, validation failed.")
      obj.disputed_payment.nil? || square.rb::DisputedPayment.validate_raw(obj: obj.disputed_payment)
