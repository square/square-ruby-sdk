...
module square.rb
# Published when an order [custom attribute](entity:CustomAttribute) associated
#  with a [custom attribute definition](entity:CustomAttributeDefinition) that is
#  owned by the subscribing app is updated.
  class OrderCustomAttributeOwnedUpdatedEvent
  # @return [String] The ID of the target seller associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"order.custom_attribute.owned.updated"`.
    attr_reader :type
  ...
  # @return [square.rb::CustomAttributeEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"order.custom_attribute.owned.updated"`.
    ...
    # @param data [square.rb::CustomAttributeEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderCustomAttributeOwnedUpdatedEvent]
...
# Serialize an instance of OrderCustomAttributeOwnedUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
