...
#  [CancelSubscription](api-endpoint:Subscriptions-CancelSubscription) endpoint.
  ...
  # @return [Array<SquareApiClient::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Subscription] The specified subscription scheduled for cancellation according to the action
#  created by the request.
    attr_reader :subscription
  # @return [Array<SquareApiClient::SubscriptionAction>] A list of a single `CANCEL` action scheduled for the subscription.
    attr_reader :actions
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::Subscription] The specified subscription scheduled for cancellation according to the action
#  created by the request.
    # @param actions [Array<SquareApiClient::SubscriptionAction>] A list of a single `CANCEL` action scheduled for the subscription.
...
# Deserialize a JSON object to an instance of CancelSubscriptionResponse
    #
...
# Serialize an instance of CancelSubscriptionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
