...
#  [CancelSubscription](api-endpoint:Subscriptions-CancelSubscription) endpoint.
  ...
  # @return [Array<square.rb::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Subscription] The specified subscription scheduled for cancellation according to the action
#  created by the request.
    attr_reader :subscription
  # @return [Array<square.rb::SubscriptionAction>] A list of a single `CANCEL` action scheduled for the subscription.
    attr_reader :actions
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::Subscription] The specified subscription scheduled for cancellation according to the action
#  created by the request.
    # @param actions [Array<square.rb::SubscriptionAction>] A list of a single `CANCEL` action scheduled for the subscription.
