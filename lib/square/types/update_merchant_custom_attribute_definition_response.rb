...
#  Either `custom_attribute_definition` or `errors` is present in the response.
  ...
  # @return [square.rb::CustomAttributeDefinition] The updated custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [square.rb::CustomAttributeDefinition] The updated custom attribute definition.
