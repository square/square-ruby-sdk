...
# Represents an
#  ](api-endpoint:MerchantCustomAttributes-UpdateMerchantCustomAttributeDefinition)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class UpdateMerchantCustomAttributeDefinitionResponse
...
# Serialize an instance of UpdateMerchantCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
