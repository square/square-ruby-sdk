...
#  is created by the subscribing application.
  class CustomerCustomAttributeDefinitionOwnedCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionOwnedCreatedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionOwnedCreatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
