...
#  a request to the [VoidTransaction](api-endpoint:Transactions-VoidTransaction)
#  endpoint.
...
# Deserialize a JSON object to an instance of VoidTransactionResponse
    #
...
# Serialize an instance of VoidTransactionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
