...
#  definition](entity:CustomAttributeDefinition) that is owned by the subscribing
#  app is created.
  class OrderCustomAttributeDefinitionOwnedCreatedEvent
...
#  `"order.custom_attribute_definition.owned.created"`.
    ...
    # @return [square.rb::OrderCustomAttributeDefinitionOwnedCreatedEvent]
...
# Serialize an instance of OrderCustomAttributeDefinitionOwnedCreatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
