...
require_relative "catalog_subscription_plan"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectSubscriptionPlan
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogSubscriptionPlan] Structured data for a `CatalogSubscriptionPlan`, set for CatalogObjects of type
#  `SUBSCRIPTION_PLAN`.
    attr_reader :subscription_plan_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param subscription_plan_data [square.rb::CatalogSubscriptionPlan] Structured data for a `CatalogSubscriptionPlan`, set for CatalogObjects of type
#  `SUBSCRIPTION_PLAN`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectSubscriptionPlan]
    def initialize(type:, subscription_plan_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @subscription_plan_data = subscription_plan_data if subscription_plan_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectSubscriptionPlan
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["subscription_plan_data"].nil?
        subscription_plan_data = parsed_json["subscription_plan_data"].to_json
        subscription_plan_data = square.rb::CatalogSubscriptionPlan.from_json(json_object: subscription_plan_data)
      else
        subscription_plan_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectSubscriptionPlan to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.subscription_plan_data.nil? || square.rb::CatalogSubscriptionPlan.validate_raw(obj: obj.subscription_plan_data)
