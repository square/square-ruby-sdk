...
module SquareApiClient
  ...
  # @return [SquareApiClient::Payout] The payout that has completed.
    attr_reader :payout
  ...
  # @return [Object] 
    ...
    # @param payout [SquareApiClient::Payout] The payout that has completed.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PayoutPaidEventObject]
