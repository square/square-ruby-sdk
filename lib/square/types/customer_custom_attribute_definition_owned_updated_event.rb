...
#  the application that created it.
  class CustomerCustomAttributeDefinitionOwnedUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionOwnedUpdatedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionOwnedUpdatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
