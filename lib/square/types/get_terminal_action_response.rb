...
module square.rb
  class GetTerminalActionResponse
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::TerminalAction] The requested `TerminalAction`
    attr_reader :action
  ...
  # @return [Object] 
    ...
    # @param action [square.rb::TerminalAction] The requested `TerminalAction`
...
# Deserialize a JSON object to an instance of GetTerminalActionResponse
    #
...
# Serialize an instance of GetTerminalActionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
