...
# Represents a
#  s](api-endpoint:LocationCustomAttributes-ListLocationCustomAttributeDefinitions)
#  response.
...
#  with `custom_attribute_definitions`.
  class ListLocationCustomAttributeDefinitionsResponse
...
# Serialize an instance of ListLocationCustomAttributeDefinitionsResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
