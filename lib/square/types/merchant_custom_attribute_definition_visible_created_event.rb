...
#  `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class MerchantCustomAttributeDefinitionVisibleCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::MerchantCustomAttributeDefinitionVisibleCreatedEvent]
...
# Serialize an instance of MerchantCustomAttributeDefinitionVisibleCreatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
