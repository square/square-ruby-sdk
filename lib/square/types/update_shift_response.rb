...
#  the request resulted in errors.
  ...
  # @return [square.rb::Shift] The updated `Shift`.
    attr_reader :shift
  ...
  # @return [Object] 
    ...
    # @param shift [square.rb::Shift] The updated `Shift`.
...
# Deserialize a JSON object to an instance of UpdateShiftResponse
    #
...
# Serialize an instance of UpdateShiftResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
