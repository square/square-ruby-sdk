...
#  when your application updates a booking custom attribute definition.
  class BookingCustomAttributeDefinitionOwnedUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::BookingCustomAttributeDefinitionOwnedUpdatedEvent]
...
# Serialize an instance of BookingCustomAttributeDefinitionOwnedUpdatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
