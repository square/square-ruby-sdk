...
# Describes a `SearchInvoices` response.
  ...
  # @return [Array<square.rb::Invoice>] The list of invoices returned by the search.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param invoices [Array<square.rb::Invoice>] The list of invoices returned by the search.
