...
# Represents additional data for rules with the `VISIT` accrual type.
  ...
  # @return [SquareApiClient::Money] The minimum purchase required during the visit to quality for points.
    attr_reader :minimum_amount_money
  # @return [SquareApiClient::LoyaltyProgramAccrualRuleTaxMode] Indicates how taxes should be treated when calculating the purchase amount to
...
#  for possible values
  ...
  # @return [Object] 
    ...
    # @param minimum_amount_money [SquareApiClient::Money] The minimum purchase required during the visit to quality for points.
    # @param tax_mode [SquareApiClient::LoyaltyProgramAccrualRuleTaxMode] Indicates how taxes should be treated when calculating the purchase amount to
#  determine whether the visit qualifies for points.
#  This setting applies only if `minimum_amount_money` is specified.
#  See [LoyaltyProgramAccrualRuleTaxMode](#type-loyaltyprogramaccrualruletaxmode)
#  for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyProgramAccrualRuleVisitData]
...
# Deserialize a JSON object to an instance of LoyaltyProgramAccrualRuleVisitData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["minimum_amount_money"].nil?
        ...
        minimum_amount_money = SquareApiClient::Money.from_json(json_object: minimum_amount_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.minimum_amount_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.minimum_amount_money)
