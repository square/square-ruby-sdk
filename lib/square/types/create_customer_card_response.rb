...
#  Either `errors` or `card` is present in a given response (never both).
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::Card] The created card on file.
    attr_reader :card
  ...
  # @return [Object] 
    ...
    # @param card [SquareApiClient::Card] The created card on file.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CreateCustomerCardResponse]
