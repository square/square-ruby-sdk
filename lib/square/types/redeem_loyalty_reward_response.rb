...
# A response that includes the `LoyaltyEvent` published for redeeming the reward.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::LoyaltyEvent] The `LoyaltyEvent` for redeeming the reward.
    attr_reader :event
  ...
  # @return [Object] 
    ...
    # @param event [square.rb::LoyaltyEvent] The `LoyaltyEvent` for redeeming the reward.
...
# Deserialize a JSON object to an instance of RedeemLoyaltyRewardResponse
    #
...
# Serialize an instance of RedeemLoyaltyRewardResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
