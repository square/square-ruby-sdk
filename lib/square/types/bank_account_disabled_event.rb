...
#  [BankAccount](entity:BankAccount) to `DISABLED`.
  ...
  # @return [square.rb::BankAccountDisabledEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::BankAccountDisabledEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::BankAccountDisabledEvent]
...
# Deserialize a JSON object to an instance of BankAccountDisabledEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::BankAccountDisabledEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::BankAccountDisabledEventData.validate_raw(obj: obj.data)
    end
  end
end