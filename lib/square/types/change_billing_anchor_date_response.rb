...
#  endpoint.
  ...
  # @return [Array<square.rb::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Subscription] The specified subscription for updating billing anchor date.
    attr_reader :subscription
  # @return [Array<square.rb::SubscriptionAction>] A list of a single billing anchor date change for the subscription.
    attr_reader :actions
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::Subscription] The specified subscription for updating billing anchor date.
    # @param actions [Array<square.rb::SubscriptionAction>] A list of a single billing anchor date change for the subscription.
