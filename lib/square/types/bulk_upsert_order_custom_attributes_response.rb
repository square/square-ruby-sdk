...
# Represents a response from a bulk upsert of order custom attributes.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Hash{String => square.rb::UpsertOrderCustomAttributeResponse}] A map of responses that correspond to individual upsert operations for custom
#  attributes.
    attr_reader :values
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => square.rb::UpsertOrderCustomAttributeResponse}] A map of responses that correspond to individual upsert operations for custom
#  attributes.
...
#  BulkUpsertOrderCustomAttributesResponse
  ...
  value = value.to_json
  square.rb::UpsertOrderCustomAttributeResponse.from_json(json_object: value)
end
      new(
        errors: errors,
        values: values,
