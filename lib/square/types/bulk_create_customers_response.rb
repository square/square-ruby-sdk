...
#  [BulkCreateCustomers](api-endpoint:Customers-BulkCreateCustomers) endpoint.
  ...
  # @return [Hash{String => square.rb::CreateCustomerResponse}] A map of responses that correspond to individual create requests, represented by
#  key-value pairs.
...
#  request.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => square.rb::CreateCustomerResponse}] A map of responses that correspond to individual create requests, represented by
#  key-value pairs.
#  Each key is the idempotency key that was provided for a create request and each
#  value
#  is the corresponding response.
...
# Deserialize a JSON object to an instance of BulkCreateCustomersResponse
  ...
  value = value.to_json
  square.rb::CreateCustomerResponse.from_json(json_object: value)
end
