...
#  if the request resulted in errors.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::GiftCard] A gift card that was fetched, if present. It returns empty if an error occurred.
  ...
  # @return [Object] 
    ...
    # @param gift_card [square.rb::GiftCard] A gift card that was fetched, if present. It returns empty if an error occurred.
