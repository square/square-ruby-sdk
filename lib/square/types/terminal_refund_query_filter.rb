...
#  `TerminalRefund` objects for the signed-in account are displayed.
  ...
  # @return [square.rb::TimeRange] The timestamp for the beginning of the reporting period, in RFC 3339 format.
#  Inclusive.
...
#  specified, then all
#  `TerminalRefund` objects for the signed-in account are displayed.
    # @param created_at [square.rb::TimeRange] The timestamp for the beginning of the reporting period, in RFC 3339 format.
#  Inclusive.
#  Default value: The current time minus one day.
#  Note that `TerminalRefund`s are available for 30 days after creation.
...
#  `COMPLETED`.
    ...
    # @return [square.rb::TerminalRefundQueryFilter]
