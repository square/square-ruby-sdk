...
module square.rb
  ...
  # @return [String] Not applicable, revocation is not an object
    attr_reader :id
  # @return [square.rb::OauthAuthorizationRevokedEventObject] An object containing information about revocation event.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [square.rb::OauthAuthorizationRevokedEventObject] An object containing information about revocation event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OauthAuthorizationRevokedEventData]
...
# Deserialize a JSON object to an instance of OauthAuthorizationRevokedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = square.rb::OauthAuthorizationRevokedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || square.rb::OauthAuthorizationRevokedEventObject.validate_raw(obj: obj.object)
    end
  end
end