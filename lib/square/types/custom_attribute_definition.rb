...
#  `VISIBILITY_READ_WRITE_VALUES`.
  ...
  # @return [square.rb::CustomAttributeDefinitionVisibility] Specifies how the custom attribute definition and its values should be shared
#  with
...
#  required if the `visibility` field is `VISIBILITY_READ_ONLY` or
#  `VISIBILITY_READ_WRITE_VALUES`.
    # @param visibility [square.rb::CustomAttributeDefinitionVisibility] Specifies how the custom attribute definition and its values should be shared
#  with
#  the seller and other applications. If no value is specified, the value defaults
#  to `VISIBILITY_HIDDEN`.
#  See [Visibility](#type-visibility) for possible values
...
#  in RFC 3339 format.
    ...
    # @return [square.rb::CustomAttributeDefinition]
