...
#  in 3rd party applications.
  ...
  # @return [SquareApiClient::CatalogCategoryType] The type of the category.
#  See [CatalogCategoryType](#type-catalogcategorytype) for possible values
    attr_reader :category_type
  # @return [SquareApiClient::CatalogObjectCategory] The ID of the parent category of this category instance.
...
#  the seller's Square Online sites.
  ...
  # @return [Array<SquareApiClient::CategoryPathToRootNode>] The path from the category to its root category. The first node of the path is
...
#  Currently these images are not displayed by Square, but are free to be displayed
#  in 3rd party applications.
    # @param category_type [SquareApiClient::CatalogCategoryType] The type of the category.
#  See [CatalogCategoryType](#type-catalogcategorytype) for possible values
    # @param parent_category [SquareApiClient::CatalogObjectCategory] The ID of the parent category of this category instance.
...
#  the seller's Square Online sites.
    ...
    # @param path_to_root [Array<SquareApiClient::CategoryPathToRootNode>] The path from the category to its root category. The first node of the path is
#  the parent of the category
#  and the last is the root category. The path is empty if the category is a root
#  category.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogCategory]
...
# Deserialize a JSON object to an instance of CatalogCategory
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["parent_category"].nil?
        ...
        parent_category = SquareApiClient::CatalogObjectCategory.from_json(json_object: parent_category)
      else
        parent_category = nil
      end
  ...
  item = item.to_json
  SquareApiClient::CategoryPathToRootNode.from_json(json_object: item)
end
      new(
        name: name,
        image_ids: image_ids,
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.category_type&.is_a?(SquareApiClient::CatalogCategoryType) != false || raise("Passed value for field obj.category_type is not the expected type, validation failed.")
      obj.parent_category.nil? || SquareApiClient::CatalogObjectCategory.validate_raw(obj: obj.parent_category)
