...
module SquareApiClient
  class SubscriptionCreatedEventObject
  # @return [SquareApiClient::Subscription] The created subscription.
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::Subscription] The created subscription.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::SubscriptionCreatedEventObject]
...
# Deserialize a JSON object to an instance of SubscriptionCreatedEventObject
    #
...
# Serialize an instance of SubscriptionCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
