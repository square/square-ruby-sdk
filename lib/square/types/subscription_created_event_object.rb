...
module square.rb
  ...
  # @return [square.rb::Subscription] The created subscription.
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::Subscription] The created subscription.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SubscriptionCreatedEventObject]
