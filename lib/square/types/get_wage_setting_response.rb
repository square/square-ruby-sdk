...
#  `WageSetting` object or error messages.
  ...
  # @return [SquareApiClient::WageSetting] The successfully retrieved `WageSetting` object.
  ...
  # @return [Object] 
    ...
    # @param wage_setting [SquareApiClient::WageSetting] The successfully retrieved `WageSetting` object.
