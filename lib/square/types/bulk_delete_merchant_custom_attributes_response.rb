...
#  request.
  ...
  # @return [Hash{String => square.rb::BulkDeleteMerchantCustomAttributesResponseMerchantCustomAttributeDeleteResponse}] A map of responses that correspond to individual delete requests. Each response
#  has the
#  same key as the corresponding request.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => square.rb::BulkDeleteMerchantCustomAttributesResponseMerchantCustomAttributeDeleteResponse}] A map of responses that correspond to individual delete requests. Each response
#  has the
#  same key as the corresponding request.
...
#  BulkDeleteMerchantCustomAttributesResponse
  ...
  value = value.to_json
  square.rb::BulkDeleteMerchantCustomAttributesResponseMerchantCustomAttributeDeleteResponse.from_json(json_object: value)
end
