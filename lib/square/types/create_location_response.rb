...
#  [CreateLocation](api-endpoint:Locations-CreateLocation) endpoint.
  ...
  # @return [Array<square.rb::Error>] Information about
#  [errors](https://developer.squareup.com/docs/build-basics/handling-errors)
#  encountered during the request.
    attr_reader :errors
  # @return [square.rb::Location] The newly created `Location` object.
  ...
  # @return [Object] 
    ...
    # @param errors [Array<square.rb::Error>] Information about
#  [errors](https://developer.squareup.com/docs/build-basics/handling-errors)
#  encountered during the request.
    # @param location [square.rb::Location] The newly created `Location` object.
