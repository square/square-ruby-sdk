...
require_relative "invoice_published_event_data"
require "ostruct"
require "json"
...
#  non-draft status.
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"invoice.published"`.
    ...
    # @param data [SquareApiClient::InvoicePublishedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoicePublishedEvent]
...
# Deserialize a JSON object to an instance of InvoicePublishedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::InvoicePublishedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of InvoicePublishedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::InvoicePublishedEventData.validate_raw(obj: obj.data)
    end
  end
end