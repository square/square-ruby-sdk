...
#  [BulkUpdateCustomers](api-endpoint:Customers-BulkUpdateCustomers) endpoint.
  ...
  # @return [Hash{String => SquareApiClient::UpdateCustomerResponse}] A map of responses that correspond to individual update requests, represented by
#  key-value pairs.
...
#  request.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => SquareApiClient::UpdateCustomerResponse}] A map of responses that correspond to individual update requests, represented by
#  key-value pairs.
#  Each key is the customer ID that was specified for an update request and each
#  value
#  is the corresponding response.
...
# Deserialize a JSON object to an instance of BulkUpdateCustomersResponse
  ...
  value = value.to_json
  SquareApiClient::UpdateCustomerResponse.from_json(json_object: value)
end
