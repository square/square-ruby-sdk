...
#  the latest draft shift details and current published shift details.
  ...
  # @return [String] **Read only** The Square-issued ID of the scheduled shift.
    attr_reader :id
  # @return [SquareApiClient::ScheduledShiftDetails] The latest draft shift details for the scheduled shift. Draft shift details are
#  used to
#  stage and manage shifts before publishing. This field is always present.
    attr_reader :draft_shift_details
  # @return [SquareApiClient::ScheduledShiftDetails] The current published (public) shift details for the scheduled shift. This field
#  is
...
#  presented as UTC.
  ...
  # @return [Object] 
    ...
    # @param draft_shift_details [SquareApiClient::ScheduledShiftDetails] The latest draft shift details for the scheduled shift. Draft shift details are
#  used to
#  stage and manage shifts before publishing. This field is always present.
    # @param published_shift_details [SquareApiClient::ScheduledShiftDetails] The current published (public) shift details for the scheduled shift. This field
#  is
#  present only if the shift was published.
...
#  presented as UTC.
    ...
    # @return [SquareApiClient::ScheduledShift]
...
# Deserialize a JSON object to an instance of ScheduledShift
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["draft_shift_details"].nil?
        ...
        draft_shift_details = SquareApiClient::ScheduledShiftDetails.from_json(json_object: draft_shift_details)
      else
      ...
      unless parsed_json["published_shift_details"].nil?
        ...
        published_shift_details = SquareApiClient::ScheduledShiftDetails.from_json(json_object: published_shift_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.draft_shift_details.nil? || SquareApiClient::ScheduledShiftDetails.validate_raw(obj: obj.draft_shift_details)
      obj.published_shift_details.nil? || SquareApiClient::ScheduledShiftDetails.validate_raw(obj: obj.published_shift_details)
