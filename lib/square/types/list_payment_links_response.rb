...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::PaymentLink>] The list of payment links.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param payment_links [Array<square.rb::PaymentLink>] The list of payment links.
...
# Deserialize a JSON object to an instance of ListPaymentLinksResponse
  ...
  item = item.to_json
  square.rb::PaymentLink.from_json(json_object: item)
end
