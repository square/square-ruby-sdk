...
#  [UpdateLocation](api-endpoint:Locations-UpdateLocation) endpoint.
  ...
  # @return [Array<square.rb::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Location] The updated `Location` object.
  ...
  # @return [Object] 
    ...
    # @param location [square.rb::Location] The updated `Location` object.
...
# Deserialize a JSON object to an instance of UpdateLocationResponse
    #
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["location"].nil?
        ...
        location = square.rb::Location.from_json(json_object: location)
      else
        location = nil
      end
      new(
...
# Serialize an instance of UpdateLocationResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.location.nil? || square.rb::Location.validate_raw(obj: obj.location)
    end
  end
end