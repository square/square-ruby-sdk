...
# Published when a [Payment](entity:Payment) is created.
  ...
  # @return [square.rb::PaymentCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::PaymentCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::PaymentCreatedEvent]
...
# Deserialize a JSON object to an instance of PaymentCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::PaymentCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::PaymentCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end