...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred when updating the payment link.
    attr_reader :errors
  # @return [SquareApiClient::PaymentLink] The updated payment link.
  ...
  # @return [Object] 
    ...
    # @param errors [Array<SquareApiClient::Error>] Any errors that occurred when updating the payment link.
    # @param payment_link [SquareApiClient::PaymentLink] The updated payment link.
