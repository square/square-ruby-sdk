...
#  when your application updates a merchant custom attribute definition.
  class MerchantCustomAttributeDefinitionOwnedUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::MerchantCustomAttributeDefinitionOwnedUpdatedEvent]
...
# Serialize an instance of MerchantCustomAttributeDefinitionOwnedUpdatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
