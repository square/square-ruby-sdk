...
# Published when a [card](entity:Card) is GDPR forgotten or vaulted.
  ...
  # @return [square.rb::CardForgottenEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::CardForgottenEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CardForgottenEvent]
...
# Deserialize a JSON object to an instance of CardForgottenEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::CardForgottenEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::CardForgottenEventData.validate_raw(obj: obj.data)
    end
  end
end