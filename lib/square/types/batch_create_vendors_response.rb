...
#  [BulkCreateVendors](api-endpoint:Vendors-BulkCreateVendors).
  class BatchCreateVendorsResponse
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Hash{String => square.rb::CreateVendorResponse}] A set of [CreateVendorResponse](entity:CreateVendorResponse) objects
...
#  a collection of idempotency-key/`Vendor`-object or idempotency-key/error-object
#  pairs. The idempotency keys correspond to those specified
#  in the input.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => square.rb::CreateVendorResponse}] A set of [CreateVendorResponse](entity:CreateVendorResponse) objects
#  encapsulating successfully created [Vendor](entity:Vendor)
#  objects or error responses for failed attempts. The set is represented by
#  a collection of idempotency-key/`Vendor`-object or idempotency-key/error-object
#  pairs. The idempotency keys correspond to those specified
...
# Deserialize a JSON object to an instance of BatchCreateVendorsResponse
    #
  ...
  value = value.to_json
  square.rb::CreateVendorResponse.from_json(json_object: value)
end
      new(
        errors: errors,
        responses: responses,
...
# Serialize an instance of BatchCreateVendorsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
