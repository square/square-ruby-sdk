...
#  booking custom attribute definition.
  class BookingCustomAttributeDefinitionVisibleCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::BookingCustomAttributeDefinitionVisibleCreatedEvent]
...
# Serialize an instance of BookingCustomAttributeDefinitionVisibleCreatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
