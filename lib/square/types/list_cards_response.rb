...
#  present.
  ...
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [Array<square.rb::Card>] The requested list of `Card`s.
    attr_reader :cards
...
#  for more information.
  ...
  # @return [Object] 
    ...
    # @param cards [Array<square.rb::Card>] The requested list of `Card`s.
...
#  for more information.
    ...
    # @return [square.rb::ListCardsResponse]
...
# Deserialize a JSON object to an instance of ListCardsResponse
  ...
  item = item.to_json
  square.rb::Card.from_json(json_object: item)
end
