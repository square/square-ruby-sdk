...
module square.rb
  ...
  # @return [square.rb::OrderCreated] Information about the created order.
  ...
  # @return [Object] 
    ...
    # @param order_created [square.rb::OrderCreated] Information about the created order.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderCreatedObject]
...
# Deserialize a JSON object to an instance of OrderCreatedObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["order_created"].nil?
        ...
        order_created = square.rb::OrderCreated.from_json(json_object: order_created)
      else
        order_created = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.order_created.nil? || square.rb::OrderCreated.validate_raw(obj: obj.order_created)
    end
  end
end