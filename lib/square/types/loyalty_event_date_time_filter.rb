...
# Filter events by date time range.
  ...
  # @return [square.rb::TimeRange] The `created_at` date time range used to filter the result.
  ...
  # @return [Object] 
    ...
    # @param created_at [square.rb::TimeRange] The `created_at` date time range used to filter the result.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyEventDateTimeFilter]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      square.rb::TimeRange.validate_raw(obj: obj.created_at)
    end
  end
end