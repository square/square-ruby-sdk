...
# Represents additional data for rules with the `SPEND` accrual type.
  ...
  # @return [square.rb::Money] The amount that buyers must spend to earn points.
...
#  endpoint to retrieve information about the excluded item variations.
  ...
  # @return [square.rb::LoyaltyProgramAccrualRuleTaxMode] Indicates how taxes should be treated when calculating the purchase amount used
#  for points accrual.
...
#  for possible values
  ...
  # @return [Object] 
    ...
    # @param amount_money [square.rb::Money] The amount that buyers must spend to earn points.
#  For example, given an "Earn 1 point for every $10 spent" accrual rule, a buyer
#  who spends $105 earns 10 points.
...
#  [BatchRetrieveCatalogObjects](api-endpoint:Catalog-BatchRetrieveCatalogObjects)
#  endpoint to retrieve information about the excluded item variations.
    # @param tax_mode [square.rb::LoyaltyProgramAccrualRuleTaxMode] Indicates how taxes should be treated when calculating the purchase amount used
#  for points accrual.
#  See [LoyaltyProgramAccrualRuleTaxMode](#type-loyaltyprogramaccrualruletaxmode)
#  for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyProgramAccrualRuleSpendData]
