...
#  `gift_card.activity.updated` event.
  ...
  # @return [SquareApiClient::GiftCardActivity] The updated gift card activity.
  ...
  # @return [Object] 
    ...
    # @param gift_card_activity [SquareApiClient::GiftCardActivity] The updated gift card activity.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::GiftCardActivityUpdatedEventObject]
