...
module square.rb
  class BatchGetInventoryChangesResponse
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::InventoryChange>] The current calculated inventory changes for the requested objects
#  and locations.
    attr_reader :changes
...
#  guide for more information.
  ...
  # @return [Object] 
    ...
    # @param changes [Array<square.rb::InventoryChange>] The current calculated inventory changes for the requested objects
#  and locations.
...
# Deserialize a JSON object to an instance of BatchGetInventoryChangesResponse
    #
...
# Serialize an instance of BatchGetInventoryChangesResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
