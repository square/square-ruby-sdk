...
#  [SearchCatalogItems](api-endpoint:Catalog-SearchCatalogItems) endpoint.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::CatalogObject>] Returned items matching the specified query expressions.
    attr_reader :items
  ...
  # @return [Object] 
    ...
    # @param items [Array<square.rb::CatalogObject>] Returned items matching the specified query expressions.
