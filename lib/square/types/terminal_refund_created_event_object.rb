...
module square.rb
  ...
  # @return [square.rb::TerminalRefund] The created terminal refund.
    attr_reader :refund
  ...
  # @return [Object] 
    ...
    # @param refund [square.rb::TerminalRefund] The created terminal refund.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TerminalRefundCreatedEventObject]
