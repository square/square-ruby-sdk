...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::PaymentLink] The created payment link.
    attr_reader :payment_link
  # @return [square.rb::PaymentLinkRelatedResources] The list of related objects.
  ...
  # @return [Object] 
    ...
    # @param payment_link [square.rb::PaymentLink] The created payment link.
    # @param related_resources [square.rb::PaymentLinkRelatedResources] The list of related objects.
...
# Deserialize a JSON object to an instance of CreatePaymentLinkResponse
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["payment_link"].nil?
        ...
        payment_link = square.rb::PaymentLink.from_json(json_object: payment_link)
      else
        payment_link = nil
      end
      unless parsed_json["related_resources"].nil?
        related_resources = parsed_json["related_resources"].to_json
        related_resources = square.rb::PaymentLinkRelatedResources.from_json(json_object: related_resources)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.payment_link.nil? || square.rb::PaymentLink.validate_raw(obj: obj.payment_link)
      obj.related_resources.nil? || square.rb::PaymentLinkRelatedResources.validate_raw(obj: obj.related_resources)
    end
  end
end