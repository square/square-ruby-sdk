...
# The response to retrieve payout records entries.
  ...
  # @return [Array<square.rb::PayoutEntry>] The requested list of payout entries, ordered with the given or default sort
#  order.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param payout_entries [Array<square.rb::PayoutEntry>] The requested list of payout entries, ordered with the given or default sort
#  order.
...
# Deserialize a JSON object to an instance of ListPayoutEntriesResponse
  ...
  item = item.to_json
  square.rb::PayoutEntry.from_json(json_object: item)
end
