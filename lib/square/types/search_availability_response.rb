...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Availability>] List of appointment slots available for booking.
  ...
  # @return [Object] 
    ...
    # @param availabilities [Array<SquareApiClient::Availability>] List of appointment slots available for booking.
...
# Deserialize a JSON object to an instance of SearchAvailabilityResponse
  ...
  item = item.to_json
  SquareApiClient::Availability.from_json(json_object: item)
end
