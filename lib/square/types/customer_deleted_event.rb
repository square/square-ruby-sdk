...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
  ...
  # @return [SquareApiClient::CustomerDeletedEventData] The data associated with the event.
    attr_reader :data
...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
    ...
    # @param data [SquareApiClient::CustomerDeletedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CustomerDeletedEvent]
...
# Deserialize a JSON object to an instance of CustomerDeletedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CustomerDeletedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CustomerDeletedEventData.validate_raw(obj: obj.data)
    end
  end
end