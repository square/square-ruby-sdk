...
#  Either `errors` or `customer` is present in a given response (never both).
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::Customer] The created customer.
  ...
  # @return [Object] 
    ...
    # @param customer [square.rb::Customer] The created customer.
...
# Deserialize a JSON object to an instance of CreateCustomerResponse
    #
...
# Serialize an instance of CreateCustomerResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
