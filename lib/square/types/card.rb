...
#  details are determined by the payment token generated by Web Payments SDK.
  ...
  # @return [String] Unique ID for this card. Generated by Square.
    attr_reader :id
  # @return [square.rb::CardBrand] The card's brand.
#  See [CardBrand](#type-cardbrand) for possible values
  ...
  # @return [square.rb::Address] The billing address for this card. `US` postal codes can be provided as a
#  5-digit zip code
...
#  external customer management system.
  ...
  # @return [Boolean] Indicates whether or not a card can be used for payments.
    attr_reader :enabled
  # @return [square.rb::CardType] The type of the card.
...
#  See [CardType](#type-cardtype) for possible values
  ...
  # @return [square.rb::CardPrepaidType] Indicates whether the card is prepaid or not.
...
#  version for the Card.
    attr_reader :version
  # @return [square.rb::CardCoBrand] The card's co-brand if available. For example, an Afterpay virtual card would
#  have a
#  co-brand of AFTERPAY.
#  See [CardCoBrand](#type-cardcobrand) for possible values
    attr_reader :card_co_brand
  # @return [square.rb::CARD_ISSUER_ALERT] An alert from the issuing bank about the card status. Alerts can indicate
#  whether
...
#  Spending Account (FSA), based on the card BIN.
  ...
  # @return [Object] 
    ...
    # @param card_brand [square.rb::CardBrand] The card's brand.
#  See [CardBrand](#type-cardbrand) for possible values
    ...
    # @param billing_address [square.rb::Address] The billing address for this card. `US` postal codes can be provided as a
#  5-digit zip code
#  or 9-digit ZIP+4 (example: `12345-6789`). For a full list of field meanings by
#  country, see
#  [Working with
...
#  external customer management system.
    ...
    # @param card_type [square.rb::CardType] The type of the card.
#  The Card object includes this field only in response to Payments API calls.
#  See [CardType](#type-cardtype) for possible values
    # @param prepaid_type [square.rb::CardPrepaidType] Indicates whether the card is prepaid or not.
#  See [CardPrepaidType](#type-cardprepaidtype) for possible values
...
#  the current
#  version for the Card.
    # @param card_co_brand [square.rb::CardCoBrand] The card's co-brand if available. For example, an Afterpay virtual card would
#  have a
#  co-brand of AFTERPAY.
#  See [CardCoBrand](#type-cardcobrand) for possible values
    # @param issuer_alert [square.rb::CARD_ISSUER_ALERT] An alert from the issuing bank about the card status. Alerts can indicate
#  whether
#  future charges to the card are likely to fail. For more information, see
#  [Manage Card on File
#  es](https://developer.squareup.com/docs/cards-api/manage-card-on-file-declines).
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.card_brand&.is_a?(square.rb::CardBrand) != false || raise("Passed value for field obj.card_brand is not the expected type, validation failed.")
      ...
      obj.card_type&.is_a?(square.rb::CardType) != false || raise("Passed value for field obj.card_type is not the expected type, validation failed.")
      obj.prepaid_type&.is_a?(square.rb::CardPrepaidType) != false || raise("Passed value for field obj.prepaid_type is not the expected type, validation failed.")
      ...
      obj.card_co_brand&.is_a?(square.rb::CardCoBrand) != false || raise("Passed value for field obj.card_co_brand is not the expected type, validation failed.")
