...
#  additional information on a per issuer basis.
  ...
  # @return [square.rb::DeviceDetails] __Deprecated__: Use `Payment.device_details` instead.
#  Details about the device that took the payment.
    attr_reader :device_details
  # @return [square.rb::CardPaymentTimeline] The timeline for card payments.
...
#  appended with
#  additional information on a per issuer basis.
    # @param device_details [square.rb::DeviceDetails] __Deprecated__: Use `Payment.device_details` instead.
#  Details about the device that took the payment.
    # @param card_payment_timeline [square.rb::CardPaymentTimeline] The timeline for card payments.
...
#  be refunded.  If set to `true`, the card must be present.
    ...
    # @return [square.rb::CardPaymentDetails]
...
# Deserialize a JSON object to an instance of CardPaymentDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["card_payment_timeline"].nil?
        ...
        card_payment_timeline = square.rb::CardPaymentTimeline.from_json(json_object: card_payment_timeline)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.card_payment_timeline.nil? || square.rb::CardPaymentTimeline.validate_raw(obj: obj.card_payment_timeline)
