...
#  `CatalogModifierListInfo`.
  ...
  # @return [Array<square.rb::CatalogModifierOverride>] A set of `CatalogModifierOverride` objects that override default modifier
...
#  `CatalogModifierListInfo`.
    # @param modifier_overrides [Array<square.rb::CatalogModifierOverride>] A set of `CatalogModifierOverride` objects that override default modifier
#  settings for this item.
...
#  to a `CatalogItem` instance.
    ...
    # @return [square.rb::CatalogItemModifierListInfo]
...
# Deserialize a JSON object to an instance of CatalogItemModifierListInfo
  ...
  item = item.to_json
  square.rb::CatalogModifierOverride.from_json(json_object: item)
end
