...
#  type](entity:GiftCardActivityType).
  ...
  # @return [square.rb::Money] The amount added to the gift card. This value is a positive integer.
...
#  request.
  ...
  # @return [String] The UID of the `GIFT_CARD` line item in the order that represents the gift card
#  purchase.
#  Applications that use the Square Orders API to process orders must specify the
#  line item UID
#  in the
...
#  related to an order or payment.
  ...
  # @return [Array<String>] The payment instrument IDs used to process the gift card purchase, such as a
#  credit card ID
#  or bank account ID.
...
#  Each buyer payment instrument ID can contain a maximum of 255 characters.
  ...
  # @return [Object] 
    ...
    # @param amount_money [square.rb::Money] The amount added to the gift card. This value is a positive integer.
#  Applications that use a custom order processing system must specify this amount
#  in the
#  [CreateGiftCardActivity](api-endpoint:GiftCardActivities-CreateGiftCardActivity)
#  request.
...
#  [CreateGiftCardActivity](api-endpoint:GiftCardActivities-CreateGiftCardActivity)
#  request.
    # @param line_item_uid [String] The UID of the `GIFT_CARD` line item in the order that represents the gift card
#  purchase.
#  Applications that use the Square Orders API to process orders must specify the
#  line item UID
#  in the
...
#  track information
#  related to an order or payment.
    # @param buyer_payment_instrument_ids [Array<String>] The payment instrument IDs used to process the gift card purchase, such as a
#  credit card ID
#  or bank account ID.
#  Applications that use a custom order processing system must specify payment
#  instrument IDs in
...
#  Each buyer payment instrument ID can contain a maximum of 255 characters.
    ...
    # @return [square.rb::GiftCardActivityActivate]
...
# Deserialize a JSON object to an instance of GiftCardActivityActivate
    #
...
# Serialize an instance of GiftCardActivityActivate to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
