...
require_relative "catalog_product_set"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectProductSet
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogProductSet] Structured data for a `CatalogProductSet`, set for CatalogObjects of type
#  `PRODUCT_SET`.
    attr_reader :product_set_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param product_set_data [square.rb::CatalogProductSet] Structured data for a `CatalogProductSet`, set for CatalogObjects of type
#  `PRODUCT_SET`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectProductSet]
    def initialize(type:, product_set_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @product_set_data = product_set_data if product_set_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectProductSet
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["product_set_data"].nil?
        product_set_data = parsed_json["product_set_data"].to_json
        product_set_data = square.rb::CatalogProductSet.from_json(json_object: product_set_data)
      else
        product_set_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectProductSet to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.product_set_data.nil? || square.rb::CatalogProductSet.validate_raw(obj: obj.product_set_data)
