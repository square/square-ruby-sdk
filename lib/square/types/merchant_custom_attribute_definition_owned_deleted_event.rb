...
#  when your application deletes a merchant custom attribute definition.
  class MerchantCustomAttributeDefinitionOwnedDeletedEvent
...
#  3339 format.
    ...
    # @return [square.rb::MerchantCustomAttributeDefinitionOwnedDeletedEvent]
...
# Serialize an instance of MerchantCustomAttributeDefinitionOwnedDeletedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
