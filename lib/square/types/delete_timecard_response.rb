...
module square.rb
# The response to a request to delete a `Timecard`. The response might contain a
#  set of
#  `Error` objects if the request resulted in errors.
  class DeleteTimecardResponse
...
# Deserialize a JSON object to an instance of DeleteTimecardResponse
    #
...
# Serialize an instance of DeleteTimecardResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
