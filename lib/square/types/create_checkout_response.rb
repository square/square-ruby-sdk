...
#  a request to the `CreateCheckout` endpoint.
  ...
  # @return [SquareApiClient::Checkout] The newly created `checkout` object associated with the provided idempotency
#  key.
  ...
  # @return [Object] 
    ...
    # @param checkout [SquareApiClient::Checkout] The newly created `checkout` object associated with the provided idempotency
#  key.
...
# Deserialize a JSON object to an instance of CreateCheckoutResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["checkout"].nil?
        ...
        checkout = SquareApiClient::Checkout.from_json(json_object: checkout)
      else
        checkout = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.checkout.nil? || SquareApiClient::Checkout.validate_raw(obj: obj.checkout)
