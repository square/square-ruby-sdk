...
#  associated payment.
  ...
  # @return [String] The tender's unique ID.
    attr_reader :id
  # @return [square.rb::V1TenderType] The type of tender.
#  See [V1TenderType](#type-v1tendertype) for possible values
  ...
  # @return [square.rb::V1TenderCardBrand] The brand of credit card provided.
#  See [V1TenderCardBrand](#type-v1tendercardbrand) for possible values
  ...
  # @return [square.rb::V1TenderEntryMethod] The tender's unique ID.
...
#  Typically only present for tender with the type: OTHER.
  ...
  # @return [square.rb::V1Money] The total amount of money provided in this form of tender.
    attr_reader :total_money
  # @return [square.rb::V1Money] The amount of total_money applied to the payment.
  ...
  # @return [square.rb::V1Money] The amount of total_money returned to the buyer as change.
    attr_reader :change_back_money
  # @return [square.rb::V1Money] The total of all refunds applied to this tender. This amount is always negative
#  or zero.
...
#  amounts needed to pay for items purchased in the exchange.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::V1TenderType] The type of tender.
#  See [V1TenderType](#type-v1tendertype) for possible values
    ...
    # @param card_brand [square.rb::V1TenderCardBrand] The brand of credit card provided.
#  See [V1TenderCardBrand](#type-v1tendercardbrand) for possible values
    # @param pan_suffix [String] The last four digits of the provided credit card's account number.
    # @param entry_method [square.rb::V1TenderEntryMethod] The tender's unique ID.
#  See [V1TenderEntryMethod](#type-v1tenderentrymethod) for possible values
    # @param payment_note [String] Notes entered by the merchant about the tender at the time of payment, if any.
#  Typically only present for tender with the type: OTHER.
    # @param total_money [square.rb::V1Money] The total amount of money provided in this form of tender.
    # @param tendered_money [square.rb::V1Money] The amount of total_money applied to the payment.
    ...
    # @param change_back_money [square.rb::V1Money] The amount of total_money returned to the buyer as change.
    # @param refunded_money [square.rb::V1Money] The total of all refunds applied to this tender. This amount is always negative
#  or zero.
...
# Deserialize a JSON object to an instance of V1Tender
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["total_money"].nil?
        ...
        total_money = square.rb::V1Money.from_json(json_object: total_money)
      else
        total_money = nil
      end
      unless parsed_json["tendered_money"].nil?
        tendered_money = parsed_json["tendered_money"].to_json
        tendered_money = square.rb::V1Money.from_json(json_object: tendered_money)
      else
        tendered_money = nil
      end
      ...
      unless parsed_json["change_back_money"].nil?
        ...
        change_back_money = square.rb::V1Money.from_json(json_object: change_back_money)
      else
        change_back_money = nil
      end
      unless parsed_json["refunded_money"].nil?
        refunded_money = parsed_json["refunded_money"].to_json
        refunded_money = square.rb::V1Money.from_json(json_object: refunded_money)
      else
        refunded_money = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(square.rb::V1TenderType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      ...
      obj.card_brand&.is_a?(square.rb::V1TenderCardBrand) != false || raise("Passed value for field obj.card_brand is not the expected type, validation failed.")
      obj.pan_suffix&.is_a?(String) != false || raise("Passed value for field obj.pan_suffix is not the expected type, validation failed.")
      obj.entry_method&.is_a?(square.rb::V1TenderEntryMethod) != false || raise("Passed value for field obj.entry_method is not the expected type, validation failed.")
      ...
      obj.total_money.nil? || square.rb::V1Money.validate_raw(obj: obj.total_money)
      obj.tendered_money.nil? || square.rb::V1Money.validate_raw(obj: obj.tendered_money)
      ...
      obj.change_back_money.nil? || square.rb::V1Money.validate_raw(obj: obj.change_back_money)
      obj.refunded_money.nil? || square.rb::V1Money.validate_raw(obj: obj.refunded_money)
