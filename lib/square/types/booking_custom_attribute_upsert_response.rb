...
#  operation.
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::BookingCustomAttributeUpsertResponse]
    def initialize(booking_id: OMIT, custom_attribute: OMIT, errors: OMIT, additional_properties: nil)
      @booking_id = booking_id if booking_id != OMIT
      @custom_attribute = custom_attribute if custom_attribute != OMIT
      @errors = errors if errors != OMIT
      @additional_properties = additional_properties
      @_field_set = { "booking_id": booking_id, "custom_attribute": custom_attribute, "errors": errors }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of BookingCustomAttributeUpsertResponse
    #
...
# Serialize an instance of BookingCustomAttributeUpsertResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
