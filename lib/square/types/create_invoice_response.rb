...
# The response returned by the `CreateInvoice` request.
  ...
  # @return [square.rb::Invoice] The newly created invoice.
    attr_reader :invoice
  ...
  # @return [Object] 
    ...
    # @param invoice [square.rb::Invoice] The newly created invoice.
...
# Deserialize a JSON object to an instance of CreateInvoiceResponse
    #
...
# Serialize an instance of CreateInvoiceResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
