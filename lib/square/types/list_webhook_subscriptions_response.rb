...
#  present.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::WebhookSubscription>] The requested list of [Subscription](entity:WebhookSubscription)s.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param subscriptions [Array<SquareApiClient::WebhookSubscription>] The requested list of [Subscription](entity:WebhookSubscription)s.
...
# Deserialize a JSON object to an instance of ListWebhookSubscriptionsResponse
  ...
  item = item.to_json
  SquareApiClient::WebhookSubscription.from_json(json_object: item)
end
