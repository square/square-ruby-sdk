...
#  the request resulted in errors.
  ...
  # @return [SquareApiClient::BreakType] The `BreakType` that was created by the request.
  ...
  # @return [Object] 
    ...
    # @param break_type [SquareApiClient::BreakType] The `BreakType` that was created by the request.
...
# Deserialize a JSON object to an instance of CreateBreakTypeResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["break_type"].nil?
        ...
        break_type = SquareApiClient::BreakType.from_json(json_object: break_type)
      else
        break_type = nil
      end
...
# Serialize an instance of CreateBreakTypeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.break_type.nil? || SquareApiClient::BreakType.validate_raw(obj: obj.break_type)
