...
#  the request resulted in errors.
  ...
  # @return [square.rb::BreakType] The `BreakType` that was created by the request.
  ...
  # @return [Object] 
    ...
    # @param break_type [square.rb::BreakType] The `BreakType` that was created by the request.
