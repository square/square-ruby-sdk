...
# Represents a response from upserting order custom attribute definitions.
  ...
  # @return [SquareApiClient::CustomAttribute] The order custom attribute that was created or modified.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute [SquareApiClient::CustomAttribute] The order custom attribute that was created or modified.
