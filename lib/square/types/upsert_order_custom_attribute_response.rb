...
# Represents a response from upserting order custom attribute definitions.
  class UpsertOrderCustomAttributeResponse
  # @return [square.rb::CustomAttribute] The order custom attribute that was created or modified.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute [square.rb::CustomAttribute] The order custom attribute that was created or modified.
...
# Deserialize a JSON object to an instance of UpsertOrderCustomAttributeResponse
    #
...
# Serialize an instance of UpsertOrderCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
