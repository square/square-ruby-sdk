...
# The settings allowed for AfterpayClearpay.
  ...
  # @return [square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange] Afterpay is shown as an option for order totals falling within the configured
#  range.
    attr_reader :order_eligibility_range
  # @return [square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange] Afterpay is shown as an option for item totals falling within the configured
#  range.
  ...
  # @return [Object] 
    ...
    # @param order_eligibility_range [square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange] Afterpay is shown as an option for order totals falling within the configured
#  range.
    # @param item_eligibility_range [square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange] Afterpay is shown as an option for item totals falling within the configured
#  range.
...
#  CheckoutMerchantSettingsPaymentMethodsAfterpayClearpay
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["order_eligibility_range"].nil?
        ...
        order_eligibility_range = square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange.from_json(json_object: order_eligibility_range)
      else
      ...
      unless parsed_json["item_eligibility_range"].nil?
        ...
        item_eligibility_range = square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange.from_json(json_object: item_eligibility_range)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.order_eligibility_range.nil? || square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange.validate_raw(obj: obj.order_eligibility_range)
      obj.item_eligibility_range.nil? || square.rb::CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange.validate_raw(obj: obj.item_eligibility_range)
