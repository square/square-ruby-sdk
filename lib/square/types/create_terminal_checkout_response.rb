...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::TerminalCheckout] The created `TerminalCheckout`.
  ...
  # @return [Object] 
    ...
    # @param checkout [SquareApiClient::TerminalCheckout] The created `TerminalCheckout`.
...
# Deserialize a JSON object to an instance of CreateTerminalCheckoutResponse
    #
...
# Serialize an instance of CreateTerminalCheckoutResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
