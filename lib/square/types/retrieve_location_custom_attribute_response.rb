...
module square.rb
# Represents a
#  ttribute](api-endpoint:LocationCustomAttributes-RetrieveLocationCustomAttribute)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class RetrieveLocationCustomAttributeResponse
...
# Serialize an instance of RetrieveLocationCustomAttributeResponse to a JSON
#  object
    #
    # @return [String]
    def to_json
