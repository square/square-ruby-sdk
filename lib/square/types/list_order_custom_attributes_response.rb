...
# Represents a response from listing order custom attributes.
  ...
  # @return [Array<square.rb::CustomAttribute>] The retrieved custom attributes. If no custom attribute are found, Square
...
#  [Pagination](https://developer.squareup.com/docs/working-with-apis/pagination).
  ...
  # @return [Object] 
    ...
    # @param custom_attributes [Array<square.rb::CustomAttribute>] The retrieved custom attributes. If no custom attribute are found, Square
#  returns an empty object (`{}`).
