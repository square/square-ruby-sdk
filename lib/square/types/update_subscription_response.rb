...
#  [UpdateSubscription](api-endpoint:Subscriptions-UpdateSubscription) endpoint.
  ...
  # @return [Array<SquareApiClient::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Subscription] The updated subscription.
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::Subscription] The updated subscription.
...
# Deserialize a JSON object to an instance of UpdateSubscriptionResponse
    #
...
# Serialize an instance of UpdateSubscriptionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
