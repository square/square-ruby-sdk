...
module square.rb
  class RetrieveLocationSettingsResponse
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::CheckoutLocationSettings] The location settings.
  ...
  # @return [Object] 
    ...
    # @param location_settings [square.rb::CheckoutLocationSettings] The location settings.
...
# Deserialize a JSON object to an instance of RetrieveLocationSettingsResponse
    #
...
# Serialize an instance of RetrieveLocationSettingsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
