...
module SquareApiClient
  class LoyaltyAccountDeletedEventObject
  # @return [SquareApiClient::LoyaltyAccount] The loyalty account that was deleted.
  ...
  # @return [Object] 
    ...
    # @param loyalty_account [SquareApiClient::LoyaltyAccount] The loyalty account that was deleted.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyAccountDeletedEventObject]
...
# Deserialize a JSON object to an instance of LoyaltyAccountDeletedEventObject
    #
...
# Serialize an instance of LoyaltyAccountDeletedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
