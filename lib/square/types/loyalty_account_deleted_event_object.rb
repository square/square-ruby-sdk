...
module square.rb
  ...
  # @return [square.rb::LoyaltyAccount] The loyalty account that was deleted.
  ...
  # @return [Object] 
    ...
    # @param loyalty_account [square.rb::LoyaltyAccount] The loyalty account that was deleted.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyAccountDeletedEventObject]
