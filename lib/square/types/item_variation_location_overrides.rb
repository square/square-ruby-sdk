...
#  specific `Location`.
  ...
  # @return [square.rb::Money] The price of the `CatalogItemVariation` at the given `Location`, or blank for
#  variable pricing.
    attr_reader :price_money
  # @return [square.rb::CatalogPricingType] The pricing type (fixed or variable) for the `CatalogItemVariation` at the given
#  `Location`.
...
#  `Location`.
  ...
  # @return [square.rb::InventoryAlertType] Indicates whether the `CatalogItemVariation` displays an alert when its
#  inventory
...
#  variation is no longer sold out.
  ...
  # @return [Object] 
    ...
    # @param price_money [square.rb::Money] The price of the `CatalogItemVariation` at the given `Location`, or blank for
#  variable pricing.
    # @param pricing_type [square.rb::CatalogPricingType] The pricing type (fixed or variable) for the `CatalogItemVariation` at the given
#  `Location`.
#  See [CatalogPricingType](#type-catalogpricingtype) for possible values
    # @param track_inventory [Boolean] If `true`, inventory tracking is active for the `CatalogItemVariation` at this
#  `Location`.
    # @param inventory_alert_type [square.rb::InventoryAlertType] Indicates whether the `CatalogItemVariation` displays an alert when its
#  inventory
#  quantity is less than or equal to its `inventory_alert_threshold`.
#  See [InventoryAlertType](#type-inventoryalerttype) for possible values
...
#  variation is no longer sold out.
    ...
    # @return [square.rb::ItemVariationLocationOverrides]
