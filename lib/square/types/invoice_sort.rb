...
# Identifies the sort field and sort order.
  class InvoiceSort
  # @return [SquareApiClient::INVOICE_SORT_FIELD] The field to use for sorting.
#  See [InvoiceSortField](#type-invoicesortfield) for possible values
    attr_reader :field
  # @return [SquareApiClient::SortOrder] The order to use for sorting the results.
#  See [SortOrder](#type-sortorder) for possible values
  ...
  # @return [Object] 
    ...
    # @param field [SquareApiClient::INVOICE_SORT_FIELD] The field to use for sorting.
#  See [InvoiceSortField](#type-invoicesortfield) for possible values
    # @param order [SquareApiClient::SortOrder] The order to use for sorting the results.
#  See [SortOrder](#type-sortorder) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoiceSort]
