...
module square.rb
  ...
  # @return [square.rb::DisputeEvidenceFile] Image, PDF, TXT
  ...
  # @return [square.rb::DisputeEvidenceType] The type of the evidence.
#  See [DisputeEvidenceType](#type-disputeevidencetype) for possible values
  ...
  # @return [Object] 
    ...
    # @param evidence_file [square.rb::DisputeEvidenceFile] Image, PDF, TXT
    # @param evidence_text [String] Raw text
    # @param uploaded_at [String] The time when the evidence was uploaded, in RFC 3339 format.
    # @param evidence_type [square.rb::DisputeEvidenceType] The type of the evidence.
#  See [DisputeEvidenceType](#type-disputeevidencetype) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DisputeEvidence]
...
# Deserialize a JSON object to an instance of DisputeEvidence
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["evidence_file"].nil?
        ...
        evidence_file = square.rb::DisputeEvidenceFile.from_json(json_object: evidence_file)
      else
        evidence_file = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.evidence_file.nil? || square.rb::DisputeEvidenceFile.validate_raw(obj: obj.evidence_file)
