...
require_relative "catalog_version_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when the catalog is updated.
  class CatalogVersionUpdatedEvent
  ...
  # @return [SquareApiClient::CatalogVersionUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::CatalogVersionUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogVersionUpdatedEvent]
...
# Deserialize a JSON object to an instance of CatalogVersionUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CatalogVersionUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CatalogVersionUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CatalogVersionUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end