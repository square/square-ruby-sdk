...
#  ns](https://developer.squareup.com/docs/subscriptions-api/plans-and-variations).
  ...
  # @return [String] The name of the plan variation.
    attr_reader :name
  # @return [Array<square.rb::SubscriptionPhase>] A list containing each [SubscriptionPhase](entity:SubscriptionPhase) for this
#  plan variation.
    attr_reader :phases
...
#  its stead.
  ...
  # @return [Object] 
    ...
    # @param phases [Array<square.rb::SubscriptionPhase>] A list containing each [SubscriptionPhase](entity:SubscriptionPhase) for this
#  plan variation.
...
#  its stead.
    ...
    # @return [square.rb::CatalogSubscriptionPlanVariation]
