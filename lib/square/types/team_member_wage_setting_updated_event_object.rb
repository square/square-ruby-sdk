...
module square.rb
  ...
  # @return [square.rb::WageSetting] The updated team member wage setting.
  ...
  # @return [Object] 
    ...
    # @param wage_setting [square.rb::WageSetting] The updated team member wage setting.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TeamMemberWageSettingUpdatedEventObject]
