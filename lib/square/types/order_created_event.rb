...
require_relative "order_created_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when an [Order](entity:Order) is created. This event is
#  triggered only by the [CreateOrder](api-endpoint:Orders-CreateOrder) endpoint
#  call.
#  Creating an order in the Point of Sale app will **not** publish this event.
  ...
  # @return [String] The type of event this represents, `"order.created"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::OrderCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"order.created"`.
    ...
    # @param data [SquareApiClient::OrderCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderCreatedEvent]
...
# Deserialize a JSON object to an instance of OrderCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::OrderCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of OrderCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::OrderCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end