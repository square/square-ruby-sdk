...
#  Creating an order in the Point of Sale app will **not** publish this event.
  ...
  # @return [square.rb::OrderCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::OrderCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderCreatedEvent]
...
# Deserialize a JSON object to an instance of OrderCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::OrderCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::OrderCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end