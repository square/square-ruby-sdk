...
module square.rb
  ...
  # @return [square.rb::TerminalAction] The created terminal action.
    attr_reader :action
  ...
  # @return [Object] 
    ...
    # @param action [square.rb::TerminalAction] The created terminal action.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TerminalActionCreatedEventObject]
