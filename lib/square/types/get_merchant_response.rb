...
#  [RetrieveMerchant](api-endpoint:Merchants-RetrieveMerchant) endpoint.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Merchant] The requested `Merchant` object.
  ...
  # @return [Object] 
    ...
    # @param merchant [SquareApiClient::Merchant] The requested `Merchant` object.
...
# Deserialize a JSON object to an instance of GetMerchantResponse
  ...
  SquareApiClient::Error.from_json(json_object: item)
      ...
      unless parsed_json["merchant"].nil?
        ...
        merchant = SquareApiClient::Merchant.from_json(json_object: merchant)
      else
        merchant = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.merchant.nil? || SquareApiClient::Merchant.validate_raw(obj: obj.merchant)
    end
  end
end