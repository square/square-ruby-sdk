...
#  present.
  ...
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::WebhookSubscription] The updated [Subscription](entity:WebhookSubscription).
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::WebhookSubscription] The updated [Subscription](entity:WebhookSubscription).
