...
# Published when a [Payout](entity:Payout) has failed.
  ...
  # @return [square.rb::PayoutFailedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::PayoutFailedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::PayoutFailedEvent]
...
# Deserialize a JSON object to an instance of PayoutFailedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::PayoutFailedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::PayoutFailedEventData.validate_raw(obj: obj.data)
    end
  end
end