...
# Details about the application that took the payment.
  ...
  # @return [square.rb::ApplicationDetailsExternalSquareProduct] The Square product, such as Square Point of Sale (POS),
...
#  application ID.
  ...
  # @return [Object] 
    ...
    # @param square_product [square.rb::ApplicationDetailsExternalSquareProduct] The Square product, such as Square Point of Sale (POS),
#  Square Invoices, or Square Virtual Terminal.
#  See [ExternalSquareProduct](#type-externalsquareproduct) for possible values
...
#  application ID.
    ...
    # @return [square.rb::ApplicationDetails]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.square_product&.is_a?(square.rb::ApplicationDetailsExternalSquareProduct) != false || raise("Passed value for field obj.square_product is not the expected type, validation failed.")
