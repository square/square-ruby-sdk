...
module square.rb
  class BatchGetInventoryCountsResponse
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::InventoryCount>] The current calculated inventory counts for the requested objects
#  and locations.
    attr_reader :counts
...
#  guide for more information.
  ...
  # @return [Object] 
    ...
    # @param counts [Array<square.rb::InventoryCount>] The current calculated inventory counts for the requested objects
#  and locations.
...
# Deserialize a JSON object to an instance of BatchGetInventoryCountsResponse
    #
...
# Serialize an instance of BatchGetInventoryCountsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
