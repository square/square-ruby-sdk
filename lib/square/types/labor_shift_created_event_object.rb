...
module SquareApiClient
  class LaborShiftCreatedEventObject
  # @return [SquareApiClient::Shift] The new `Shift`.
    attr_reader :shift
  ...
  # @return [Object] 
    ...
    # @param shift [SquareApiClient::Shift] The new `Shift`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborShiftCreatedEventObject]
...
# Deserialize a JSON object to an instance of LaborShiftCreatedEventObject
    #
...
# Serialize an instance of LaborShiftCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
