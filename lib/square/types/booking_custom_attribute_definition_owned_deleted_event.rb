...
#  when your application deletes a booking custom attribute definition.
  class BookingCustomAttributeDefinitionOwnedDeletedEvent
...
#  3339 format.
    ...
    # @return [square.rb::BookingCustomAttributeDefinitionOwnedDeletedEvent]
...
# Serialize an instance of BookingCustomAttributeDefinitionOwnedDeletedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
