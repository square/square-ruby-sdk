...
#  Terminal.
    attr_reader :body
  # @return [square.rb::DataCollectionOptionsInputType] Represents the type of the input text.
#  See [InputType](#type-inputtype) for possible values
    attr_reader :input_type
  # @return [square.rb::CollectedData] The buyer’s input text from the data collection screen.
...
#  the
#  Terminal.
    # @param input_type [square.rb::DataCollectionOptionsInputType] Represents the type of the input text.
#  See [InputType](#type-inputtype) for possible values
    # @param collected_data [square.rb::CollectedData] The buyer’s input text from the data collection screen.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DataCollectionOptions]
...
# Deserialize a JSON object to an instance of DataCollectionOptions
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["collected_data"].nil?
        ...
        collected_data = square.rb::CollectedData.from_json(json_object: collected_data)
      else
        collected_data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.input_type.is_a?(square.rb::DataCollectionOptionsInputType) != false || raise("Passed value for field obj.input_type is not the expected type, validation failed.")
      obj.collected_data.nil? || square.rb::CollectedData.validate_raw(obj: obj.collected_data)
    end
  end
end