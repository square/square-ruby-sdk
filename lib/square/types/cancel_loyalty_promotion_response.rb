...
#  Either `loyalty_promotion` or `errors` is present in the response.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::LoyaltyPromotion] The canceled loyalty promotion.
  ...
  # @return [Object] 
    ...
    # @param loyalty_promotion [SquareApiClient::LoyaltyPromotion] The canceled loyalty promotion.
