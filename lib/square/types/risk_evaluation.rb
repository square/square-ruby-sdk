...
#  provide the goods/services or refund the payment).
  ...
  # @return [square.rb::RiskEvaluationRiskLevel] The risk level associated with the payment
#  See [RiskEvaluationRiskLevel](#type-riskevaluationrisklevel) for possible values
  ...
  # @return [Object] 
    ...
    # @param risk_level [square.rb::RiskEvaluationRiskLevel] The risk level associated with the payment
#  See [RiskEvaluationRiskLevel](#type-riskevaluationrisklevel) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::RiskEvaluation]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.risk_level&.is_a?(square.rb::RiskEvaluationRiskLevel) != false || raise("Passed value for field obj.risk_level is not the expected type, validation failed.")
    end
  end
end