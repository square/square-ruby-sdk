...
#  or error messages.
  ...
  # @return [SquareApiClient::WageSetting] The successfully updated `WageSetting` object.
  ...
  # @return [Object] 
    ...
    # @param wage_setting [SquareApiClient::WageSetting] The successfully updated `WageSetting` object.
