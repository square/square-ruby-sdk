...
module square.rb
# Represents a
#  mAttributes](api-endpoint:MerchantCustomAttributes-ListMerchantCustomAttributes)
#  response.
...
#  `custom_attributes`.
  class ListMerchantCustomAttributesResponse
  # @return [Array<square.rb::CustomAttribute>] The retrieved custom attributes. If `with_definitions` was set to `true` in the
#  request,
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param custom_attributes [Array<square.rb::CustomAttribute>] The retrieved custom attributes. If `with_definitions` was set to `true` in the
#  request,
#  the custom attribute definition is returned in the `definition` field of each
#  custom attribute.
#  If no custom attributes are found, Square returns an empty object (`{}`).
...
# Deserialize a JSON object to an instance of ListMerchantCustomAttributesResponse
    #
  ...
  item = item.to_json
  square.rb::CustomAttribute.from_json(json_object: item)
end
...
# Serialize an instance of ListMerchantCustomAttributesResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
