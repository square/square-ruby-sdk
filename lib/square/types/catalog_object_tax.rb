...
require_relative "catalog_tax"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectTax
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogTax] Structured data for a `CatalogTax`, set for CatalogObjects of type `TAX`.
    attr_reader :tax_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param tax_data [square.rb::CatalogTax] Structured data for a `CatalogTax`, set for CatalogObjects of type `TAX`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectTax]
    def initialize(type:, tax_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @tax_data = tax_data if tax_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectTax
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["tax_data"].nil?
        tax_data = parsed_json["tax_data"].to_json
        tax_data = square.rb::CatalogTax.from_json(json_object: tax_data)
      else
        tax_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectTax to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.tax_data.nil? || square.rb::CatalogTax.validate_raw(obj: obj.tax_data)
