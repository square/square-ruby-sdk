...
#  by the application that created it.
  class LocationCustomAttributeDefinitionOwnedUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::LocationCustomAttributeDefinitionOwnedUpdatedEvent]
...
# Serialize an instance of LocationCustomAttributeDefinitionOwnedUpdatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
