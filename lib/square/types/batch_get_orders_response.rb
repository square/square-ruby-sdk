...
#  a request to the `BatchRetrieveOrders` endpoint.
  ...
  # @return [Array<SquareApiClient::Order>] The requested orders. This will omit any requested orders that do not exist.
    attr_reader :orders
  ...
  # @return [Object] 
    ...
    # @param orders [Array<SquareApiClient::Order>] The requested orders. This will omit any requested orders that do not exist.
