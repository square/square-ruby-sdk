...
#  ingredients.
  ...
  # @return [SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreferenceType] The dietary preference type. Supported values include `STANDARD` and `CUSTOM` as
...
#  See [DietaryPreferenceType](#type-dietarypreferencetype) for possible values
    attr_reader :type
  # @return [SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreferenceStandardDietaryPreference] The name of the dietary preference from a standard pre-defined list. This should
...
#  it's a standard dietary preference.
  ...
  # @return [Object] 
    ...
    # @param type [SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreferenceType] The dietary preference type. Supported values include `STANDARD` and `CUSTOM` as
#  specified in `FoodAndBeverageDetails.DietaryPreferenceType`.
#  See [DietaryPreferenceType](#type-dietarypreferencetype) for possible values
    # @param standard_name [SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreferenceStandardDietaryPreference] The name of the dietary preference from a standard pre-defined list. This should
#  be null if it's a custom dietary preference.
#  See [StandardDietaryPreference](#type-standarddietarypreference) for possible
#  values
...
#  it's a standard dietary preference.
    ...
    # @return [SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreference]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.standard_name&.is_a?(SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreferenceStandardDietaryPreference) != false || raise("Passed value for field obj.standard_name is not the expected type, validation failed.")
