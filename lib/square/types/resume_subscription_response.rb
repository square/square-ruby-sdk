...
#  [ResumeSubscription](api-endpoint:Subscriptions-ResumeSubscription) endpoint.
  ...
  # @return [Array<SquareApiClient::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Subscription] The resumed subscription.
    attr_reader :subscription
  # @return [Array<SquareApiClient::SubscriptionAction>] A list of `RESUME` actions created by the request and scheduled for the
#  subscription.
    attr_reader :actions
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::Subscription] The resumed subscription.
    # @param actions [Array<SquareApiClient::SubscriptionAction>] A list of `RESUME` actions created by the request and scheduled for the
#  subscription.
