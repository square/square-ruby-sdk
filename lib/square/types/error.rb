...
#  more information.
  class Error
  # @return [square.rb::ErrorCategory] The high-level category for the error.
#  See [ErrorCategory](#type-errorcategory) for possible values
    attr_reader :category
  # @return [square.rb::ErrorCode] The specific code of the error.
...
#  the error pertains to.
  ...
  # @return [Object] 
    ...
    # @param category [square.rb::ErrorCategory] The high-level category for the error.
#  See [ErrorCategory](#type-errorcategory) for possible values
    # @param code [square.rb::ErrorCode] The specific code of the error.
#  See [ErrorCode](#type-errorcode) for possible values
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.category.is_a?(square.rb::ErrorCategory) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")
      obj.code.is_a?(square.rb::ErrorCode) != false || raise("Passed value for field obj.code is not the expected type, validation failed.")
