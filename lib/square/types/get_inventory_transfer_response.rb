...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::InventoryTransfer] The requested [InventoryTransfer](entity:InventoryTransfer).
  ...
  # @return [Object] 
    ...
    # @param transfer [square.rb::InventoryTransfer] The requested [InventoryTransfer](entity:InventoryTransfer).
