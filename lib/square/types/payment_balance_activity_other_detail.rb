...
module SquareApiClient
  class PaymentBalanceActivityOtherDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivityOtherDetail]
...
# Deserialize a JSON object to an instance of PaymentBalanceActivityOtherDetail
    #
...
# Serialize an instance of PaymentBalanceActivityOtherDetail to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
