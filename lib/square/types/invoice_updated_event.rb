...
# Published when an [Invoice](entity:Invoice) is updated.
  ...
  # @return [square.rb::InvoiceUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::InvoiceUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::InvoiceUpdatedEvent]
...
# Deserialize a JSON object to an instance of InvoiceUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::InvoiceUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::InvoiceUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end