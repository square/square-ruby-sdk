...
require_relative "invoice_updated_event_data"
require "ostruct"
require "json"
...
# Published when an [Invoice](entity:Invoice) is updated.
  ...
  # @return [String] The type of event this represents, `"invoice.updated"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::InvoiceUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"invoice.updated"`.
    ...
    # @param data [SquareApiClient::InvoiceUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoiceUpdatedEvent]
...
# Deserialize a JSON object to an instance of InvoiceUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::InvoiceUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of InvoiceUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::InvoiceUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end