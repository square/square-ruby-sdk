...
#  definition](entity:CustomAttributeDefinition).
  class CustomerCustomAttributeVisibleUpdatedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeVisibleUpdatedEvent]
...
# Serialize an instance of CustomerCustomAttributeVisibleUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
