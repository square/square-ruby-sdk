...
module SquareApiClient
  class PaymentBalanceActivityReserveReleaseDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivityReserveReleaseDetail]
...
# Serialize an instance of PaymentBalanceActivityReserveReleaseDetail to a JSON
#  object
    #
    # @return [String]
    def to_json
