...
#  An application that subscribes to this event is notified when a booking custom
#  attribute definition is updated
#  by any application for which the subscribing application has read access to the
#  booking custom attribute definition.
  class BookingCustomAttributeDefinitionVisibleUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::BookingCustomAttributeDefinitionVisibleUpdatedEvent]
...
# Serialize an instance of BookingCustomAttributeDefinitionVisibleUpdatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
