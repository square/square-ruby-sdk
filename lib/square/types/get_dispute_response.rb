...
# Defines fields in a `RetrieveDispute` response.
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Dispute] Details about the requested `Dispute`.
    attr_reader :dispute
  ...
  # @return [Object] 
    ...
    # @param dispute [SquareApiClient::Dispute] Details about the requested `Dispute`.
...
# Deserialize a JSON object to an instance of GetDisputeResponse
    #
...
# Serialize an instance of GetDisputeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
