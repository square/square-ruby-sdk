...
#  the request resulted in errors.
  ...
  # @return [square.rb::EmployeeWage] The requested `EmployeeWage` object.
  ...
  # @return [Object] 
    ...
    # @param employee_wage [square.rb::EmployeeWage] The requested `EmployeeWage` object.
...
# Deserialize a JSON object to an instance of GetEmployeeWageResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["employee_wage"].nil?
        ...
        employee_wage = square.rb::EmployeeWage.from_json(json_object: employee_wage)
      else
        employee_wage = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.employee_wage.nil? || square.rb::EmployeeWage.validate_raw(obj: obj.employee_wage)
