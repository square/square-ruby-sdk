...
module square.rb
# Represents a
#  ttribute](api-endpoint:MerchantCustomAttributes-RetrieveMerchantCustomAttribute)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class RetrieveMerchantCustomAttributeResponse
...
# Serialize an instance of RetrieveMerchantCustomAttributeResponse to a JSON
#  object
    #
    # @return [String]
    def to_json
