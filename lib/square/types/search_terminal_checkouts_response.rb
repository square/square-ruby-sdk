...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [Array<square.rb::TerminalCheckout>] The requested search result of `TerminalCheckout` objects.
...
#  for more information.
  ...
  # @return [Object] 
    ...
    # @param checkouts [Array<square.rb::TerminalCheckout>] The requested search result of `TerminalCheckout` objects.
...
# Deserialize a JSON object to an instance of SearchTerminalCheckoutsResponse
  ...
  item = item.to_json
  square.rb::TerminalCheckout.from_json(json_object: item)
end
