...
# Deserialize a JSON object to an instance of DisableEventsResponse
    #
...
# Serialize an instance of DisableEventsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
