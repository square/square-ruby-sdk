...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [Array<square.rb::TerminalRefund>] The requested search result of `TerminalRefund` objects.
    attr_reader :refunds
...
#  for more information.
  ...
  # @return [Object] 
    ...
    # @param refunds [Array<square.rb::TerminalRefund>] The requested search result of `TerminalRefund` objects.
...
# Deserialize a JSON object to an instance of SearchTerminalRefundsResponse
  ...
  item = item.to_json
  square.rb::TerminalRefund.from_json(json_object: item)
end
