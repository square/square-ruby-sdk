...
#  guide for more information.
    attr_reader :cursor
  # @return [Array<SquareApiClient::InventoryState>] The filter to return results by `InventoryState`. The filter is only applicable
#  when set.
...
#  [Pagination](https://developer.squareup.com/docs/working-with-apis/pagination)
#  guide for more information.
    # @param states [Array<SquareApiClient::InventoryState>] The filter to return results by `InventoryState`. The filter is only applicable
#  when set.
#  Ignored are untracked states of `NONE`, `SOLD`, and `UNLINKED_RETURN`.
#  The default is null.
    # @param limit [Integer] The number of [records](entity:InventoryCount) to return.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BatchGetInventoryCountsRequest]
