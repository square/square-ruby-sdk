...
#  es](https://developer.squareup.com/docs/labor-api/what-it-does#migration-notes).
  class ShiftWorkday
  # @return [square.rb::DateRange] Dates for fetching the shifts.
    attr_reader :date_range
  # @return [square.rb::ShiftWorkdayMatcher] The strategy on which the dates are applied.
...
#  identifier for the relevant timezone.
  ...
  # @return [Object] 
    ...
    # @param date_range [square.rb::DateRange] Dates for fetching the shifts.
    # @param match_shifts_by [square.rb::ShiftWorkdayMatcher] The strategy on which the dates are applied.
#  See [ShiftWorkdayMatcher](#type-shiftworkdaymatcher) for possible values
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.match_shifts_by&.is_a?(square.rb::ShiftWorkdayMatcher) != false || raise("Passed value for field obj.match_shifts_by is not the expected type, validation failed.")
