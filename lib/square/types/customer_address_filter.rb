...
#  searching by an `Address`-type custom attribute.
  ...
  # @return [SquareApiClient::CustomerTextFilter] The postal code to search for. Only an `exact` match is supported.
    attr_reader :postal_code
  # @return [SquareApiClient::Country] The country code to search for.
#  See [Country](#type-country) for possible values
  ...
  # @return [Object] 
    ...
    # @param postal_code [SquareApiClient::CustomerTextFilter] The postal code to search for. Only an `exact` match is supported.
    # @param country [SquareApiClient::Country] The country code to search for.
#  See [Country](#type-country) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CustomerAddressFilter]
...
# Deserialize a JSON object to an instance of CustomerAddressFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["postal_code"].nil?
        ...
        postal_code = SquareApiClient::CustomerTextFilter.from_json(json_object: postal_code)
      else
        postal_code = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.postal_code.nil? || SquareApiClient::CustomerTextFilter.validate_raw(obj: obj.postal_code)
