...
#  Either `errors` or `group` is present in a given response (never both).
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::CustomerGroup] The successfully updated customer group.
    attr_reader :group
  ...
  # @return [Object] 
    ...
    # @param group [SquareApiClient::CustomerGroup] The successfully updated customer group.
...
# Deserialize a JSON object to an instance of UpdateCustomerGroupResponse
    #
...
# Serialize an instance of UpdateCustomerGroupResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
