...
#  indicated by `customer_id`.
  ...
  # @return [square.rb::Address] The address of the fulfillment recipient. This field is required.
...
#  If provided, the phone number overrides the corresponding customer profile value
#  indicated by `customer_id`.
    # @param address [square.rb::Address] The address of the fulfillment recipient. This field is required.
#  If provided, the address overrides the corresponding customer profile value
#  indicated by `customer_id`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::FulfillmentRecipient]
