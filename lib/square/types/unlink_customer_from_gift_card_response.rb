...
#  the response contains a set of `Error` objects.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::GiftCard] The gift card with the ID of the unlinked customer removed from the
#  `customer_ids` field.
#  If no other customers are linked, the `customer_ids` field is also removed.
  ...
  # @return [Object] 
    ...
    # @param gift_card [square.rb::GiftCard] The gift card with the ID of the unlinked customer removed from the
#  `customer_ids` field.
#  If no other customers are linked, the `customer_ids` field is also removed.
