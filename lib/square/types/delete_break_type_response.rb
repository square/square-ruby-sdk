...
# The response to a request to delete a `BreakType`. The response might contain a
#  set
...
# Deserialize a JSON object to an instance of DeleteBreakTypeResponse
    #
...
# Serialize an instance of DeleteBreakTypeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
