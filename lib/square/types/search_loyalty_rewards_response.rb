...
# A response that includes the loyalty rewards satisfying the search criteria.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::LoyaltyReward>] The loyalty rewards that satisfy the search criteria.
...
#  request. If empty, this is the final response.
  ...
  # @return [Object] 
    ...
    # @param rewards [Array<square.rb::LoyaltyReward>] The loyalty rewards that satisfy the search criteria.
#  These are returned in descending order by `updated_at`.
...
# Deserialize a JSON object to an instance of SearchLoyaltyRewardsResponse
  ...
  item = item.to_json
  square.rb::LoyaltyReward.from_json(json_object: item)
end
