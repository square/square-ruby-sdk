...
#  a set of `TeamMemberWage` objects.
  ...
  # @return [Array<square.rb::TeamMemberWage>] A page of `TeamMemberWage` results.
...
#  of `TeamMemberWage` results.
  ...
  # @return [Object] 
    ...
    # @param team_member_wages [Array<square.rb::TeamMemberWage>] A page of `TeamMemberWage` results.
...
# Deserialize a JSON object to an instance of ListTeamMemberWagesResponse
  ...
  item = item.to_json
  square.rb::TeamMemberWage.from_json(json_object: item)
end
