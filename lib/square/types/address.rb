...
#  esses](https://developer.squareup.com/docs/build-basics/working-with-addresses).
  ...
  # @return [SquareApiClient::Country] The address's country, in the two-letter format of ISO 3166. For example, `US`
#  or `FR`.
...
#  [Working with
#  esses](https://developer.squareup.com/docs/build-basics/working-with-addresses).
    # @param country [SquareApiClient::Country] The address's country, in the two-letter format of ISO 3166. For example, `US`
#  or `FR`.
#  See [Country](#type-country) for possible values
    ...
    # @return [SquareApiClient::Address]
