...
module square.rb
# Represents a
#  tomAttributes](api-endpoint:BookingCustomAttributes-ListBookingCustomAttributes)
#  response.
...
# Deserialize a JSON object to an instance of ListBookingCustomAttributesResponse
    #
...
# Serialize an instance of ListBookingCustomAttributesResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
