...
#  [BulkRetrieveCustomers](api-endpoint:Customers-BulkRetrieveCustomers) endpoint.
  ...
  # @return [Hash{String => SquareApiClient::GetCustomerResponse}] A map of responses that correspond to individual retrieve requests, represented
#  by
#  key-value pairs.
...
#  request.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => SquareApiClient::GetCustomerResponse}] A map of responses that correspond to individual retrieve requests, represented
#  by
#  key-value pairs.
#  Each key is the customer ID that was specified for a retrieve request and each
#  value
...
# Deserialize a JSON object to an instance of BulkRetrieveCustomersResponse
  ...
  value = value.to_json
  SquareApiClient::GetCustomerResponse.from_json(json_object: value)
end
