...
# Represents a query used to search for loyalty events.
  ...
  # @return [square.rb::LoyaltyEventFilter] The query filter criteria.
    attr_reader :filter
  ...
  # @return [Object] 
    ...
    # @param filter [square.rb::LoyaltyEventFilter] The query filter criteria.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyEventQuery]
...
# Deserialize a JSON object to an instance of LoyaltyEventQuery
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["filter"].nil?
        ...
        filter = square.rb::LoyaltyEventFilter.from_json(json_object: filter)
      else
        filter = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.filter.nil? || square.rb::LoyaltyEventFilter.validate_raw(obj: obj.filter)
    end
  end
end