...
# Published when a [card](entity:Card) is disabled.
  ...
  # @return [square.rb::CardDisabledEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::CardDisabledEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CardDisabledEvent]
...
# Deserialize a JSON object to an instance of CardDisabledEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::CardDisabledEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::CardDisabledEventData.validate_raw(obj: obj.data)
    end
  end
end