...
#  Typically the `refund.status` changes when a refund is completed.
  ...
  # @return [square.rb::RefundUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::RefundUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::RefundUpdatedEvent]
...
# Deserialize a JSON object to an instance of RefundUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::RefundUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::RefundUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end