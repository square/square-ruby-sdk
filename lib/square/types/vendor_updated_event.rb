...
#  associated with the location.
  ...
  # @return [square.rb::VendorUpdatedEventData] The data associated with this event.
    attr_reader :data
...
#  associated with the location.
    ...
    # @param data [square.rb::VendorUpdatedEventData] The data associated with this event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::VendorUpdatedEvent]
...
# Deserialize a JSON object to an instance of VendorUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::VendorUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::VendorUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end