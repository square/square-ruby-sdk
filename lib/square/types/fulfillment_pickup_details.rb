...
# Contains details necessary to fulfill a pickup order.
  ...
  # @return [square.rb::FulfillmentRecipient] Information about the person to pick up this fulfillment from a physical
#  location.
...
#  completed.
  ...
  # @return [square.rb::FulfillmentPickupDetailsScheduleType] The schedule type of the pickup fulfillment. Defaults to `SCHEDULED`.
#  See
...
#  in-store pickup.
  ...
  # @return [square.rb::FulfillmentPickupDetailsCurbsidePickupDetails] Specific details for curbside pickup. These details can only be populated if
#  `is_curbside_pickup` is set to `true`.
  ...
  # @return [Object] 
    ...
    # @param recipient [square.rb::FulfillmentRecipient] Information about the person to pick up this fulfillment from a physical
#  location.
...
#  If not set, this pickup fulfillment remains in progress until it is canceled or
#  completed.
    # @param schedule_type [square.rb::FulfillmentPickupDetailsScheduleType] The schedule type of the pickup fulfillment. Defaults to `SCHEDULED`.
#  See
#  ulfillmentPickupDetailsScheduleType](#type-fulfillmentpickupdetailsscheduletype)
#  for possible values
...
#  in-store pickup.
    # @param curbside_pickup_details [square.rb::FulfillmentPickupDetailsCurbsidePickupDetails] Specific details for curbside pickup. These details can only be populated if
#  `is_curbside_pickup` is set to `true`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::FulfillmentPickupDetails]
...
# Deserialize a JSON object to an instance of FulfillmentPickupDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["curbside_pickup_details"].nil?
        ...
        curbside_pickup_details = square.rb::FulfillmentPickupDetailsCurbsidePickupDetails.from_json(json_object: curbside_pickup_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.schedule_type&.is_a?(square.rb::FulfillmentPickupDetailsScheduleType) != false || raise("Passed value for field obj.schedule_type is not the expected type, validation failed.")
      ...
      obj.curbside_pickup_details.nil? || square.rb::FulfillmentPickupDetailsCurbsidePickupDetails.validate_raw(obj: obj.curbside_pickup_details)
    end
  end
end