...
# An object that contains the customer associated with the event.
  ...
  # @return [SquareApiClient::Customer] The deleted customer.
    attr_reader :customer
  # @return [SquareApiClient::CustomerDeletedEventEventContext] Information about the change that triggered the event. This field is returned
#  only if the customer is deleted by a merge operation.
  ...
  # @return [Object] 
    ...
    # @param customer [SquareApiClient::Customer] The deleted customer.
    # @param event_context [SquareApiClient::CustomerDeletedEventEventContext] Information about the change that triggered the event. This field is returned
#  only if the customer is deleted by a merge operation.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CustomerDeletedEventObject]
...
# Deserialize a JSON object to an instance of CustomerDeletedEventObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["event_context"].nil?
        ...
        event_context = SquareApiClient::CustomerDeletedEventEventContext.from_json(json_object: event_context)
      else
        event_context = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.event_context.nil? || SquareApiClient::CustomerDeletedEventEventContext.validate_raw(obj: obj.event_context)
    end
  end
end