...
# Defines the fields in a `CreateDisputeEvidenceFile` response.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::DisputeEvidence] The metadata of the newly uploaded dispute evidence.
  ...
  # @return [Object] 
    ...
    # @param evidence [square.rb::DisputeEvidence] The metadata of the newly uploaded dispute evidence.
