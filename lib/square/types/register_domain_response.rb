...
#  Either `errors` or `status` are present in a given response (never both).
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::RegisterDomainResponseStatus] The status of the domain registration.
...
#  possible values
  ...
  # @return [Object] 
    ...
    # @param status [SquareApiClient::RegisterDomainResponseStatus] The status of the domain registration.
#  See [RegisterDomainResponseStatus](entity:RegisterDomainResponseStatus) for
#  possible values.
#  See [RegisterDomainResponseStatus](#type-registerdomainresponsestatus) for
#  possible values
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::RegisterDomainResponseStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end