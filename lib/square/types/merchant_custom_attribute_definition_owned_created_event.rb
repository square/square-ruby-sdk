...
#  when your application creates a merchant custom attribute definition.
  class MerchantCustomAttributeDefinitionOwnedCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::MerchantCustomAttributeDefinitionOwnedCreatedEvent]
...
# Serialize an instance of MerchantCustomAttributeDefinitionOwnedCreatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
