...
#  information.
  ...
  # @return [Array<SquareApiClient::InventoryChange>] The set of physical counts and inventory adjustments to be made.
...
#  for more
#  information.
    # @param changes [Array<SquareApiClient::InventoryChange>] The set of physical counts and inventory adjustments to be made.
#  Changes are applied based on the client-supplied timestamp and may be sent
#  out of order.
...
#  the quantity is unchanged since the last physical count. Default: `true`.
    ...
    # @return [SquareApiClient::BatchChangeInventoryRequest]
