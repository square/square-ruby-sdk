...
module square.rb
  ...
  # @return [square.rb::Booking] The booking that was requested.
    attr_reader :booking
  ...
  # @return [Object] 
    ...
    # @param booking [square.rb::Booking] The booking that was requested.
...
# Deserialize a JSON object to an instance of GetBookingResponse
    #
...
# Serialize an instance of GetBookingResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
