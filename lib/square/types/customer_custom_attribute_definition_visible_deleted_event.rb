...
#  that is visible to the subscribing application is deleted. A custom attribute
#  definition can only be deleted
#  by the application that created it. A notification is sent when your application
#  deletes a custom attribute
#  definition or when another application deletes a custom attribute definition
#  whose `visibility` is
#  `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class CustomerCustomAttributeDefinitionVisibleDeletedEvent
...
#  3339 format.
  ...
  # @return [square.rb::CustomAttributeDefinitionEventData] The data associated with the event that triggered the event notification.
    attr_reader :data
...
#  3339 format.
    # @param data [square.rb::CustomAttributeDefinitionEventData] The data associated with the event that triggered the event notification.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CustomerCustomAttributeDefinitionVisibleDeletedEvent]
...
#  CustomerCustomAttributeDefinitionVisibleDeletedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::CustomAttributeDefinitionEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CustomerCustomAttributeDefinitionVisibleDeletedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::CustomAttributeDefinitionEventData.validate_raw(obj: obj.data)
    end
  end
end