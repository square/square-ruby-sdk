...
#  application.
  class CustomerCustomAttributeOwnedUpdatedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeOwnedUpdatedEvent]
...
# Serialize an instance of CustomerCustomAttributeOwnedUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
