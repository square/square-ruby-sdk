...
module square.rb
# Represents a
#  [CreateLoyaltyPromotion](api-endpoint:Loyalty-CreateLoyaltyPromotion) response.
#  Either `loyalty_promotion` or `errors` is present in the response.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::LoyaltyPromotion] The new loyalty promotion.
  ...
  # @return [Object] 
    ...
    # @param loyalty_promotion [square.rb::LoyaltyPromotion] The new loyalty promotion.
...
# Deserialize a JSON object to an instance of CreateLoyaltyPromotionResponse
    #
...
# Serialize an instance of CreateLoyaltyPromotionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
