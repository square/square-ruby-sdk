...
#  redemption.
  ...
  # @return [String] The Square-assigned ID of the gift card activity.
    attr_reader :id
  # @return [square.rb::GiftCardActivityType] The type of gift card activity.
...
#  is not required if `gift_card_id` is specified.
  ...
  # @return [square.rb::Money] The final balance on the gift card after the action is completed.
    attr_reader :gift_card_balance_money
  # @return [square.rb::GiftCardActivityLoad] Additional details about a `LOAD` activity, which is used to reload money onto a
#  gift card.
    attr_reader :load_activity_details
  # @return [square.rb::GiftCardActivityActivate] Additional details about an `ACTIVATE` activity, which is used to activate a
#  gift card with
#  an initial balance.
    attr_reader :activate_activity_details
  # @return [square.rb::GiftCardActivityRedeem] Additional details about a `REDEEM` activity, which is used to redeem a gift
#  card for a purchase.
...
#  to create the `REDEEM` activity.
  ...
  # @return [square.rb::GiftCardActivityClearBalance] Additional details about a `CLEAR_BALANCE` activity, which is used to set the
#  balance of a gift card to zero.
    attr_reader :clear_balance_activity_details
  # @return [square.rb::GiftCardActivityDeactivate] Additional details about a `DEACTIVATE` activity, which is used to deactivate a
#  gift card.
    attr_reader :deactivate_activity_details
  # @return [square.rb::GiftCardActivityAdjustIncrement] Additional details about an `ADJUST_INCREMENT` activity, which is used to add
...
#  outside of a typical `ACTIVATE`, `LOAD`, or `REFUND` activity flow.
  ...
  # @return [square.rb::GiftCardActivityAdjustDecrement] Additional details about an `ADJUST_DECREMENT` activity, which is used to deduct
#  money from a gift
#  card outside of a typical `REDEEM` activity flow.
    attr_reader :adjust_decrement_activity_details
  # @return [square.rb::GiftCardActivityRefund] Additional details about a `REFUND` activity, which is used to add money to a
#  gift card when
#  refunding a payment.
...
#  to create the `REFUND` activity.
  ...
  # @return [square.rb::GiftCardActivityUnlinkedActivityRefund] Additional details about an `UNLINKED_ACTIVITY_REFUND` activity. This activity
...
#  and not linked to the gift card.
  ...
  # @return [square.rb::GiftCardActivityImport] Additional details about an `IMPORT` activity, which Square uses to import a
#  third-party
#  gift card with a balance.
    attr_reader :import_activity_details
  # @return [square.rb::GiftCardActivityBlock] Additional details about a `BLOCK` activity, which Square uses to temporarily
#  block a gift card.
    attr_reader :block_activity_details
  # @return [square.rb::GiftCardActivityUnblock] Additional details about an `UNBLOCK` activity, which Square uses to unblock a
#  gift card.
    attr_reader :unblock_activity_details
  # @return [square.rb::GiftCardActivityImportReversal] Additional details about an `IMPORT_REVERSAL` activity, which Square uses to
#  reverse the
#  import of a third-party gift card.
    attr_reader :import_reversal_activity_details
  # @return [square.rb::GiftCardActivityTransferBalanceTo] Additional details about a `TRANSFER_BALANCE_TO` activity, which Square uses to
#  add money to
#  a gift card as the result of a transfer from another gift card.
    attr_reader :transfer_balance_to_activity_details
  # @return [square.rb::GiftCardActivityTransferBalanceFrom] Additional details about a `TRANSFER_BALANCE_FROM` activity, which Square uses
...
#  a gift as the result of a transfer to another gift card.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::GiftCardActivityType] The type of gift card activity.
#  See [Type](#type-type) for possible values
...
#  `gift_card_gan`
#  is not required if `gift_card_id` is specified.
    # @param gift_card_balance_money [square.rb::Money] The final balance on the gift card after the action is completed.
    # @param load_activity_details [square.rb::GiftCardActivityLoad] Additional details about a `LOAD` activity, which is used to reload money onto a
#  gift card.
    # @param activate_activity_details [square.rb::GiftCardActivityActivate] Additional details about an `ACTIVATE` activity, which is used to activate a
#  gift card with
#  an initial balance.
    # @param redeem_activity_details [square.rb::GiftCardActivityRedeem] Additional details about a `REDEEM` activity, which is used to redeem a gift
#  card for a purchase.
#  For applications that process payments using the Square Payments API, Square
#  creates a `REDEEM` activity that
#  updates the gift card balance after the corresponding
...
#  [CreateGiftCardActivity](api-endpoint:GiftCardActivities-CreateGiftCardActivity)
#  to create the `REDEEM` activity.
    # @param clear_balance_activity_details [square.rb::GiftCardActivityClearBalance] Additional details about a `CLEAR_BALANCE` activity, which is used to set the
#  balance of a gift card to zero.
    # @param deactivate_activity_details [square.rb::GiftCardActivityDeactivate] Additional details about a `DEACTIVATE` activity, which is used to deactivate a
#  gift card.
    # @param adjust_increment_activity_details [square.rb::GiftCardActivityAdjustIncrement] Additional details about an `ADJUST_INCREMENT` activity, which is used to add
#  money to a gift card
#  outside of a typical `ACTIVATE`, `LOAD`, or `REFUND` activity flow.
    # @param adjust_decrement_activity_details [square.rb::GiftCardActivityAdjustDecrement] Additional details about an `ADJUST_DECREMENT` activity, which is used to deduct
#  money from a gift
#  card outside of a typical `REDEEM` activity flow.
    # @param refund_activity_details [square.rb::GiftCardActivityRefund] Additional details about a `REFUND` activity, which is used to add money to a
#  gift card when
#  refunding a payment.
#  For applications that refund payments to a gift card using the Square Refunds
#  API, Square automatically
...
#  [CreateGiftCardActivity](api-endpoint:GiftCardActivities-CreateGiftCardActivity)
#  to create the `REFUND` activity.
    # @param unlinked_activity_refund_activity_details [square.rb::GiftCardActivityUnlinkedActivityRefund] Additional details about an `UNLINKED_ACTIVITY_REFUND` activity. This activity
#  is used to add money
#  to a gift card when refunding a payment that was processed using a custom
#  payment processing system
#  and not linked to the gift card.
    # @param import_activity_details [square.rb::GiftCardActivityImport] Additional details about an `IMPORT` activity, which Square uses to import a
#  third-party
#  gift card with a balance.
    # @param block_activity_details [square.rb::GiftCardActivityBlock] Additional details about a `BLOCK` activity, which Square uses to temporarily
#  block a gift card.
    # @param unblock_activity_details [square.rb::GiftCardActivityUnblock] Additional details about an `UNBLOCK` activity, which Square uses to unblock a
#  gift card.
    # @param import_reversal_activity_details [square.rb::GiftCardActivityImportReversal] Additional details about an `IMPORT_REVERSAL` activity, which Square uses to
#  reverse the
#  import of a third-party gift card.
    # @param transfer_balance_to_activity_details [square.rb::GiftCardActivityTransferBalanceTo] Additional details about a `TRANSFER_BALANCE_TO` activity, which Square uses to
#  add money to
#  a gift card as the result of a transfer from another gift card.
    # @param transfer_balance_from_activity_details [square.rb::GiftCardActivityTransferBalanceFrom] Additional details about a `TRANSFER_BALANCE_FROM` activity, which Square uses
#  to deduct money from
#  a gift as the result of a transfer to another gift card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::GiftCardActivity]
...
# Deserialize a JSON object to an instance of GiftCardActivity
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["gift_card_balance_money"].nil?
        ...
        gift_card_balance_money = square.rb::Money.from_json(json_object: gift_card_balance_money)
      else
      ...
      unless parsed_json["load_activity_details"].nil?
        ...
        load_activity_details = square.rb::GiftCardActivityLoad.from_json(json_object: load_activity_details)
      else
      ...
      unless parsed_json["activate_activity_details"].nil?
        ...
        activate_activity_details = square.rb::GiftCardActivityActivate.from_json(json_object: activate_activity_details)
      else
      ...
      unless parsed_json["redeem_activity_details"].nil?
        ...
        redeem_activity_details = square.rb::GiftCardActivityRedeem.from_json(json_object: redeem_activity_details)
      else
      ...
      unless parsed_json["clear_balance_activity_details"].nil?
        ...
        clear_balance_activity_details = square.rb::GiftCardActivityClearBalance.from_json(json_object: clear_balance_activity_details)
      else
      ...
      unless parsed_json["deactivate_activity_details"].nil?
        ...
        deactivate_activity_details = square.rb::GiftCardActivityDeactivate.from_json(json_object: deactivate_activity_details)
      else
      ...
      unless parsed_json["adjust_increment_activity_details"].nil?
        ...
        adjust_increment_activity_details = square.rb::GiftCardActivityAdjustIncrement.from_json(json_object: adjust_increment_activity_details)
      else
      ...
      unless parsed_json["adjust_decrement_activity_details"].nil?
        ...
        adjust_decrement_activity_details = square.rb::GiftCardActivityAdjustDecrement.from_json(json_object: adjust_decrement_activity_details)
      else
      ...
      unless parsed_json["refund_activity_details"].nil?
        ...
        refund_activity_details = square.rb::GiftCardActivityRefund.from_json(json_object: refund_activity_details)
      else
      ...
      unless parsed_json["unlinked_activity_refund_activity_details"].nil?
        ...
        unlinked_activity_refund_activity_details = square.rb::GiftCardActivityUnlinkedActivityRefund.from_json(json_object: unlinked_activity_refund_activity_details)
      else
      ...
      unless parsed_json["import_activity_details"].nil?
        ...
        import_activity_details = square.rb::GiftCardActivityImport.from_json(json_object: import_activity_details)
      else
      ...
      unless parsed_json["block_activity_details"].nil?
        ...
        block_activity_details = square.rb::GiftCardActivityBlock.from_json(json_object: block_activity_details)
      else
      ...
      unless parsed_json["unblock_activity_details"].nil?
        ...
        unblock_activity_details = square.rb::GiftCardActivityUnblock.from_json(json_object: unblock_activity_details)
      else
      ...
      unless parsed_json["import_reversal_activity_details"].nil?
        ...
        import_reversal_activity_details = square.rb::GiftCardActivityImportReversal.from_json(json_object: import_reversal_activity_details)
      else
      ...
      unless parsed_json["transfer_balance_to_activity_details"].nil?
        ...
        transfer_balance_to_activity_details = square.rb::GiftCardActivityTransferBalanceTo.from_json(json_object: transfer_balance_to_activity_details)
      else
      ...
      unless parsed_json["transfer_balance_from_activity_details"].nil?
        ...
        transfer_balance_from_activity_details = square.rb::GiftCardActivityTransferBalanceFrom.from_json(json_object: transfer_balance_from_activity_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(square.rb::GiftCardActivityType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      ...
      obj.gift_card_balance_money.nil? || square.rb::Money.validate_raw(obj: obj.gift_card_balance_money)
      obj.load_activity_details.nil? || square.rb::GiftCardActivityLoad.validate_raw(obj: obj.load_activity_details)
      obj.activate_activity_details.nil? || square.rb::GiftCardActivityActivate.validate_raw(obj: obj.activate_activity_details)
      obj.redeem_activity_details.nil? || square.rb::GiftCardActivityRedeem.validate_raw(obj: obj.redeem_activity_details)
      obj.clear_balance_activity_details.nil? || square.rb::GiftCardActivityClearBalance.validate_raw(obj: obj.clear_balance_activity_details)
      obj.deactivate_activity_details.nil? || square.rb::GiftCardActivityDeactivate.validate_raw(obj: obj.deactivate_activity_details)
      obj.adjust_increment_activity_details.nil? || square.rb::GiftCardActivityAdjustIncrement.validate_raw(obj: obj.adjust_increment_activity_details)
      obj.adjust_decrement_activity_details.nil? || square.rb::GiftCardActivityAdjustDecrement.validate_raw(obj: obj.adjust_decrement_activity_details)
      obj.refund_activity_details.nil? || square.rb::GiftCardActivityRefund.validate_raw(obj: obj.refund_activity_details)
      obj.unlinked_activity_refund_activity_details.nil? || square.rb::GiftCardActivityUnlinkedActivityRefund.validate_raw(obj: obj.unlinked_activity_refund_activity_details)
      obj.import_activity_details.nil? || square.rb::GiftCardActivityImport.validate_raw(obj: obj.import_activity_details)
      obj.block_activity_details.nil? || square.rb::GiftCardActivityBlock.validate_raw(obj: obj.block_activity_details)
      obj.unblock_activity_details.nil? || square.rb::GiftCardActivityUnblock.validate_raw(obj: obj.unblock_activity_details)
      obj.import_reversal_activity_details.nil? || square.rb::GiftCardActivityImportReversal.validate_raw(obj: obj.import_reversal_activity_details)
      obj.transfer_balance_to_activity_details.nil? || square.rb::GiftCardActivityTransferBalanceTo.validate_raw(obj: obj.transfer_balance_to_activity_details)
      obj.transfer_balance_from_activity_details.nil? || square.rb::GiftCardActivityTransferBalanceFrom.validate_raw(obj: obj.transfer_balance_from_activity_details)
    end
  end
end