...
#  owner.
    ...
    # @return [SquareApiClient::BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest]
...
#  BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest to
#  a JSON object
    #
    # @return [String]
    def to_json
