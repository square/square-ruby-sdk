...
#  the request resulted in errors.
  ...
  # @return [SquareApiClient::WorkweekConfig] The response object.
  ...
  # @return [Object] 
    ...
    # @param workweek_config [SquareApiClient::WorkweekConfig] The response object.
...
# Deserialize a JSON object to an instance of UpdateWorkweekConfigResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["workweek_config"].nil?
        ...
        workweek_config = SquareApiClient::WorkweekConfig.from_json(json_object: workweek_config)
      else
        workweek_config = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.workweek_config.nil? || SquareApiClient::WorkweekConfig.validate_raw(obj: obj.workweek_config)
