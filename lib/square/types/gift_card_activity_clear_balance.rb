...
#  type](entity:GiftCardActivityType).
  ...
  # @return [square.rb::GiftCardActivityClearBalanceReason] The reason the gift card balance was cleared.
#  See [Reason](#type-reason) for possible values
  ...
  # @return [Object] 
    ...
    # @param reason [square.rb::GiftCardActivityClearBalanceReason] The reason the gift card balance was cleared.
#  See [Reason](#type-reason) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::GiftCardActivityClearBalance]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.reason.is_a?(square.rb::GiftCardActivityClearBalanceReason) != false || raise("Passed value for field obj.reason is not the expected type, validation failed.")
    end
  end
end