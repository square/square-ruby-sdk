...
#  present.
  ...
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Card] The retrieved card.
    attr_reader :card
  ...
  # @return [Object] 
    ...
    # @param card [square.rb::Card] The retrieved card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DisableCardResponse]
...
# Deserialize a JSON object to an instance of DisableCardResponse
    #
...
# Serialize an instance of DisableCardResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
