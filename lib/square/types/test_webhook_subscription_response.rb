...
#  present.
  ...
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::SubscriptionTestResult] The [SubscriptionTestResult](entity:SubscriptionTestResult).
  ...
  # @return [Object] 
    ...
    # @param subscription_test_result [square.rb::SubscriptionTestResult] The [SubscriptionTestResult](entity:SubscriptionTestResult).
...
# Deserialize a JSON object to an instance of TestWebhookSubscriptionResponse
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["subscription_test_result"].nil?
        ...
        subscription_test_result = square.rb::SubscriptionTestResult.from_json(json_object: subscription_test_result)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.subscription_test_result.nil? || square.rb::SubscriptionTestResult.validate_raw(obj: obj.subscription_test_result)
    end
  end
end