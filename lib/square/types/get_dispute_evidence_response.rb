...
# Defines the fields in a `RetrieveDisputeEvidence` response.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::DisputeEvidence] Metadata about the dispute evidence file.
  ...
  # @return [Object] 
    ...
    # @param evidence [square.rb::DisputeEvidence] Metadata about the dispute evidence file.
