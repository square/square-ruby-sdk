...
module square.rb
  ...
  # @return [square.rb::TerminalCheckout] The created terminal checkout
  ...
  # @return [Object] 
    ...
    # @param checkout [square.rb::TerminalCheckout] The created terminal checkout
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TerminalCheckoutCreatedEventObject]
