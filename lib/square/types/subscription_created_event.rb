...
# Published when a [Subscription](entity:Subscription) is created.
  ...
  # @return [square.rb::SubscriptionCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::SubscriptionCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SubscriptionCreatedEvent]
...
# Deserialize a JSON object to an instance of SubscriptionCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::SubscriptionCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::SubscriptionCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end