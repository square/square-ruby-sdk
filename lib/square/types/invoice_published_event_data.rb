...
module SquareApiClient
  ...
  # @return [String] ID of the affected invoice.
    attr_reader :id
  # @return [SquareApiClient::InvoicePublishedEventObject] An object containing the published invoice.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::InvoicePublishedEventObject] An object containing the published invoice.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoicePublishedEventData]
...
# Deserialize a JSON object to an instance of InvoicePublishedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::InvoicePublishedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::InvoicePublishedEventObject.validate_raw(obj: obj.object)
    end
  end
end