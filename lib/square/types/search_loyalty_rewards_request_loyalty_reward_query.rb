...
#  reward belongs.
  ...
  # @return [square.rb::LoyaltyRewardStatus] The status of the loyalty reward.
...
#  reward belongs.
    # @param status [square.rb::LoyaltyRewardStatus] The status of the loyalty reward.
#  See [LoyaltyRewardStatus](#type-loyaltyrewardstatus) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchLoyaltyRewardsRequestLoyaltyRewardQuery]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(square.rb::LoyaltyRewardStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end