...
# Represents a payment processed by the Square API.
  ...
  # @return [SquareApiClient::Money] The amount processed for this payment, not including `tip_money`.
...
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
  ...
  # @return [SquareApiClient::Money] The amount designated as a tip.
...
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
  ...
  # @return [SquareApiClient::Money] The total amount for the payment, including `amount_money` and `tip_money`.
#  This amount is specified in the smallest denomination of the applicable currency
#  (for example,
#  US dollar amounts are specified in cents). For more information, see
#  [Working with Monetary
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
  ...
  # @return [SquareApiClient::Money] The amount the developer is taking as a fee for facilitating the payment on
#  behalf
...
#  oper.squareup.com/docs/payments-api/take-payments-and-collect-fees#permissions).
  ...
  # @return [SquareApiClient::Money] The amount of money approved for this payment. This value may change if Square
#  chooses to
#  obtain reauthorization as part of a call to
#  [UpdatePayment](api-endpoint:Payments-UpdatePayment).
    attr_reader :approved_money
  # @return [Array<SquareApiClient::ProcessingFee>] The processing fees and fee adjustments assessed by Square for this payment.
    attr_reader :processing_fee
  # @return [SquareApiClient::Money] The total amount of the payment refunded to date.
#  This amount is specified in the smallest denomination of the applicable currency
#  (for example,
...
#  Payments](https://developer.squareup.com/docs/payments-api/take-payments).
  ...
  # @return [SquareApiClient::CardPaymentDetails] Details about a card payment. These details are only populated if the
#  source_type is `CARD`.
    attr_reader :card_details
  # @return [SquareApiClient::CashPaymentDetails] Details about a cash payment. These details are only populated if the
#  source_type is `CASH`.
    attr_reader :cash_details
  # @return [SquareApiClient::BankAccountPaymentDetails] Details about a bank account payment. These details are only populated if the
#  source_type is `BANK_ACCOUNT`.
    attr_reader :bank_account_details
  # @return [SquareApiClient::ExternalPaymentDetails] Details about an external payment. The details are only populated
#  if the `source_type` is `EXTERNAL`.
    attr_reader :external_details
  # @return [SquareApiClient::DigitalWalletDetails] Details about an wallet payment. The details are only populated
#  if the `source_type` is `WALLET`.
    attr_reader :wallet_details
  # @return [SquareApiClient::BuyNowPayLaterDetails] Details about a Buy Now Pay Later payment. The details are only populated
...
#  tps://developer.squareup.com/docs/payments-api/take-payments/afterpay-payments).
  ...
  # @return [SquareApiClient::SquareAccountDetails] Details about a Square Account payment. The details are only populated
...
#  payment.
  ...
  # @return [SquareApiClient::RiskEvaluation] Provides information about the risk associated with the payment, as determined
#  by Square.
...
#  evaluations.
  ...
  # @return [SquareApiClient::Address] The buyer's billing address.
    attr_reader :billing_address
  # @return [SquareApiClient::Address] The buyer's shipping address.
...
#  The field is only populated for COMPLETED payments.
  ...
  # @return [SquareApiClient::DeviceDetails] Details about the device that took the payment.
    attr_reader :device_details
  # @return [SquareApiClient::ApplicationDetails] Details about the application that took the payment.
  ...
  # @return [SquareApiClient::OfflinePaymentDetails] Additional information about the payment if it was taken offline.
...
#  `Payment` object.
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The amount processed for this payment, not including `tip_money`.
#  The amount is specified in the smallest denomination of the applicable currency
#  (for example,
#  US dollar amounts are specified in cents). For more information, see
#  [Working with Monetary
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
    # @param tip_money [SquareApiClient::Money] The amount designated as a tip.
#  This amount is specified in the smallest denomination of the applicable currency
#  (for example,
#  US dollar amounts are specified in cents). For more information, see
#  [Working with Monetary
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
    # @param total_money [SquareApiClient::Money] The total amount for the payment, including `amount_money` and `tip_money`.
#  This amount is specified in the smallest denomination of the applicable currency
#  (for example,
#  US dollar amounts are specified in cents). For more information, see
#  [Working with Monetary
#  https://developer.squareup.com/docs/build-basics/working-with-monetary-amounts).
    # @param app_fee_money [SquareApiClient::Money] The amount the developer is taking as a fee for facilitating the payment on
#  behalf
#  of the seller. This amount is specified in the smallest denomination of the
#  applicable currency
#  (for example, US dollar amounts are specified in cents). For more information,
...
#  For more information, see
#  oper.squareup.com/docs/payments-api/take-payments-and-collect-fees#permissions).
    # @param approved_money [SquareApiClient::Money] The amount of money approved for this payment. This value may change if Square
#  chooses to
#  obtain reauthorization as part of a call to
#  [UpdatePayment](api-endpoint:Payments-UpdatePayment).
    # @param processing_fee [Array<SquareApiClient::ProcessingFee>] The processing fees and fee adjustments assessed by Square for this payment.
    # @param refunded_money [SquareApiClient::Money] The total amount of the payment refunded to date.
#  This amount is specified in the smallest denomination of the applicable currency
#  (for example,
#  US dollar amounts are specified in cents).
...
#  see [Take
#  Payments](https://developer.squareup.com/docs/payments-api/take-payments).
    # @param card_details [SquareApiClient::CardPaymentDetails] Details about a card payment. These details are only populated if the
#  source_type is `CARD`.
    # @param cash_details [SquareApiClient::CashPaymentDetails] Details about a cash payment. These details are only populated if the
#  source_type is `CASH`.
    # @param bank_account_details [SquareApiClient::BankAccountPaymentDetails] Details about a bank account payment. These details are only populated if the
#  source_type is `BANK_ACCOUNT`.
    # @param external_details [SquareApiClient::ExternalPaymentDetails] Details about an external payment. The details are only populated
#  if the `source_type` is `EXTERNAL`.
    # @param wallet_details [SquareApiClient::DigitalWalletDetails] Details about an wallet payment. The details are only populated
#  if the `source_type` is `WALLET`.
    # @param buy_now_pay_later_details [SquareApiClient::BuyNowPayLaterDetails] Details about a Buy Now Pay Later payment. The details are only populated
#  if the `source_type` is `BUY_NOW_PAY_LATER`. For more information, see
#  [Afterpay
#  tps://developer.squareup.com/docs/payments-api/take-payments/afterpay-payments).
    # @param square_account_details [SquareApiClient::SquareAccountDetails] Details about a Square Account payment. The details are only populated
#  if the `source_type` is `SQUARE_ACCOUNT`.
...
#  payment.
    ...
    # @param risk_evaluation [SquareApiClient::RiskEvaluation] Provides information about the risk associated with the payment, as determined
#  by Square.
#  This field is present for payments to sellers that have opted in to receive risk
#  evaluations.
    ...
    # @param billing_address [SquareApiClient::Address] The buyer's billing address.
    # @param shipping_address [SquareApiClient::Address] The buyer's shipping address.
...
#  The field is only populated for COMPLETED payments.
    # @param device_details [SquareApiClient::DeviceDetails] Details about the device that took the payment.
    # @param application_details [SquareApiClient::ApplicationDetails] Details about the application that took the payment.
    # @param is_offline_payment [Boolean] Whether or not this payment was taken offline.
    # @param offline_payment_details [SquareApiClient::OfflinePaymentDetails] Additional information about the payment if it was taken offline.
...
#  `Payment` object.
    ...
    # @return [SquareApiClient::Payment]
...
# Deserialize a JSON object to an instance of Payment
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["approved_money"].nil?
        ...
        approved_money = SquareApiClient::Money.from_json(json_object: approved_money)
      else
        approved_money = nil
      end
  ...
  SquareApiClient::ProcessingFee.from_json(json_object: item)
      ...
      unless parsed_json["refunded_money"].nil?
        ...
        refunded_money = SquareApiClient::Money.from_json(json_object: refunded_money)
      else
        refunded_money = nil
      end
      ...
      unless parsed_json["card_details"].nil?
        ...
        card_details = SquareApiClient::CardPaymentDetails.from_json(json_object: card_details)
      else
        card_details = nil
      end
      unless parsed_json["cash_details"].nil?
        cash_details = parsed_json["cash_details"].to_json
        cash_details = SquareApiClient::CashPaymentDetails.from_json(json_object: cash_details)
      else
        cash_details = nil
      end
      unless parsed_json["bank_account_details"].nil?
        bank_account_details = parsed_json["bank_account_details"].to_json
        bank_account_details = SquareApiClient::BankAccountPaymentDetails.from_json(json_object: bank_account_details)
      else
        bank_account_details = nil
      end
      unless parsed_json["external_details"].nil?
        external_details = parsed_json["external_details"].to_json
        external_details = SquareApiClient::ExternalPaymentDetails.from_json(json_object: external_details)
      else
        external_details = nil
      end
      unless parsed_json["wallet_details"].nil?
        wallet_details = parsed_json["wallet_details"].to_json
        wallet_details = SquareApiClient::DigitalWalletDetails.from_json(json_object: wallet_details)
      else
        wallet_details = nil
      end
      unless parsed_json["buy_now_pay_later_details"].nil?
        buy_now_pay_later_details = parsed_json["buy_now_pay_later_details"].to_json
        buy_now_pay_later_details = SquareApiClient::BuyNowPayLaterDetails.from_json(json_object: buy_now_pay_later_details)
      else
      ...
      unless parsed_json["square_account_details"].nil?
        ...
        square_account_details = SquareApiClient::SquareAccountDetails.from_json(json_object: square_account_details)
      else
      ...
      unless parsed_json["risk_evaluation"].nil?
        ...
        risk_evaluation = SquareApiClient::RiskEvaluation.from_json(json_object: risk_evaluation)
      else
        risk_evaluation = nil
      end
      ...
      unless parsed_json["application_details"].nil?
        ...
        application_details = SquareApiClient::ApplicationDetails.from_json(json_object: application_details)
      else
      ...
      unless parsed_json["offline_payment_details"].nil?
        ...
        offline_payment_details = SquareApiClient::OfflinePaymentDetails.from_json(json_object: offline_payment_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.approved_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.approved_money)
      ...
      obj.refunded_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.refunded_money)
      ...
      obj.card_details.nil? || SquareApiClient::CardPaymentDetails.validate_raw(obj: obj.card_details)
      obj.cash_details.nil? || SquareApiClient::CashPaymentDetails.validate_raw(obj: obj.cash_details)
      obj.bank_account_details.nil? || SquareApiClient::BankAccountPaymentDetails.validate_raw(obj: obj.bank_account_details)
      obj.external_details.nil? || SquareApiClient::ExternalPaymentDetails.validate_raw(obj: obj.external_details)
      obj.wallet_details.nil? || SquareApiClient::DigitalWalletDetails.validate_raw(obj: obj.wallet_details)
      obj.buy_now_pay_later_details.nil? || SquareApiClient::BuyNowPayLaterDetails.validate_raw(obj: obj.buy_now_pay_later_details)
      obj.square_account_details.nil? || SquareApiClient::SquareAccountDetails.validate_raw(obj: obj.square_account_details)
      ...
      obj.risk_evaluation.nil? || SquareApiClient::RiskEvaluation.validate_raw(obj: obj.risk_evaluation)
      ...
      obj.application_details.nil? || SquareApiClient::ApplicationDetails.validate_raw(obj: obj.application_details)
      ...
      obj.offline_payment_details.nil? || SquareApiClient::OfflinePaymentDetails.validate_raw(obj: obj.offline_payment_details)
