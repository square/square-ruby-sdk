...
#  One of `errors` or `transactions` is present in a given response (never both).
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::Transaction>] An array of transactions that match your query.
...
#  more information.
  ...
  # @return [Object] 
    ...
    # @param transactions [Array<square.rb::Transaction>] An array of transactions that match your query.
...
# Deserialize a JSON object to an instance of ListTransactionsResponse
  ...
  item = item.to_json
  square.rb::Transaction.from_json(json_object: item)
end
