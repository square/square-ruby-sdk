...
#  `InventoryTransfer` to an external system.
  ...
  # @return [square.rb::InventoryState] The [inventory state](entity:InventoryState) for the quantity of
...
#  received the transfer request.
  ...
  # @return [square.rb::SourceApplication] Information about the application that initiated the
#  inventory transfer.
    attr_reader :source
...
#  `InventoryTransfer` to an external system.
    # @param state [square.rb::InventoryState] The [inventory state](entity:InventoryState) for the quantity of
#  items being transferred.
#  See [InventoryState](#type-inventorystate) for possible values
...
#  received the transfer request.
    # @param source [square.rb::SourceApplication] Information about the application that initiated the
#  inventory transfer.
...
#  inventory transfer.
    ...
    # @return [square.rb::InventoryTransfer]
