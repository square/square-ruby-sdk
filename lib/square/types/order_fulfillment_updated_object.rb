...
module square.rb
  ...
  # @return [square.rb::OrderFulfillmentUpdated] Information about the updated order fulfillment.
  ...
  # @return [Object] 
    ...
    # @param order_fulfillment_updated [square.rb::OrderFulfillmentUpdated] Information about the updated order fulfillment.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderFulfillmentUpdatedObject]
...
# Deserialize a JSON object to an instance of OrderFulfillmentUpdatedObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["order_fulfillment_updated"].nil?
        ...
        order_fulfillment_updated = square.rb::OrderFulfillmentUpdated.from_json(json_object: order_fulfillment_updated)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.order_fulfillment_updated.nil? || square.rb::OrderFulfillmentUpdated.validate_raw(obj: obj.order_fulfillment_updated)
    end
  end
end