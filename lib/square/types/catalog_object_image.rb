...
require_relative "catalog_image"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectImage
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogImage] Structured data for a `CatalogImage`, set for CatalogObjects of type `IMAGE`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param image_data [square.rb::CatalogImage] Structured data for a `CatalogImage`, set for CatalogObjects of type `IMAGE`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectImage]
    def initialize(type:, image_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @image_data = image_data if image_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectImage
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["image_data"].nil?
        image_data = parsed_json["image_data"].to_json
        image_data = square.rb::CatalogImage.from_json(json_object: image_data)
      else
        image_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectImage to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.image_data.nil? || square.rb::CatalogImage.validate_raw(obj: obj.image_data)
