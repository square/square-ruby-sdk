...
# Published when a [Payout](entity:Payout) is complete.
  ...
  # @return [square.rb::PayoutPaidEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::PayoutPaidEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::PayoutPaidEvent]
...
# Deserialize a JSON object to an instance of PayoutPaidEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::PayoutPaidEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::PayoutPaidEventData.validate_raw(obj: obj.data)
    end
  end
end