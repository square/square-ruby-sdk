...
#  `"online_checkout.location_settings.updated"`.
  ...
  # @return [square.rb::LocationSettingsUpdatedEventData] Data associated with the event.
    attr_reader :data
...
#  `"online_checkout.location_settings.updated"`.
    ...
    # @param data [square.rb::LocationSettingsUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LocationSettingsUpdatedEvent]
...
# Deserialize a JSON object to an instance of LocationSettingsUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::LocationSettingsUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::LocationSettingsUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end