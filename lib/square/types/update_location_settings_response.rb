...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred when updating the location settings.
    attr_reader :errors
  # @return [square.rb::CheckoutLocationSettings] The updated location settings.
  ...
  # @return [Object] 
    ...
    # @param errors [Array<square.rb::Error>] Any errors that occurred when updating the location settings.
    # @param location_settings [square.rb::CheckoutLocationSettings] The updated location settings.
...
# Deserialize a JSON object to an instance of UpdateLocationSettingsResponse
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["location_settings"].nil?
        ...
        location_settings = square.rb::CheckoutLocationSettings.from_json(json_object: location_settings)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.location_settings.nil? || square.rb::CheckoutLocationSettings.validate_raw(obj: obj.location_settings)
    end
  end
end