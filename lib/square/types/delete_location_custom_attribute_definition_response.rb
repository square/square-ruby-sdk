...
# Represents a response from a delete request containing error messages if there
#  are any.
  class DeleteLocationCustomAttributeDefinitionResponse
...
# Serialize an instance of DeleteLocationCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
