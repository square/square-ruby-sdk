...
#  or [ListCustomers](api-endpoint:Customers-ListCustomers) endpoint.
  ...
  # @return [square.rb::Address] The physical address associated with the customer profile.
    attr_reader :address
...
#  entity in another system.
  ...
  # @return [String] A custom note associated with the customer profile.
    attr_reader :note
  # @return [square.rb::CustomerPreferences] Represents general customer preferences.
    attr_reader :preferences
  # @return [square.rb::CustomerCreationSource] The method used to create the customer profile.
...
#  for changes to customer segment membership.
    attr_reader :version
  # @return [square.rb::CustomerTaxIds] The tax ID associated with the customer profile. This field is present only for
...
#  or [ListCustomers](api-endpoint:Customers-ListCustomers) endpoint.
    ...
    # @param address [square.rb::Address] The physical address associated with the customer profile.
...
#  entity in another system.
    ...
    # @param preferences [square.rb::CustomerPreferences] Represents general customer preferences.
    # @param creation_source [square.rb::CustomerCreationSource] The method used to create the customer profile.
#  See [CustomerCreationSource](#type-customercreationsource) for possible values
...
#  is incremented each time an update is committed to the customer profile, except
#  for changes to customer segment membership.
    # @param tax_ids [square.rb::CustomerTaxIds] The tax ID associated with the customer profile. This field is present only for
#  customers of sellers in EU countries or the United Kingdom.
#  For more information, see [Customer tax
#  ttps://developer.squareup.com/docs/customers-api/what-it-does#customer-tax-ids).
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::Customer]
...
# Deserialize a JSON object to an instance of Customer
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["preferences"].nil?
        ...
        preferences = square.rb::CustomerPreferences.from_json(json_object: preferences)
      else
        preferences = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.preferences.nil? || square.rb::CustomerPreferences.validate_raw(obj: obj.preferences)
      obj.creation_source&.is_a?(square.rb::CustomerCreationSource) != false || raise("Passed value for field obj.creation_source is not the expected type, validation failed.")
