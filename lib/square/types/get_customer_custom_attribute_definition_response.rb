...
# Represents a
#  api-endpoint:CustomerCustomAttributes-RetrieveCustomerCustomAttributeDefinition)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class GetCustomerCustomAttributeDefinitionResponse
...
# Serialize an instance of GetCustomerCustomAttributeDefinitionResponse to a JSON
#  object
    #
    # @return [String]
    def to_json
