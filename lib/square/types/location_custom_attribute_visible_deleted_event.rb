...
#  definition](entity:CustomAttributeDefinition).
  class LocationCustomAttributeVisibleDeletedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::LocationCustomAttributeVisibleDeletedEvent]
...
# Serialize an instance of LocationCustomAttributeVisibleDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
