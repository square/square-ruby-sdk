...
module square.rb
  ...
  # @return [square.rb::DeviceComponentDetailsExternalPower] The status of external_power.
#  See [ExternalPower](#type-externalpower) for possible values
  ...
  # @return [Object] 
    ...
    # @param external_power [square.rb::DeviceComponentDetailsExternalPower] The status of external_power.
#  See [ExternalPower](#type-externalpower) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DeviceComponentDetailsBatteryDetails]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.external_power&.is_a?(square.rb::DeviceComponentDetailsExternalPower) != false || raise("Passed value for field obj.external_power is not the expected type, validation failed.")
    end
  end
end