...
# Describes changes to a subscription and the subscription status.
  ...
  # @return [String] The ID of the subscription event.
    attr_reader :id
  # @return [SquareApiClient::SubscriptionEventSubscriptionEventType] Type of the subscription event.
#  See
...
#  event occurred.
  ...
  # @return [SquareApiClient::SubscriptionEventInfo] Additional information about the subscription event.
    attr_reader :info
  ...
  # @return [Object] 
    ...
    # @param subscription_event_type [SquareApiClient::SubscriptionEventSubscriptionEventType] Type of the subscription event.
#  See
#  riptionEventSubscriptionEventType](#type-subscriptioneventsubscriptioneventtype)
#  for possible values
...
#  event occurred.
    ...
    # @param info [SquareApiClient::SubscriptionEventInfo] Additional information about the subscription event.
    ...
    # @return [SquareApiClient::SubscriptionEvent]
...
# Deserialize a JSON object to an instance of SubscriptionEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["info"].nil?
        ...
        info = SquareApiClient::SubscriptionEventInfo.from_json(json_object: info)
      else
        info = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.subscription_event_type.is_a?(SquareApiClient::SubscriptionEventSubscriptionEventType) != false || raise("Passed value for field obj.subscription_event_type is not the expected type, validation failed.")
      ...
      obj.info.nil? || SquareApiClient::SubscriptionEventInfo.validate_raw(obj: obj.info)
