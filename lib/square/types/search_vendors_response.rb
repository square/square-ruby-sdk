...
#  [SearchVendors](api-endpoint:Vendors-SearchVendors).
  ...
  # @return [Array<square.rb::Error>] Errors encountered when the request fails.
    attr_reader :errors
  # @return [Array<square.rb::Vendor>] The [Vendor](entity:Vendor) objects matching the specified search filter.
    attr_reader :vendors
...
#  guide for more information.
  ...
  # @return [Object] 
    ...
    # @param vendors [Array<square.rb::Vendor>] The [Vendor](entity:Vendor) objects matching the specified search filter.
...
# Deserialize a JSON object to an instance of SearchVendorsResponse
  ...
  item = item.to_json
  square.rb::Vendor.from_json(json_object: item)
end
