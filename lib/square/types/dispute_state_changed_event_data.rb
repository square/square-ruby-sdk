...
module square.rb
  ...
  # @return [String] ID of the affected dispute.
    attr_reader :id
  # @return [square.rb::DisputeStateChangedEventObject] An object containing fields and values relevant to the event.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [square.rb::DisputeStateChangedEventObject] An object containing fields and values relevant to the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DisputeStateChangedEventData]
...
# Deserialize a JSON object to an instance of DisputeStateChangedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = square.rb::DisputeStateChangedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || square.rb::DisputeStateChangedEventObject.validate_raw(obj: obj.object)
    end
  end
end