...
#  field.
  ...
  # @return [String] The text of the custom field. If omitted, only the label is rendered.
    attr_reader :value
  # @return [square.rb::InvoiceCustomFieldPlacement] The location of the custom field on the invoice. This field is required for a
#  custom field.
...
#  field.
    ...
    # @param placement [square.rb::InvoiceCustomFieldPlacement] The location of the custom field on the invoice. This field is required for a
#  custom field.
#  See [InvoiceCustomFieldPlacement](#type-invoicecustomfieldplacement) for
#  possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::InvoiceCustomField]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.placement&.is_a?(square.rb::InvoiceCustomFieldPlacement) != false || raise("Passed value for field obj.placement is not the expected type, validation failed.")
    end
  end
end