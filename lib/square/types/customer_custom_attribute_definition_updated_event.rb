...
#  created by the subscribing application is updated. A custom attribute definition
#  can only be updated by
#  the application that created it.
#  This event is replaced by
#  tion.owned.updated](webhook:customer.custom_attribute_definition.owned.updated).
  class CustomerCustomAttributeDefinitionUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionUpdatedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
