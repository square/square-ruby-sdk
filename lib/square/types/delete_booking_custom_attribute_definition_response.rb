...
# Represents a
#  on](api-endpoint:BookingCustomAttributes-DeleteBookingCustomAttributeDefinition)
#  response
...
# Serialize an instance of DeleteBookingCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
