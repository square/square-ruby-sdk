...
module square.rb
  ...
  # @return [Array<square.rb::InventoryCount>] The inventory counts.
  ...
  # @return [Object] 
    ...
    # @param inventory_counts [Array<square.rb::InventoryCount>] The inventory counts.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::InventoryCountUpdatedEventObject]
