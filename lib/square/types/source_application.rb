...
# Represents information about the application used to generate a change.
  ...
  # @return [SquareApiClient::Product] __Read only__ The [product](entity:Product) type of the application.
...
#  (for example, `"Custom Application"` or `"Square POS 4.74 for Android"`).
  ...
  # @return [Object] 
    ...
    # @param product [SquareApiClient::Product] __Read only__ The [product](entity:Product) type of the application.
#  See [Product](#type-product) for possible values
...
#  (for example, `"Custom Application"` or `"Square POS 4.74 for Android"`).
    ...
    # @return [SquareApiClient::SourceApplication]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.product&.is_a?(SquareApiClient::Product) != false || raise("Passed value for field obj.product is not the expected type, validation failed.")
