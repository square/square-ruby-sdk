...
#  of points to the points earned from the base program.
  ...
  # @return [SquareApiClient::LoyaltyPromotionIncentiveType] The type of points incentive.
#  See [LoyaltyPromotionIncentiveType](#type-loyaltypromotionincentivetype) for
#  possible values
    attr_reader :type
  # @return [SquareApiClient::LoyaltyPromotionIncentivePointsMultiplierData] Additional data for a `POINTS_MULTIPLIER` incentive type.
    attr_reader :points_multiplier_data
  # @return [SquareApiClient::LoyaltyPromotionIncentivePointsAdditionData] Additional data for a `POINTS_ADDITION` incentive type.
  ...
  # @return [Object] 
    ...
    # @param type [SquareApiClient::LoyaltyPromotionIncentiveType] The type of points incentive.
#  See [LoyaltyPromotionIncentiveType](#type-loyaltypromotionincentivetype) for
#  possible values
    # @param points_multiplier_data [SquareApiClient::LoyaltyPromotionIncentivePointsMultiplierData] Additional data for a `POINTS_MULTIPLIER` incentive type.
    # @param points_addition_data [SquareApiClient::LoyaltyPromotionIncentivePointsAdditionData] Additional data for a `POINTS_ADDITION` incentive type.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyPromotionIncentive]
...
# Deserialize a JSON object to an instance of LoyaltyPromotionIncentive
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["points_multiplier_data"].nil?
        ...
        points_multiplier_data = SquareApiClient::LoyaltyPromotionIncentivePointsMultiplierData.from_json(json_object: points_multiplier_data)
      else
      ...
      unless parsed_json["points_addition_data"].nil?
        ...
        points_addition_data = SquareApiClient::LoyaltyPromotionIncentivePointsAdditionData.from_json(json_object: points_addition_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type.is_a?(SquareApiClient::LoyaltyPromotionIncentiveType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.points_multiplier_data.nil? || SquareApiClient::LoyaltyPromotionIncentivePointsMultiplierData.validate_raw(obj: obj.points_multiplier_data)
      obj.points_addition_data.nil? || SquareApiClient::LoyaltyPromotionIncentivePointsAdditionData.validate_raw(obj: obj.points_addition_data)
    end
  end
end