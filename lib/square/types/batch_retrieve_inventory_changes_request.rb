...
#  The filter is only applicable when set. The default value is null.
  ...
  # @return [Array<square.rb::InventoryChangeType>] The filter to return results by `InventoryChangeType` values other than
#  `TRANSFER`.
#  The default value is `[PHYSICAL_COUNT, ADJUSTMENT]`.
    attr_reader :types
  # @return [Array<square.rb::InventoryState>] The filter to return `ADJUSTMENT` query results by
...
#  The filter is only applicable when set. The default value is null.
    # @param types [Array<square.rb::InventoryChangeType>] The filter to return results by `InventoryChangeType` values other than
#  `TRANSFER`.
#  The default value is `[PHYSICAL_COUNT, ADJUSTMENT]`.
    # @param states [Array<square.rb::InventoryState>] The filter to return `ADJUSTMENT` query results by
#  `InventoryState`. This filter is only applied when set.
#  The default value is null.
...
#  guide for more information.
    ...
    # @return [square.rb::BatchRetrieveInventoryChangesRequest]
