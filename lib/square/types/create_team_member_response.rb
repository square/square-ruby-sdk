...
#  object or error messages.
  ...
  # @return [SquareApiClient::TeamMember] The successfully created `TeamMember` object.
  ...
  # @return [Object] 
    ...
    # @param team_member [SquareApiClient::TeamMember] The successfully created `TeamMember` object.
