...
# Filter based on [order fulfillment](entity:Fulfillment) information.
  ...
  # @return [Array<square.rb::FulfillmentType>] A list of [fulfillment types](entity:FulfillmentType) to filter
#  for. The list returns orders if any of its fulfillments match any of the
#  fulfillment types
#  listed in this field.
#  See [FulfillmentType](#type-fulfillmenttype) for possible values
    attr_reader :fulfillment_types
  # @return [Array<square.rb::FulfillmentState>] A list of [fulfillment states](entity:FulfillmentState) to filter
#  for. The list returns orders if any of its fulfillments match any of the
...
#  See [FulfillmentState](#type-fulfillmentstate) for possible values
  ...
  # @return [Object] 
    ...
    # @param fulfillment_types [Array<square.rb::FulfillmentType>] A list of [fulfillment types](entity:FulfillmentType) to filter
#  for. The list returns orders if any of its fulfillments match any of the
#  fulfillment types
#  listed in this field.
#  See [FulfillmentType](#type-fulfillmenttype) for possible values
    # @param fulfillment_states [Array<square.rb::FulfillmentState>] A list of [fulfillment states](entity:FulfillmentState) to filter
#  for. The list returns orders if any of its fulfillments match any of the
#  fulfillment states listed in this field.
#  See [FulfillmentState](#type-fulfillmentstate) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchOrdersFulfillmentFilter]
