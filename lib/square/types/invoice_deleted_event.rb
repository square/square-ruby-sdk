...
# Published when a draft [Invoice](entity:Invoice) is deleted.
  ...
  # @return [square.rb::InvoiceDeletedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::InvoiceDeletedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::InvoiceDeletedEvent]
...
# Deserialize a JSON object to an instance of InvoiceDeletedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::InvoiceDeletedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::InvoiceDeletedEventData.validate_raw(obj: obj.data)
    end
  end
end