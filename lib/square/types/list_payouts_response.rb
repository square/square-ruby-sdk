...
# The response to retrieve payout records entries.
  ...
  # @return [Array<square.rb::Payout>] The requested list of payouts.
    attr_reader :payouts
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param payouts [Array<square.rb::Payout>] The requested list of payouts.
...
# Deserialize a JSON object to an instance of ListPayoutsResponse
  ...
  item = item.to_json
  square.rb::Payout.from_json(json_object: item)
end
