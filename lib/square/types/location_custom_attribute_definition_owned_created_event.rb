...
#  is created by the subscribing application.
  class LocationCustomAttributeDefinitionOwnedCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::LocationCustomAttributeDefinitionOwnedCreatedEvent]
...
# Serialize an instance of LocationCustomAttributeDefinitionOwnedCreatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
