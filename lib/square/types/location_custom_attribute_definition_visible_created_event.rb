...
#  that is visible to the subscribing application is created. A notification is
#  sent when your application
#  creates a custom attribute definition or another application creates a custom
#  attribute definition whose
#  `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class LocationCustomAttributeDefinitionVisibleCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::LocationCustomAttributeDefinitionVisibleCreatedEvent]
...
# Serialize an instance of LocationCustomAttributeDefinitionVisibleCreatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
