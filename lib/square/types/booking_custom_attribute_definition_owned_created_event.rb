...
#  when your application creates a booking custom attribute definition.
  class BookingCustomAttributeDefinitionOwnedCreatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::BookingCustomAttributeDefinitionOwnedCreatedEvent]
...
# Serialize an instance of BookingCustomAttributeDefinitionOwnedCreatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
