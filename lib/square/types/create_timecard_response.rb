...
#  the request resulted in errors.
  ...
  # @return [SquareApiClient::Timecard] The `Timecard` that was created on the request.
  ...
  # @return [Object] 
    ...
    # @param timecard [SquareApiClient::Timecard] The `Timecard` that was created on the request.
