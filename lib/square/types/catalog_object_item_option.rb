...
require_relative "catalog_item_option"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectItemOption
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogItemOption] Structured data for a `CatalogItemOption`, set for CatalogObjects of type
#  `ITEM_OPTION`.
    attr_reader :item_option_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_option_data [square.rb::CatalogItemOption] Structured data for a `CatalogItemOption`, set for CatalogObjects of type
#  `ITEM_OPTION`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectItemOption]
    def initialize(type:, item_option_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @item_option_data = item_option_data if item_option_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectItemOption
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_option_data"].nil?
        item_option_data = parsed_json["item_option_data"].to_json
        item_option_data = square.rb::CatalogItemOption.from_json(json_object: item_option_data)
      else
        item_option_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectItemOption to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_option_data.nil? || square.rb::CatalogItemOption.validate_raw(obj: obj.item_option_data)
