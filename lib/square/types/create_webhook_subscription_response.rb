...
#  present.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::WebhookSubscription] The new [Subscription](entity:WebhookSubscription).
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::WebhookSubscription] The new [Subscription](entity:WebhookSubscription).
