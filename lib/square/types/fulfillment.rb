...
module Square
    module Types
        ...
        class Fulfillment < Square::Internal::Types::Model
            ...
            field :entries, Square::Internal::Types::Array[Square::FulfillmentFulfillmentEntry], optional: true, nullable: false
