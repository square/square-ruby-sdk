...
module square.rb
  class DeviceStatus
  # @return [square.rb::DeviceStatusCategory] 
#  See [Category](#type-category) for possible values
  ...
  # @return [Object] 
    ...
    # @param category [square.rb::DeviceStatusCategory] 
#  See [Category](#type-category) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DeviceStatus]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.category&.is_a?(square.rb::DeviceStatusCategory) != false || raise("Passed value for field obj.category is not the expected type, validation failed.")
    end
  end
end