...
module SquareApiClient
  ...
  # @return [SquareApiClient::APPLICATION_TYPE] The type of application.
#  See [ApplicationType](#type-applicationtype) for possible values
  ...
  # @return [Object] 
    ...
    # @param application_type [SquareApiClient::APPLICATION_TYPE] The type of application.
#  See [ApplicationType](#type-applicationtype) for possible values
    ...
    # @return [SquareApiClient::DeviceComponentDetailsApplicationDetails]
