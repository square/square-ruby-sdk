...
#  ps://developer.squareup.com/docs/checkout-api/optional-checkout-configurations).
  ...
  # @return [square.rb::Address] The buyer address to prepopulate in the payment form.
  ...
  # @return [Object] 
    ...
    # @param buyer_address [square.rb::Address] The buyer address to prepopulate in the payment form.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::PrePopulatedData]
...
# Deserialize a JSON object to an instance of PrePopulatedData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["buyer_address"].nil?
        ...
        buyer_address = square.rb::Address.from_json(json_object: buyer_address)
      else
        buyer_address = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.buyer_address.nil? || square.rb::Address.validate_raw(obj: obj.buyer_address)
    end
  end
end