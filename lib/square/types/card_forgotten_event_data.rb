...
module square.rb
  ...
  # @return [String] The ID of the event data object.
    attr_reader :id
  # @return [square.rb::CardForgottenEventObject] An object containing the forgotten card.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [square.rb::CardForgottenEventObject] An object containing the forgotten card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CardForgottenEventData]
...
# Deserialize a JSON object to an instance of CardForgottenEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = square.rb::CardForgottenEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || square.rb::CardForgottenEventObject.validate_raw(obj: obj.object)
    end
  end
end