...
module SquareApiClient
  ...
  # @return [String] The ID of the event data object.
    attr_reader :id
  # @return [SquareApiClient::CardAutomaticallyUpdatedEventObject] An object containing the automatically updated card.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::CardAutomaticallyUpdatedEventObject] An object containing the automatically updated card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardAutomaticallyUpdatedEventData]
...
# Deserialize a JSON object to an instance of CardAutomaticallyUpdatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::CardAutomaticallyUpdatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::CardAutomaticallyUpdatedEventObject.validate_raw(obj: obj.object)
    end
  end
end