...
#  the RFC.
  ...
  # @return [SquareApiClient::DayOfWeek] The day of the week for this availability period.
...
#  Note that the seconds value is always :00, but it is appended for conformance to
#  the RFC.
    # @param day_of_week [SquareApiClient::DayOfWeek] The day of the week for this availability period.
#  See [DayOfWeek](#type-dayofweek) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogAvailabilityPeriod]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.day_of_week&.is_a?(SquareApiClient::DayOfWeek) != false || raise("Passed value for field obj.day_of_week is not the expected type, validation failed.")
    end
  end
end