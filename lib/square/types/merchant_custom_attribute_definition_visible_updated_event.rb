...
#  that is visible to the subscribing application is updated. A notification is
#  sent when your application
#  updates a custom attribute definition or another application updates a custom
#  attribute definition whose
#  `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class MerchantCustomAttributeDefinitionVisibleUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::MerchantCustomAttributeDefinitionVisibleUpdatedEvent]
...
# Serialize an instance of MerchantCustomAttributeDefinitionVisibleUpdatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
