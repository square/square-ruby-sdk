...
# Represents a payout fee that can incur as part of a payout.
  class PayoutFee
  # @return [square.rb::Money] The money amount of the payout fee.
    attr_reader :amount_money
  # @return [String] The timestamp of when the fee takes effect, in RFC 3339 format.
    attr_reader :effective_at
  # @return [square.rb::PayoutFeeType] The type of fee assessed as part of the payout.
#  See [PayoutFeeType](#type-payoutfeetype) for possible values
  ...
  # @return [Object] 
    ...
    # @param amount_money [square.rb::Money] The money amount of the payout fee.
    # @param effective_at [String] The timestamp of when the fee takes effect, in RFC 3339 format.
    # @param type [square.rb::PayoutFeeType] The type of fee assessed as part of the payout.
#  See [PayoutFeeType](#type-payoutfeetype) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::PayoutFee]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(square.rb::PayoutFeeType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end