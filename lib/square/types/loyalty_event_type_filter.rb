...
# Filter events by event type.
  ...
  # @return [Array<square.rb::LoyaltyEventType>] The loyalty event types used to filter the result.
...
#  See [LoyaltyEventType](#type-loyaltyeventtype) for possible values
  ...
  # @return [Object] 
    ...
    # @param types [Array<square.rb::LoyaltyEventType>] The loyalty event types used to filter the result.
#  If multiple values are specified, the endpoint uses a
#  logical OR to combine them.
#  See [LoyaltyEventType](#type-loyaltyeventtype) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyEventTypeFilter]
