...
module Square
    module Types
        ...
        class LoyaltyPromotionAvailableTimeData < Square::Internal::Types::Model
            field :start_date, String, optional: true, nullable: false
            field :end_date, String, optional: true, nullable: false
            field :time_periods, Square::Internal::Types::Array[String], optional: false, nullable: false
        end
    end
end
