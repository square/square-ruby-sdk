...
#  request.
  ...
  # @return [Hash{String => square.rb::BookingCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
...
#  `custom_attribute` or an `errors` field.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => square.rb::BookingCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
#  same ID as the corresponding request and contains either a `booking_id` and
#  `custom_attribute` or an `errors` field.
...
#  BulkUpsertBookingCustomAttributesResponse
  ...
  value = value.to_json
  square.rb::BookingCustomAttributeUpsertResponse.from_json(json_object: value)
end
