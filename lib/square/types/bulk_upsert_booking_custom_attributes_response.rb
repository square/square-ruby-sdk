...
#  request.
  ...
  # @return [Hash{String => SquareApiClient::BookingCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
#  same ID as the corresponding request and contains either a `booking_id` and
#  `custom_attribute` or an `errors` field.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => SquareApiClient::BookingCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
#  same ID as the corresponding request and contains either a `booking_id` and
#  `custom_attribute` or an `errors` field.
...
#  BulkUpsertBookingCustomAttributesResponse
  ...
  value = value.to_json
  SquareApiClient::BookingCustomAttributeUpsertResponse.from_json(json_object: value)
end
...
# Serialize an instance of BulkUpsertBookingCustomAttributesResponse to a JSON
#  object
    #
    # @return [String]
    def to_json
