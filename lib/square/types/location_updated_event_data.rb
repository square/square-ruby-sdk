...
module SquareApiClient
  class LocationUpdatedEventData
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::LocationUpdatedEventData]
...
# Deserialize a JSON object to an instance of LocationUpdatedEventData
    #
...
# Serialize an instance of LocationUpdatedEventData to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
