...
# Information about a booking creator.
  ...
  # @return [SquareApiClient::BookingCreatorDetailsCreatorType] The seller-accessible type of the creator of the booking.
...
#  Access to this field requires seller-level permissions.
  ...
  # @return [Object] 
    ...
    # @param creator_type [SquareApiClient::BookingCreatorDetailsCreatorType] The seller-accessible type of the creator of the booking.
#  See [BookingCreatorDetailsCreatorType](#type-bookingcreatordetailscreatortype)
#  for possible values
...
#  Access to this field requires seller-level permissions.
    ...
    # @return [SquareApiClient::BookingCreatorDetails]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.creator_type&.is_a?(SquareApiClient::BookingCreatorDetailsCreatorType) != false || raise("Passed value for field obj.creator_type is not the expected type, validation failed.")
