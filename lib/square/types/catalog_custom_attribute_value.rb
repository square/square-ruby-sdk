...
#  value belongs to.
  ...
  # @return [square.rb::CatalogCustomAttributeDefinitionType] A copy of type from the associated `CatalogCustomAttributeDefinition`.
#  See
...
#  [CatalogCustomAttributeDefinition](entity:CatalogCustomAttributeDefinition) this
#  value belongs to.
    # @param type [square.rb::CatalogCustomAttributeDefinitionType] A copy of type from the associated `CatalogCustomAttributeDefinition`.
#  See
#  atalogCustomAttributeDefinitionType](#type-catalogcustomattributedefinitiontype)
#  for possible values
...
#  "cocoa_brand".
    ...
    # @return [square.rb::CatalogCustomAttributeValue]
