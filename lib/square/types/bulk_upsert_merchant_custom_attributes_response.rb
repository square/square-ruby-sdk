...
#  request.
  ...
  # @return [Hash{String => SquareApiClient::BulkUpsertMerchantCustomAttributesResponseMerchantCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
...
#  `custom_attribute` or an `errors` field.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => SquareApiClient::BulkUpsertMerchantCustomAttributesResponseMerchantCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
#  same ID as the corresponding request and contains either a `merchant_id` and
#  `custom_attribute` or an `errors` field.
...
#  BulkUpsertMerchantCustomAttributesResponse
  ...
  value = value.to_json
  SquareApiClient::BulkUpsertMerchantCustomAttributesResponseMerchantCustomAttributeUpsertResponse.from_json(json_object: value)
end
