...
#  created by the subscribing application is deleted. A custom attribute definition
#  can only be deleted by
#  the application that created it.
#  This event is replaced by
#  tion.owned.deleted](webhook:customer.custom_attribute_definition.owned.deleted).
  class CustomerCustomAttributeDefinitionDeletedEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionDeletedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
