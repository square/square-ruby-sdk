...
#  Either `errors` or `segments` is present in a given response (never both).
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::CustomerSegment>] The list of customer segments belonging to the associated Square account.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param segments [Array<square.rb::CustomerSegment>] The list of customer segments belonging to the associated Square account.
...
# Deserialize a JSON object to an instance of ListCustomerSegmentsResponse
  ...
  item = item.to_json
  square.rb::CustomerSegment.from_json(json_object: item)
end
