...
#  errors.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::GiftCardActivity] The gift card activity that was created.
  ...
  # @return [Object] 
    ...
    # @param gift_card_activity [square.rb::GiftCardActivity] The gift card activity that was created.
