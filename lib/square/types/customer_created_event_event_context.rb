...
# Information about the change that triggered the event.
  ...
  # @return [square.rb::CustomerCreatedEventEventContextMerge] Information about the merge operation associated with the event.
    attr_reader :merge
  ...
  # @return [Object] 
    ...
    # @param merge [square.rb::CustomerCreatedEventEventContextMerge] Information about the merge operation associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CustomerCreatedEventEventContext]
...
# Deserialize a JSON object to an instance of CustomerCreatedEventEventContext
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["merge"].nil?
        ...
        merge = square.rb::CustomerCreatedEventEventContextMerge.from_json(json_object: merge)
      else
        merge = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.merge.nil? || square.rb::CustomerCreatedEventEventContextMerge.validate_raw(obj: obj.merge)
    end
  end
end