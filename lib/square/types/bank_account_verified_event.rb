...
#  [BankAccount](entity:BankAccount) to `VERIFIED`.
  ...
  # @return [square.rb::BankAccountVerifiedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::BankAccountVerifiedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::BankAccountVerifiedEvent]
...
# Deserialize a JSON object to an instance of BankAccountVerifiedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::BankAccountVerifiedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::BankAccountVerifiedEventData.validate_raw(obj: obj.data)
    end
  end
end