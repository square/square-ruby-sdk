...
# Represents a response from deleting an order custom attribute.
  class DeleteOrderCustomAttributeResponse
...
# Deserialize a JSON object to an instance of DeleteOrderCustomAttributeResponse
    #
...
# Serialize an instance of DeleteOrderCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
