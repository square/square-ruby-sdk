...
# Represents a tender (i.e., a method of payment) used in a Square transaction.
  ...
  # @return [String] An optional note associated with the tender at the time of payment.
    attr_reader :note
  # @return [SquareApiClient::Money] The total amount of the tender, including `tip_money`. If the tender has a
#  `payment_id`,
...
#  `amount_money` of the tender.
  ...
  # @return [SquareApiClient::Money] The tip's amount of the tender.
    attr_reader :tip_money
  # @return [SquareApiClient::Money] The amount of any Square processing fees applied to the tender.
...
#  this is the ID of the associated customer.
  ...
  # @return [SquareApiClient::TenderType] The type of tender, such as `CARD` or `CASH`.
#  See [TenderType](#type-tendertype) for possible values
    attr_reader :type
  # @return [SquareApiClient::TenderCardDetails] The details of the card tender.
#  This value is present only if the value of `type` is `CARD`.
    attr_reader :card_details
  # @return [SquareApiClient::TenderCashDetails] The details of the cash tender.
#  This value is present only if the value of `type` is `CASH`.
    attr_reader :cash_details
  # @return [SquareApiClient::TenderBankAccountDetails] The details of the bank account tender.
#  This value is present only if the value of `type` is `BANK_ACCOUNT`.
    attr_reader :bank_account_details
  # @return [SquareApiClient::TenderBuyNowPayLaterDetails] The details of a Buy Now Pay Later tender.
#  This value is present only if the value of `type` is `BUY_NOW_PAY_LATER`.
    attr_reader :buy_now_pay_later_details
  # @return [SquareApiClient::TenderSquareAccountDetails] The details of a Square Account tender.
...
#  This value is only present for payments created with the v2 Payments API.
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The total amount of the tender, including `tip_money`. If the tender has a
#  `payment_id`,
#  the `total_money` of the corresponding [Payment](entity:Payment) will be equal
#  to the
#  `amount_money` of the tender.
    # @param tip_money [SquareApiClient::Money] The tip's amount of the tender.
    # @param processing_fee_money [SquareApiClient::Money] The amount of any Square processing fees applied to the tender.
#  This field is not immediately populated when a new transaction is created.
#  It is usually available after about ten seconds.
    # @param customer_id [String] If the tender is associated with a customer or represents a customer's card on
#  file,
#  this is the ID of the associated customer.
    # @param type [SquareApiClient::TenderType] The type of tender, such as `CARD` or `CASH`.
#  See [TenderType](#type-tendertype) for possible values
    # @param card_details [SquareApiClient::TenderCardDetails] The details of the card tender.
#  This value is present only if the value of `type` is `CARD`.
    # @param cash_details [SquareApiClient::TenderCashDetails] The details of the cash tender.
#  This value is present only if the value of `type` is `CASH`.
    # @param bank_account_details [SquareApiClient::TenderBankAccountDetails] The details of the bank account tender.
#  This value is present only if the value of `type` is `BANK_ACCOUNT`.
    # @param buy_now_pay_later_details [SquareApiClient::TenderBuyNowPayLaterDetails] The details of a Buy Now Pay Later tender.
#  This value is present only if the value of `type` is `BUY_NOW_PAY_LATER`.
    # @param square_account_details [SquareApiClient::TenderSquareAccountDetails] The details of a Square Account tender.
#  This value is present only if the value of `type` is `SQUARE_ACCOUNT`.
...
# Deserialize a JSON object to an instance of Tender
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["tip_money"].nil?
        ...
        tip_money = SquareApiClient::Money.from_json(json_object: tip_money)
      else
        tip_money = nil
      end
      ...
      unless parsed_json["card_details"].nil?
        ...
        card_details = SquareApiClient::TenderCardDetails.from_json(json_object: card_details)
      else
        card_details = nil
      end
      unless parsed_json["cash_details"].nil?
        cash_details = parsed_json["cash_details"].to_json
        cash_details = SquareApiClient::TenderCashDetails.from_json(json_object: cash_details)
      else
        cash_details = nil
      end
      unless parsed_json["bank_account_details"].nil?
        bank_account_details = parsed_json["bank_account_details"].to_json
        bank_account_details = SquareApiClient::TenderBankAccountDetails.from_json(json_object: bank_account_details)
      else
      ...
      unless parsed_json["buy_now_pay_later_details"].nil?
        ...
        buy_now_pay_later_details = SquareApiClient::TenderBuyNowPayLaterDetails.from_json(json_object: buy_now_pay_later_details)
      else
      ...
      unless parsed_json["square_account_details"].nil?
        ...
        square_account_details = SquareApiClient::TenderSquareAccountDetails.from_json(json_object: square_account_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.tip_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.tip_money)
      ...
      obj.type.is_a?(SquareApiClient::TenderType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.card_details.nil? || SquareApiClient::TenderCardDetails.validate_raw(obj: obj.card_details)
      obj.cash_details.nil? || SquareApiClient::TenderCashDetails.validate_raw(obj: obj.cash_details)
      obj.bank_account_details.nil? || SquareApiClient::TenderBankAccountDetails.validate_raw(obj: obj.bank_account_details)
      obj.buy_now_pay_later_details.nil? || SquareApiClient::TenderBuyNowPayLaterDetails.validate_raw(obj: obj.buy_now_pay_later_details)
      obj.square_account_details.nil? || SquareApiClient::TenderSquareAccountDetails.validate_raw(obj: obj.square_account_details)
