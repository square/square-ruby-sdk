...
module square.rb
  ...
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogCustomAttributeDefinition] Structured data for a `CatalogCustomAttributeDefinition`, set for CatalogObjects
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param custom_attribute_definition_data [square.rb::CatalogCustomAttributeDefinition] Structured data for a `CatalogCustomAttributeDefinition`, set for CatalogObjects
#  of type `CUSTOM_ATTRIBUTE_DEFINITION`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectCustomAttributeDefinition]
...
#  CatalogObjectCustomAttributeDefinition
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["custom_attribute_definition_data"].nil?
        ...
        custom_attribute_definition_data = square.rb::CatalogCustomAttributeDefinition.from_json(json_object: custom_attribute_definition_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.custom_attribute_definition_data.nil? || square.rb::CatalogCustomAttributeDefinition.validate_raw(obj: obj.custom_attribute_definition_data)
