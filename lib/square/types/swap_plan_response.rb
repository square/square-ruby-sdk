...
#  [SwapPlan](api-endpoint:Subscriptions-SwapPlan) endpoint.
  ...
  # @return [Array<square.rb::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::Subscription] The subscription with the updated subscription plan.
    attr_reader :subscription
  # @return [Array<square.rb::SubscriptionAction>] A list of a `SWAP_PLAN` action created by the request.
    attr_reader :actions
  ...
  # @return [Object] 
    ...
    # @param subscription [square.rb::Subscription] The subscription with the updated subscription plan.
    # @param actions [Array<square.rb::SubscriptionAction>] A list of a `SWAP_PLAN` action created by the request.
