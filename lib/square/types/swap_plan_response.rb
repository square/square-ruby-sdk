...
#  [SwapPlan](api-endpoint:Subscriptions-SwapPlan) endpoint.
  class SwapPlanResponse
  # @return [Array<SquareApiClient::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Subscription] The subscription with the updated subscription plan.
    attr_reader :subscription
  # @return [Array<SquareApiClient::SubscriptionAction>] A list of a `SWAP_PLAN` action created by the request.
    attr_reader :actions
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::Subscription] The subscription with the updated subscription plan.
    # @param actions [Array<SquareApiClient::SubscriptionAction>] A list of a `SWAP_PLAN` action created by the request.
...
# Deserialize a JSON object to an instance of SwapPlanResponse
    #
...
# Serialize an instance of SwapPlanResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
