...
require_relative "catalog_quick_amounts_settings"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectQuickAmountsSettings
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogQuickAmountsSettings] Structured data for a `CatalogQuickAmountsSettings`, set for CatalogObjects of
#  type `QUICK_AMOUNTS_SETTINGS`.
    attr_reader :quick_amounts_settings_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param quick_amounts_settings_data [square.rb::CatalogQuickAmountsSettings] Structured data for a `CatalogQuickAmountsSettings`, set for CatalogObjects of
#  type `QUICK_AMOUNTS_SETTINGS`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectQuickAmountsSettings]
    def initialize(type:, quick_amounts_settings_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @quick_amounts_settings_data = quick_amounts_settings_data if quick_amounts_settings_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectQuickAmountsSettings
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["quick_amounts_settings_data"].nil?
        quick_amounts_settings_data = parsed_json["quick_amounts_settings_data"].to_json
        quick_amounts_settings_data = square.rb::CatalogQuickAmountsSettings.from_json(json_object: quick_amounts_settings_data)
      else
        quick_amounts_settings_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectQuickAmountsSettings to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.quick_amounts_settings_data.nil? || square.rb::CatalogQuickAmountsSettings.validate_raw(obj: obj.quick_amounts_settings_data)
