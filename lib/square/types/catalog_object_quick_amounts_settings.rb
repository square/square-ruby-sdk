...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogQuickAmountsSettings] Structured data for a `CatalogQuickAmountsSettings`, set for CatalogObjects of
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param quick_amounts_settings_data [SquareApiClient::CatalogQuickAmountsSettings] Structured data for a `CatalogQuickAmountsSettings`, set for CatalogObjects of
#  type `QUICK_AMOUNTS_SETTINGS`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectQuickAmountsSettings]
...
# Deserialize a JSON object to an instance of CatalogObjectQuickAmountsSettings
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["quick_amounts_settings_data"].nil?
        ...
        quick_amounts_settings_data = SquareApiClient::CatalogQuickAmountsSettings.from_json(json_object: quick_amounts_settings_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.quick_amounts_settings_data.nil? || SquareApiClient::CatalogQuickAmountsSettings.validate_raw(obj: obj.quick_amounts_settings_data)
