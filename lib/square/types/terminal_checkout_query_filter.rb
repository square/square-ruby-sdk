...
module SquareApiClient
  ...
  # @return [String] The `TerminalCheckout` objects associated with a specific device. If no device
#  is specified, then all
#  `TerminalCheckout` objects for the merchant are displayed.
    attr_reader :device_id
  # @return [SquareApiClient::TimeRange] The time range for the beginning of the reporting period, which is inclusive.
#  Default value: The current time minus one day.
#  Note that `TerminalCheckout`s are available for 30 days after creation.
    attr_reader :created_at
  # @return [String] Filtered results with the desired status of the `TerminalCheckout`.
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
  ...
  # @return [Object] 
    ...
    # @param device_id [String] The `TerminalCheckout` objects associated with a specific device. If no device
#  is specified, then all
#  `TerminalCheckout` objects for the merchant are displayed.
    # @param created_at [SquareApiClient::TimeRange] The time range for the beginning of the reporting period, which is inclusive.
#  Default value: The current time minus one day.
#  Note that `TerminalCheckout`s are available for 30 days after creation.
    # @param status [String] Filtered results with the desired status of the `TerminalCheckout`.
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalCheckoutQueryFilter]
...
# Deserialize a JSON object to an instance of TerminalCheckoutQueryFilter
    #
...
# Serialize an instance of TerminalCheckoutQueryFilter to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
