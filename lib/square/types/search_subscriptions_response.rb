...
#  [SearchSubscriptions](api-endpoint:Subscriptions-SearchSubscriptions) endpoint.
  ...
  # @return [Array<SquareApiClient::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::Subscription>] The subscriptions matching the specified query expressions.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param subscriptions [Array<SquareApiClient::Subscription>] The subscriptions matching the specified query expressions.
...
# Deserialize a JSON object to an instance of SearchSubscriptionsResponse
  ...
  item = item.to_json
  SquareApiClient::Subscription.from_json(json_object: item)
end
