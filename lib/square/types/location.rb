...
#  A location name must be unique within a seller account.
    attr_reader :name
  # @return [SquareApiClient::Address] The physical address of the location.
    attr_reader :address
...
#  the time zone of the location. For example, `America/Los_Angeles`.
  ...
  # @return [Array<SquareApiClient::LocationCapability>] The Square features that are enabled for the location.
#  See [LocationCapability](entity:LocationCapability) for possible values.
#  See [LocationCapability](#type-locationcapability) for possible values
    attr_reader :capabilities
  # @return [SquareApiClient::LocationStatus] The status of the location.
...
#  Dates](https://developer.squareup.com/docs/build-basics/working-with-dates).
  ...
  # @return [SquareApiClient::Country] The country of the location, in the two-letter format of ISO 3166. For example,
#  `US` or `JP`.
...
#  per.squareup.com/docs/build-basics/general-considerations/language-preferences).
  ...
  # @return [SquareApiClient::Currency] The currency used for all transactions at this location,
...
#  in a twelve-month period.
  ...
  # @return [SquareApiClient::LocationType] The type of the location.
#  See [LocationType](#type-locationtype) for possible values
  ...
  # @return [SquareApiClient::BusinessHours] The hours of operation for the location.
...
#  'facebook.com/'. For example, `https://www.facebook.com/square`.
  ...
  # @return [SquareApiClient::Coordinates] The physical coordinates (latitude and longitude) of the location.
...
#  This image can be wider than it is tall and should be at least 1280x648 pixels.
  ...
  # @return [SquareApiClient::TaxIds] The tax IDs for this location.
    attr_reader :tax_ids
...
#  This information appears in the Seller Dashboard as the nickname.
#  A location name must be unique within a seller account.
    # @param address [SquareApiClient::Address] The physical address of the location.
    # @param timezone [String] The [IANA time zone](https://www.iana.org/time-zones) identifier for
#  the time zone of the location. For example, `America/Los_Angeles`.
    # @param capabilities [Array<SquareApiClient::LocationCapability>] The Square features that are enabled for the location.
#  See [LocationCapability](entity:LocationCapability) for possible values.
#  See [LocationCapability](#type-locationcapability) for possible values
    # @param status [SquareApiClient::LocationStatus] The status of the location.
#  See [LocationStatus](#type-locationstatus) for possible values
...
#  Dates](https://developer.squareup.com/docs/build-basics/working-with-dates).
    ...
    # @param country [SquareApiClient::Country] The country of the location, in the two-letter format of ISO 3166. For example,
#  `US` or `JP`.
#  See [Country](entity:Country) for possible values.
#  See [Country](#type-country) for possible values
...
#  For more information, see [Language
#  per.squareup.com/docs/build-basics/general-considerations/language-preferences).
    # @param currency [SquareApiClient::Currency] The currency used for all transactions at this location,
#  in ISO 4217 format. For example, the currency code for US dollars is `USD`.
#  See [Currency](entity:Currency) for possible values.
#  See [Currency](#type-currency) for possible values
...
#  and other customer-facing branding, and can be changed no more than three times
#  in a twelve-month period.
    # @param type [SquareApiClient::LocationType] The type of the location.
#  See [LocationType](#type-locationtype) for possible values
    # @param website_url [String] The website URL of the location.  For example, `https://squareup.com`.
    # @param business_hours [SquareApiClient::BusinessHours] The hours of operation for the location.
...
#  'facebook.com/'. For example, `https://www.facebook.com/square`.
    # @param coordinates [SquareApiClient::Coordinates] The physical coordinates (latitude and longitude) of the location.
...
#  and invoices) that Square generates on behalf of the seller.
#  This image can be wider than it is tall and should be at least 1280x648 pixels.
    # @param tax_ids [SquareApiClient::TaxIds] The tax IDs for this location.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Location]
...
# Deserialize a JSON object to an instance of Location
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["business_hours"].nil?
        ...
        business_hours = SquareApiClient::BusinessHours.from_json(json_object: business_hours)
      else
        business_hours = nil
      end
      ...
      unless parsed_json["coordinates"].nil?
        ...
        coordinates = SquareApiClient::Coordinates.from_json(json_object: coordinates)
      else
        coordinates = nil
      end
      ...
      unless parsed_json["tax_ids"].nil?
        ...
        tax_ids = SquareApiClient::TaxIds.from_json(json_object: tax_ids)
      else
        tax_ids = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::LocationStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.type&.is_a?(SquareApiClient::LocationType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      ...
      obj.business_hours.nil? || SquareApiClient::BusinessHours.validate_raw(obj: obj.business_hours)
      ...
      obj.coordinates.nil? || SquareApiClient::Coordinates.validate_raw(obj: obj.coordinates)
      ...
      obj.tax_ids.nil? || SquareApiClient::TaxIds.validate_raw(obj: obj.tax_ids)
    end
  end
end