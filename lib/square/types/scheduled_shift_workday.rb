...
#  a `Shift` must start or end in before passing the filter condition.
  ...
  # @return [square.rb::DateRange] Dates for fetching the scheduled shifts.
    attr_reader :date_range
  # @return [square.rb::ScheduledShiftWorkdayMatcher] The strategy on which the dates are applied.
...
#  identifier for the relevant timezone.
  ...
  # @return [Object] 
    ...
    # @param date_range [square.rb::DateRange] Dates for fetching the scheduled shifts.
    # @param match_scheduled_shifts_by [square.rb::ScheduledShiftWorkdayMatcher] The strategy on which the dates are applied.
#  See [ScheduledShiftWorkdayMatcher](#type-scheduledshiftworkdaymatcher) for
#  possible values
...
#  identifier for the relevant timezone.
    ...
    # @return [square.rb::ScheduledShiftWorkday]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.match_scheduled_shifts_by&.is_a?(square.rb::ScheduledShiftWorkdayMatcher) != false || raise("Passed value for field obj.match_scheduled_shifts_by is not the expected type, validation failed.")
