...
require_relative "catalog_item_variation"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectItemVariation
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogItemVariation] Structured data for a `CatalogItemVariation`, set for CatalogObjects of type
#  `ITEM_VARIATION`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_variation_data [square.rb::CatalogItemVariation] Structured data for a `CatalogItemVariation`, set for CatalogObjects of type
#  `ITEM_VARIATION`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectItemVariation]
    def initialize(type:, item_variation_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
...
# Deserialize a JSON object to an instance of CatalogObjectItemVariation
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_variation_data"].nil?
        ...
        item_variation_data = square.rb::CatalogItemVariation.from_json(json_object: item_variation_data)
      else
...
# Serialize an instance of CatalogObjectItemVariation to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_variation_data.nil? || square.rb::CatalogItemVariation.validate_raw(obj: obj.item_variation_data)
