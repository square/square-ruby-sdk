...
#  item name.
    attr_reader :name
  # @return [square.rb::Money] The price of the item.
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      square.rb::Money.validate_raw(obj: obj.price_money)
