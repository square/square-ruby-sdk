...
# Represents a Square gift card.
  ...
  # @return [String] The Square-assigned ID of the gift card.
    attr_reader :id
  # @return [square.rb::GiftCardType] The gift card type.
#  See [Type](#type-type) for possible values
    attr_reader :type
  # @return [square.rb::GiftCardGanSource] The source that generated the gift card account number (GAN). The default value
#  is `SQUARE`.
#  See [GANSource](#type-gansource) for possible values
    attr_reader :gan_source
  # @return [square.rb::GiftCardStatus] The current gift card state.
#  See [Status](#type-status) for possible values
    attr_reader :state
  # @return [square.rb::Money] The current gift card balance. This balance is always greater than or equal to
#  zero.
...
#  linked.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::GiftCardType] The gift card type.
#  See [Type](#type-type) for possible values
    # @param gan_source [square.rb::GiftCardGanSource] The source that generated the gift card account number (GAN). The default value
#  is `SQUARE`.
#  See [GANSource](#type-gansource) for possible values
    # @param state [square.rb::GiftCardStatus] The current gift card state.
#  See [Status](#type-status) for possible values
    # @param balance_money [square.rb::Money] The current gift card balance. This balance is always greater than or equal to
#  zero.
...
# Deserialize a JSON object to an instance of GiftCard
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["balance_money"].nil?
        ...
        balance_money = square.rb::Money.from_json(json_object: balance_money)
      else
        balance_money = nil
      end
      gan = parsed_json["gan"]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(square.rb::GiftCardType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.gan_source&.is_a?(square.rb::GiftCardGanSource) != false || raise("Passed value for field obj.gan_source is not the expected type, validation failed.")
      obj.state&.is_a?(square.rb::GiftCardStatus) != false || raise("Passed value for field obj.state is not the expected type, validation failed.")
      obj.balance_money.nil? || square.rb::Money.validate_raw(obj: obj.balance_money)
