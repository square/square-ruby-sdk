...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogModifierList] Structured data for a `CatalogModifierList`, set for CatalogObjects of type
#  `MODIFIER_LIST`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param modifier_list_data [SquareApiClient::CatalogModifierList] Structured data for a `CatalogModifierList`, set for CatalogObjects of type
#  `MODIFIER_LIST`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectModifierList]
...
# Deserialize a JSON object to an instance of CatalogObjectModifierList
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["modifier_list_data"].nil?
        ...
        modifier_list_data = SquareApiClient::CatalogModifierList.from_json(json_object: modifier_list_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.modifier_list_data.nil? || SquareApiClient::CatalogModifierList.validate_raw(obj: obj.modifier_list_data)
