...
require_relative "catalog_modifier_list"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectModifierList
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogModifierList] Structured data for a `CatalogModifierList`, set for CatalogObjects of type
#  `MODIFIER_LIST`.
    attr_reader :modifier_list_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param modifier_list_data [square.rb::CatalogModifierList] Structured data for a `CatalogModifierList`, set for CatalogObjects of type
#  `MODIFIER_LIST`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectModifierList]
    def initialize(type:, modifier_list_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @modifier_list_data = modifier_list_data if modifier_list_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectModifierList
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["modifier_list_data"].nil?
        modifier_list_data = parsed_json["modifier_list_data"].to_json
        modifier_list_data = square.rb::CatalogModifierList.from_json(json_object: modifier_list_data)
      else
        modifier_list_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectModifierList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.modifier_list_data.nil? || square.rb::CatalogModifierList.validate_raw(obj: obj.modifier_list_data)
