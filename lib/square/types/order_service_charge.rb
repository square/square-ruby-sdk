...
#  Exactly one of `percentage` or `amount_money` should be set.
  ...
  # @return [square.rb::Money] The amount of money applied to the order by the service charge,
...
#  `applied_money` and `total_tax_money`.
  ...
  # @return [square.rb::OrderServiceChargeCalculationPhase] The calculation phase at which to apply the service charge.
#  See
...
#  service charges calculated in the `TOTAL_PHASE` cannot be marked as taxable.
    attr_reader :taxable
  # @return [Array<square.rb::OrderLineItemAppliedTax>] The list of references to the taxes applied to this service charge. Each
...
#  [Metadata](https://developer.squareup.com/docs/build-basics/metadata).
  ...
  # @return [square.rb::OrderServiceChargeType] The type of the service charge.
...
#  Exactly one of `percentage` or `amount_money` should be set.
    # @param applied_money [square.rb::Money] The amount of money applied to the order by the service charge,
#  including any inclusive tax amounts, as calculated by Square.
#  - For fixed-amount service charges, `applied_money` is equal to `amount_money`.
#  - For percentage-based service charges, `applied_money` is the money
#  calculated using the percentage.
...
#  `applied_money` and `total_tax_money`.
    ...
    # @param calculation_phase [square.rb::OrderServiceChargeCalculationPhase] The calculation phase at which to apply the service charge.
#  See
#  [OrderServiceChargeCalculationPhase](#type-orderservicechargecalculationphase)
#  for possible values
...
#  order-level taxes automatically apply to the service charge. Note that
#  service charges calculated in the `TOTAL_PHASE` cannot be marked as taxable.
    # @param applied_taxes [Array<square.rb::OrderLineItemAppliedTax>] The list of references to the taxes applied to this service charge. Each
#  `OrderLineItemAppliedTax` has a `tax_uid` that references the `uid` of a
#  top-level
#  `OrderLineItemTax` that is being applied to this service charge. On reads, the
#  amount applied
...
#  For more information, see
#  [Metadata](https://developer.squareup.com/docs/build-basics/metadata).
    # @param type [square.rb::OrderServiceChargeType] The type of the service charge.
#  See [OrderServiceChargeType](#type-orderservicechargetype) for possible values
...
#  See [OrderServiceChargeScope](#type-orderservicechargescope) for possible values
    ...
    # @return [square.rb::OrderServiceCharge]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(square.rb::OrderServiceChargeType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
