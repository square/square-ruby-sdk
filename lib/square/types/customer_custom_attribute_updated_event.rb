...
# Published when a customer [custom attribute](entity:CustomAttribute) owned by
#  the
#  subscribing application is created or updated. Custom attributes are owned by
...
#  `visibility` is `VISIBILITY_READ_WRITE_VALUES` can be created or updated by any
#  application.
#  This event is replaced by
#  ustom_attribute.owned.updated](webhook:customer.custom_attribute.owned.updated).
  class CustomerCustomAttributeUpdatedEvent
  # @return [String] The ID of the seller associated with the event that triggered the event
#  notification.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"customer.custom_attribute.updated"`.
    attr_reader :type
...
#  notification.
    # @param type [String] The type of this event. The value is `"customer.custom_attribute.updated"`.
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeUpdatedEvent]
...
# Deserialize a JSON object to an instance of CustomerCustomAttributeUpdatedEvent
    #
...
# Serialize an instance of CustomerCustomAttributeUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
