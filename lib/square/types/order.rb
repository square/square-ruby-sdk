...
#  with this order.
  ...
  # @return [square.rb::OrderSource] The origination details of the order.
    attr_reader :source
...
#  ttps://developer.squareup.com/docs/customers-api/what-it-does#instant-profiles).
  ...
  # @return [Array<square.rb::OrderLineItem>] The line items included in the order.
    attr_reader :line_items
  # @return [Array<square.rb::OrderLineItemTax>] The list of all taxes associated with the order.
...
#  instead.
    attr_reader :taxes
  # @return [Array<square.rb::OrderLineItemDiscount>] The list of all discounts associated with the order.
...
#  instead.
  ...
  # @return [Array<square.rb::OrderServiceCharge>] A list of service charges applied to the order.
    attr_reader :service_charges
  # @return [Array<square.rb::Fulfillment>] Details about order fulfillment.
...
#  by the API might contain multiple fulfillments.
  ...
  # @return [Array<square.rb::OrderReturn>] A collection of items from sale orders being returned in this one. Normally part
#  of an
#  itemized return or exchange. There is exactly one `Return` object per sale
#  `Order` being
#  referenced.
    attr_reader :returns
  # @return [square.rb::OrderMoneyAmounts] The rollup of the returned money amounts.
    attr_reader :return_amounts
  # @return [square.rb::OrderMoneyAmounts] The net money amounts (sale money - return money).
    attr_reader :net_amounts
  # @return [square.rb::OrderRoundingAdjustment] A positive rounding adjustment to the total of the order. This adjustment is
#  commonly
#  used to apply cash rounding when the minimum unit of account is smaller than the
#  lowest physical
#  denomination of the currency.
    attr_reader :rounding_adjustment
  # @return [Array<square.rb::Tender>] The tenders that were used to pay for the order.
    attr_reader :tenders
  # @return [Array<square.rb::Refund>] The refunds that are part of this order.
    attr_reader :refunds
...
#  in RFC 3339 format (for example "2016-09-04T23:59:33.123Z").
  ...
  # @return [square.rb::OrderState] The current state of the order.
...
#  ns](https://developer.squareup.com/docs/orders-api/manage-orders/update-orders).
    attr_reader :version
  # @return [square.rb::Money] The total amount of money to collect for the order.
    attr_reader :total_money
  # @return [square.rb::Money] The total amount of tax money to collect for the order.
    attr_reader :total_tax_money
  # @return [square.rb::Money] The total amount of discount money to collect for the order.
    attr_reader :total_discount_money
  # @return [square.rb::Money] The total amount of tip money to collect for the order.
    attr_reader :total_tip_money
  # @return [square.rb::Money] The total amount of money collected in service charges for the order.
...
#  table number, or auto-generated order number that resets daily).
  ...
  # @return [square.rb::OrderPricingOptions] Pricing options for an order. The options affect how the order's price is
#  calculated.
...
#  preconfigured [pricing rules](entity:CatalogPricingRule).
  ...
  # @return [Array<square.rb::OrderReward>] A set-like list of Rewards that have been added to the Order.
    attr_reader :rewards
  # @return [square.rb::Money] The net amount of money due on the order.
...
#  with this order.
    # @param source [square.rb::OrderSource] The origination details of the order.
...
#  [instant
#  ttps://developer.squareup.com/docs/customers-api/what-it-does#instant-profiles).
    # @param line_items [Array<square.rb::OrderLineItem>] The line items included in the order.
    # @param taxes [Array<square.rb::OrderLineItemTax>] The list of all taxes associated with the order.
#  Taxes can be scoped to either `ORDER` or `LINE_ITEM`. For taxes with `LINE_ITEM`
#  scope, an
#  `OrderLineItemAppliedTax` must be added to each line item that the tax applies
#  to. For taxes
...
#  `line_items.taxes` field results in an error. Use `line_items.applied_taxes`
#  instead.
    # @param discounts [Array<square.rb::OrderLineItemDiscount>] The list of all discounts associated with the order.
#  Discounts can be scoped to either `ORDER` or `LINE_ITEM`. For discounts scoped
#  to `LINE_ITEM`,
#  an `OrderLineItemAppliedDiscount` must be added to each line item that the
#  discount applies to.
...
#  `line_items.applied_discounts`
#  instead.
    # @param service_charges [Array<square.rb::OrderServiceCharge>] A list of service charges applied to the order.
    # @param fulfillments [Array<square.rb::Fulfillment>] Details about order fulfillment.
#  Orders can only be created with at most one fulfillment. However, orders
#  returned
#  by the API might contain multiple fulfillments.
    # @param returns [Array<square.rb::OrderReturn>] A collection of items from sale orders being returned in this one. Normally part
#  of an
#  itemized return or exchange. There is exactly one `Return` object per sale
#  `Order` being
#  referenced.
    # @param return_amounts [square.rb::OrderMoneyAmounts] The rollup of the returned money amounts.
    # @param net_amounts [square.rb::OrderMoneyAmounts] The net money amounts (sale money - return money).
    # @param rounding_adjustment [square.rb::OrderRoundingAdjustment] A positive rounding adjustment to the total of the order. This adjustment is
#  commonly
#  used to apply cash rounding when the minimum unit of account is smaller than the
#  lowest physical
#  denomination of the currency.
    # @param tenders [Array<square.rb::Tender>] The tenders that were used to pay for the order.
    # @param refunds [Array<square.rb::Refund>] The refunds that are part of this order.
...
#  in RFC 3339 format (for example "2016-09-04T23:59:33.123Z").
    # @param state [square.rb::OrderState] The current state of the order.
#  See [OrderState](#type-orderstate) for possible values
...
#  [Read more about working with
#  ns](https://developer.squareup.com/docs/orders-api/manage-orders/update-orders).
    # @param total_money [square.rb::Money] The total amount of money to collect for the order.
    # @param total_tax_money [square.rb::Money] The total amount of tax money to collect for the order.
    # @param total_discount_money [square.rb::Money] The total amount of discount money to collect for the order.
    # @param total_tip_money [square.rb::Money] The total amount of tip money to collect for the order.
    # @param total_service_charge_money [square.rb::Money] The total amount of money collected in service charges for the order.
#  Note: `total_service_charge_money` is the sum of `applied_money` fields for each
#  individual
#  service charge. Therefore, `total_service_charge_money` only includes inclusive
#  tax amounts,
...
#  table number, or auto-generated order number that resets daily).
    # @param pricing_options [square.rb::OrderPricingOptions] Pricing options for an order. The options affect how the order's price is
#  calculated.
#  They can be used, for example, to apply automatic price adjustments that are
#  based on
#  preconfigured [pricing rules](entity:CatalogPricingRule).
    # @param rewards [Array<square.rb::OrderReward>] A set-like list of Rewards that have been added to the Order.
    # @param net_amount_due_money [square.rb::Money] The net amount of money due on the order.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::Order]
...
# Deserialize a JSON object to an instance of Order
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["source"].nil?
        ...
        source = square.rb::OrderSource.from_json(json_object: source)
      else
        source = nil
      end
  ...
  item = item.to_json
  square.rb::OrderLineItem.from_json(json_object: item)
end
      taxes = parsed_json["taxes"]&.map do | item |
  item = item.to_json
  square.rb::OrderLineItemTax.from_json(json_object: item)
end
      discounts = parsed_json["discounts"]&.map do | item |
  item = item.to_json
  square.rb::OrderLineItemDiscount.from_json(json_object: item)
end
      service_charges = parsed_json["service_charges"]&.map do | item |
  item = item.to_json
  square.rb::OrderServiceCharge.from_json(json_object: item)
end
      fulfillments = parsed_json["fulfillments"]&.map do | item |
  item = item.to_json
  square.rb::Fulfillment.from_json(json_object: item)
end
      returns = parsed_json["returns"]&.map do | item |
  item = item.to_json
  square.rb::OrderReturn.from_json(json_object: item)
end
      ...
      unless parsed_json["net_amounts"].nil?
        ...
        net_amounts = square.rb::OrderMoneyAmounts.from_json(json_object: net_amounts)
      else
        net_amounts = nil
      end
  ...
  square.rb::Refund.from_json(json_object: item)
      ...
      unless parsed_json["total_tip_money"].nil?
        ...
        total_tip_money = square.rb::Money.from_json(json_object: total_tip_money)
      else
        total_tip_money = nil
      end
      ...
      unless parsed_json["pricing_options"].nil?
        ...
        pricing_options = square.rb::OrderPricingOptions.from_json(json_object: pricing_options)
      else
        pricing_options = nil
      end
      rewards = parsed_json["rewards"]&.map do | item |
  item = item.to_json
  square.rb::OrderReward.from_json(json_object: item)
end
      unless parsed_json["net_amount_due_money"].nil?
        net_amount_due_money = parsed_json["net_amount_due_money"].to_json
        net_amount_due_money = square.rb::Money.from_json(json_object: net_amount_due_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.source.nil? || square.rb::OrderSource.validate_raw(obj: obj.source)
      ...
      obj.net_amounts.nil? || square.rb::OrderMoneyAmounts.validate_raw(obj: obj.net_amounts)
      ...
      obj.total_tip_money.nil? || square.rb::Money.validate_raw(obj: obj.total_tip_money)
      ...
      obj.pricing_options.nil? || square.rb::OrderPricingOptions.validate_raw(obj: obj.pricing_options)
      obj.rewards&.is_a?(Array) != false || raise("Passed value for field obj.rewards is not the expected type, validation failed.")
      obj.net_amount_due_money.nil? || square.rb::Money.validate_raw(obj: obj.net_amount_due_money)
    end
  end
end