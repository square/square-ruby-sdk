...
# Provides metadata when the event `type` is `CREATE_REWARD`.
  ...
  # @return [String] The Square-assigned ID of the created [loyalty reward](entity:LoyaltyReward).
#  This field is returned only if the event source is `LOYALTY_API`.
    attr_reader :reward_id
  # @return [Integer] The loyalty points used to create the reward.
    attr_reader :points
  ...
  # @return [Object] 
    ...
    # @param reward_id [String] The Square-assigned ID of the created [loyalty reward](entity:LoyaltyReward).
#  This field is returned only if the event source is `LOYALTY_API`.
    # @param points [Integer] The loyalty points used to create the reward.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyEventCreateReward]
...
# Deserialize a JSON object to an instance of LoyaltyEventCreateReward
    #
...
# Serialize an instance of LoyaltyEventCreateReward to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
