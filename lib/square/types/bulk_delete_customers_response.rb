...
#  [BulkDeleteCustomers](api-endpoint:Customers-BulkDeleteCustomers) endpoint.
  ...
  # @return [Hash{String => SquareApiClient::DeleteCustomerResponse}] A map of responses that correspond to individual delete requests, represented by
#  key-value pairs.
...
#  request.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => SquareApiClient::DeleteCustomerResponse}] A map of responses that correspond to individual delete requests, represented by
#  key-value pairs.
#  Each key is the customer ID that was specified for a delete request and each
#  value
#  is the corresponding response.
...
# Deserialize a JSON object to an instance of BulkDeleteCustomersResponse
  ...
  value = value.to_json
  SquareApiClient::DeleteCustomerResponse.from_json(json_object: value)
end
