...
module square.rb
  class CatalogObjectBase
  # @return [square.rb::CatalogObjectType] The type of this object. Each object type has expected
#  properties expressed in a structured format within its corresponding `*_data`
#  field below.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::CatalogObjectType] The type of this object. Each object type has expected
#  properties expressed in a structured format within its corresponding `*_data`
#  field below.
#  See [CatalogObjectType](#type-catalogobjecttype) for possible values
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectBase]
    def initialize(type:, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @id = id
...
# Serialize an instance of CatalogObjectBase to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type.is_a?(square.rb::CatalogObjectType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
