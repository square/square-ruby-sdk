...
#  specifies the precision for decimal quantities.
  ...
  # @return [SquareApiClient::MeasurementUnit] Indicates the unit used to measure the quantity of a catalog item variation.
...
#  Default: 3
  ...
  # @return [Object] 
    ...
    # @param measurement_unit [SquareApiClient::MeasurementUnit] Indicates the unit used to measure the quantity of a catalog item variation.
...
#  Default: 3
    ...
    # @return [SquareApiClient::CatalogMeasurementUnit]
