...
# Represents a
#  ](api-endpoint:BookingCustomAttributes-RetrieveBookingCustomAttributeDefinition)
#  response.
...
# Serialize an instance of RetrieveBookingCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
