...
# Represents an update request for a `TeamMember` object.
  ...
  # @return [SquareApiClient::TeamMember] The team member fields to add, change, or clear. Fields can be cleared using a
...
#  [ListJobs](api-endpoint:Team-ListJobs) to get the required `job_id` values.
  ...
  # @return [Object] 
    ...
    # @param team_member [SquareApiClient::TeamMember] The team member fields to add, change, or clear. Fields can be cleared using a
#  null value. To update
#  `wage_setting.job_assignments`, you must provide the complete list of job
#  assignments. If needed, call
#  [ListJobs](api-endpoint:Team-ListJobs) to get the required `job_id` values.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::UpdateTeamMemberRequest]
