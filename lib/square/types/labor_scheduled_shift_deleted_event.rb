...
# Published when a [ScheduledShift](entity:ScheduledShift) is deleted.
  ...
  # @return [square.rb::LaborScheduledShiftDeletedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::LaborScheduledShiftDeletedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborScheduledShiftDeletedEvent]
...
# Deserialize a JSON object to an instance of LaborScheduledShiftDeletedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::LaborScheduledShiftDeletedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::LaborScheduledShiftDeletedEventData.validate_raw(obj: obj.data)
    end
  end
end