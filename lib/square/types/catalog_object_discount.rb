...
require_relative "catalog_discount"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectDiscount
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogDiscount] Structured data for a `CatalogDiscount`, set for CatalogObjects of type
#  `DISCOUNT`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param discount_data [square.rb::CatalogDiscount] Structured data for a `CatalogDiscount`, set for CatalogObjects of type
#  `DISCOUNT`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectDiscount]
    def initialize(type:, discount_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @discount_data = discount_data if discount_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectDiscount
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["discount_data"].nil?
        discount_data = parsed_json["discount_data"].to_json
        discount_data = square.rb::CatalogDiscount.from_json(json_object: discount_data)
      else
        discount_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectDiscount to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.discount_data.nil? || square.rb::CatalogDiscount.validate_raw(obj: obj.discount_data)
