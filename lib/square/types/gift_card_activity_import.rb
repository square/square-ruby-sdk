...
#  `gan_source` of the gift card is set to `OTHER`.
  ...
  # @return [SquareApiClient::Money] The balance amount on the imported gift card.
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The balance amount on the imported gift card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::GiftCardActivityImport]
