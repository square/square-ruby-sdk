...
#  [BulkCreateCustomers](api-endpoint:Customers-BulkCreateCustomers) operation.
  ...
  # @return [SquareApiClient::Address] The physical address associated with the customer profile. For maximum length
#  constraints,
#  see [Customer
...
#  `0000` if a birth year is not specified.
  ...
  # @return [SquareApiClient::CustomerTaxIds] The tax ID associated with the customer profile. This field is available only
#  for
...
#  ttps://developer.squareup.com/docs/customers-api/what-it-does#customer-tax-ids).
  ...
  # @return [Object] 
    ...
    # @param address [SquareApiClient::Address] The physical address associated with the customer profile. For maximum length
#  constraints,
#  see [Customer
#  s://developer.squareup.com/docs/customers-api/use-the-api/keep-records#address).
#  The `first_name` and `last_name` fields are ignored if they are present in the
...
#  birth year or
#  `0000` if a birth year is not specified.
    # @param tax_ids [SquareApiClient::CustomerTaxIds] The tax ID associated with the customer profile. This field is available only
#  for
#  customers of sellers in EU countries or the United Kingdom. For more
#  information, see
#  [Customer tax
#  ttps://developer.squareup.com/docs/customers-api/what-it-does#customer-tax-ids).
    ...
    # @return [SquareApiClient::BulkCreateCustomerData]
    def initialize(given_name: OMIT, family_name: OMIT, company_name: OMIT, nickname: OMIT, email_address: OMIT, address: OMIT, phone_number: OMIT, reference_id: OMIT, note: OMIT, birthday: OMIT, tax_ids: OMIT, additional_properties: nil)
      ...
      @_field_set = { "given_name": given_name, "family_name": family_name, "company_name": company_name, "nickname": nickname, "email_address": email_address, "address": address, "phone_number": phone_number, "reference_id": reference_id, "note": note, "birthday": birthday, "tax_ids": tax_ids }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of BulkCreateCustomerData
    #
...
# Serialize an instance of BulkCreateCustomerData to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
