...
# Contains the name and abbreviation for standard measurement unit.
  ...
  # @return [square.rb::MeasurementUnit] Identifies the measurement unit being described.
    attr_reader :unit
  ...
  # @return [Object] 
    ...
    # @param unit [square.rb::MeasurementUnit] Identifies the measurement unit being described.
    ...
    # @return [square.rb::StandardUnitDescription]
...
# Deserialize a JSON object to an instance of StandardUnitDescription
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["unit"].nil?
        ...
        unit = square.rb::MeasurementUnit.from_json(json_object: unit)
      else
        unit = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.unit.nil? || square.rb::MeasurementUnit.validate_raw(obj: obj.unit)
