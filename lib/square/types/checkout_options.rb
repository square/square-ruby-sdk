...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::CustomField>] The custom fields requesting information from the buyer.
...
#  payment.
  ...
  # @return [SquareApiClient::AcceptedPaymentMethods] The methods allowed for buyers during checkout.
    attr_reader :accepted_payment_methods
  # @return [SquareApiClient::Money] The amount of money that the developer is taking as a fee for facilitating the
...
#  areup.com/docs/payments-api/collect-fees/additional-considerations#permissions).
  ...
  # @return [SquareApiClient::ShippingFee] The fee associated with shipping to be applied to the `Order` as a service
#  charge.
...
#  loyalty, redeem rewards in the payment form, or both.
  ...
  # @return [Object] 
    ...
    # @param custom_fields [Array<SquareApiClient::CustomField>] The custom fields requesting information from the buyer.
...
#  payment.
    ...
    # @param accepted_payment_methods [SquareApiClient::AcceptedPaymentMethods] The methods allowed for buyers during checkout.
    # @param app_fee_money [SquareApiClient::Money] The amount of money that the developer is taking as a fee for facilitating the
#  payment on behalf of the seller.
#  The amount cannot be more than 90% of the total amount of the payment.
#  The amount must be specified in the smallest denomination of the applicable
#  currency (for example, US dollar amounts are specified in cents). For more
...
#  required. For more information, see
#  areup.com/docs/payments-api/collect-fees/additional-considerations#permissions).
    # @param shipping_fee [SquareApiClient::ShippingFee] The fee associated with shipping to be applied to the `Order` as a service
#  charge.
...
#  loyalty, redeem rewards in the payment form, or both.
    ...
    # @return [SquareApiClient::CheckoutOptions]
...
# Deserialize a JSON object to an instance of CheckoutOptions
  ...
  item = item.to_json
  SquareApiClient::CustomField.from_json(json_object: item)
end
      ...
      unless parsed_json["accepted_payment_methods"].nil?
        ...
        accepted_payment_methods = SquareApiClient::AcceptedPaymentMethods.from_json(json_object: accepted_payment_methods)
      else
      ...
      unless parsed_json["shipping_fee"].nil?
        ...
        shipping_fee = SquareApiClient::ShippingFee.from_json(json_object: shipping_fee)
      else
        shipping_fee = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.accepted_payment_methods.nil? || SquareApiClient::AcceptedPaymentMethods.validate_raw(obj: obj.accepted_payment_methods)
      obj.app_fee_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.app_fee_money)
      obj.shipping_fee.nil? || SquareApiClient::ShippingFee.validate_raw(obj: obj.shipping_fee)
