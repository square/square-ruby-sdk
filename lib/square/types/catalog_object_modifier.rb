...
require_relative "catalog_modifier"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectModifier
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogModifier] Structured data for a `CatalogModifier`, set for CatalogObjects of type
#  `MODIFIER`.
    attr_reader :modifier_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param modifier_data [square.rb::CatalogModifier] Structured data for a `CatalogModifier`, set for CatalogObjects of type
#  `MODIFIER`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectModifier]
    def initialize(type:, modifier_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @modifier_data = modifier_data if modifier_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectModifier
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["modifier_data"].nil?
        modifier_data = parsed_json["modifier_data"].to_json
        modifier_data = square.rb::CatalogModifier.from_json(json_object: modifier_data)
      else
        modifier_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectModifier to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.modifier_data.nil? || square.rb::CatalogModifier.validate_raw(obj: obj.modifier_data)
