...
#  specifies the number of digits after the decimal point for decimal quantities.
  ...
  # @return [square.rb::MeasurementUnit] A [MeasurementUnit](entity:MeasurementUnit) that represents the
...
#  This field is set when this is a catalog-backed measurement unit.
  ...
  # @return [Object] 
    ...
    # @param measurement_unit [square.rb::MeasurementUnit] A [MeasurementUnit](entity:MeasurementUnit) that represents the
#  unit of measure for the quantity.
...
#  This field is set when this is a catalog-backed measurement unit.
    ...
    # @return [square.rb::OrderQuantityUnit]
