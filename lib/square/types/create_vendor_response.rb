...
#  [CreateVendor](api-endpoint:Vendors-CreateVendor).
  ...
  # @return [Array<square.rb::Error>] Errors encountered when the request fails.
    attr_reader :errors
  # @return [square.rb::Vendor] The successfully created [Vendor](entity:Vendor) object.
    attr_reader :vendor
  ...
  # @return [Object] 
    ...
    # @param vendor [square.rb::Vendor] The successfully created [Vendor](entity:Vendor) object.
