...
#  `OrderLineItemAppliedDiscount`.
  ...
  # @return [square.rb::Money] The amount of money applied by the discount to the line item.
...
#  you must delete the discount and re-add it as a new
#  `OrderLineItemAppliedDiscount`.
    # @param applied_money [square.rb::Money] The amount of money applied by the discount to the line item.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderLineItemAppliedDiscount]
