...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogItem] Structured data for a `CatalogItem`, set for CatalogObjects of type `ITEM`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_data [SquareApiClient::CatalogItem] Structured data for a `CatalogItem`, set for CatalogObjects of type `ITEM`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectItem]
...
# Deserialize a JSON object to an instance of CatalogObjectItem
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_data"].nil?
        ...
        item_data = SquareApiClient::CatalogItem.from_json(json_object: item_data)
      else
        item_data = nil
      end
      id = parsed_json["id"]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_data.nil? || SquareApiClient::CatalogItem.validate_raw(obj: obj.item_data)
