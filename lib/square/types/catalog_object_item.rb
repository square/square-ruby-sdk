...
module square.rb
  class CatalogObjectItem
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogItem] Structured data for a `CatalogItem`, set for CatalogObjects of type `ITEM`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_data [square.rb::CatalogItem] Structured data for a `CatalogItem`, set for CatalogObjects of type `ITEM`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectItem]
    def initialize(type:, item_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @item_data = item_data if item_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectItem
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_data"].nil?
        item_data = parsed_json["item_data"].to_json
        item_data = square.rb::CatalogItem.from_json(json_object: item_data)
      else
        item_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectItem to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_data.nil? || square.rb::CatalogItem.validate_raw(obj: obj.item_data)
