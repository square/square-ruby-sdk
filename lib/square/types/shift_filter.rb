...
#  `team_member_ids` instead.
  ...
  # @return [square.rb::ShiftFilterStatus] Fetch a `Shift` instance by `Shift.status`.
#  See [ShiftFilterStatus](#type-shiftfilterstatus) for possible values
    attr_reader :status
  # @return [square.rb::TimeRange] Fetch `Shift` instances that start in the time range - Inclusive.
    attr_reader :start
  # @return [square.rb::TimeRange] Fetch the `Shift` instances that end in the time range - Inclusive.
    attr_reader :end_
  # @return [square.rb::ShiftWorkday] Fetch the `Shift` instances based on the workday date range.
    attr_reader :workday
...
#  `team_member_ids` instead.
    # @param status [square.rb::ShiftFilterStatus] Fetch a `Shift` instance by `Shift.status`.
#  See [ShiftFilterStatus](#type-shiftfilterstatus) for possible values
    # @param start [square.rb::TimeRange] Fetch `Shift` instances that start in the time range - Inclusive.
    # @param end_ [square.rb::TimeRange] Fetch the `Shift` instances that end in the time range - Inclusive.
    # @param workday [square.rb::ShiftWorkday] Fetch the `Shift` instances based on the workday date range.
...
# Deserialize a JSON object to an instance of ShiftFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["workday"].nil?
        ...
        workday = square.rb::ShiftWorkday.from_json(json_object: workday)
      else
        workday = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(square.rb::ShiftFilterStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      obj.start.nil? || square.rb::TimeRange.validate_raw(obj: obj.start)
      obj.end_.nil? || square.rb::TimeRange.validate_raw(obj: obj.end_)
      obj.workday.nil? || square.rb::ShiftWorkday.validate_raw(obj: obj.workday)
