...
#  type](entity:GiftCardActivityType).
  ...
  # @return [SquareApiClient::Money] The amount added to the gift card balance. This value is a positive integer.
    attr_reader :amount_money
  # @return [SquareApiClient::GiftCardActivityAdjustIncrementReason] The reason the gift card balance was adjusted.
#  See [Reason](#type-reason) for possible values
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The amount added to the gift card balance. This value is a positive integer.
    # @param reason [SquareApiClient::GiftCardActivityAdjustIncrementReason] The reason the gift card balance was adjusted.
#  See [Reason](#type-reason) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::GiftCardActivityAdjustIncrement]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.reason.is_a?(SquareApiClient::GiftCardActivityAdjustIncrementReason) != false || raise("Passed value for field obj.reason is not the expected type, validation failed.")
    end
  end
end