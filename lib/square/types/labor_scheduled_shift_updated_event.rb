...
# Published when a [ScheduledShift](entity:ScheduledShift) is updated.
  ...
  # @return [square.rb::LaborScheduledShiftUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::LaborScheduledShiftUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborScheduledShiftUpdatedEvent]
...
# Deserialize a JSON object to an instance of LaborScheduledShiftUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::LaborScheduledShiftUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::LaborScheduledShiftUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end