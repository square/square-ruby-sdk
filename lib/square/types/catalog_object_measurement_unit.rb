...
module square.rb
  class CatalogObjectMeasurementUnit
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogMeasurementUnit] Structured data for a `CatalogMeasurementUnit`, set for CatalogObjects of type
#  `MEASUREMENT_UNIT`.
    attr_reader :measurement_unit_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param measurement_unit_data [square.rb::CatalogMeasurementUnit] Structured data for a `CatalogMeasurementUnit`, set for CatalogObjects of type
#  `MEASUREMENT_UNIT`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectMeasurementUnit]
    def initialize(type:, measurement_unit_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @measurement_unit_data = measurement_unit_data if measurement_unit_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectMeasurementUnit
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["measurement_unit_data"].nil?
        measurement_unit_data = parsed_json["measurement_unit_data"].to_json
        measurement_unit_data = square.rb::CatalogMeasurementUnit.from_json(json_object: measurement_unit_data)
      else
        measurement_unit_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectMeasurementUnit to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.measurement_unit_data.nil? || square.rb::CatalogMeasurementUnit.validate_raw(obj: obj.measurement_unit_data)
