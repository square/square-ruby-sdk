...
#  app is updated.
  class OrderCustomAttributeDefinitionVisibleUpdatedEvent
...
#  `"order.custom_attribute_definition.visible.updated"`.
    ...
    # @return [square.rb::OrderCustomAttributeDefinitionVisibleUpdatedEvent]
...
# Serialize an instance of OrderCustomAttributeDefinitionVisibleUpdatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
