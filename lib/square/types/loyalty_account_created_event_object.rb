...
module SquareApiClient
  class LoyaltyAccountCreatedEventObject
  # @return [SquareApiClient::LoyaltyAccount] The loyalty account that was created.
  ...
  # @return [Object] 
    ...
    # @param loyalty_account [SquareApiClient::LoyaltyAccount] The loyalty account that was created.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyAccountCreatedEventObject]
...
# Deserialize a JSON object to an instance of LoyaltyAccountCreatedEventObject
    #
...
# Serialize an instance of LoyaltyAccountCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
