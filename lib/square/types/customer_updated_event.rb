...
require_relative "customer_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [customer](entity:Customer) is updated. For more information,
#  see [Use Customer
#  ttps://developer.squareup.com/docs/customers-api/use-the-api/customer-webhooks).
#  Updates to the 'segment_ids' customer field does not invoke a `customer.updated`
#  event. In addition, the `customer` object in the event notification does not
#  include this field.
  class CustomerUpdatedEvent
  # @return [String] The ID of the seller associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event. For this object, the value is `customer.updated`.
    attr_reader :type
...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
  ...
  # @return [SquareApiClient::CustomerUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this object, the value is `customer.updated`.
...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
    ...
    # @param data [SquareApiClient::CustomerUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CustomerUpdatedEvent]
...
# Deserialize a JSON object to an instance of CustomerUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CustomerUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CustomerUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CustomerUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end