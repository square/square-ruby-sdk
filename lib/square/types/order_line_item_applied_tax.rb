...
#  `OrderLineItemAppliedTax`.
    attr_reader :tax_uid
  # @return [SquareApiClient::Money] The amount of money applied by the tax to the line item.
...
#  add a new
#  `OrderLineItemAppliedTax`.
    # @param applied_money [SquareApiClient::Money] The amount of money applied by the tax to the line item.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderLineItemAppliedTax]
