...
# Represents an
#  on](api-endpoint:BookingCustomAttributes-UpdateBookingCustomAttributeDefinition)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class UpdateBookingCustomAttributeDefinitionResponse
...
# Serialize an instance of UpdateBookingCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
