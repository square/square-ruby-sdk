...
#  `gift_card.activity.created` event.
  class GiftCardActivityCreatedEventObject
  # @return [SquareApiClient::GiftCardActivity] The new gift card activity.
  ...
  # @return [Object] 
    ...
    # @param gift_card_activity [SquareApiClient::GiftCardActivity] The new gift card activity.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::GiftCardActivityCreatedEventObject]
...
# Deserialize a JSON object to an instance of GiftCardActivityCreatedEventObject
    #
...
# Serialize an instance of GiftCardActivityCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
