...
#  `gift_card.activity.created` event.
  ...
  # @return [square.rb::GiftCardActivity] The new gift card activity.
  ...
  # @return [Object] 
    ...
    # @param gift_card_activity [square.rb::GiftCardActivity] The new gift card activity.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::GiftCardActivityCreatedEventObject]
