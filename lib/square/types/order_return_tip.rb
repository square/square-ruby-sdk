...
# A tip being returned.
  ...
  # @return [String] A unique ID that identifies the tip only within this order.
    attr_reader :uid
  # @return [square.rb::Money] The amount of tip being returned
#  --
...
#  tip.
  ...
  # @return [Object] 
    ...
    # @param applied_money [square.rb::Money] The amount of tip being returned
#  --
...
#  tip.
    ...
    # @return [square.rb::OrderReturnTip]
