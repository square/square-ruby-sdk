...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<String>] The IDs of all catalog objects deleted by this request.
#  Multiple IDs may be returned when associated objects are also deleted, for
#  example
...
#  of this deletion in RFC 3339 format, e.g., `2016-09-04T23:59:33.123Z`.
  ...
  # @return [Object] 
    ...
    # @param deleted_object_ids [Array<String>] The IDs of all catalog objects deleted by this request.
#  Multiple IDs may be returned when associated objects are also deleted, for
#  example
#  a catalog item variation will be deleted (and its ID included in this field)
#  when its parent catalog item is deleted.
...
# Deserialize a JSON object to an instance of DeleteCatalogObjectResponse
    #
...
# Serialize an instance of DeleteCatalogObjectResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
