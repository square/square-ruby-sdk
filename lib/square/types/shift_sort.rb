...
#  es](https://developer.squareup.com/docs/labor-api/what-it-does#migration-notes).
  class ShiftSort
  # @return [SquareApiClient::ShiftSortField] The field to sort on.
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.field&.is_a?(SquareApiClient::ShiftSortField) != false || raise("Passed value for field obj.field is not the expected type, validation failed.")
