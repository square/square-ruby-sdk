...
require_relative "labor_shift_updated_event_data"
require "ostruct"
require "json"
...
#  `labor.timecard.updated`.
  class LaborShiftUpdatedEvent
  # @return [String] The ID of the merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event. For this event, the value is `labor.shift.updated`.
    attr_reader :type
  ...
  # @return [SquareApiClient::LaborShiftUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this event, the value is `labor.shift.updated`.
    ...
    # @param data [SquareApiClient::LaborShiftUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborShiftUpdatedEvent]
...
# Deserialize a JSON object to an instance of LaborShiftUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborShiftUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborShiftUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborShiftUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end