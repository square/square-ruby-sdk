...
#  owned by the subscribing application is updated. Subscribe to this event to be
#  notified
#  when your application updates a merchant custom attribute.
  class MerchantCustomAttributeOwnedUpdatedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::MerchantCustomAttributeOwnedUpdatedEvent]
...
# Serialize an instance of MerchantCustomAttributeOwnedUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
