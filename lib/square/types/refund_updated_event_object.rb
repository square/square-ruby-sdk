...
module SquareApiClient
  class RefundUpdatedEventObject
  # @return [SquareApiClient::PaymentRefund] The updated refund.
    attr_reader :refund
  ...
  # @return [Object] 
    ...
    # @param refund [SquareApiClient::PaymentRefund] The updated refund.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::RefundUpdatedEventObject]
...
# Deserialize a JSON object to an instance of RefundUpdatedEventObject
    #
...
# Serialize an instance of RefundUpdatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
