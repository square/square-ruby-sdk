...
# Published when a [Payout](entity:Payout) is sent.
  ...
  # @return [SquareApiClient::PayoutSentEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::PayoutSentEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PayoutSentEvent]
...
# Deserialize a JSON object to an instance of PayoutSentEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::PayoutSentEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::PayoutSentEventData.validate_raw(obj: obj.data)
    end
  end
end