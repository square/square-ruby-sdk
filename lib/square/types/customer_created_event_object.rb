...
# An object that contains the customer associated with the event.
  ...
  # @return [square.rb::Customer] The new customer.
    attr_reader :customer
  # @return [square.rb::CustomerCreatedEventEventContext] Information about the change that triggered the event. This field is returned
#  only if the customer is created by a merge operation.
  ...
  # @return [Object] 
    ...
    # @param customer [square.rb::Customer] The new customer.
    # @param event_context [square.rb::CustomerCreatedEventEventContext] Information about the change that triggered the event. This field is returned
#  only if the customer is created by a merge operation.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CustomerCreatedEventObject]
...
# Deserialize a JSON object to an instance of CustomerCreatedEventObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["event_context"].nil?
        ...
        event_context = square.rb::CustomerCreatedEventEventContext.from_json(json_object: event_context)
      else
        event_context = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.event_context.nil? || square.rb::CustomerCreatedEventEventContext.validate_raw(obj: obj.event_context)
    end
  end
end