...
#  See [OrderState](#type-orderstate) for possible values
    ...
    # @return [SquareApiClient::OrderUpdated]
    def initialize(order_id: OMIT, version: OMIT, location_id: OMIT, state: OMIT, created_at: OMIT, updated_at: OMIT, additional_properties: nil)
      ...
      @_field_set = { "order_id": order_id, "version": version, "location_id": location_id, "state": state, "created_at": created_at, "updated_at": updated_at }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of OrderUpdated
    #
...
# Serialize an instance of OrderUpdated to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
