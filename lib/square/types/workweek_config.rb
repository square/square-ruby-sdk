...
#  workweek. This is used to calculate overtime pay.
  ...
  # @return [String] The UUID for this object.
    attr_reader :id
  # @return [SquareApiClient::Weekday] The day of the week on which a business week starts for
...
#  write.
  ...
  # @return [Object] 
    ...
    # @param start_of_week [SquareApiClient::Weekday] The day of the week on which a business week starts for
#  compensation purposes.
#  See [Weekday](#type-weekday) for possible values
...
#  write.
    ...
    # @return [SquareApiClient::WorkweekConfig]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.start_of_week.is_a?(SquareApiClient::Weekday) != false || raise("Passed value for field obj.start_of_week is not the expected type, validation failed.")
