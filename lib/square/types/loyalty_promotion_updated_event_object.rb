...
#  `loyalty.promotion.updated` event.
  ...
  # @return [SquareApiClient::LoyaltyPromotion] The loyalty promotion that was updated.
  ...
  # @return [Object] 
    ...
    # @param loyalty_promotion [SquareApiClient::LoyaltyPromotion] The loyalty promotion that was updated.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyPromotionUpdatedEventObject]
