...
#  response.
  class DeleteInvoiceAttachmentResponse
...
# Deserialize a JSON object to an instance of DeleteInvoiceAttachmentResponse
    #
...
# Serialize an instance of DeleteInvoiceAttachmentResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
