...
#  See [CashDrawerShiftState](#type-cashdrawershiftstate) for possible values
  ...
  # @return [square.rb::Money] The amount of money in the cash drawer at the start of the shift.
#  The amount must be greater than or equal to zero.
    attr_reader :opened_cash_money
  # @return [square.rb::Money] The amount of money added to the cash drawer from cash payments.
...
#  zero.
  ...
  # @return [square.rb::Money] The amount of money removed from the cash drawer from cash refunds.
#  It is computed by summing the events of type CASH_TENDER_REFUND. The amount
#  is always greater than or equal to zero.
    attr_reader :cash_refunds_money
  # @return [square.rb::Money] The amount of money added to the cash drawer for reasons other than cash
#  payments. It is computed by summing the events of type PAID_IN. The amount is
#  always greater than or equal to zero.
    attr_reader :cash_paid_in_money
  # @return [square.rb::Money] The amount of money removed from the cash drawer for reasons other than
...
#  or positive), and cash_paid_out_money (zero or negative) event types.
  ...
  # @return [square.rb::Money] The amount of money found in the cash drawer at the end of the shift
#  by an auditing employee. The amount should be positive.
    attr_reader :closed_cash_money
  # @return [square.rb::CashDrawerDevice] The device running Square Point of Sale that was connected to the cash drawer.
    attr_reader :device
...
#  See [CashDrawerShiftState](#type-cashdrawershiftstate) for possible values
    ...
    # @param opened_cash_money [square.rb::Money] The amount of money in the cash drawer at the start of the shift.
#  The amount must be greater than or equal to zero.
    # @param cash_payment_money [square.rb::Money] The amount of money added to the cash drawer from cash payments.
#  This is computed by summing all events with the types CASH_TENDER_PAYMENT and
#  CASH_TENDER_CANCELED_PAYMENT. The amount is always greater than or equal to
#  zero.
    # @param cash_refunds_money [square.rb::Money] The amount of money removed from the cash drawer from cash refunds.
#  It is computed by summing the events of type CASH_TENDER_REFUND. The amount
#  is always greater than or equal to zero.
    # @param cash_paid_in_money [square.rb::Money] The amount of money added to the cash drawer for reasons other than cash
#  payments. It is computed by summing the events of type PAID_IN. The amount is
#  always greater than or equal to zero.
    # @param cash_paid_out_money [square.rb::Money] The amount of money removed from the cash drawer for reasons other than
#  cash refunds. It is computed by summing the events of type PAID_OUT. The amount
#  is always greater than or equal to zero.
...
#  or positive), cash_refunds_money (zero or negative), cash_paid_in_money (zero
#  or positive), and cash_paid_out_money (zero or negative) event types.
    # @param closed_cash_money [square.rb::Money] The amount of money found in the cash drawer at the end of the shift
#  by an auditing employee. The amount should be positive.
    # @param device [square.rb::CashDrawerDevice] The device running Square Point of Sale that was connected to the cash drawer.
...
#  the cash drawer contents.
    ...
    # @return [square.rb::CashDrawerShift]
...
# Deserialize a JSON object to an instance of CashDrawerShift
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["cash_paid_out_money"].nil?
        ...
        cash_paid_out_money = square.rb::Money.from_json(json_object: cash_paid_out_money)
      else
      ...
      unless parsed_json["device"].nil?
        ...
        device = square.rb::CashDrawerDevice.from_json(json_object: device)
      else
        device = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.cash_payment_money.nil? || square.rb::Money.validate_raw(obj: obj.cash_payment_money)
      obj.cash_refunds_money.nil? || square.rb::Money.validate_raw(obj: obj.cash_refunds_money)
      obj.cash_paid_in_money.nil? || square.rb::Money.validate_raw(obj: obj.cash_paid_in_money)
      obj.cash_paid_out_money.nil? || square.rb::Money.validate_raw(obj: obj.cash_paid_out_money)
      ...
      obj.device.nil? || square.rb::CashDrawerDevice.validate_raw(obj: obj.device)
