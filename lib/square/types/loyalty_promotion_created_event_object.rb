...
#  `loyalty.promotion.created` event.
  ...
  # @return [square.rb::LoyaltyPromotion] The loyalty promotion that was created.
  ...
  # @return [Object] 
    ...
    # @param loyalty_promotion [square.rb::LoyaltyPromotion] The loyalty promotion that was created.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyPromotionCreatedEventObject]
