...
#  type](entity:GiftCardActivityType).
  ...
  # @return [square.rb::GIFT_CARD_ACTIVITY_UNBLOCK_REASON] The reason the gift card was unblocked.
#  See [Reason](#type-reason) for possible values
  ...
  # @return [Object] 
    ...
    # @param reason [square.rb::GIFT_CARD_ACTIVITY_UNBLOCK_REASON] The reason the gift card was unblocked.
#  See [Reason](#type-reason) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::GiftCardActivityUnblock]
