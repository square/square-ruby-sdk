...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::InventoryCount>] The current counts for all objects referenced in the request.
    attr_reader :counts
  # @return [Array<square.rb::InventoryChange>] Changes created for the request.
    attr_reader :changes
  ...
  # @return [Object] 
    ...
    # @param counts [Array<square.rb::InventoryCount>] The current counts for all objects referenced in the request.
    # @param changes [Array<square.rb::InventoryChange>] Changes created for the request.
