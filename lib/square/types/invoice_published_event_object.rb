...
module SquareApiClient
  class InvoicePublishedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::InvoicePublishedEventObject]
...
# Deserialize a JSON object to an instance of InvoicePublishedEventObject
    #
...
# Serialize an instance of InvoicePublishedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
