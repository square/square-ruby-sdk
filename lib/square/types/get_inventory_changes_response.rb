...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::InventoryChange>] The set of inventory changes for the requested object and locations.
    attr_reader :changes
...
#  guide for more information.
  ...
  # @return [Object] 
    ...
    # @param changes [Array<SquareApiClient::InventoryChange>] The set of inventory changes for the requested object and locations.
