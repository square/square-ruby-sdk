...
module SquareApiClient
  class CardCreatedEventObject
  # @return [SquareApiClient::Card] The created card.
    attr_reader :card
  ...
  # @return [Object] 
    ...
    # @param card [SquareApiClient::Card] The created card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardCreatedEventObject]
...
# Deserialize a JSON object to an instance of CardCreatedEventObject
    #
...
# Serialize an instance of CardCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
