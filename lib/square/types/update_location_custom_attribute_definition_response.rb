...
# Represents an
#  ](api-endpoint:LocationCustomAttributes-UpdateLocationCustomAttributeDefinition)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class UpdateLocationCustomAttributeDefinitionResponse
  # @return [SquareApiClient::CustomAttributeDefinition] The updated custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [SquareApiClient::CustomAttributeDefinition] The updated custom attribute definition.
...
# Serialize an instance of UpdateLocationCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
