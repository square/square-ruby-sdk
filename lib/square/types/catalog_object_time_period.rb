...
require_relative "catalog_time_period"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectTimePeriod
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogTimePeriod] Structured data for a `CatalogTimePeriod`, set for CatalogObjects of type
#  `TIME_PERIOD`.
    attr_reader :time_period_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param time_period_data [square.rb::CatalogTimePeriod] Structured data for a `CatalogTimePeriod`, set for CatalogObjects of type
#  `TIME_PERIOD`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectTimePeriod]
    def initialize(type:, time_period_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @time_period_data = time_period_data if time_period_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectTimePeriod
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["time_period_data"].nil?
        time_period_data = parsed_json["time_period_data"].to_json
        time_period_data = square.rb::CatalogTimePeriod.from_json(json_object: time_period_data)
      else
        time_period_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectTimePeriod to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.time_period_data.nil? || square.rb::CatalogTimePeriod.validate_raw(obj: obj.time_period_data)
