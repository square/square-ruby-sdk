...
module square.rb
# Represents a
#  mAttribute](api-endpoint:MerchantCustomAttributes-DeleteMerchantCustomAttribute)
#  response.
#  Either an empty object `{}` (for a successful deletion) or `errors` is present
#  in the response.
  class DeleteMerchantCustomAttributeResponse
...
# Serialize an instance of DeleteMerchantCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
