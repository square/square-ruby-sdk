...
#  [ListSubscriptionEvents](api-endpoint:Subscriptions-ListSubscriptionEvents).
  ...
  # @return [Array<square.rb::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [Array<square.rb::SubscriptionEvent>] The retrieved subscription events.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param subscription_events [Array<square.rb::SubscriptionEvent>] The retrieved subscription events.
...
# Deserialize a JSON object to an instance of ListSubscriptionEventsResponse
  ...
  item = item.to_json
  square.rb::SubscriptionEvent.from_json(json_object: item)
end
