...
#  `"order.custom_attribute_definition.visible.deleted"`.
  ...
  # @return [SquareApiClient::CustomAttributeDefinitionEventData] The data associated with the event.
    attr_reader :data
...
#  `"order.custom_attribute_definition.visible.deleted"`.
    ...
    # @param data [SquareApiClient::CustomAttributeDefinitionEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderCustomAttributeDefinitionVisibleDeletedEvent]
