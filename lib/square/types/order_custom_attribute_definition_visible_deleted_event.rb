...
#  app is deleted.
  class OrderCustomAttributeDefinitionVisibleDeletedEvent
...
#  `"order.custom_attribute_definition.visible.deleted"`.
    ...
    # @return [square.rb::OrderCustomAttributeDefinitionVisibleDeletedEvent]
...
# Serialize an instance of OrderCustomAttributeDefinitionVisibleDeletedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
