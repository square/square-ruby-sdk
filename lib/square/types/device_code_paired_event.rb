...
#  available.
  ...
  # @return [SquareApiClient::DeviceCodePairedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::DeviceCodePairedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DeviceCodePairedEvent]
...
# Deserialize a JSON object to an instance of DeviceCodePairedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::DeviceCodePairedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::DeviceCodePairedEventData.validate_raw(obj: obj.data)
    end
  end
end