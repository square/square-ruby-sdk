...
#  you provide when creating a draft invoice.
  ...
  # @return [SquareApiClient::Address] The recipient's physical address.
    attr_reader :address
  # @return [String] The recipient's phone number.
    attr_reader :phone_number
  # @return [String] The name of the recipient's company.
    attr_reader :company_name
  # @return [SquareApiClient::InvoiceRecipientTaxIds] The recipient's tax IDs. The country of the seller account determines whether
#  this field
...
#  you provide when creating a draft invoice.
    ...
    # @param address [SquareApiClient::Address] The recipient's physical address.
    # @param phone_number [String] The recipient's phone number.
    # @param company_name [String] The name of the recipient's company.
    # @param tax_ids [SquareApiClient::InvoiceRecipientTaxIds] The recipient's tax IDs. The country of the seller account determines whether
#  this field
#  is available for the customer. For more information, see [Invoice recipient tax
#  s](https://developer.squareup.com/docs/invoices-api/overview#recipient-tax-ids).
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoiceRecipient]
...
# Deserialize a JSON object to an instance of InvoiceRecipient
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["tax_ids"].nil?
        ...
        tax_ids = SquareApiClient::InvoiceRecipientTaxIds.from_json(json_object: tax_ids)
      else
        tax_ids = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.tax_ids.nil? || SquareApiClient::InvoiceRecipientTaxIds.validate_raw(obj: obj.tax_ids)
    end
  end
end