...
# Represents an [UpdateScheduledShift](api-endpoint:Labor-UpdateScheduledShift)
#  response.
#  Either `scheduled_shift` or `errors` is present in the response.
  class UpdateScheduledShiftResponse
  # @return [SquareApiClient::ScheduledShift] The updated scheduled shift. To make the changes public, call
...
#  [BulkPublishScheduledShifts](api-endpoint:Labor-BulkPublishScheduledShifts).
  ...
  # @return [Object] 
    ...
    # @param scheduled_shift [SquareApiClient::ScheduledShift] The updated scheduled shift. To make the changes public, call
#  [PublishScheduledShift](api-endpoint:Labor-PublishScheduledShift) or
#  [BulkPublishScheduledShifts](api-endpoint:Labor-BulkPublishScheduledShifts).
...
# Deserialize a JSON object to an instance of UpdateScheduledShiftResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["scheduled_shift"].nil?
        ...
        scheduled_shift = SquareApiClient::ScheduledShift.from_json(json_object: scheduled_shift)
      else
        scheduled_shift = nil
      end
...
# Serialize an instance of UpdateScheduledShiftResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.scheduled_shift.nil? || SquareApiClient::ScheduledShift.validate_raw(obj: obj.scheduled_shift)
