...
#  Either `scheduled_shift` or `errors` is present in the response.
  ...
  # @return [square.rb::ScheduledShift] The updated scheduled shift. To make the changes public, call
...
#  [BulkPublishScheduledShifts](api-endpoint:Labor-BulkPublishScheduledShifts).
  ...
  # @return [Object] 
    ...
    # @param scheduled_shift [square.rb::ScheduledShift] The updated scheduled shift. To make the changes public, call
#  [PublishScheduledShift](api-endpoint:Labor-PublishScheduledShift) or
#  [BulkPublishScheduledShifts](api-endpoint:Labor-BulkPublishScheduledShifts).
