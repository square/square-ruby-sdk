...
#  [ListPayments](api-endpoint:Payments-ListPayments).
  ...
  # @return [Array<square.rb::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [Array<square.rb::Payment>] The requested list of payments.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param payments [Array<square.rb::Payment>] The requested list of payments.
...
# Deserialize a JSON object to an instance of ListPaymentsResponse
  ...
  item = item.to_json
  square.rb::Payment.from_json(json_object: item)
end
