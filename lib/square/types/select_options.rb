...
module square.rb
  ...
  # @return [String] The body text to display in the select flow on the Terminal.
    attr_reader :body
  # @return [Array<square.rb::SelectOption>] Represents the buttons/options that should be displayed in the select flow on
#  the Terminal.
    attr_reader :options
  # @return [square.rb::SelectOption] The buyer’s selected option.
  ...
  # @return [Object] 
    ...
    # @param options [Array<square.rb::SelectOption>] Represents the buttons/options that should be displayed in the select flow on
#  the Terminal.
    # @param selected_option [square.rb::SelectOption] The buyer’s selected option.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SelectOptions]
...
# Deserialize a JSON object to an instance of SelectOptions
  ...
  item = item.to_json
  square.rb::SelectOption.from_json(json_object: item)
end
      unless parsed_json["selected_option"].nil?
        selected_option = parsed_json["selected_option"].to_json
        selected_option = square.rb::SelectOption.from_json(json_object: selected_option)
      else
        selected_option = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.selected_option.nil? || square.rb::SelectOption.validate_raw(obj: obj.selected_option)
    end
  end
end