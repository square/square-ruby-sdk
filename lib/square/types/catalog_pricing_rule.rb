...
#  (HH:MM:SS). Partial seconds will be truncated.
  ...
  # @return [square.rb::ExcludeStrategy] If an `exclude_products_id` was given, controls which subset of matched
...
#  See [ExcludeStrategy](#type-excludestrategy) for possible values
  ...
  # @return [square.rb::Money] The minimum order subtotal (before discounts or taxes are applied)
...
#  RFC 3339 partial-time format
#  (HH:MM:SS). Partial seconds will be truncated.
    # @param exclude_strategy [square.rb::ExcludeStrategy] If an `exclude_products_id` was given, controls which subset of matched
#  products is excluded from any discounts.
#  Default value: `LEAST_EXPENSIVE`
#  See [ExcludeStrategy](#type-excludestrategy) for possible values
    # @param minimum_order_subtotal_money [square.rb::Money] The minimum order subtotal (before discounts or taxes are applied)
#  that must be met before this rule may be applied.
...
#  customer groups.
    ...
    # @return [square.rb::CatalogPricingRule]
...
# Deserialize a JSON object to an instance of CatalogPricingRule
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["minimum_order_subtotal_money"].nil?
        ...
        minimum_order_subtotal_money = square.rb::Money.from_json(json_object: minimum_order_subtotal_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.exclude_strategy&.is_a?(square.rb::ExcludeStrategy) != false || raise("Passed value for field obj.exclude_strategy is not the expected type, validation failed.")
      obj.minimum_order_subtotal_money.nil? || square.rb::Money.validate_raw(obj: obj.minimum_order_subtotal_money)
