...
require_relative "terminal_action_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a TerminalAction is updated.
  class TerminalActionUpdatedEvent
  # @return [String] The ID of the target merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event this represents, `"terminal.action.updated"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] RFC 3339 timestamp of when the event was created.
    attr_reader :created_at
  # @return [SquareApiClient::TerminalActionUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"terminal.action.updated"`.
    # @param event_id [String] A unique ID for the event.
    # @param created_at [String] RFC 3339 timestamp of when the event was created.
    # @param data [SquareApiClient::TerminalActionUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalActionUpdatedEvent]
...
# Deserialize a JSON object to an instance of TerminalActionUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::TerminalActionUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of TerminalActionUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::TerminalActionUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end