...
#  are ANDed together.
  ...
  # @return [square.rb::SearchOrdersStateFilter] Filter by [OrderState](entity:OrderState).
    attr_reader :state_filter
  # @return [square.rb::SearchOrdersDateTimeFilter] Filter for results within a time range.
...
#  manage-orders/search-orders#important-note-about-filtering-orders-by-time-range)
  ...
  # @return [square.rb::SearchOrdersFulfillmentFilter] Filter by the fulfillment type or state.
    attr_reader :fulfillment_filter
  # @return [square.rb::SearchOrdersSourceFilter] Filter by the source of the order.
    attr_reader :source_filter
  # @return [square.rb::SearchOrdersCustomerFilter] Filter by customers associated with the order.
  ...
  # @return [Object] 
    ...
    # @param state_filter [square.rb::SearchOrdersStateFilter] Filter by [OrderState](entity:OrderState).
    # @param date_time_filter [square.rb::SearchOrdersDateTimeFilter] Filter for results within a time range.
#  __Important:__ If you filter for orders by time range, you must set
#  `SearchOrdersSort`
#  to sort by the same field.
#  [Learn more about filtering orders by time
#  manage-orders/search-orders#important-note-about-filtering-orders-by-time-range)
    # @param fulfillment_filter [square.rb::SearchOrdersFulfillmentFilter] Filter by the fulfillment type or state.
    # @param source_filter [square.rb::SearchOrdersSourceFilter] Filter by the source of the order.
    # @param customer_filter [square.rb::SearchOrdersCustomerFilter] Filter by customers associated with the order.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchOrdersFilter]
...
# Deserialize a JSON object to an instance of SearchOrdersFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["state_filter"].nil?
        ...
        state_filter = square.rb::SearchOrdersStateFilter.from_json(json_object: state_filter)
      else
        state_filter = nil
      end
      unless parsed_json["date_time_filter"].nil?
        date_time_filter = parsed_json["date_time_filter"].to_json
        date_time_filter = square.rb::SearchOrdersDateTimeFilter.from_json(json_object: date_time_filter)
      else
        date_time_filter = nil
      end
      unless parsed_json["fulfillment_filter"].nil?
        fulfillment_filter = parsed_json["fulfillment_filter"].to_json
        fulfillment_filter = square.rb::SearchOrdersFulfillmentFilter.from_json(json_object: fulfillment_filter)
      else
        fulfillment_filter = nil
      end
      unless parsed_json["source_filter"].nil?
        source_filter = parsed_json["source_filter"].to_json
        source_filter = square.rb::SearchOrdersSourceFilter.from_json(json_object: source_filter)
      else
        source_filter = nil
      end
      unless parsed_json["customer_filter"].nil?
        customer_filter = parsed_json["customer_filter"].to_json
        customer_filter = square.rb::SearchOrdersCustomerFilter.from_json(json_object: customer_filter)
      else
        customer_filter = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.state_filter.nil? || square.rb::SearchOrdersStateFilter.validate_raw(obj: obj.state_filter)
      obj.date_time_filter.nil? || square.rb::SearchOrdersDateTimeFilter.validate_raw(obj: obj.date_time_filter)
      obj.fulfillment_filter.nil? || square.rb::SearchOrdersFulfillmentFilter.validate_raw(obj: obj.fulfillment_filter)
      obj.source_filter.nil? || square.rb::SearchOrdersSourceFilter.validate_raw(obj: obj.source_filter)
      obj.customer_filter.nil? || square.rb::SearchOrdersCustomerFilter.validate_raw(obj: obj.customer_filter)
    end
  end
end