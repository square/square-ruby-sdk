...
require_relative "catalog_item_option_value"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectItemOptionValue
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogItemOptionValue] Structured data for a `CatalogItemOptionValue`, set for CatalogObjects of type
#  `ITEM_OPTION_VAL`.
    attr_reader :item_option_value_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_option_value_data [square.rb::CatalogItemOptionValue] Structured data for a `CatalogItemOptionValue`, set for CatalogObjects of type
#  `ITEM_OPTION_VAL`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectItemOptionValue]
    def initialize(type:, item_option_value_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @item_option_value_data = item_option_value_data if item_option_value_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectItemOptionValue
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_option_value_data"].nil?
        item_option_value_data = parsed_json["item_option_value_data"].to_json
        item_option_value_data = square.rb::CatalogItemOptionValue.from_json(json_object: item_option_value_data)
      else
        item_option_value_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectItemOptionValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_option_value_data.nil? || square.rb::CatalogItemOptionValue.validate_raw(obj: obj.item_option_value_data)
