...
# The response returned by the `CancelInvoice` request.
  ...
  # @return [square.rb::Invoice] The canceled invoice.
    attr_reader :invoice
  ...
  # @return [Object] 
    ...
    # @param invoice [square.rb::Invoice] The canceled invoice.
...
# Deserialize a JSON object to an instance of CancelInvoiceResponse
    #
...
# Serialize an instance of CancelInvoiceResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
