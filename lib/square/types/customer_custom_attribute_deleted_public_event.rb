...
#  visible
#  to all applications is deleted. A notification is sent when any application
...
#  m_attribute.visible.deleted](webhook:customer.custom_attribute.visible.deleted),
#  which applies to custom attributes that are visible to the subscribing
#  application.
  class CustomerCustomAttributeDeletedPublicEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeDeletedPublicEvent]
...
# Serialize an instance of CustomerCustomAttributeDeletedPublicEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
