...
#  when your application deletes a booking custom attribute.
  class BookingCustomAttributeOwnedDeletedEvent
  # @return [String] The ID of the seller associated with the event that triggered the event
#  notification.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"booking.custom_attribute.owned.deleted"`.
    attr_reader :type
...
#  notification.
    # @param type [String] The type of this event. The value is `"booking.custom_attribute.owned.deleted"`.
...
#  3339 format.
    ...
    # @return [SquareApiClient::BookingCustomAttributeOwnedDeletedEvent]
...
# Serialize an instance of BookingCustomAttributeOwnedDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
