...
# Represents a period of time during which a business location is open.
  ...
  # @return [SquareApiClient::DayOfWeek] The day of the week for this time period.
...
#  the RFC.
  ...
  # @return [Object] 
    ...
    # @param day_of_week [SquareApiClient::DayOfWeek] The day of the week for this time period.
#  See [DayOfWeek](#type-dayofweek) for possible values
...
#  the RFC.
    ...
    # @return [SquareApiClient::BusinessHoursPeriod]
