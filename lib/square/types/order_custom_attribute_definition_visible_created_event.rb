...
#  definition](entity:CustomAttributeDefinition) that is visible to the subscribing
#  app is created.
  class OrderCustomAttributeDefinitionVisibleCreatedEvent
...
#  `"order.custom_attribute_definition.visible.created"`.
  ...
  # @return [square.rb::CustomAttributeDefinitionEventData] The data associated with the event.
    attr_reader :data
...
#  `"order.custom_attribute_definition.visible.created"`.
    ...
    # @param data [square.rb::CustomAttributeDefinitionEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderCustomAttributeDefinitionVisibleCreatedEvent]
...
# Serialize an instance of OrderCustomAttributeDefinitionVisibleCreatedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
