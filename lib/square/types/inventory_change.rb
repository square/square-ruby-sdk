...
#  [CatalogObject](entity:CatalogObject) instance.
  ...
  # @return [square.rb::InventoryChangeType] Indicates how the inventory change is applied. See
...
#  See [InventoryChangeType](#type-inventorychangetype) for possible values
    attr_reader :type
  # @return [square.rb::InventoryPhysicalCount] Contains details about the physical count when `type` is
#  `PHYSICAL_COUNT`, and is unset for all other change types.
    attr_reader :physical_count
  # @return [square.rb::InventoryAdjustment] Contains details about the inventory adjustment when `type` is
#  `ADJUSTMENT`, and is unset for all other change types.
    attr_reader :adjustment
  # @return [square.rb::InventoryTransfer] Contains details about the inventory transfer when `type` is
...
#  when the seller has an active Retail Plus subscription.
  ...
  # @return [square.rb::CatalogMeasurementUnit] The [CatalogMeasurementUnit](entity:CatalogMeasurementUnit) object representing
...
#  representing the catalog measurement unit associated with the inventory change.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::InventoryChangeType] Indicates how the inventory change is applied. See
#  [InventoryChangeType](entity:InventoryChangeType) for all possible values.
#  See [InventoryChangeType](#type-inventorychangetype) for possible values
    # @param physical_count [square.rb::InventoryPhysicalCount] Contains details about the physical count when `type` is
#  `PHYSICAL_COUNT`, and is unset for all other change types.
    # @param adjustment [square.rb::InventoryAdjustment] Contains details about the inventory adjustment when `type` is
#  `ADJUSTMENT`, and is unset for all other change types.
    # @param transfer [square.rb::InventoryTransfer] Contains details about the inventory transfer when `type` is
#  `TRANSFER`, and is unset for all other change types.
#  _Note:_ An [InventoryTransfer](entity:InventoryTransfer) object can only be set
#  in the input to the
#  [BatchChangeInventory](api-endpoint:Inventory-BatchChangeInventory) endpoint
#  when the seller has an active Retail Plus subscription.
    # @param measurement_unit [square.rb::CatalogMeasurementUnit] The [CatalogMeasurementUnit](entity:CatalogMeasurementUnit) object representing
#  the catalog measurement unit associated with the inventory change.
...
#  representing the catalog measurement unit associated with the inventory change.
    ...
    # @return [square.rb::InventoryChange]
...
# Deserialize a JSON object to an instance of InventoryChange
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["physical_count"].nil?
        ...
        physical_count = square.rb::InventoryPhysicalCount.from_json(json_object: physical_count)
      else
        physical_count = nil
      end
      ...
      unless parsed_json["transfer"].nil?
        ...
        transfer = square.rb::InventoryTransfer.from_json(json_object: transfer)
      else
        transfer = nil
      end
      unless parsed_json["measurement_unit"].nil?
        measurement_unit = parsed_json["measurement_unit"].to_json
        measurement_unit = square.rb::CatalogMeasurementUnit.from_json(json_object: measurement_unit)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type&.is_a?(square.rb::InventoryChangeType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.physical_count.nil? || square.rb::InventoryPhysicalCount.validate_raw(obj: obj.physical_count)
      obj.adjustment.nil? || square.rb::InventoryAdjustment.validate_raw(obj: obj.adjustment)
      obj.transfer.nil? || square.rb::InventoryTransfer.validate_raw(obj: obj.transfer)
      obj.measurement_unit.nil? || square.rb::CatalogMeasurementUnit.validate_raw(obj: obj.measurement_unit)
