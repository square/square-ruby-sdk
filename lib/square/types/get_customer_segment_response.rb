...
#  Either `errors` or `segment` is present in a given response (never both).
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::CustomerSegment] The retrieved customer segment.
    attr_reader :segment
  ...
  # @return [Object] 
    ...
    # @param segment [square.rb::CustomerSegment] The retrieved customer segment.
...
# Deserialize a JSON object to an instance of GetCustomerSegmentResponse
  ...
  square.rb::Error.from_json(json_object: item)
      ...
      unless parsed_json["segment"].nil?
        ...
        segment = square.rb::CustomerSegment.from_json(json_object: segment)
      else
        segment = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.segment.nil? || square.rb::CustomerSegment.validate_raw(obj: obj.segment)
    end
  end
end