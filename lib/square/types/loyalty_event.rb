...
#  Events](https://developer.squareup.com/docs/loyalty-api/loyalty-events).
  ...
  # @return [String] The Square-assigned ID of the loyalty event.
    attr_reader :id
  # @return [square.rb::LoyaltyEventType] The type of the loyalty event.
#  See [LoyaltyEventType](#type-loyaltyeventtype) for possible values
  ...
  # @return [square.rb::LoyaltyEventAccumulatePoints] Provides metadata when the event `type` is `ACCUMULATE_POINTS`.
    attr_reader :accumulate_points
  # @return [square.rb::LoyaltyEventCreateReward] Provides metadata when the event `type` is `CREATE_REWARD`.
    attr_reader :create_reward
  # @return [square.rb::LoyaltyEventRedeemReward] Provides metadata when the event `type` is `REDEEM_REWARD`.
    attr_reader :redeem_reward
  # @return [square.rb::LoyaltyEventDeleteReward] Provides metadata when the event `type` is `DELETE_REWARD`.
    attr_reader :delete_reward
  # @return [square.rb::LoyaltyEventAdjustPoints] Provides metadata when the event `type` is `ADJUST_POINTS`.
...
#  event.
  ...
  # @return [square.rb::LoyaltyEventSource] Defines whether the event was generated by the Square Point of Sale.
#  See [LoyaltyEventSource](#type-loyaltyeventsource) for possible values
    attr_reader :source
  # @return [square.rb::LoyaltyEventExpirePoints] Provides metadata when the event `type` is `EXPIRE_POINTS`.
    attr_reader :expire_points
  # @return [square.rb::LoyaltyEventOther] Provides metadata when the event `type` is `OTHER`.
    attr_reader :other_event
  # @return [square.rb::LoyaltyEventAccumulatePromotionPoints] Provides metadata when the event `type` is `ACCUMULATE_PROMOTION_POINTS`.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::LoyaltyEventType] The type of the loyalty event.
#  See [LoyaltyEventType](#type-loyaltyeventtype) for possible values
    # @param created_at [String] The timestamp when the event was created, in RFC 3339 format.
    # @param accumulate_points [square.rb::LoyaltyEventAccumulatePoints] Provides metadata when the event `type` is `ACCUMULATE_POINTS`.
    # @param create_reward [square.rb::LoyaltyEventCreateReward] Provides metadata when the event `type` is `CREATE_REWARD`.
    # @param redeem_reward [square.rb::LoyaltyEventRedeemReward] Provides metadata when the event `type` is `REDEEM_REWARD`.
    # @param delete_reward [square.rb::LoyaltyEventDeleteReward] Provides metadata when the event `type` is `DELETE_REWARD`.
    # @param adjust_points [square.rb::LoyaltyEventAdjustPoints] Provides metadata when the event `type` is `ADJUST_POINTS`.
...
#  event.
    ...
    # @param source [square.rb::LoyaltyEventSource] Defines whether the event was generated by the Square Point of Sale.
#  See [LoyaltyEventSource](#type-loyaltyeventsource) for possible values
    # @param expire_points [square.rb::LoyaltyEventExpirePoints] Provides metadata when the event `type` is `EXPIRE_POINTS`.
    # @param other_event [square.rb::LoyaltyEventOther] Provides metadata when the event `type` is `OTHER`.
    # @param accumulate_promotion_points [square.rb::LoyaltyEventAccumulatePromotionPoints] Provides metadata when the event `type` is `ACCUMULATE_PROMOTION_POINTS`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LoyaltyEvent]
...
# Deserialize a JSON object to an instance of LoyaltyEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["accumulate_points"].nil?
        ...
        accumulate_points = square.rb::LoyaltyEventAccumulatePoints.from_json(json_object: accumulate_points)
      else
        accumulate_points = nil
      end
      unless parsed_json["create_reward"].nil?
        create_reward = parsed_json["create_reward"].to_json
        create_reward = square.rb::LoyaltyEventCreateReward.from_json(json_object: create_reward)
      else
        create_reward = nil
      end
      unless parsed_json["redeem_reward"].nil?
        redeem_reward = parsed_json["redeem_reward"].to_json
        redeem_reward = square.rb::LoyaltyEventRedeemReward.from_json(json_object: redeem_reward)
      else
        redeem_reward = nil
      end
      unless parsed_json["delete_reward"].nil?
        delete_reward = parsed_json["delete_reward"].to_json
        delete_reward = square.rb::LoyaltyEventDeleteReward.from_json(json_object: delete_reward)
      else
        delete_reward = nil
      end
      unless parsed_json["adjust_points"].nil?
        adjust_points = parsed_json["adjust_points"].to_json
        adjust_points = square.rb::LoyaltyEventAdjustPoints.from_json(json_object: adjust_points)
      else
        adjust_points = nil
      end
      ...
      unless parsed_json["expire_points"].nil?
        ...
        expire_points = square.rb::LoyaltyEventExpirePoints.from_json(json_object: expire_points)
      else
        expire_points = nil
      end
      unless parsed_json["other_event"].nil?
        other_event = parsed_json["other_event"].to_json
        other_event = square.rb::LoyaltyEventOther.from_json(json_object: other_event)
      else
        other_event = nil
      end
      unless parsed_json["accumulate_promotion_points"].nil?
        ...
        accumulate_promotion_points = square.rb::LoyaltyEventAccumulatePromotionPoints.from_json(json_object: accumulate_promotion_points)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(square.rb::LoyaltyEventType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.created_at&.is_a?(String) != false || raise("Passed value for field obj.created_at is not the expected type, validation failed.")
      obj.accumulate_points.nil? || square.rb::LoyaltyEventAccumulatePoints.validate_raw(obj: obj.accumulate_points)
      obj.create_reward.nil? || square.rb::LoyaltyEventCreateReward.validate_raw(obj: obj.create_reward)
      obj.redeem_reward.nil? || square.rb::LoyaltyEventRedeemReward.validate_raw(obj: obj.redeem_reward)
      obj.delete_reward.nil? || square.rb::LoyaltyEventDeleteReward.validate_raw(obj: obj.delete_reward)
      obj.adjust_points.nil? || square.rb::LoyaltyEventAdjustPoints.validate_raw(obj: obj.adjust_points)
      ...
      obj.source.is_a?(square.rb::LoyaltyEventSource) != false || raise("Passed value for field obj.source is not the expected type, validation failed.")
      obj.expire_points.nil? || square.rb::LoyaltyEventExpirePoints.validate_raw(obj: obj.expire_points)
      obj.other_event.nil? || square.rb::LoyaltyEventOther.validate_raw(obj: obj.other_event)
      obj.accumulate_promotion_points.nil? || square.rb::LoyaltyEventAccumulatePromotionPoints.validate_raw(obj: obj.accumulate_promotion_points)
    end
  end
end