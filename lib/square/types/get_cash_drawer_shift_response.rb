...
module SquareApiClient
  ...
  # @return [SquareApiClient::CashDrawerShift] The cash drawer shift queried for.
  ...
  # @return [Object] 
    ...
    # @param cash_drawer_shift [SquareApiClient::CashDrawerShift] The cash drawer shift queried for.
...
# Deserialize a JSON object to an instance of GetCashDrawerShiftResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["cash_drawer_shift"].nil?
        ...
        cash_drawer_shift = SquareApiClient::CashDrawerShift.from_json(json_object: cash_drawer_shift)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.cash_drawer_shift.nil? || SquareApiClient::CashDrawerShift.validate_raw(obj: obj.cash_drawer_shift)
