...
module Square
    module Types
        ...
        class LoyaltyAccount < Square::Internal::Types::Model
            ...
            field :mapping, Square::LoyaltyAccountMapping, optional: true, nullable: false
            field :expiring_point_deadlines, Square::Internal::Types::Array[Square::LoyaltyAccountExpiringPointDeadline], optional: true, nullable: false
        end
    end
end
