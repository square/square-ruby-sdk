...
# A response that contains all loyalty programs.
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<square.rb::LoyaltyProgram>] A list of `LoyaltyProgram` for the merchant.
  ...
  # @return [Object] 
    ...
    # @param programs [Array<square.rb::LoyaltyProgram>] A list of `LoyaltyProgram` for the merchant.
...
# Deserialize a JSON object to an instance of ListLoyaltyProgramsResponse
  ...
  item = item.to_json
  square.rb::LoyaltyProgram.from_json(json_object: item)
end
      new(
        errors: errors,
        programs: programs,
