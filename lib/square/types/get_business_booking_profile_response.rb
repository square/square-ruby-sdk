...
module square.rb
  ...
  # @return [square.rb::BusinessBookingProfile] The seller's booking profile.
  ...
  # @return [Object] 
    ...
    # @param business_booking_profile [square.rb::BusinessBookingProfile] The seller's booking profile.
...
# Deserialize a JSON object to an instance of GetBusinessBookingProfileResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["business_booking_profile"].nil?
        ...
        business_booking_profile = square.rb::BusinessBookingProfile.from_json(json_object: business_booking_profile)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.business_booking_profile.nil? || square.rb::BusinessBookingProfile.validate_raw(obj: obj.business_booking_profile)
