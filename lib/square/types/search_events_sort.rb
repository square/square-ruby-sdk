...
# Criteria to sort events by.
  ...
  # @return [square.rb::SEARCH_EVENTS_SORT_FIELD] Sort events by event types.
#  See [SearchEventsSortField](#type-searcheventssortfield) for possible values
    attr_reader :field
  # @return [square.rb::SortOrder] The order to use for sorting the events.
#  See [SortOrder](#type-sortorder) for possible values
  ...
  # @return [Object] 
    ...
    # @param field [square.rb::SEARCH_EVENTS_SORT_FIELD] Sort events by event types.
#  See [SearchEventsSortField](#type-searcheventssortfield) for possible values
    # @param order [square.rb::SortOrder] The order to use for sorting the events.
#  See [SortOrder](#type-sortorder) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::SearchEventsSort]
