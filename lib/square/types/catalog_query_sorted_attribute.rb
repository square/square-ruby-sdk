...
#  descending sorts).
  ...
  # @return [SquareApiClient::SortOrder] The desired sort order, `"ASC"` (ascending) or `"DESC"` (descending).
...
#  or less. If unset, start at the beginning (for ascending sorts) or end (for
#  descending sorts).
    # @param sort_order [SquareApiClient::SortOrder] The desired sort order, `"ASC"` (ascending) or `"DESC"` (descending).
#  See [SortOrder](#type-sortorder) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogQuerySortedAttribute]
