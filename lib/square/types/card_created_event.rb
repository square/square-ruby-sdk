...
require_relative "card_created_event_data"
require "ostruct"
require "json"
...
# Published when a [card](entity:Card) is created or imported.
  ...
  # @return [String] The type of this event. The value is `"card.created"`.
    attr_reader :type
  ...
  # @return [SquareApiClient::CardCreatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"card.created"`.
    ...
    # @param data [SquareApiClient::CardCreatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardCreatedEvent]
...
# Deserialize a JSON object to an instance of CardCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CardCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CardCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CardCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end