...
# Sets the sort order of search results.
  class TimecardSort
  # @return [square.rb::TimecardSortField] The field to sort on.
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.field&.is_a?(square.rb::TimecardSortField) != false || raise("Passed value for field obj.field is not the expected type, validation failed.")
