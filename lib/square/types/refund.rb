...
# Represents a refund processed for a Square transaction.
  ...
  # @return [String] The reason for the refund being issued.
    attr_reader :reason
  # @return [square.rb::Money] The amount of money refunded to the buyer.
    attr_reader :amount_money
  # @return [square.rb::RefundStatus] The current status of the refund (`PENDING`, `APPROVED`, `REJECTED`,
#  or `FAILED`).
#  See [RefundStatus](#type-refundstatus) for possible values
    attr_reader :status
  # @return [square.rb::Money] The amount of Square processing fee money refunded to the *merchant*.
...
#  integration.
  ...
  # @return [Object] 
    ...
    # @param amount_money [square.rb::Money] The amount of money refunded to the buyer.
    # @param status [square.rb::RefundStatus] The current status of the refund (`PENDING`, `APPROVED`, `REJECTED`,
#  or `FAILED`).
#  See [RefundStatus](#type-refundstatus) for possible values
    # @param processing_fee_money [square.rb::Money] The amount of Square processing fee money refunded to the *merchant*.
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status.is_a?(square.rb::RefundStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
