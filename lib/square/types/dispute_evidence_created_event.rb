...
#  [CreateDisputeEvidenceText](api-endpoint:Disputes-CreateDisputeEvidenceText).
  ...
  # @return [square.rb::DisputeEvidenceCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::DisputeEvidenceCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::DisputeEvidenceCreatedEvent]
...
# Deserialize a JSON object to an instance of DisputeEvidenceCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::DisputeEvidenceCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::DisputeEvidenceCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end