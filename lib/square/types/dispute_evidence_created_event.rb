...
require_relative "dispute_evidence_created_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when evidence is added to a [Dispute](entity:Dispute)
#  from the Disputes Dashboard in the Seller Dashboard, the Square Point of Sale
#  app,
#  or by calling either
#  [CreateDisputeEvidenceFile](api-endpoint:Disputes-CreateDisputeEvidenceFile) or
#  [CreateDisputeEvidenceText](api-endpoint:Disputes-CreateDisputeEvidenceText).
  class DisputeEvidenceCreatedEvent
  ...
  # @return [String] The type of event this represents.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::DisputeEvidenceCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents.
    ...
    # @param data [SquareApiClient::DisputeEvidenceCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputeEvidenceCreatedEvent]
...
# Deserialize a JSON object to an instance of DisputeEvidenceCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::DisputeEvidenceCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of DisputeEvidenceCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::DisputeEvidenceCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end