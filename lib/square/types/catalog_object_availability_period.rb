...
require_relative "catalog_availability_period"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectAvailabilityPeriod
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogAvailabilityPeriod] Structured data for a `CatalogAvailabilityPeriod`, set for CatalogObjects of
#  type `AVAILABILITY_PERIOD`.
    attr_reader :availability_period_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param availability_period_data [square.rb::CatalogAvailabilityPeriod] Structured data for a `CatalogAvailabilityPeriod`, set for CatalogObjects of
#  type `AVAILABILITY_PERIOD`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectAvailabilityPeriod]
    def initialize(type:, availability_period_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @availability_period_data = availability_period_data if availability_period_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectAvailabilityPeriod
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["availability_period_data"].nil?
        availability_period_data = parsed_json["availability_period_data"].to_json
        availability_period_data = square.rb::CatalogAvailabilityPeriod.from_json(json_object: availability_period_data)
      else
        availability_period_data = nil
      end
      id = parsed_json["id"]
  ...
  square.rb::CatalogV1Id.from_json(json_object: item)
      ...
      new(
        type: type,
        availability_period_data: availability_period_data,
        id: id,
...
# Serialize an instance of CatalogObjectAvailabilityPeriod to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.availability_period_data.nil? || square.rb::CatalogAvailabilityPeriod.validate_raw(obj: obj.availability_period_data)
