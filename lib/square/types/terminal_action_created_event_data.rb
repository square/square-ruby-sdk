...
module square.rb
  ...
  # @return [String] ID of the created terminal action.
    attr_reader :id
  # @return [square.rb::TerminalActionCreatedEventObject] An object containing the created terminal action.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [square.rb::TerminalActionCreatedEventObject] An object containing the created terminal action.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TerminalActionCreatedEventData]
...
# Deserialize a JSON object to an instance of TerminalActionCreatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = square.rb::TerminalActionCreatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || square.rb::TerminalActionCreatedEventObject.validate_raw(obj: obj.object)
    end
  end
end