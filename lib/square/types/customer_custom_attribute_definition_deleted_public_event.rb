...
#  that is visible to all applications is deleted. A notification is sent when any
#  application deletes a custom
#  attribute definition whose `visibility` is `VISIBILITY_READ_ONLY` or
#  `VISIBILITY_READ_WRITE_VALUES`.
#  This event is replaced by
#  .visible.deleted](webhook:customer.custom_attribute_definition.visible.deleted),
#  which applies to custom attribute definitions that are visible to the
#  subscribing application.
  class CustomerCustomAttributeDefinitionDeletedPublicEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionDeletedPublicEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionDeletedPublicEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
