...
# Published when a [Timecard](entity:Timecard) is deleted.
  ...
  # @return [square.rb::LaborTimecardDeletedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::LaborTimecardDeletedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborTimecardDeletedEvent]
...
# Deserialize a JSON object to an instance of LaborTimecardDeletedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::LaborTimecardDeletedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::LaborTimecardDeletedEventData.validate_raw(obj: obj.data)
    end
  end
end