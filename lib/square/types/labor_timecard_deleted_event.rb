...
require_relative "labor_timecard_deleted_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [Timecard](entity:Timecard) is deleted.
  class LaborTimecardDeletedEvent
  # @return [String] The ID of the merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event. For this event, the value is `labor.timecard.deleted`.
    attr_reader :type
  ...
  # @return [SquareApiClient::LaborTimecardDeletedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this event, the value is `labor.timecard.deleted`.
    ...
    # @param data [SquareApiClient::LaborTimecardDeletedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborTimecardDeletedEvent]
...
# Deserialize a JSON object to an instance of LaborTimecardDeletedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborTimecardDeletedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborTimecardDeletedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborTimecardDeletedEventData.validate_raw(obj: obj.data)
    end
  end
end