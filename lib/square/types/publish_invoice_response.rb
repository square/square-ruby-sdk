...
# Describes a `PublishInvoice` response.
  ...
  # @return [square.rb::Invoice] The published invoice.
    attr_reader :invoice
  ...
  # @return [Object] 
    ...
    # @param invoice [square.rb::Invoice] The published invoice.
...
# Deserialize a JSON object to an instance of PublishInvoiceResponse
    #
...
# Serialize an instance of PublishInvoiceResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
