...
#  `CatalogModifierList` instances.
    attr_reader :ordinal
  # @return [SquareApiClient::CatalogModifierListSelectionType] __Deprecated__: Indicates whether a single (`SINGLE`) modifier or multiple
...
#  for possible values
  ...
  # @return [Array<SquareApiClient::CatalogObject>] A non-empty list of `CatalogModifier` objects to be included in the
#  `CatalogModifierList`,
...
#  displayed in 3rd-party applications.
  ...
  # @return [SquareApiClient::CatalogModifierListModifierType] The type of the modifier.
...
#  `CatalogModifierList` instances.
    # @param selection_type [SquareApiClient::CatalogModifierListSelectionType] __Deprecated__: Indicates whether a single (`SINGLE`) modifier or multiple
#  (`MULTIPLE`) modifiers can be selected. Use
#  `min_selected_modifiers` and `max_selected_modifiers` instead.
#  See [CatalogModifierListSelectionType](#type-catalogmodifierlistselectiontype)
#  for possible values
    # @param modifiers [Array<SquareApiClient::CatalogObject>] A non-empty list of `CatalogModifier` objects to be included in the
#  `CatalogModifierList`,
#  for non text-based modifiers when the `modifier_type` attribute is `LIST`. Each
#  element of this list
#  is a `CatalogObject` instance of the `MODIFIER` type, containing the following
...
#  displayed in 3rd-party applications.
    ...
    # @param modifier_type [SquareApiClient::CatalogModifierListModifierType] The type of the modifier.
#  When this `modifier_type` value is `TEXT`,  the `CatalogModifierList` represents
#  a text-based modifier.
#  When this `modifier_type` value is `LIST`, the `CatalogModifierList` contains a
#  list of `CatalogModifier` objects.
...
#  `CatalogItemModifierListInfo.hidden_from_customer_override`.
    ...
    # @return [SquareApiClient::CatalogModifierList]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.selection_type&.is_a?(SquareApiClient::CatalogModifierListSelectionType) != false || raise("Passed value for field obj.selection_type is not the expected type, validation failed.")
      ...
      obj.modifier_type&.is_a?(SquareApiClient::CatalogModifierListModifierType) != false || raise("Passed value for field obj.modifier_type is not the expected type, validation failed.")
