...
module SquareApiClient
  ...
  # @return [SquareApiClient::Booking] The updated booking.
    attr_reader :booking
  ...
  # @return [Object] 
    ...
    # @param booking [SquareApiClient::Booking] The updated booking.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BookingUpdatedEventObject]
