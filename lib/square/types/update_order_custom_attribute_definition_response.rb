...
# Represents a response from updating an order custom attribute definition.
  ...
  # @return [square.rb::CustomAttributeDefinition] The updated order custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [square.rb::CustomAttributeDefinition] The updated order custom attribute definition.
