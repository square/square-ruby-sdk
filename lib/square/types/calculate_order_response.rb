...
module square.rb
  ...
  # @return [square.rb::Order] The calculated version of the order provided in the request.
    attr_reader :order
  ...
  # @return [Object] 
    ...
    # @param order [square.rb::Order] The calculated version of the order provided in the request.
