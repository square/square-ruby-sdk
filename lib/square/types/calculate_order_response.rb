...
module SquareApiClient
  ...
  # @return [SquareApiClient::Order] The calculated version of the order provided in the request.
    attr_reader :order
  ...
  # @return [Object] 
    ...
    # @param order [SquareApiClient::Order] The calculated version of the order provided in the request.
...
# Deserialize a JSON object to an instance of CalculateOrderResponse
    #
...
# Serialize an instance of CalculateOrderResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
