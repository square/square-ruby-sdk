...
# Defines fields in a `ListDisputes` response.
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::Dispute>] The list of disputes.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param disputes [Array<SquareApiClient::Dispute>] The list of disputes.
...
# Deserialize a JSON object to an instance of ListDisputesResponse
  ...
  item = item.to_json
  SquareApiClient::Dispute.from_json(json_object: item)
end
