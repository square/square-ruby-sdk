...
module square.rb
  ...
  # @return [square.rb::Order] The order to create. If this field is set, the only other top-level field that
#  can be
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
  ...
  # @return [Object] 
    ...
    # @param order [square.rb::Order] The order to create. If this field is set, the only other top-level field that
#  can be
#  set is the `idempotency_key`.
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
    ...
    # @return [square.rb::CreateOrderRequest]
