...
module square.rb
# Represents a
#  mAttribute](api-endpoint:LocationCustomAttributes-DeleteLocationCustomAttribute)
#  response.
#  Either an empty object `{}` (for a successful deletion) or `errors` is present
#  in the response.
  class DeleteLocationCustomAttributeResponse
...
# Serialize an instance of DeleteLocationCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
