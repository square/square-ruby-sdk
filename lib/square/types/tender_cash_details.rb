...
# Represents the details of a tender with `type` `CASH`.
  ...
  # @return [square.rb::Money] The total amount of cash provided by the buyer, before change is given.
    attr_reader :buyer_tendered_money
  # @return [square.rb::Money] The amount of change returned to the buyer.
  ...
  # @return [Object] 
    ...
    # @param buyer_tendered_money [square.rb::Money] The total amount of cash provided by the buyer, before change is given.
    # @param change_back_money [square.rb::Money] The amount of change returned to the buyer.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::TenderCashDetails]
...
# Deserialize a JSON object to an instance of TenderCashDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["buyer_tendered_money"].nil?
        ...
        buyer_tendered_money = square.rb::Money.from_json(json_object: buyer_tendered_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.buyer_tendered_money.nil? || square.rb::Money.validate_raw(obj: obj.buyer_tendered_money)
