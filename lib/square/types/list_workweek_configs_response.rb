...
#  the request resulted in errors.
  ...
  # @return [Array<SquareApiClient::WorkweekConfig>] A page of `WorkweekConfig` results.
...
#  `WorkweekConfig` results.
  ...
  # @return [Object] 
    ...
    # @param workweek_configs [Array<SquareApiClient::WorkweekConfig>] A page of `WorkweekConfig` results.
...
# Deserialize a JSON object to an instance of ListWorkweekConfigsResponse
  ...
  item = item.to_json
  SquareApiClient::WorkweekConfig.from_json(json_object: item)
end
