...
#  where an image can be attached to catalog items at a later time.
  ...
  # @return [square.rb::CatalogObject] The new `CatalogObject` of the `IMAGE` type, namely, a `CatalogImage` object, to
...
#  integration
#  where an image can be attached to catalog items at a later time.
    # @param image [square.rb::CatalogObject] The new `CatalogObject` of the `IMAGE` type, namely, a `CatalogImage` object, to
#  encapsulate the specified image file.
...
#  Otherwise, the effective default value is `true`.
    ...
    # @return [square.rb::CreateCatalogImageRequest]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      square.rb::CatalogObject.validate_raw(obj: obj.image)
