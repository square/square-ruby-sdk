...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogPricingRule] Structured data for a `CatalogPricingRule`, set for CatalogObjects of type
#  `PRICING_RULE`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param pricing_rule_data [SquareApiClient::CatalogPricingRule] Structured data for a `CatalogPricingRule`, set for CatalogObjects of type
#  `PRICING_RULE`.
#  A `CatalogPricingRule` object often works with a `CatalogProductSet` object or a
#  `CatalogTimePeriod` object.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectPricingRule]
...
# Deserialize a JSON object to an instance of CatalogObjectPricingRule
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["pricing_rule_data"].nil?
        ...
        pricing_rule_data = SquareApiClient::CatalogPricingRule.from_json(json_object: pricing_rule_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.pricing_rule_data.nil? || SquareApiClient::CatalogPricingRule.validate_raw(obj: obj.pricing_rule_data)
