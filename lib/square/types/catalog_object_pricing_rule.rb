...
require_relative "catalog_pricing_rule"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
  class CatalogObjectPricingRule
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogPricingRule] Structured data for a `CatalogPricingRule`, set for CatalogObjects of type
#  `PRICING_RULE`.
#  A `CatalogPricingRule` object often works with a `CatalogProductSet` object or a
#  `CatalogTimePeriod` object.
    attr_reader :pricing_rule_data
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param pricing_rule_data [square.rb::CatalogPricingRule] Structured data for a `CatalogPricingRule`, set for CatalogObjects of type
#  `PRICING_RULE`.
#  A `CatalogPricingRule` object often works with a `CatalogProductSet` object or a
#  `CatalogTimePeriod` object.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectPricingRule]
    def initialize(type:, pricing_rule_data: OMIT, id:, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @type = type
      @pricing_rule_data = pricing_rule_data if pricing_rule_data != OMIT
      @id = id
...
# Deserialize a JSON object to an instance of CatalogObjectPricingRule
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["pricing_rule_data"].nil?
        pricing_rule_data = parsed_json["pricing_rule_data"].to_json
        pricing_rule_data = square.rb::CatalogPricingRule.from_json(json_object: pricing_rule_data)
      else
        pricing_rule_data = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of CatalogObjectPricingRule to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.pricing_rule_data.nil? || square.rb::CatalogPricingRule.validate_raw(obj: obj.pricing_rule_data)
