...
#  The number can support up to 5 digits after the decimal point.
  ...
  # @return [SquareApiClient::SourceApplication] Information about the application with which the
...
#  The number can support up to 5 digits after the decimal point.
    # @param source [SquareApiClient::SourceApplication] Information about the application with which the
#  physical count is submitted.
...
#  received.
    ...
    # @return [SquareApiClient::InventoryPhysicalCount]
