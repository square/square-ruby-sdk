...
#  updates a custom
#  attribute definition or when another application updates a custom attribute
#  definition whose `visibility` is
#  `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
  class CustomerCustomAttributeDefinitionVisibleUpdatedEvent
...
#  3339 format.
    ...
    # @return [square.rb::CustomerCustomAttributeDefinitionVisibleUpdatedEvent]
...
# Serialize an instance of CustomerCustomAttributeDefinitionVisibleUpdatedEvent to
#  a JSON object
    #
    # @return [String]
    def to_json
