...
#  endpoint call, Order Manager, or the Square Dashboard.
  ...
  # @return [square.rb::OrderUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::OrderUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::OrderUpdatedEvent]
...
# Deserialize a JSON object to an instance of OrderUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::OrderUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::OrderUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end