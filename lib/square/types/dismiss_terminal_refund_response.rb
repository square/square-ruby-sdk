...
module square.rb
  class DismissTerminalRefundResponse
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::TerminalRefund] Current state of the refund to be dismissed.
    attr_reader :refund
  ...
  # @return [Object] 
    ...
    # @param refund [square.rb::TerminalRefund] Current state of the refund to be dismissed.
...
# Deserialize a JSON object to an instance of DismissTerminalRefundResponse
    #
...
# Serialize an instance of DismissTerminalRefundResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
