...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::TerminalRefund] Current state of the refund to be dismissed.
    attr_reader :refund
  ...
  # @return [Object] 
    ...
    # @param refund [SquareApiClient::TerminalRefund] Current state of the refund to be dismissed.
