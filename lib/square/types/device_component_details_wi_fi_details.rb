...
#  is unsecured.
  ...
  # @return [SquareApiClient::DeviceComponentDetailsMeasurement] A representation of signal strength of the WIFI network connection.
...
#  connection
#  is unsecured.
    # @param signal_strength [SquareApiClient::DeviceComponentDetailsMeasurement] A representation of signal strength of the WIFI network connection.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DeviceComponentDetailsWiFiDetails]
...
# Deserialize a JSON object to an instance of DeviceComponentDetailsWiFiDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["signal_strength"].nil?
        ...
        signal_strength = SquareApiClient::DeviceComponentDetailsMeasurement.from_json(json_object: signal_strength)
      else
        signal_strength = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.signal_strength.nil? || SquareApiClient::DeviceComponentDetailsMeasurement.validate_raw(obj: obj.signal_strength)
    end
  end
end