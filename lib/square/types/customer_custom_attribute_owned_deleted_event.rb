...
#  application.
  class CustomerCustomAttributeOwnedDeletedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeOwnedDeletedEvent]
...
# Serialize an instance of CustomerCustomAttributeOwnedDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
