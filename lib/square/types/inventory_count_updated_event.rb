...
require_relative "inventory_count_updated_event_data"
require "ostruct"
require "json"
...
#  [CatalogItemVariation](entity:CatalogItemVariation).
  class InventoryCountUpdatedEvent
  ...
  # @return [SquareApiClient::InventoryCountUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::InventoryCountUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InventoryCountUpdatedEvent]
...
# Deserialize a JSON object to an instance of InventoryCountUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::InventoryCountUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of InventoryCountUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::InventoryCountUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end