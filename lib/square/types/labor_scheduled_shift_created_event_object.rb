...
module square.rb
  ...
  # @return [square.rb::ScheduledShift] The new `ScheduledShift`.
  ...
  # @return [Object] 
    ...
    # @param scheduled_shift [square.rb::ScheduledShift] The new `ScheduledShift`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborScheduledShiftCreatedEventObject]
