...
# Published when a [Timecard](entity:Timecard) is updated.
  ...
  # @return [square.rb::LaborTimecardUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::LaborTimecardUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::LaborTimecardUpdatedEvent]
...
# Deserialize a JSON object to an instance of LaborTimecardUpdatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::LaborTimecardUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::LaborTimecardUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end