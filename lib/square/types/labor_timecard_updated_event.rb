...
require_relative "labor_timecard_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [Timecard](entity:Timecard) is updated.
  class LaborTimecardUpdatedEvent
  # @return [String] The ID of the merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event. For this event, the value is `labor.timecard.updated`.
    attr_reader :type
  ...
  # @return [SquareApiClient::LaborTimecardUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this event, the value is `labor.timecard.updated`.
    ...
    # @param data [SquareApiClient::LaborTimecardUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborTimecardUpdatedEvent]
...
# Deserialize a JSON object to an instance of LaborTimecardUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborTimecardUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborTimecardUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborTimecardUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end