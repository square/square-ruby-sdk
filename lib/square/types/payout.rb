...
#  external bank account or to the Square balance.
  ...
  # @return [String] A unique ID for the payout.
    attr_reader :id
  # @return [SquareApiClient::PayoutStatus] Indicates the payout status.
...
#  seller's banking destination, in RFC 3339 format.
  ...
  # @return [SquareApiClient::Money] The amount of money involved in the payout. A positive amount indicates a
#  deposit, and a negative amount indicates a withdrawal. This amount is never
#  zero.
    attr_reader :amount_money
  # @return [SquareApiClient::Destination] Information about the banking destination (such as a bank account, Square
...
#  order.
    attr_reader :version
  # @return [SquareApiClient::PayoutType] Indicates the payout type.
#  See [PayoutType](#type-payouttype) for possible values
    attr_reader :type
  # @return [Array<SquareApiClient::PayoutFee>] A list of transfer fees and any taxes on the fees assessed by Square for this
#  payout.
...
#  payout with the corresponding line item on the bank statement.
  ...
  # @return [Object] 
    ...
    # @param status [SquareApiClient::PayoutStatus] Indicates the payout status.
#  See [PayoutStatus](#type-payoutstatus) for possible values
...
#  seller's banking destination, in RFC 3339 format.
    ...
    # @param amount_money [SquareApiClient::Money] The amount of money involved in the payout. A positive amount indicates a
#  deposit, and a negative amount indicates a withdrawal. This amount is never
#  zero.
    # @param destination [SquareApiClient::Destination] Information about the banking destination (such as a bank account, Square
#  checking account, or debit card)
#  against which the payout was made.
...
#  The version number helps developers receive event notifications or feeds out of
#  order.
    # @param type [SquareApiClient::PayoutType] Indicates the payout type.
#  See [PayoutType](#type-payouttype) for possible values
    # @param payout_fee [Array<SquareApiClient::PayoutFee>] A list of transfer fees and any taxes on the fees assessed by Square for this
#  payout.
...
# Deserialize a JSON object to an instance of Payout
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["destination"].nil?
        ...
        destination = SquareApiClient::Destination.from_json(json_object: destination)
      else
        destination = nil
      end
  ...
  item = item.to_json
  SquareApiClient::PayoutFee.from_json(json_object: item)
end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::PayoutStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.destination.nil? || SquareApiClient::Destination.validate_raw(obj: obj.destination)
      obj.version&.is_a?(Integer) != false || raise("Passed value for field obj.version is not the expected type, validation failed.")
      obj.type&.is_a?(SquareApiClient::PayoutType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
