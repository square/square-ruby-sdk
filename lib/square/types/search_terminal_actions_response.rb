...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::TerminalAction>] The requested search result of `TerminalAction`s.
    attr_reader :action
...
#  information.
  ...
  # @return [Object] 
    ...
    # @param action [Array<SquareApiClient::TerminalAction>] The requested search result of `TerminalAction`s.
...
# Deserialize a JSON object to an instance of SearchTerminalActionsResponse
  ...
  item = item.to_json
  SquareApiClient::TerminalAction.from_json(json_object: item)
end
