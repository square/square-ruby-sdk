...
module square.rb
  ...
  # @return [square.rb::DEVICE_ATTRIBUTES_DEVICE_TYPE] The device type.
...
#  (Could represent any field update on the device.)
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::DEVICE_ATTRIBUTES_DEVICE_TYPE] The device type.
#  See [DeviceType](#type-devicetype) for possible values
...
#  (Could represent any field update on the device.)
    ...
    # @return [square.rb::DeviceAttributes]
