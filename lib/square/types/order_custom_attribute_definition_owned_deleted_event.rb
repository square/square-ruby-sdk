...
#  app is deleted.
  class OrderCustomAttributeDefinitionOwnedDeletedEvent
...
#  `"order.custom_attribute_definition.owned.deleted"`.
    ...
    # @return [square.rb::OrderCustomAttributeDefinitionOwnedDeletedEvent]
...
# Serialize an instance of OrderCustomAttributeDefinitionOwnedDeletedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
