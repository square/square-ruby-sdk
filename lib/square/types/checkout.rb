...
#  Default: none; only exists if explicitly set.
  ...
  # @return [square.rb::Address] If provided, the buyer's shipping info is pre-populated on the
...
#  finalize the order through your existing/normal confirmation workflow.
  ...
  # @return [square.rb::Order] Order to be checked out.
    attr_reader :order
...
#  as an editable text field.
#  Default: none; only exists if explicitly set.
    # @param pre_populate_shipping_address [square.rb::Address] If provided, the buyer's shipping info is pre-populated on the
#  checkout page as editable text fields.
#  Default: none; only exists if explicitly set.
...
#  you provide a redirect URL so you can verify the transaction results and
#  finalize the order through your existing/normal confirmation workflow.
    # @param order [square.rb::Order] Order to be checked out.
...
# Deserialize a JSON object to an instance of Checkout
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["pre_populate_shipping_address"].nil?
        ...
        pre_populate_shipping_address = square.rb::Address.from_json(json_object: pre_populate_shipping_address)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.pre_populate_shipping_address.nil? || square.rb::Address.validate_raw(obj: obj.pre_populate_shipping_address)
