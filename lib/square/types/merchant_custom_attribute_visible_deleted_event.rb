...
#  merchant custom attribute.
  class MerchantCustomAttributeVisibleDeletedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::MerchantCustomAttributeVisibleDeletedEvent]
...
# Serialize an instance of MerchantCustomAttributeVisibleDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
