...
module square.rb
# Represents a
#  mAttributes](api-endpoint:LocationCustomAttributes-ListLocationCustomAttributes)
#  response.
...
#  `custom_attributes`.
  class ListLocationCustomAttributesResponse
...
# Deserialize a JSON object to an instance of ListLocationCustomAttributesResponse
    #
...
# Serialize an instance of ListLocationCustomAttributesResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
