...
#  the request resulted in errors.
  ...
  # @return [SquareApiClient::BreakType] The response object.
  ...
  # @return [Object] 
    ...
    # @param break_type [SquareApiClient::BreakType] The response object.
...
# Deserialize a JSON object to an instance of GetBreakTypeResponse
    #
...
# Serialize an instance of GetBreakTypeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
