...
#  control the amounts.
  ...
  # @return [square.rb::CatalogQuickAmountsSettingsOption] Represents the option seller currently uses on Quick Amounts.
...
#  `amounts`.
  ...
  # @return [Array<square.rb::CatalogQuickAmount>] Represents a set of Quick Amounts at this location.
    attr_reader :amounts
  ...
  # @return [Object] 
    ...
    # @param option [square.rb::CatalogQuickAmountsSettingsOption] Represents the option seller currently uses on Quick Amounts.
#  See [CatalogQuickAmountsSettingsOption](#type-catalogquickamountssettingsoption)
#  for possible values
    # @param eligible_for_auto_amounts [Boolean] Represents location's eligibility for auto amounts
#  The boolean should be consistent with whether there are AUTO amounts in the
#  `amounts`.
    # @param amounts [Array<square.rb::CatalogQuickAmount>] Represents a set of Quick Amounts at this location.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CatalogQuickAmountsSettings]
...
# Deserialize a JSON object to an instance of CatalogQuickAmountsSettings
  ...
  item = item.to_json
  square.rb::CatalogQuickAmount.from_json(json_object: item)
end
      new(
        option: option,
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.option.is_a?(square.rb::CatalogQuickAmountsSettingsOption) != false || raise("Passed value for field obj.option is not the expected type, validation failed.")
