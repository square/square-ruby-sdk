...
#  the application that created it.
  class LocationCustomAttributeDefinitionOwnedDeletedEvent
...
#  3339 format.
    ...
    # @return [square.rb::LocationCustomAttributeDefinitionOwnedDeletedEvent]
...
# Serialize an instance of LocationCustomAttributeDefinitionOwnedDeletedEvent to a
#  JSON object
    #
    # @return [String]
    def to_json
