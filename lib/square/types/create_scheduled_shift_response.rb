...
# Represents a [CreateScheduledShift](api-endpoint:Labor-CreateScheduledShift)
#  response.
#  Either `scheduled_shift` or `errors` is present in the response.
  class CreateScheduledShiftResponse
  # @return [SquareApiClient::ScheduledShift] The new scheduled shift. To make the shift public, call
...
#  [BulkPublishScheduledShifts](api-endpoint:Labor-BulkPublishScheduledShifts).
  ...
  # @return [Object] 
    ...
    # @param scheduled_shift [SquareApiClient::ScheduledShift] The new scheduled shift. To make the shift public, call
#  [PublishScheduledShift](api-endpoint:Labor-PublishScheduledShift) or
#  [BulkPublishScheduledShifts](api-endpoint:Labor-BulkPublishScheduledShifts).
...
# Deserialize a JSON object to an instance of CreateScheduledShiftResponse
    #
...
# Serialize an instance of CreateScheduledShiftResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
