...
#  provided.
  ...
  # @return [Array<square.rb::BusinessAppointmentSettingsBookingLocationType>] Types of the location allowed for bookings.
#  See
#  ttingsBookingLocationType](#type-businessappointmentsettingsbookinglocationtype)
#  for possible values
    attr_reader :location_types
  # @return [square.rb::BusinessAppointmentSettingsAlignmentTime] The time unit of the service duration for bookings.
#  See
...
#  booking.
  ...
  # @return [square.rb::BusinessAppointmentSettingsMaxAppointmentsPerDayLimitType] Indicates whether the daily appointment limit applies to team members or to
#  business locations.
#  See
...
#  appointment.
  ...
  # @return [square.rb::Money] The flat-fee amount charged for a no-show booking.
    attr_reader :cancellation_fee_money
  # @return [square.rb::BusinessAppointmentSettingsCancellationPolicy] The cancellation policy adopted by the seller.
#  See
...
#  s staff member of their choice (`false`).
  ...
  # @return [Object] 
    ...
    # @param location_types [Array<square.rb::BusinessAppointmentSettingsBookingLocationType>] Types of the location allowed for bookings.
#  See
#  ttingsBookingLocationType](#type-businessappointmentsettingsbookinglocationtype)
#  for possible values
    # @param alignment_time [square.rb::BusinessAppointmentSettingsAlignmentTime] The time unit of the service duration for bookings.
#  See
#  ppointmentSettingsAlignmentTime](#type-businessappointmentsettingsalignmenttime)
#  for possible values
...
#  booking.
    # @param max_appointments_per_day_limit_type [square.rb::BusinessAppointmentSettingsMaxAppointmentsPerDayLimitType] Indicates whether the daily appointment limit applies to team members or to
#  business locations.
#  See
#  erDayLimitType](#type-businessappointmentsettingsmaxappointmentsperdaylimittype)
#  for possible values
...
#  appointment.
    # @param cancellation_fee_money [square.rb::Money] The flat-fee amount charged for a no-show booking.
    # @param cancellation_policy [square.rb::BusinessAppointmentSettingsCancellationPolicy] The cancellation policy adopted by the seller.
#  See
#  SettingsCancellationPolicy](#type-businessappointmentsettingscancellationpolicy)
#  for possible values
...
#  s staff member of their choice (`false`).
    ...
    # @return [square.rb::BusinessAppointmentSettings]
...
# Deserialize a JSON object to an instance of BusinessAppointmentSettings
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["cancellation_fee_money"].nil?
        ...
        cancellation_fee_money = square.rb::Money.from_json(json_object: cancellation_fee_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.alignment_time&.is_a?(square.rb::BusinessAppointmentSettingsAlignmentTime) != false || raise("Passed value for field obj.alignment_time is not the expected type, validation failed.")
      ...
      obj.max_appointments_per_day_limit_type&.is_a?(square.rb::BusinessAppointmentSettingsMaxAppointmentsPerDayLimitType) != false || raise("Passed value for field obj.max_appointments_per_day_limit_type is not the expected type, validation failed.")
      ...
      obj.cancellation_fee_money.nil? || square.rb::Money.validate_raw(obj: obj.cancellation_fee_money)
      obj.cancellation_policy&.is_a?(square.rb::BusinessAppointmentSettingsCancellationPolicy) != false || raise("Passed value for field obj.cancellation_policy is not the expected type, validation failed.")
