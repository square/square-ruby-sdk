...
#  [SearchCustomers](api-endpoint:Customers-SearchCustomers) results.
  class CustomerSort
  # @return [square.rb::CustomerSortField] Indicates the fields to use as the sort key, which is either the default set of
#  fields or `created_at`.
#  The default value is `DEFAULT`.
#  See [CustomerSortField](#type-customersortfield) for possible values
    attr_reader :field
  # @return [square.rb::SortOrder] Indicates the order in which results should be sorted based on the
...
#  See [SortOrder](#type-sortorder) for possible values
  ...
  # @return [Object] 
    ...
    # @param field [square.rb::CustomerSortField] Indicates the fields to use as the sort key, which is either the default set of
#  fields or `created_at`.
#  The default value is `DEFAULT`.
#  See [CustomerSortField](#type-customersortfield) for possible values
    # @param order [square.rb::SortOrder] Indicates the order in which results should be sorted based on the
#  sort field value. Strings use standard alphabetic comparison
#  to determine order. Strings representing numbers are sorted as strings.
#  The default value is `ASC`.
#  See [SortOrder](#type-sortorder) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::CustomerSort]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.field&.is_a?(square.rb::CustomerSortField) != false || raise("Passed value for field obj.field is not the expected type, validation failed.")
