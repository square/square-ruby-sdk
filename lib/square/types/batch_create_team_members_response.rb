...
#  `TeamMember` objects or error messages.
  ...
  # @return [Hash{String => SquareApiClient::CreateTeamMemberResponse}] The successfully created `TeamMember` objects. Each key is the `idempotency_key`
#  that maps to the `CreateTeamMemberRequest`.
  ...
  # @return [Object] 
    ...
    # @param team_members [Hash{String => SquareApiClient::CreateTeamMemberResponse}] The successfully created `TeamMember` objects. Each key is the `idempotency_key`
#  that maps to the `CreateTeamMemberRequest`.
...
# Deserialize a JSON object to an instance of BatchCreateTeamMembersResponse
  ...
  value = value.to_json
  SquareApiClient::CreateTeamMemberResponse.from_json(json_object: value)
end
