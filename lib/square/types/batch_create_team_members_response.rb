...
#  `TeamMember` objects or error messages.
  class BatchCreateTeamMembersResponse
  # @return [Hash{String => square.rb::CreateTeamMemberResponse}] The successfully created `TeamMember` objects. Each key is the `idempotency_key`
#  that maps to the `CreateTeamMemberRequest`.
  ...
  # @return [Object] 
    ...
    # @param team_members [Hash{String => square.rb::CreateTeamMemberResponse}] The successfully created `TeamMember` objects. Each key is the `idempotency_key`
#  that maps to the `CreateTeamMemberRequest`.
...
# Deserialize a JSON object to an instance of BatchCreateTeamMembersResponse
    #
  ...
  value = value.to_json
  square.rb::CreateTeamMemberResponse.from_json(json_object: value)
end
...
# Serialize an instance of BatchCreateTeamMembersResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
