...
#  ://developer.squareup.com/docs/invoices-api/pay-refund-invoices#refund-invoice).
  ...
  # @return [square.rb::InvoiceRefundedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [square.rb::InvoiceRefundedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::InvoiceRefundedEvent]
...
# Deserialize a JSON object to an instance of InvoiceRefundedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = square.rb::InvoiceRefundedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || square.rb::InvoiceRefundedEventData.validate_raw(obj: obj.data)
    end
  end
end