...
require_relative "invoice_refunded_event_data"
require "ostruct"
require "json"
...
#  ://developer.squareup.com/docs/invoices-api/pay-refund-invoices#refund-invoice).
  class InvoiceRefundedEvent
  # @return [String] The ID of the target merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event this represents, `"invoice.refunded"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::InvoiceRefundedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"invoice.refunded"`.
    ...
    # @param data [SquareApiClient::InvoiceRefundedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoiceRefundedEvent]
...
# Deserialize a JSON object to an instance of InvoiceRefundedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::InvoiceRefundedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of InvoiceRefundedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::InvoiceRefundedEventData.validate_raw(obj: obj.data)
    end
  end
end