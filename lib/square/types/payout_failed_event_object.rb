...
module SquareApiClient
  ...
  # @return [SquareApiClient::Payout] The payout that failed.
    attr_reader :payout
  ...
  # @return [Object] 
    ...
    # @param payout [SquareApiClient::Payout] The payout that failed.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PayoutFailedEventObject]
