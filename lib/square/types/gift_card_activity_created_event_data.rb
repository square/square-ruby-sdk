...
#  `gift_card_activity`.
  ...
  # @return [String] The ID of the new gift card activity.
    attr_reader :id
  # @return [square.rb::GiftCardActivityCreatedEventObject] An object that contains the new gift card activity.
    attr_reader :object
...
#  `gift_card_activity`.
    ...
    # @param object [square.rb::GiftCardActivityCreatedEventObject] An object that contains the new gift card activity.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::GiftCardActivityCreatedEventData]
...
# Deserialize a JSON object to an instance of GiftCardActivityCreatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = square.rb::GiftCardActivityCreatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || square.rb::GiftCardActivityCreatedEventObject.validate_raw(obj: obj.object)
    end
  end
end