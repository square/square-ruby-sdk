...
require_relative "catalog_category"
require_relative "catalog_v_1_id"
require "ostruct"
require "json"

module square.rb
# A category that can be assigned to an item or a parent category that can be
#  assigned
...
#  be made as the parent category to the pants category.
  ...
  # @return [String] The ID of the object's category.
    attr_reader :id
  # @return [Long] The order of the object within the context of the category.
    attr_reader :ordinal
  # @return [String] 
    attr_reader :type
  # @return [square.rb::CatalogCategory] Structured data for a `CatalogCategory`, set for CatalogObjects of type
#  `CATEGORY`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param id [String] The ID of the object's category.
    # @param ordinal [Long] The order of the object within the context of the category.
    # @param type [String] 
    # @param category_data [square.rb::CatalogCategory] Structured data for a `CatalogCategory`, set for CatalogObjects of type
#  `CATEGORY`.
...
#  This can include locations that are deactivated.
    ...
    # @return [square.rb::CatalogObjectCategory]
    def initialize(id: OMIT, ordinal: OMIT, type:, category_data: OMIT, updated_at: OMIT, version: OMIT, is_deleted: OMIT, custom_attribute_values: OMIT, catalog_v_1_ids: OMIT, present_at_all_locations: OMIT, present_at_location_ids: OMIT, absent_at_location_ids: OMIT, image_id: OMIT, additional_properties: nil)
      @id = id if id != OMIT
...
# Deserialize a JSON object to an instance of CatalogObjectCategory
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["category_data"].nil?
        ...
        category_data = square.rb::CatalogCategory.from_json(json_object: category_data)
      else
        category_data = nil
      end
...
# Serialize an instance of CatalogObjectCategory to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.category_data.nil? || square.rb::CatalogCategory.validate_raw(obj: obj.category_data)
