...
#  be made as the parent category to the pants category.
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogCategory] Structured data for a `CatalogCategory`, set for CatalogObjects of type
#  `CATEGORY`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param category_data [SquareApiClient::CatalogCategory] Structured data for a `CatalogCategory`, set for CatalogObjects of type
#  `CATEGORY`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectCategory]
...
# Deserialize a JSON object to an instance of CatalogObjectCategory
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["category_data"].nil?
        ...
        category_data = SquareApiClient::CatalogCategory.from_json(json_object: category_data)
      else
        category_data = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.category_data.nil? || SquareApiClient::CatalogCategory.validate_raw(obj: obj.category_data)
