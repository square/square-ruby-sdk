...
module square.rb
  class CreateTerminalActionResponse
  # @return [Array<square.rb::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [square.rb::TerminalAction] The created `TerminalAction`
    attr_reader :action
  ...
  # @return [Object] 
    ...
    # @param action [square.rb::TerminalAction] The created `TerminalAction`
...
# Deserialize a JSON object to an instance of CreateTerminalActionResponse
    #
...
# Serialize an instance of CreateTerminalActionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
