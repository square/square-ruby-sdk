...
module square.rb
  ...
  # @return [Array<square.rb::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [square.rb::CatalogObject] The newly updated `CatalogImage` including a Square-generated
#  URL for the encapsulated image file.
  ...
  # @return [Object] 
    ...
    # @param image [square.rb::CatalogObject] The newly updated `CatalogImage` including a Square-generated
#  URL for the encapsulated image file.
