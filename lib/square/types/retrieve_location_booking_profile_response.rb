...
module square.rb
  ...
  # @return [square.rb::LocationBookingProfile] The requested location booking profile.
  ...
  # @return [Object] 
    ...
    # @param location_booking_profile [square.rb::LocationBookingProfile] The requested location booking profile.
...
#  RetrieveLocationBookingProfileResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["location_booking_profile"].nil?
        ...
        location_booking_profile = square.rb::LocationBookingProfile.from_json(json_object: location_booking_profile)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.location_booking_profile.nil? || square.rb::LocationBookingProfile.validate_raw(obj: obj.location_booking_profile)
