...
#  `loyalty.program.created` event.
  ...
  # @return [SquareApiClient::LoyaltyProgram] The loyalty program that was created.
  ...
  # @return [Object] 
    ...
    # @param loyalty_program [SquareApiClient::LoyaltyProgram] The loyalty program that was created.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyProgramCreatedEventObject]
