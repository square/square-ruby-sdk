...
#  The brand can be `AFTERPAY`, `CLEARPAY` or `UNKNOWN`.
    attr_reader :brand
  # @return [square.rb::AfterpayDetails] Details about an Afterpay payment. These details are only populated if the
#  `brand` is
#  `AFTERPAY`.
    attr_reader :afterpay_details
  # @return [square.rb::ClearpayDetails] Details about a Clearpay payment. These details are only populated if the
#  `brand` is
#  `CLEARPAY`.
...
#  The brand can be `AFTERPAY`, `CLEARPAY` or `UNKNOWN`.
    # @param afterpay_details [square.rb::AfterpayDetails] Details about an Afterpay payment. These details are only populated if the
#  `brand` is
#  `AFTERPAY`.
    # @param clearpay_details [square.rb::ClearpayDetails] Details about a Clearpay payment. These details are only populated if the
#  `brand` is
#  `CLEARPAY`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::BuyNowPayLaterDetails]
...
# Deserialize a JSON object to an instance of BuyNowPayLaterDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["afterpay_details"].nil?
        ...
        afterpay_details = square.rb::AfterpayDetails.from_json(json_object: afterpay_details)
      else
        afterpay_details = nil
      end
      unless parsed_json["clearpay_details"].nil?
        clearpay_details = parsed_json["clearpay_details"].to_json
        clearpay_details = square.rb::ClearpayDetails.from_json(json_object: clearpay_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.afterpay_details.nil? || square.rb::AfterpayDetails.validate_raw(obj: obj.afterpay_details)
      obj.clearpay_details.nil? || square.rb::ClearpayDetails.validate_raw(obj: obj.clearpay_details)
    end
  end
end