...
#  information.
  ...
  # @return [square.rb::Vendor] The specified [Vendor](entity:Vendor) to be updated.
    attr_reader :vendor
...
#  for more
#  information.
    # @param vendor [square.rb::Vendor] The specified [Vendor](entity:Vendor) to be updated.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::UpdateVendorRequest]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      square.rb::Vendor.validate_raw(obj: obj.vendor)
    end
  end
end