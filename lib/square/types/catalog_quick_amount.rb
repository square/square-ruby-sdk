...
# Represents a Quick Amount in the Catalog.
  ...
  # @return [square.rb::CatalogQuickAmountType] Represents the type of the Quick Amount.
#  See [CatalogQuickAmountType](#type-catalogquickamounttype) for possible values
    attr_reader :type
  # @return [square.rb::Money] Represents the actual amount of the Quick Amount with Money type.
    attr_reader :amount
...
#  MANUAL type amount will always have score = 100.
  ...
  # @return [Object] 
    ...
    # @param type [square.rb::CatalogQuickAmountType] Represents the type of the Quick Amount.
#  See [CatalogQuickAmountType](#type-catalogquickamounttype) for possible values
    # @param amount [square.rb::Money] Represents the actual amount of the Quick Amount with Money type.
...
#  MANUAL type amount will always have score = 100.
    ...
    # @return [square.rb::CatalogQuickAmount]
...
# Deserialize a JSON object to an instance of CatalogQuickAmount
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["amount"].nil?
        ...
        amount = square.rb::Money.from_json(json_object: amount)
      else
        amount = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type.is_a?(square.rb::CatalogQuickAmountType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      square.rb::Money.validate_raw(obj: obj.amount)
