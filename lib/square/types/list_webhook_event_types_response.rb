...
#  present.
  ...
  # @return [Array<square.rb::EventTypeMetadata>] Contains the metadata of a webhook event type. For more information, see
#  [EventTypeMetadata](entity:EventTypeMetadata).
  ...
  # @return [Object] 
    ...
    # @param metadata [Array<square.rb::EventTypeMetadata>] Contains the metadata of a webhook event type. For more information, see
#  [EventTypeMetadata](entity:EventTypeMetadata).
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [square.rb::ListWebhookEventTypesResponse]
