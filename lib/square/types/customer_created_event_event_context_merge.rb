...
module Square
    module Types
        ...
        class CustomerCreatedEventEventContextMerge < Square::Internal::Types::Model
            field :from_customer_ids, Square::Internal::Types::Array[String], optional: true, nullable: false
