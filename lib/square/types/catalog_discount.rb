...
#  filters, and its value length is of Unicode code points.
    attr_reader :name
  # @return [SquareApiClient::CatalogDiscountType] Indicates whether the discount is a fixed amount or percentage, or entered at
#  the time of sale.
...
#  Do not use this field for amount-based or variable discounts.
  ...
  # @return [SquareApiClient::Money] The amount of the discount. Specify an amount of `0` if `discount_type` is
#  `VARIABLE_AMOUNT`.
...
#  must be a valid hex color code.
  ...
  # @return [SquareApiClient::CatalogDiscountModifyTaxBasis] Indicates whether this discount should reduce the price used to calculate tax.
...
#  possible values
  ...
  # @return [SquareApiClient::Money] For a percentage discount, the maximum absolute value of the discount. For
#  example, if a
...
#  filters, and its value length is of Unicode code points.
    # @param discount_type [SquareApiClient::CatalogDiscountType] Indicates whether the discount is a fixed amount or percentage, or entered at
#  the time of sale.
#  See [CatalogDiscountType](#type-catalogdiscounttype) for possible values
...
#  is `VARIABLE_PERCENTAGE`.
#  Do not use this field for amount-based or variable discounts.
    # @param amount_money [SquareApiClient::Money] The amount of the discount. Specify an amount of `0` if `discount_type` is
#  `VARIABLE_AMOUNT`.
#  Do not use this field for percentage-based or variable discounts.
...
#  must be a valid hex color code.
    # @param modify_tax_basis [SquareApiClient::CatalogDiscountModifyTaxBasis] Indicates whether this discount should reduce the price used to calculate tax.
#  Most discounts should use `MODIFY_TAX_BASIS`. However, in some circumstances
#  taxes must
#  be calculated based on an item's price, ignoring a particular discount. For
#  example,
...
#  See [CatalogDiscountModifyTaxBasis](#type-catalogdiscountmodifytaxbasis) for
#  possible values
    # @param maximum_amount_money [SquareApiClient::Money] For a percentage discount, the maximum absolute value of the discount. For
#  example, if a
#  50% discount has a `maximum_amount_money` of $20, a $100 purchase will yield a
#  $20 discount,
#  not a $50 discount.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogDiscount]
...
# Deserialize a JSON object to an instance of CatalogDiscount
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["maximum_amount_money"].nil?
        ...
        maximum_amount_money = SquareApiClient::Money.from_json(json_object: maximum_amount_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.discount_type&.is_a?(SquareApiClient::CatalogDiscountType) != false || raise("Passed value for field obj.discount_type is not the expected type, validation failed.")
      ...
      obj.modify_tax_basis&.is_a?(SquareApiClient::CatalogDiscountModifyTaxBasis) != false || raise("Passed value for field obj.modify_tax_basis is not the expected type, validation failed.")
      obj.maximum_amount_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.maximum_amount_money)
    end
  end
end