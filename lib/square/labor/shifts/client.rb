...
#  the `Shift.end_at`, or both.
      ...
      # @param shift [Hash] The `Shift` to be created.Request of type SquareApiClient::Shift, as a Hash
      #   * :id (String) 
      #   * :employee_id (String) 
      #   * :location_id (String) 
      #   * :timezone (String) 
      ...
      #   * :status (SquareApiClient::ShiftStatus) 
      #   * :version (Integer) 
      #   * :created_at (String) 
      #   * :updated_at (String) 
      ...
      # @return [SquareApiClient::CreateShiftResponse]
      # @example
...
#  api.labor.shifts.create(idempotency_key: "HIDSNG5KS478L", shift: { location_id: "PAA1RJZZKXBFG", start_at: "2019-01-25T03:11:00-05:00", end_at: "2019-01-25T13:11:00-05:00", wage: { title: "Barista", hourly_rate: { amount: 1100, currency: USD }, tip_eligible: true }, breaks: [{ start_at: "2019-01-25T06:11:00-05:00", end_at: "2019-01-25T06:16:00-05:00", break_type_id: "REGS1EQR1TPZ5", name: "Tea Break", expected_duration: "PT5M", is_paid: true }], team_member_id: "ormj0jJJZ5OZIzxrZYJI", declared_cash_tip_money: { amount: 500, currency: USD } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/shifts"
        ...
        SquareApiClient::CreateShiftResponse.from_json(json_object: response.body)
      end
...
#  - `UPDATED_AT`
      #
      # @param query [Hash] Query filters.Request of type SquareApiClient::ShiftQuery, as a Hash
      #   * :filter (Hash)
      #     * :location_ids (Array<String>) 
      #     * :employee_ids (Array<String>) 
      #     * :status (SquareApiClient::ShiftFilterStatus) 
      #     * :start (Hash)
      #       * :start_at (String) 
      #       * :end_at (String) 
      #     * :end_ (Hash)
      ...
      #         * :start_date (String) 
      #         * :end_date (String) 
      #       * :match_shifts_by (SquareApiClient::ShiftWorkdayMatcher) 
      #       * :default_timezone (String) 
      #     * :team_member_ids (Array<String>) 
      #   * :sort (Hash)
      #     * :field (SquareApiClient::ShiftSortField) 
...
#  api.labor.shifts.search(query: { filter: { workday: { date_range: { start_date: "2019-01-20", end_date: "2019-02-03" }, match_shifts_by: START_AT, default_timezone: "America/Los_Angeles" } } }, limit: 100)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/shifts/search"
        ...
        SquareApiClient::SearchShiftsResponse.from_json(json_object: response.body)
      end
# Returns a single `Shift` specified by `id`.
      #
      # @param id [String] The UUID for the `Shift` being retrieved.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetShiftResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.labor.shifts.get(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/shifts/#{id}"
        ...
        SquareApiClient::GetShiftResponse.from_json(json_object: response.body)
      end
...
#  set on each `Break`.
      ...
      # @param shift [Hash] The updated `Shift` object.Request of type SquareApiClient::Shift, as a Hash
      #   * :id (String) 
      #   * :employee_id (String) 
      #   * :location_id (String) 
      #   * :timezone (String) 
      ...
      #     * :currency (SquareApiClient::Currency) 
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpdateShiftResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.labor.shifts.update(id: "id", shift: { location_id: "PAA1RJZZKXBFG", start_at: "2019-01-25T03:11:00-05:00", end_at: "2019-01-25T13:11:00-05:00", wage: { title: "Bartender", hourly_rate: { amount: 1500, currency: USD }, tip_eligible: true }, breaks: [{ id: "X7GAQYVVRRG6P", start_at: "2019-01-25T06:11:00-05:00", end_at: "2019-01-25T06:16:00-05:00", break_type_id: "REGS1EQR1TPZ5", name: "Tea Break", expected_duration: "PT5M", is_paid: true }], version: 1, team_member_id: "ormj0jJJZ5OZIzxrZYJI", declared_cash_tip_money: { amount: 500, currency: USD } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/shifts/#{id}"
        ...
        SquareApiClient::UpdateShiftResponse.from_json(json_object: response.body)
      end
# Deletes a `Shift`.
      #
      # @param id [String] The UUID for the `Shift` being deleted.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteShiftResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.labor.shifts.delete(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/shifts/#{id}"
        ...
        SquareApiClient::DeleteShiftResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Labor::AsyncShiftsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Creates a new `Shift`.
