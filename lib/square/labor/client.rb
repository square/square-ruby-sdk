...
module square.rb
  ...
  # @return [square.rb::Labor::WorkweekConfigsClient] 
    ...
    def initialize(request_client:)
      ...
      @break_types = square.rb::Labor::BreakTypesClient.new(request_client: request_client)
      @employee_wages = square.rb::Labor::EmployeeWagesClient.new(request_client: request_client)
      @shifts = square.rb::Labor::ShiftsClient.new(request_client: request_client)
      @team_member_wages = square.rb::Labor::TeamMemberWagesClient.new(request_client: request_client)
      @workweek_configs = square.rb::Labor::WorkweekConfigsClient.new(request_client: request_client)
    end
...
#  2024-10-31T12:30:00-08:00Request of type square.rb::ScheduledShift, as a Hash
    #   * :id (String) 
    ...
    # @return [square.rb::CreateScheduledShiftResponse]
    # @example
...
#  api.labor.create_scheduled_shift(idempotency_key: "HIDSNG5KS478L", scheduled_shift: { draft_shift_details: { team_member_id: "ormj0jJJZ5OZIzxrZYJI", location_id: "PAA1RJZZKXBFG", job_id: "FzbJAtt9qEWncK1BWgVCxQ6M", start_at: "2019-01-25T03:11:00-05:00", end_at: "2019-01-25T13:11:00-05:00", notes: "Dont forget to prep the vegetables", is_deleted: false } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/scheduled-shifts"
      ...
      square.rb::CreateScheduledShiftResponse.from_json(json_object: response.body)
    end
...
#  `BulkPublishScheduledShifts` request must fall within a two-week period.
    #
    # @param scheduled_shifts [Hash{String => square.rb::BulkPublishScheduledShiftsData}] A map of 1 to 100 key-value pairs that represent individual publish requests.
...
#  `version` field or is an empty object.
    # @param scheduled_shift_notification_audience [square.rb::ScheduledShiftNotificationAudience] Indicates whether Square should send email notifications to team members and
...
#  for possible values
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::BulkPublishScheduledShiftsResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.labor.bulk_publish_scheduled_shifts(scheduled_shifts: { "key": {  } }, scheduled_shift_notification_audience: AFFECTED)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/scheduled-shifts/bulk-publish"
      ...
      square.rb::BulkPublishScheduledShiftsResponse.from_json(json_object: response.body)
    end
...
#  By default, results are sorted by `start_at` in ascending order.
    #
    # @param query [Hash] Query conditions used to filter and sort the results.Request of type square.rb::ScheduledShiftQuery, as a Hash
    #   * :filter (Hash)
    ...
    #         * :start_date (String) 
    #         * :end_date (String) 
    #       * :match_scheduled_shifts_by (square.rb::ScheduledShiftWorkdayMatcher) 
    #       * :default_timezone (String) 
    #     * :team_member_ids (Array<String>) 
    #     * :assignment_status (square.rb::ScheduledShiftFilterAssignmentStatus) 
    #     * :scheduled_shift_statuses (Array<square.rb::ScheduledShiftFilterScheduledShiftStatus>) 
    #   * :sort (Hash)
    #     * :field (square.rb::ScheduledShiftSortField) 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/scheduled-shifts/search"
      ...
      square.rb::SearchScheduledShiftsResponse.from_json(json_object: response.body)
    end
...
#  api.labor.retrieve_scheduled_shift(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/scheduled-shifts/#{id}"
      ...
      square.rb::RetrieveScheduledShiftResponse.from_json(json_object: response.body)
    end
...
#  another publish request.Request of type square.rb::ScheduledShift, as a Hash
    #   * :id (String) 
    #   * :draft_shift_details (Hash)
    #     * :team_member_id (String) 
    #     * :location_id (String) 
    ...
    #   * :updated_at (String) 
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::UpdateScheduledShiftResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.labor.update_scheduled_shift(id: "id", scheduled_shift: { draft_shift_details: { team_member_id: "ormj0jJJZ5OZIzxrZYJI", location_id: "PAA1RJZZKXBFG", job_id: "FzbJAtt9qEWncK1BWgVCxQ6M", start_at: "2019-03-25T03:11:00-05:00", end_at: "2019-03-25T13:18:00-05:00", notes: "Dont forget to prep the vegetables", is_deleted: false }, version: 1 })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/scheduled-shifts/#{id}"
      ...
      square.rb::UpdateScheduledShiftResponse.from_json(json_object: response.body)
    end
...
#  another publish request.
    # @param scheduled_shift_notification_audience [square.rb::ScheduledShiftNotificationAudience] Indicates whether Square should send an email notification to team members and
...
#  for possible values
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::PublishScheduledShiftResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/scheduled-shifts/#{id}/publish"
      ...
      square.rb::PublishScheduledShiftResponse.from_json(json_object: response.body)
    end
...
#  the `Timecard.end_at`, or both.
    ...
    # @param timecard [Hash] The `Timecard` to be created.Request of type square.rb::Timecard, as a Hash
    #   * :id (String) 
    #   * :location_id (String) 
    #   * :timezone (String) 
    #   * :start_at (String) 
    ...
    #   * :status (square.rb::TimecardStatus) 
    #   * :version (Integer) 
    #   * :created_at (String) 
    #   * :updated_at (String) 
    #   * :team_member_id (String) 
...
#  api.labor.create_timecard(idempotency_key: "HIDSNG5KS478L", timecard: { location_id: "PAA1RJZZKXBFG", start_at: "2019-01-25T03:11:00-05:00", end_at: "2019-01-25T13:11:00-05:00", wage: { title: "Barista", hourly_rate: { amount: 1100, currency: USD }, tip_eligible: true }, breaks: [{ start_at: "2019-01-25T06:11:00-05:00", end_at: "2019-01-25T06:16:00-05:00", break_type_id: "REGS1EQR1TPZ5", name: "Tea Break", expected_duration: "PT5M", is_paid: true }], team_member_id: "ormj0jJJZ5OZIzxrZYJI", declared_cash_tip_money: { amount: 500, currency: USD } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/timecards"
      ...
      square.rb::CreateTimecardResponse.from_json(json_object: response.body)
    end
...
#  - `UPDATED_AT`
    #
    # @param query [Hash] Query filters.Request of type square.rb::TimecardQuery, as a Hash
    #   * :filter (Hash)
    #     * :location_ids (Array<String>) 
    #     * :status (square.rb::TimecardFilterStatus) 
    #     * :start (Hash)
    #       * :start_at (String) 
    #       * :end_at (String) 
    #     * :end_ (Hash)
    ...
    #         * :start_date (String) 
    #         * :end_date (String) 
    #       * :match_timecards_by (square.rb::TimecardWorkdayMatcher) 
    #       * :default_timezone (String) 
    #     * :team_member_ids (Array<String>) 
    #   * :sort (Hash)
    #     * :field (square.rb::TimecardSortField) 
    #     * :order (square.rb::SortOrder) 
    ...
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::SearchTimecardsResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.labor.search_timecards(query: { filter: { workday: { date_range: { start_date: "2019-01-20", end_date: "2019-02-03" }, match_timecards_by: START_AT, default_timezone: "America/Los_Angeles" } } }, limit: 100)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/timecards/search"
      ...
      square.rb::SearchTimecardsResponse.from_json(json_object: response.body)
    end
# Returns a single `Timecard` specified by `id`.
    #
    # @param id [String] The UUID for the `Timecard` being retrieved.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::RetrieveTimecardResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.labor.retrieve_timecard(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/timecards/#{id}"
      ...
      square.rb::RetrieveTimecardResponse.from_json(json_object: response.body)
    end
...
#  set on each `Break`.
    ...
    # @param timecard [Hash] The updated `Timecard` object.Request of type square.rb::Timecard, as a Hash
    #   * :id (String) 
    #   * :location_id (String) 
    #   * :timezone (String) 
    #   * :start_at (String) 
    ...
    #     * :currency (square.rb::Currency) 
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::UpdateTimecardResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.labor.update_timecard(id: "id", timecard: { location_id: "PAA1RJZZKXBFG", start_at: "2019-01-25T03:11:00-05:00", end_at: "2019-01-25T13:11:00-05:00", wage: { title: "Bartender", hourly_rate: { amount: 1500, currency: USD }, tip_eligible: true }, breaks: [{ id: "X7GAQYVVRRG6P", start_at: "2019-01-25T06:11:00-05:00", end_at: "2019-01-25T06:16:00-05:00", break_type_id: "REGS1EQR1TPZ5", name: "Tea Break", expected_duration: "PT5M", is_paid: true }], status: CLOSED, version: 1, team_member_id: "ormj0jJJZ5OZIzxrZYJI", declared_cash_tip_money: { amount: 500, currency: USD } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/timecards/#{id}"
      ...
      square.rb::UpdateTimecardResponse.from_json(json_object: response.body)
    end
# Deletes a `Timecard`.
    #
    # @param id [String] The UUID for the `Timecard` being deleted.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::DeleteTimecardResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.labor.delete_timecard(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/timecards/#{id}"
      ...
      square.rb::DeleteTimecardResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [square.rb::Labor::WorkweekConfigsClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @break_types = square.rb::Labor::AsyncBreakTypesClient.new(request_client: request_client)
      @employee_wages = square.rb::Labor::AsyncEmployeeWagesClient.new(request_client: request_client)
      @shifts = square.rb::Labor::AsyncShiftsClient.new(request_client: request_client)
      @team_member_wages = square.rb::Labor::AsyncTeamMemberWagesClient.new(request_client: request_client)
      @workweek_configs = square.rb::Labor::AsyncWorkweekConfigsClient.new(request_client: request_client)
    end
# Creates a scheduled shift by providing draft shift details such as job ID,
#  team member assignment, and start and end times.
#  The following `draft_shift_details` fields are required:
