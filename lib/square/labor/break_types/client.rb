...
#  and 200. The default is 200.
      ...
      # @return [SquareApiClient::ListBreakTypesResponse]
      # @example
...
#  api.labor.break_types.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/break-types"
        ...
        SquareApiClient::ListBreakTypesResponse.from_json(json_object: response.body)
      end
...
#  is returned.
      ...
      # @param break_type [Hash] The `BreakType` to be created.Request of type SquareApiClient::BreakType, as a Hash
      #   * :id (String) 
      #   * :location_id (String) 
      #   * :break_name (String) 
      ...
      #   * :updated_at (String) 
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CreateBreakTypeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.labor.break_types.create(idempotency_key: "PAD3NG5KSN2GL", break_type: { location_id: "CGJN03P1D08GF", break_name: "Lunch Break", expected_duration: "PT30M", is_paid: true })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/break-types"
        ...
        SquareApiClient::CreateBreakTypeResponse.from_json(json_object: response.body)
      end
# Returns a single `BreakType` specified by `id`.
      #
      # @param id [String] The UUID for the `BreakType` being retrieved.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetBreakTypeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.labor.break_types.get(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/break-types/#{id}"
        ...
        SquareApiClient::GetBreakTypeResponse.from_json(json_object: response.body)
      end
# Updates an existing `BreakType`.
      #
      # @param id [String] The UUID for the `BreakType` being updated.
      # @param break_type [Hash] The updated `BreakType`.Request of type SquareApiClient::BreakType, as a Hash
      #   * :id (String) 
      #   * :location_id (String) 
      #   * :break_name (String) 
      #   * :expected_duration (String) 
      ...
      #   * :updated_at (String) 
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpdateBreakTypeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.labor.break_types.update(id: "id", break_type: { location_id: "26M7H24AZ9N6R", break_name: "Lunch", expected_duration: "PT50M", is_paid: true, version: 1 })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/break-types/#{id}"
        ...
        SquareApiClient::UpdateBreakTypeResponse.from_json(json_object: response.body)
      end
...
#  A `BreakType` can be deleted even if it is referenced from a `Shift`.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteBreakTypeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.labor.break_types.delete(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/break-types/#{id}"
        ...
        SquareApiClient::DeleteBreakTypeResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Labor::AsyncBreakTypesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Returns a paginated list of `BreakType` instances for a business.
