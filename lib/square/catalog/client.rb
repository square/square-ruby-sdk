...
module square.rb
  ...
  # @return [square.rb::Catalog::ObjectClient] 
    ...
    def initialize(request_client:)
      ...
      @images = square.rb::Catalog::ImagesClient.new(request_client: request_client)
      @object = square.rb::Catalog::ObjectClient.new(request_client: request_client)
    end
...
#  CatalogItem will delete its CatalogItemVariation.
    ...
    # @return [square.rb::BatchDeleteCatalogObjectsResponse]
    # @example
...
#  api.catalog.batch_delete(object_ids: ["W62UWFY35CWMYGVWK6TWJDNI", "AA27W3M2GGTF3H6AVPNB77CK"])
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/batch-delete"
      ...
      square.rb::BatchDeleteCatalogObjectsResponse.from_json(json_object: response.body)
    end
...
#  api.catalog.batch_get(object_ids: ["W62UWFY35CWMYGVWK6TWJDNI", "AA27W3M2GGTF3H6AVPNB77CK"], include_related_objects: true)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/batch-retrieve"
      ...
      square.rb::BatchGetCatalogObjectsResponse.from_json(json_object: response.body)
    end
...
#  be inserted or updated.Request of type Array<square.rb::CatalogObjectBatch>, as a Hash
    #   * :objects (Array<square.rb::CatalogObject>) 
    # @param request_options [square.rb::RequestOptions] 
...
#  api.catalog.batch_upsert(idempotency_key: "789ff020-f723-43a9-b4b5-43b5dc1fa3dc", batches: [{ objects: [{ type: "IMAGE", id: "#Tea", present_at_all_locations: true }, { type: "IMAGE", id: "#Coffee", present_at_all_locations: true }, { type: "ITEM", id: "#Beverages", present_at_all_locations: true }, { type: "TAX", id: "#SalesTax", present_at_all_locations: true, tax_data: { name: "Sales Tax", calculation_phase: TAX_SUBTOTAL_PHASE, inclusion_type: ADDITIVE, percentage: "5.0", applies_to_custom_amounts: true, enabled: true } }] }])
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/batch-upsert"
      ...
      square.rb::BatchUpsertCatalogObjectsResponse.from_json(json_object: response.body)
    end
...
#  api.catalog.info
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/info"
      ...
      square.rb::CatalogInfoResponse.from_json(json_object: response.body)
    end
...
#  api.catalog.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/list"
      ...
      square.rb::ListCatalogResponse.from_json(json_object: response.body)
    end
...
#  https://developer.squareup.com/docs/build-basics/common-api-patterns/pagination)
#  for more information.
    # @param object_types [Array<square.rb::CatalogObjectType>] The desired set of object types to appear in the search results.
#  If this is unspecified, the operation returns objects of all the top level types
#  at the version
#  of the Square API used to make the request. Object types that are nested onto
#  other object types
...
#  entire catalog will be returned.Request of type square.rb::CatalogQuery, as a Hash
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/search"
      ...
      square.rb::SearchCatalogObjectsResponse.from_json(json_object: response.body)
    end
...
#  category IDs.
    # @param stock_levels [Array<square.rb::SearchCatalogItemsRequestStockLevel>] The stock-level query expression to return item variations with the specified
#  stock levels.
#  See
...
#  batch of pending results.
    ...
    # @param sort_order [square.rb::SortOrder] The order to sort the results by item names. The default sort order is ascending
#  (`ASC`).
#  See [SortOrder](#type-sortorder) for possible values
    # @param product_types [Array<square.rb::CatalogItemProductType>] The product types query expression to return items or item variations having the
...
#  [SearchCatalogItems](api-endpoint:Catalog-SearchCatalogItems) endpoint.Request of type Array<square.rb::CustomAttributeFilter>, as a Hash
    ...
    #   * :bool_filter (Boolean) 
    # @param archived_state [square.rb::ArchivedState] The query filter to return not archived (`ARCHIVED_STATE_NOT_ARCHIVED`),
#  archived (`ARCHIVED_STATE_ARCHIVED`), or either type (`ARCHIVED_STATE_ALL`) of
#  items.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::SearchCatalogItemsResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/search-catalog-items"
      ...
      square.rb::SearchCatalogItemsResponse.from_json(json_object: response.body)
    end
...
#  be specified.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::UpdateItemModifierListsResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/update-item-modifier-lists"
      ...
      square.rb::UpdateItemModifierListsResponse.from_json(json_object: response.body)
    end
...
#  At least one of `taxes_to_enable` or `taxes_to_disable` must be specified.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::UpdateItemTaxesResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/update-item-taxes"
      ...
      square.rb::UpdateItemTaxesResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [square.rb::Catalog::ObjectClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @images = square.rb::Catalog::AsyncImagesClient.new(request_client: request_client)
      @object = square.rb::Catalog::AsyncObjectClient.new(request_client: request_client)
    end
# Deletes a set of [CatalogItem](entity:CatalogItem)s based on the
#  provided list of target IDs and returns a set of successfully deleted IDs in
#  the response. Deletion is a cascading event such that all children of the
