...
#  for more information.
      # @param object [SquareApiClient::CatalogObjectItem, SquareApiClient::CatalogObjectImage, SquareApiClient::CatalogObjectCategory, SquareApiClient::CatalogObjectItemVariation, SquareApiClient::CatalogObjectTax, SquareApiClient::CatalogObjectDiscount, SquareApiClient::CatalogObjectModifierList, SquareApiClient::CatalogObjectModifier, SquareApiClient::CatalogObjectPricingRule, SquareApiClient::CatalogObjectProductSet, SquareApiClient::CatalogObjectTimePeriod, SquareApiClient::CatalogObjectMeasurementUnit, SquareApiClient::CatalogObjectSubscriptionPlanVariation, SquareApiClient::CatalogObjectItemOption, SquareApiClient::CatalogObjectItemOptionValue, SquareApiClient::CatalogObjectCustomAttributeDefinition, SquareApiClient::CatalogObjectQuickAmountsSettings, SquareApiClient::CatalogObjectSubscriptionPlan, SquareApiClient::CatalogObjectAvailabilityPeriod] A CatalogObject to be created or updated.
...
#  api.catalog.object.upsert(idempotency_key: "af3d1afc-7212-4300-b463-0bfc5314a5ae", object: { type: "IMAGE", id: "#Cocoa" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/object"
        ...
        SquareApiClient::UpsertCatalogObjectResponse.from_json(json_object: response.body)
      end
...
#  in the response payload.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetCatalogObjectResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.catalog.object.get(object_id: "object_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/object/#{object_id}"
        ...
        SquareApiClient::GetCatalogObjectResponse.from_json(json_object: response.body)
      end
...
#  catalog item will delete its catalog item variations).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteCatalogObjectResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.catalog.object.delete(object_id: "object_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/catalog/object/#{object_id}"
        ...
        SquareApiClient::DeleteCatalogObjectResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Catalog::AsyncObjectClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Creates a new or updates the specified [CatalogObject](entity:CatalogObject).
