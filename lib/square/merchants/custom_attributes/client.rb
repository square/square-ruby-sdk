      ...
      class Client
        ...
        def batch_delete(request_options: {}, **params)
          ...
          request = Square::Internal::JSON::Request.new(
            ...
            body: Square::Merchants::CustomAttributes::Types::BulkDeleteMerchantCustomAttributesRequest.new(params).to_h,
        ...
        def batch_upsert(request_options: {}, **params)
          ...
          request = Square::Internal::JSON::Request.new(
            ...
            body: Square::Merchants::CustomAttributes::Types::BulkUpsertMerchantCustomAttributesRequest.new(params).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
        ...
        def upsert(request_options: {}, **params)
          params = Square::Internal::Types::Utils.normalize_keys(params)
          request_data = Square::Merchants::CustomAttributes::Types::UpsertMerchantCustomAttributeRequest.new(params).to_h
          non_body_param_names = %w[merchant_id key]
