...
module square.rb
  module Merchants
    ...
    # @return [square.rb::RequestClient] 
      ...
      # @return [square.rb::Merchants::CustomAttributesClient]
...
#  `VISIBILITY_READ_WRITE_VALUES`.
      #
      # @param values [Hash{String => square.rb::BulkDeleteMerchantCustomAttributesRequestMerchantCustomAttributeDeleteRequest}] The data used to update the `CustomAttribute` objects.
#  The keys must be unique and are used to map to the corresponding response.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::BulkDeleteMerchantCustomAttributesResponse]
      # @example
...
#  api.merchants.custom_attributes.batch_delete(values: { "id1": { key: "alternative_seller_name" }, "id2": { key: "has_seen_tutorial" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/custom-attributes/bulk-delete"
        ...
        square.rb::BulkDeleteMerchantCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  must be `VISIBILITY_READ_WRITE_VALUES`.
      #
      # @param values [Hash{String => square.rb::BulkUpsertMerchantCustomAttributesRequestMerchantCustomAttributeUpsertRequest}] A map containing 1 to 25 individual upsert requests. For each request, provide
#  an
#  arbitrary ID that is unique for this `BulkUpsertMerchantCustomAttributes`
#  request and the
#  information needed to create or update a custom attribute.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::BulkUpsertMerchantCustomAttributesResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.merchants.custom_attributes.batch_upsert(values: { "id1": { merchant_id: "DM7VKY8Q63GNP", custom_attribute: { key: "alternative_seller_name", value: "Ultimate Sneaker Store" } }, "id2": { merchant_id: "DM7VKY8Q63GNP", custom_attribute: { key: "has_seen_tutorial", value: true } } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/custom-attributes/bulk-upsert"
        ...
        square.rb::BulkUpsertMerchantCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  default value is `false`.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::ListMerchantCustomAttributesResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.merchants.custom_attributes.list(merchant_id: "merchant_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/#{merchant_id}/custom-attributes"
        ...
        square.rb::ListMerchantCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  higher than the current version, Square returns a `BAD_REQUEST` error.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::RetrieveMerchantCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.merchants.custom_attributes.get(merchant_id: "merchant_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/#{merchant_id}/custom-attributes/#{key}"
        ...
        square.rb::RetrieveMerchantCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  other values, the request fails with a BAD_REQUEST error.Request of type square.rb::CustomAttribute, as a Hash
      #   * :key (String) 
      #   * :value (Object) 
      #   * :version (Integer) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::UpsertMerchantCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/#{merchant_id}/custom-attributes/#{key}"
        ...
        square.rb::UpsertMerchantCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  definition owner, you must use the qualified key.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::DeleteMerchantCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.merchants.custom_attributes.delete(merchant_id: "merchant_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/#{merchant_id}/custom-attributes/#{key}"
        ...
        square.rb::DeleteMerchantCustomAttributeResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Merchants::AsyncCustomAttributesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Deletes [custom attributes](entity:CustomAttribute) for a merchant as a bulk
