...
module square.rb
  ...
  # @return [square.rb::Merchants::CustomAttributesClient] 
    ...
    def initialize(request_client:)
      ...
      @custom_attribute_definitions = square.rb::Merchants::CustomAttributeDefinitionsClient.new(request_client: request_client)
      @custom_attributes = square.rb::Merchants::CustomAttributesClient.new(request_client: request_client)
    end
...
#  api.merchants.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants"
      ...
      square.rb::ListMerchantsResponse.from_json(json_object: response.body)
    end
...
#  api.merchants.get(merchant_id: "merchant_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/#{merchant_id}"
      ...
      square.rb::GetMerchantResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [square.rb::Merchants::CustomAttributesClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @custom_attribute_definitions = square.rb::Merchants::AsyncCustomAttributeDefinitionsClient.new(request_client: request_client)
      @custom_attributes = square.rb::Merchants::AsyncCustomAttributesClient.new(request_client: request_client)
    end
# Provides details about the merchant associated with a given access token.
#  The access token used to connect your application to a Square seller is
#  associated
