...
#  eup.com/docs/subscriptions-api/manage-subscriptions#phases-and-order-templates).Request of type SquareApiClient::Money, as a Hash
    #   * :amount (Long) 
...
#  zones](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones).
    # @param source [Hash] The origination details of the subscription.Request of type SquareApiClient::SubscriptionSource, as a Hash
    #   * :name (String) 
    # @param monthly_billing_anchor_date [Integer] The day-of-the-month to change the billing date to.
    # @param phases [Array<Hash>] array of phases for this subscriptionRequest of type Array<SquareApiClient::Phase>, as a Hash
    #   * :uid (String) 
    #   * :ordinal (Long) 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions"
      ...
      SquareApiClient::CreateSubscriptionResponse.from_json(json_object: response.body)
    end
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/bulk-swap-plan"
      ...
      SquareApiClient::BulkSwapPlanResponse.from_json(json_object: response.body)
    end
...
#  all subscriptions.Request of type SquareApiClient::SearchSubscriptionsQuery, as a Hash
    #   * :filter (Hash)
...
#  - `actions`: to include scheduled actions on the targeted subscriptions.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::SearchSubscriptionsResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.subscriptions.search(query: { filter: { customer_ids: ["CHFGVKYY8RSV93M5KCYTG4PN0G"], location_ids: ["S8GWD5R9QB376"], source_names: ["My App"] } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/search"
      ...
      SquareApiClient::SearchSubscriptionsResponse.from_json(json_object: response.body)
    end
...
#  api.subscriptions.get(subscription_id: "subscription_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}"
      ...
      SquareApiClient::GetSubscriptionResponse.from_json(json_object: response.body)
    end
...
#  will
#  be treated as a request to clear the relevant data.Request of type SquareApiClient::Subscription, as a Hash
    #   * :id (String) 
    #   * :location_id (String) 
    ...
    #   * :status (SquareApiClient::SubscriptionStatus) 
    ...
    #   * :source (Hash)
    #     * :name (String) 
    #   * :actions (Array<SquareApiClient::SubscriptionAction>) 
    #   * :monthly_billing_anchor_date (Integer) 
    #   * :phases (Array<SquareApiClient::Phase>) 
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::UpdateSubscriptionResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.subscriptions.update(subscription_id: "subscription_id", subscription: { card_id: "{NEW CARD ID}" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}"
      ...
      SquareApiClient::UpdateSubscriptionResponse.from_json(json_object: response.body)
    end
# Deletes a scheduled action for a subscription.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::DeleteSubscriptionActionResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.subscriptions.delete_action(subscription_id: "subscription_id", action_id: "action_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}/actions/#{action_id}"
      ...
      SquareApiClient::DeleteSubscriptionActionResponse.from_json(json_object: response.body)
    end
...
#  is changed immediately.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::ChangeBillingAnchorDateResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.subscriptions.change_billing_anchor_date(subscription_id: "subscription_id", monthly_billing_anchor_date: 1)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}/billing-anchor"
      ...
      SquareApiClient::ChangeBillingAnchorDateResponse.from_json(json_object: response.body)
    end
...
#  the subscription status changes from ACTIVE to CANCELED.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::CancelSubscriptionResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.subscriptions.cancel(subscription_id: "subscription_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}/cancel"
      ...
      SquareApiClient::CancelSubscriptionResponse.from_json(json_object: response.body)
    end
# Lists all
...
#  api.subscriptions.list_events(subscription_id: "subscription_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}/events"
      ...
      SquareApiClient::ListSubscriptionEventsResponse.from_json(json_object: response.body)
    end
...
#  This date must be at least one billing cycle ahead of `pause_effective_date`.
    # @param resume_change_timing [SquareApiClient::ChangeTiming] The timing whether the subscription is reactivated immediately or at the end of
...
#  api.subscriptions.pause(subscription_id: "subscription_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}/pause"
      ...
      SquareApiClient::PauseSubscriptionResponse.from_json(json_object: response.body)
    end
# Schedules a `RESUME` action to resume a paused or a deactivated subscription.
    ...
    # @param resume_change_timing [SquareApiClient::ChangeTiming] The timing to resume a subscription, relative to the specified
#  `resume_effective_date` attribute value.
#  See [ChangeTiming](#type-changetiming) for possible values
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::ResumeSubscriptionResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.subscriptions.resume(subscription_id: "subscription_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}/resume"
      ...
      SquareApiClient::ResumeSubscriptionResponse.from_json(json_object: response.body)
    end
...
#  ns](https://developer.squareup.com/docs/subscriptions-api/swap-plan-variations).
    ...
    # @param new_plan_variation_id [String] The ID of the new subscription plan variation.
#  This field is required.
    # @param phases [Array<Hash>] A list of PhaseInputs, to pass phase-specific information used in the swap.Request of type Array<SquareApiClient::PhaseInput>, as a Hash
    #   * :ordinal (Long) 
    #   * :order_template_id (String) 
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::SwapPlanResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/subscriptions/#{subscription_id}/swap-plan"
      ...
      SquareApiClient::SwapPlanResponse.from_json(json_object: response.body)
    end
  end
