...
#  api.team.list_jobs
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/team-members/jobs"
      ...
      square.rb::ListJobsResponse.from_json(json_object: response.body)
    end
...
#  to true.Request of type square.rb::Job, as a Hash
    #   * :id (String) 
    #   * :title (String) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::CreateJobResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.team.create_job(job: { title: "Cashier", is_tip_eligible: true }, idempotency_key: "idempotency-key-0")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/team-members/jobs"
      ...
      square.rb::CreateJobResponse.from_json(json_object: response.body)
    end
# Retrieves a specified job.
    #
    # @param job_id [String] The ID of the job to retrieve.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::RetrieveJobResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.team.retrieve_job(job_id: "job_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/team-members/jobs/#{job_id}"
      ...
      square.rb::RetrieveJobResponse.from_json(json_object: response.body)
    end
...
#  concurrency control.Request of type square.rb::Job, as a Hash
    #   * :id (String) 
    #   * :title (String) 
    #   * :is_tip_eligible (Boolean) 
    #   * :created_at (String) 
    ...
    #   * :version (Integer) 
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::UpdateJobResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.team.update_job(job_id: "job_id", job: { title: "Cashier 1", is_tip_eligible: true })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/team-members/jobs/#{job_id}"
      ...
      square.rb::UpdateJobResponse.from_json(json_object: response.body)
    end
  end
