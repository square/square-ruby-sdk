...
#  api.bookings.custom_attribute_definitions.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/custom-attribute-definitions"
        ...
        SquareApiClient::ListBookingCustomAttributeDefinitionsResponse.from_json(json_object: response.body)
      end
...
#  information, see
#  [Specifying the
#  docs/booking-custom-attributes-api/custom-attribute-definitions#specify-schema).Request of type SquareApiClient::CustomAttributeDefinition, as a Hash
      #   * :key (String) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CreateBookingCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attribute_definitions.create(custom_attribute_definition: {  })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/custom-attribute-definitions"
        ...
        SquareApiClient::CreateBookingCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  is higher than the current version, Square returns a `BAD_REQUEST` error.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::RetrieveBookingCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attribute_definitions.get(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::RetrieveBookingCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpdateBookingCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attribute_definitions.update(key: "key", custom_attribute_definition: {  })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::UpdateBookingCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  or *Appointments Premium*.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteBookingCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attribute_definitions.delete(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::DeleteBookingCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Bookings::AsyncCustomAttributeDefinitionsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Get all bookings custom attribute definitions.
