...
#  `program_id` and a `mapping` with the `phone_number` of the buyer.
      #
      # @param loyalty_account [Hash] The loyalty account to create.Request of type square.rb::LoyaltyAccount, as a Hash
      #   * :id (String) 
      #   * :program_id (String) 
      #   * :balance (Integer) 
      ...
      #     * :created_at (String) 
      #     * :phone_number (String) 
      #   * :expiring_point_deadlines (Array<square.rb::LoyaltyAccountExpiringPointDeadline>) 
...
#  api.loyalty.accounts.create(loyalty_account: { program_id: "d619f755-2d17-41f3-990d-c04ecedd64dd", mapping: { phone_number: "+14155551234" } }, idempotency_key: "ec78c477-b1c3-4899-a209-a4e71337c996")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/accounts"
        ...
        square.rb::CreateLoyaltyAccountResponse.from_json(json_object: response.body)
      end
...
#  Search results are sorted by `created_at` in ascending order.
      #
      # @param query [Hash] The search criteria for the request.Request of type square.rb::SearchLoyaltyAccountsRequestLoyaltyAccountQuery, as a Hash
      #   * :mappings (Array<square.rb::LoyaltyAccountMapping>) 
...
#  api.loyalty.accounts.search(query: { mappings: [{ phone_number: "+14155551234" }] }, limit: 10)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/accounts/search"
        ...
        square.rb::SearchLoyaltyAccountsResponse.from_json(json_object: response.body)
      end
# Retrieves a loyalty account.
      #
      # @param account_id [String] The ID of the [loyalty account](entity:LoyaltyAccount) to retrieve.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::GetLoyaltyAccountResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.loyalty.accounts.get(account_id: "account_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/accounts/#{account_id}"
        ...
        square.rb::GetLoyaltyAccountResponse.from_json(json_object: response.body)
      end
...
#  Otherwise, specify the points to add.Request of type square.rb::LoyaltyEventAccumulatePoints, as a Hash
...
#  Keys can be any valid string but must be unique for every request.
      ...
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::AccumulateLoyaltyPointsResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/accounts/#{account_id}/accumulate"
        ...
        square.rb::AccumulateLoyaltyPointsResponse.from_json(json_object: response.body)
      end
...
#  To subtract points, specify a negative integer.Request of type square.rb::LoyaltyEventAdjustPoints, as a Hash
      #   * :loyalty_program_id (String) 
      #   * :points (Integer) 
      #   * :reason (String) 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/accounts/#{account_id}/adjust"
        ...
        square.rb::AdjustLoyaltyPointsResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Loyalty::AsyncAccountsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Creates a loyalty account. To create a loyalty account, you must provide the
