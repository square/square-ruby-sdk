...
module SquareApiClient
  ...
  # @return [SquareApiClient::Loyalty::ProgramsClient] 
  ...
  # @return [SquareApiClient::Loyalty::RewardsClient] 
    ...
    def initialize(request_client:)
      ...
      @accounts = SquareApiClient::Loyalty::AccountsClient.new(request_client: request_client)
      @programs = SquareApiClient::Loyalty::ProgramsClient.new(request_client: request_client)
      @rewards = SquareApiClient::Loyalty::RewardsClient.new(request_client: request_client)
    end
...
#  that specifies multiple field values.Request of type SquareApiClient::LoyaltyEventQuery, as a Hash
    #   * :filter (Hash)
    #     * :loyalty_account_filter (Hash)
    #       * :loyalty_account_id (String) 
    #     * :type_filter (Hash)
    #       * :types (Array<SquareApiClient::LoyaltyEventType>) 
...
#  api.loyalty.search_events(query: { filter: { order_filter: { order_id: "PyATxhYLfsMqpVkcKJITPydgEYfZY" } } }, limit: 30)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/events/search"
      ...
      SquareApiClient::SearchLoyaltyEventsResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [SquareApiClient::Loyalty::RewardsClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @accounts = SquareApiClient::Loyalty::AsyncAccountsClient.new(request_client: request_client)
      @programs = SquareApiClient::Loyalty::AsyncProgramsClient.new(request_client: request_client)
      @rewards = SquareApiClient::Loyalty::AsyncRewardsClient.new(request_client: request_client)
    end
# Searches for loyalty events.
#  A Square loyalty program maintains a ledger of events that occur during the
#  lifetime of a
