...
#  not available for the buyer to redeem another reward.
      #
      # @param reward [Hash] The reward to create.Request of type square.rb::LoyaltyReward, as a Hash
      #   * :id (String) 
      #   * :status (square.rb::LoyaltyRewardStatus) 
...
#  api.loyalty.rewards.create(reward: { loyalty_account_id: "5adcb100-07f1-4ee7-b8c6-6bb9ebc474bd", reward_tier_id: "e1b39225-9da5-43d1-a5db-782cdd8ad94f", order_id: "RFZfrdtm3mhO1oGzf5Cx7fEMsmGZY" }, idempotency_key: "18c2e5ea-a620-4b1f-ad60-7b167285e451")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/rewards"
        ...
        square.rb::CreateLoyaltyRewardResponse.from_json(json_object: response.body)
      end
...
#  If empty, the endpoint retrieves all loyalty rewards in the loyalty program.Request of type square.rb::SearchLoyaltyRewardsRequestLoyaltyRewardQuery, as a Hash
      #   * :loyalty_account_id (String) 
      #   * :status (square.rb::LoyaltyRewardStatus) 
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::SearchLoyaltyRewardsResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.loyalty.rewards.search(query: { loyalty_account_id: "5adcb100-07f1-4ee7-b8c6-6bb9ebc474bd" }, limit: 10)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/rewards/search"
        ...
        square.rb::SearchLoyaltyRewardsResponse.from_json(json_object: response.body)
      end
# Retrieves a loyalty reward.
      #
      # @param reward_id [String] The ID of the [loyalty reward](entity:LoyaltyReward) to retrieve.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::GetLoyaltyRewardResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.loyalty.rewards.get(reward_id: "reward_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/rewards/#{reward_id}"
        ...
        square.rb::GetLoyaltyRewardResponse.from_json(json_object: response.body)
      end
...
#  You cannot delete a reward that has reached the terminal state (REDEEMED).
      ...
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::DeleteLoyaltyRewardResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.loyalty.rewards.delete(reward_id: "reward_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/rewards/#{reward_id}"
        ...
        square.rb::DeleteLoyaltyRewardResponse.from_json(json_object: response.body)
      end
...
#  Keys can be any valid string, but must be unique for every request.
      ...
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::RedeemLoyaltyRewardResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/rewards/#{reward_id}/redeem"
        ...
        square.rb::RedeemLoyaltyRewardResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Loyalty::AsyncRewardsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Creates a loyalty reward. In the process, the endpoint does following:
