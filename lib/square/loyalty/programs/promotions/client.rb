...
#  the `main` keyword.
        # @param status [square.rb::LoyaltyPromotionStatus] The status to filter the results by. If a status is provided, only loyalty
#  promotions
...
#  api.loyalty.programs.promotions.list(program_id: "program_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/programs/#{program_id}/promotions"
          ...
          square.rb::ListLoyaltyPromotionsResponse.from_json(json_object: response.body)
        end
...
#  using the `main` keyword.
        # @param loyalty_promotion [Hash] The loyalty promotion to create.Request of type square.rb::LoyaltyPromotion, as a Hash
        #   * :id (String) 
        #   * :name (String) 
        #   * :incentive (Hash)
        #     * :type (square.rb::LoyaltyPromotionIncentiveType) 
        ...
        #   * :trigger_limit (Hash)
        #     * :times (Integer) 
        #     * :interval (square.rb::LoyaltyPromotionTriggerLimitInterval) 
        #   * :status (square.rb::LoyaltyPromotionStatus) 
        #   * :created_at (String) 
        #   * :canceled_at (String) 
        #   * :updated_at (String) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
        # @param request_options [square.rb::RequestOptions] 
        # @return [square.rb::CreateLoyaltyPromotionResponse]
        # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/programs/#{program_id}/promotions"
          ...
          square.rb::CreateLoyaltyPromotionResponse.from_json(json_object: response.body)
        end
...
#  api.loyalty.programs.promotions.get(promotion_id: "promotion_id", program_id: "program_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/programs/#{promotion_id}/promotions/#{program_id}"
          ...
          square.rb::GetLoyaltyPromotionResponse.from_json(json_object: response.body)
        end
...
#  api.loyalty.programs.promotions.cancel(promotion_id: "promotion_id", program_id: "program_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/programs/#{promotion_id}/promotions/#{program_id}/cancel"
          ...
          square.rb::CancelLoyaltyPromotionResponse.from_json(json_object: response.body)
        end
      end
      ...
      # @return [square.rb::AsyncRequestClient] 
        ...
        # @param request_client [square.rb::RequestClient] 
        # @return [square.rb::Loyalty::Programs::AsyncPromotionsClient]
        def initialize(request_client:)
          @request_client = request_client
        end
# Lists the loyalty promotions associated with a [loyalty
