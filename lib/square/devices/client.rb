...
module square.rb
  ...
  # @return [square.rb::Devices::CodesClient] 
    ...
    def initialize(request_client:)
      ...
      @codes = square.rb::Devices::CodesClient.new(request_client: request_client)
    end
...
#  api.devices.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/devices"
      ...
      square.rb::ListDevicesResponse.from_json(json_object: response.body)
    end
...
#  api.devices.get(device_id: "device_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/devices/#{device_id}"
      ...
      square.rb::GetDeviceResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [square.rb::Devices::CodesClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @codes = square.rb::Devices::AsyncCodesClient.new(request_client: request_client)
    end
# List devices associated with the merchant. Currently, only Terminal API
#  devices are supported.
    #
