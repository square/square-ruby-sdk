...
#  Returns DeviceCodes of all locations if empty.
      # @param product_type [SquareApiClient::PRODUCT_TYPE] If specified, only returns DeviceCodes targeting the specified product type.
#  Returns DeviceCodes of all product types if empty.
      # @param status [SquareApiClient::DeviceCodeStatus] If specified, returns DeviceCodes with the specified statuses.
#  Returns DeviceCodes of status `PAIRED` and `UNPAIRED` if empty.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::ListDeviceCodesResponse]
      # @example
...
#  api.devices.codes.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/devices/codes"
        ...
        SquareApiClient::ListDeviceCodesResponse.from_json(json_object: response.body)
      end
...
#  for more information.
      # @param device_code [Hash] The device code to create.Request of type SquareApiClient::DeviceCode, as a Hash
      #   * :id (String) 
      #   * :name (String) 
      #   * :code (String) 
      #   * :device_id (String) 
      #   * :product_type (SquareApiClient::PRODUCT_TYPE) 
      #   * :location_id (String) 
      #   * :status (SquareApiClient::DeviceCodeStatus) 
      #   * :pair_by (String) 
      #   * :created_at (String) 
      #   * :status_changed_at (String) 
      #   * :paired_at (String) 
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CreateDeviceCodeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.devices.codes.create(idempotency_key: "01bb00a6-0c86-4770-94ed-f5fca973cd56", device_code: { name: "Counter 1", product_type: "TERMINAL_API", location_id: "B5E4484SHHNYH" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/devices/codes"
        ...
        SquareApiClient::CreateDeviceCodeResponse.from_json(json_object: response.body)
      end
...
#  api.devices.codes.get(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/devices/codes/#{id}"
        ...
        SquareApiClient::GetDeviceCodeResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Devices::AsyncCodesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Lists all DeviceCodes associated with the merchant.
