...
#  (also known as custom fields) are always set to `VISIBILITY_READ_WRITE_VALUES`.
      #
      # @param values [Hash{String => square.rb::BulkDeleteOrderCustomAttributesRequestDeleteCustomAttribute}] A map of requests that correspond to individual delete operations for custom
#  attributes.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::BulkDeleteOrderCustomAttributesResponse]
      # @example
...
#  api.orders.custom_attributes.batch_delete(values: { "cover-count": { key: "cover-count", order_id: "7BbXGEIWNldxAzrtGf9GPVZTwZ4F" }, "table-number": { key: "table-number", order_id: "7BbXGEIWNldxAzrtGf9GPVZTwZ4F" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/custom-attributes/bulk-delete"
        ...
        square.rb::BulkDeleteOrderCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  (also known as custom fields) are always set to `VISIBILITY_READ_WRITE_VALUES`.
      #
      # @param values [Hash{String => square.rb::BulkUpsertOrderCustomAttributesRequestUpsertCustomAttribute}] A map of requests that correspond to individual upsert operations for custom
#  attributes.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::BulkUpsertOrderCustomAttributesResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.orders.custom_attributes.batch_upsert(values: { "cover-count": { custom_attribute: { key: "cover-count", value: "6", version: 2 }, order_id: "7BbXGEIWNldxAzrtGf9GPVZTwZ4F" }, "table-number": { custom_attribute: { key: "table-number", value: "11", version: 4 }, order_id: "7BbXGEIWNldxAzrtGf9GPVZTwZ4F" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/custom-attributes/bulk-upsert"
        ...
        square.rb::BulkUpsertOrderCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  and set to `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
      ...
      # @param visibility_filter [square.rb::VisibilityFilter] Requests that all of the custom attributes be returned, or only those that are
...
#  is `false`.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::ListOrderCustomAttributesResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.orders.custom_attributes.list(order_id: "order_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/#{order_id}/custom-attributes"
        ...
        square.rb::ListOrderCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  is `false`.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::RetrieveOrderCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.orders.custom_attributes.get(order_id: "order_id", custom_attribute_key: "custom_attribute_key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/#{order_id}/custom-attributes/#{custom_attribute_key}"
        ...
        square.rb::RetrieveOrderCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  loper.squareup.com/docs/build-basics/common-api-patterns/optimistic-concurrency)
#  control, include this optional field and specify the current version of the
#  custom attribute.Request of type square.rb::CustomAttribute, as a Hash
      #   * :key (String) 
      #   * :value (Object) 
      #   * :version (Integer) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::UpsertOrderCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/#{order_id}/custom-attributes/#{custom_attribute_key}"
        ...
        square.rb::UpsertOrderCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  existing custom attribute definition.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::DeleteOrderCustomAttributeResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.orders.custom_attributes.delete(order_id: "order_id", custom_attribute_key: "custom_attribute_key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/#{order_id}/custom-attributes/#{custom_attribute_key}"
        ...
        square.rb::DeleteOrderCustomAttributeResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Orders::AsyncCustomAttributesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Deletes order [custom attributes](entity:CustomAttribute) as a bulk operation.
