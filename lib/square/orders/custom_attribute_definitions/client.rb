...
#  api.orders.custom_attribute_definitions.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/custom-attribute-definitions"
        ...
        square.rb::ListOrderCustomAttributeDefinitionsResponse.from_json(json_object: response.body)
      end
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::CreateOrderCustomAttributeDefinitionResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.orders.custom_attribute_definitions.create(custom_attribute_definition: { key: "cover-count", schema: { "ref": "https://developer-production-s.squarecdn.com/schemas/v1/common.json#squareup.common.Number" }, name: "Cover count", description: "The number of people seated at a table", visibility: VISIBILITY_READ_WRITE_VALUES }, idempotency_key: "IDEMPOTENCY_KEY")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/custom-attribute-definitions"
        ...
        square.rb::CreateOrderCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  custom attribute.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::RetrieveOrderCustomAttributeDefinitionResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.orders.custom_attribute_definitions.get(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/custom-attribute-definitions/#{key}"
        ...
        square.rb::RetrieveOrderCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::UpdateOrderCustomAttributeDefinitionResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/custom-attribute-definitions/#{key}"
        ...
        square.rb::UpdateOrderCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  Only the definition owner can delete a custom attribute definition.
      ...
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::DeleteOrderCustomAttributeDefinitionResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.orders.custom_attribute_definitions.delete(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/custom-attribute-definitions/#{key}"
        ...
        square.rb::DeleteOrderCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Orders::AsyncCustomAttributeDefinitionsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Lists the order-related [custom attribute
