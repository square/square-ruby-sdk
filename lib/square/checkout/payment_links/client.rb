...
#  Default value: `100`
      ...
      # @return [square.rb::ListPaymentLinksResponse]
      # @example
...
#  api.checkout.payment_links.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/online-checkout/payment-links"
        ...
        square.rb::ListPaymentLinksResponse.from_json(json_object: response.body)
      end
...
#  see [Quick Pay
#  Checkout](https://developer.squareup.com/docs/checkout-api/quick-pay-checkout).Request of type square.rb::QuickPay, as a Hash
      #   * :name (String) 
      #   * :price_money (Hash)
      #     * :amount (Long) 
...
#  For more information,
#  see [Square Order
#  eckout](https://developer.squareup.com/docs/checkout-api/square-order-checkout).Request of type square.rb::Order, as a Hash
      #   * :id (String) 
      #   * :location_id (String) 
      #   * :reference_id (String) 
      #   * :source (Hash)
...
#  ps://developer.squareup.com/docs/checkout-api/optional-checkout-configurations).Request of type square.rb::CheckoutOptions, as a Hash
      #   * :allow_tipping (Boolean) 
      #   * :custom_fields (Array<square.rb::CustomField>) 
...
#  checkout-api/optional-checkout-configurations#prepopulate-the-shipping-address).Request of type square.rb::PrePopulatedData, as a Hash
      #   * :buyer_email (String) 
...
#  the resulting `Payment`.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::CreatePaymentLinkResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.checkout.payment_links.create(idempotency_key: "cd9e25dc-d9f2-4430-aedb-61605070e95f", quick_pay: { name: "Auto Detailing", price_money: { amount: 10000, currency: USD }, location_id: "A9Y43N9ABXZBP" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/online-checkout/payment-links"
        ...
        square.rb::CreatePaymentLinkResponse.from_json(json_object: response.body)
      end
# Retrieves a payment link.
      #
      # @param id [String] The ID of link to retrieve.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::GetPaymentLinkResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.checkout.payment_links.get(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/online-checkout/payment-links/#{id}"
        ...
        square.rb::GetPaymentLinkResponse.from_json(json_object: response.body)
      end
...
#  developer.squareup.com/docs/checkout-api/manage-checkout#update-a-payment-link).Request of type square.rb::PaymentLink, as a Hash
      #   * :id (String) 
      #   * :version (Integer) 
      #   * :description (String) 
      #   * :order_id (String) 
      ...
      #   * :payment_note (String) 
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::UpdatePaymentLinkResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.checkout.payment_links.update(id: "id", payment_link: { version: 1, checkout_options: { ask_for_shipping_address: true } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/online-checkout/payment-links/#{id}"
        ...
        square.rb::UpdatePaymentLinkResponse.from_json(json_object: response.body)
      end
...
#  api.checkout.payment_links.delete(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/online-checkout/payment-links/#{id}"
        ...
        square.rb::DeletePaymentLinkResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Checkout::AsyncPaymentLinksClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Lists all payment links.
