...
module square.rb
  ...
  # @return [square.rb::Terminal::RefundsClient] 
    ...
    def initialize(request_client:)
      ...
      @actions = square.rb::Terminal::ActionsClient.new(request_client: request_client)
      @checkouts = square.rb::Terminal::CheckoutsClient.new(request_client: request_client)
      @refunds = square.rb::Terminal::RefundsClient.new(request_client: request_client)
    end
...
#  api.terminal.dismiss_terminal_action(action_id: "action_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/actions/#{action_id}/dismiss"
      ...
      square.rb::DismissTerminalActionResponse.from_json(json_object: response.body)
    end
...
#  dismissed.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::DismissTerminalCheckoutResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.terminal.dismiss_terminal_checkout(checkout_id: "checkout_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/checkouts/#{checkout_id}/dismiss"
      ...
      square.rb::DismissTerminalCheckoutResponse.from_json(json_object: response.body)
    end
...
#  permits it.
    ...
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::DismissTerminalRefundResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.terminal.dismiss_terminal_refund(terminal_refund_id: "terminal_refund_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/refunds/#{terminal_refund_id}/dismiss"
      ...
      square.rb::DismissTerminalRefundResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [square.rb::Terminal::RefundsClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @actions = square.rb::Terminal::AsyncActionsClient.new(request_client: request_client)
      @checkouts = square.rb::Terminal::AsyncCheckoutsClient.new(request_client: request_client)
      @refunds = square.rb::Terminal::AsyncRefundsClient.new(request_client: request_client)
    end
# Dismisses a Terminal action request if the status and type of the request
#  permits it.
#  See [Link and Dismiss
