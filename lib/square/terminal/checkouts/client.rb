  ...
  module Terminal
    module Checkouts
      class Client
        ...
        # @param params [Square::Terminal::Checkouts::Types::CreateTerminalCheckoutRequest]
        ...
        def create(request_options: {}, **params)
          ...
          if code.between?(200, 299)
            Square::Types::CreateTerminalCheckoutResponse.load(response.body)
          else
        ...
        # Returns a filtered list of Terminal checkout requests created by the application making the request. Only
        # Terminal checkout requests created for the merchant scoped to the OAuth token are returned. Terminal checkout
        # requests are available for 30 days.
        #
        # @param request_options [Hash]
        # @param params [Square::Terminal::Checkouts::Types::SearchTerminalCheckoutsRequest]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        def search(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Square::Types::SearchTerminalCheckoutsResponse.load(response.body)
          else
            error_class = Square::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        def get(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Square::Types::GetTerminalCheckoutResponse.load(response.body)
          else
            error_class = Square::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        def cancel(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Square::Types::CancelTerminalCheckoutResponse.load(response.body)
          else
            error_class = Square::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
