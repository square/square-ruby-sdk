...
#  for more information.
      # @param refund [Hash] The refund to create.Request of type SquareApiClient::TerminalRefund, as a Hash
      #   * :id (String) 
      #   * :refund_id (String) 
      #   * :payment_id (String) 
      #   * :order_id (String) 
      ...
      # @return [SquareApiClient::CreateTerminalRefundResponse]
      # @example
...
#  api.terminal.refunds.create(idempotency_key: "402a640b-b26f-401f-b406-46f839590c04", refund: { payment_id: "5O5OvgkcNUhl7JBuINflcjKqUzXZY", amount_money: { amount: 111, currency: CAD }, reason: "Returning items", device_id: "f72dfb8e-4d65-4e56-aade-ec3fb8d33291" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/refunds"
        ...
        SquareApiClient::CreateTerminalRefundResponse.from_json(json_object: response.body)
      end
...
#  available
#  refunds with the default sort order.Request of type SquareApiClient::TerminalRefundQuery, as a Hash
      #   * :filter (Hash)
      #     * :device_id (String) 
      #     * :created_at (Hash)
      #       * :start_at (String) 
...
#  Provide this cursor to retrieve the next set of results for the original query.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::SearchTerminalRefundsResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.terminal.refunds.search(query: { filter: { status: "COMPLETED" } }, limit: 1)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/refunds/search"
        ...
        SquareApiClient::SearchTerminalRefundsResponse.from_json(json_object: response.body)
      end
...
#  api.terminal.refunds.get(terminal_refund_id: "terminal_refund_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/refunds/#{terminal_refund_id}"
        ...
        SquareApiClient::GetTerminalRefundResponse.from_json(json_object: response.body)
      end
...
#  the request permits it.
      ...
      # @param terminal_refund_id [String] The unique ID for the desired `TerminalRefund`.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CancelTerminalRefundResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.terminal.refunds.cancel(terminal_refund_id: "terminal_refund_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/refunds/#{terminal_refund_id}/cancel"
        ...
        SquareApiClient::CancelTerminalRefundResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Terminal::AsyncRefundsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Creates a request to refund an Interac payment completed on a Square Terminal.
