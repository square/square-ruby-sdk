...
module square.rb
  module Terminal
    ...
    # @return [square.rb::RequestClient] 
      ...
      # @return [square.rb::Terminal::ActionsClient]
...
#  for more
#  information.
      # @param action [Hash] The Action to create.Request of type square.rb::TerminalAction, as a Hash
      #   * :id (String) 
      #   * :device_id (String) 
      ...
      #   * :app_id (String) 
      #   * :location_id (String) 
      #   * :type (square.rb::TerminalActionActionType) 
      ...
      #     * :title (String) 
      #     * :body (String) 
      #     * :signature (Array<square.rb::SignatureImage>) 
      ...
      #     * :title (String) 
      #     * :body (String) 
      #     * :input_type (square.rb::DataCollectionOptionsInputType) 
      #     * :collected_data (Hash)
      #       * :input_text (String) 
      #   * :select_options (Hash)
      #     * :title (String) 
      #     * :body (String) 
      #     * :options (Array<square.rb::SelectOption>) 
      ...
      # @return [square.rb::CreateTerminalActionResponse]
      # @example
...
#  api.terminal.actions.create(idempotency_key: "thahn-70e75c10-47f7-4ab6-88cc-aaa4076d065e", action: { device_id: "{{DEVICE_ID}}", deadline_duration: "PT5M", type: SAVE_CARD, save_card_options: { customer_id: "{{CUSTOMER_ID}}", reference_id: "user-id-1" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/actions"
        ...
        square.rb::CreateTerminalActionResponse.from_json(json_object: response.body)
      end
...
#  Leaving this unset will return all actions with the default sort order.Request of type square.rb::TerminalActionQuery, as a Hash
      #   * :filter (Hash)
      #     * :device_id (String) 
      #     * :created_at (Hash)
      #       * :start_at (String) 
...
#  api.terminal.actions.search(query: { filter: { created_at: { start_at: "2022-04-01T00:00:00.000Z" } }, sort: { sort_order: DESC } }, limit: 2)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/actions/search"
        ...
        square.rb::SearchTerminalActionsResponse.from_json(json_object: response.body)
      end
...
#  available for 30 days.
      ...
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::GetTerminalActionResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.terminal.actions.get(action_id: "action_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/actions/#{action_id}"
        ...
        square.rb::GetTerminalActionResponse.from_json(json_object: response.body)
      end
# Cancels a Terminal action request if the status of the request permits it.
      #
      # @param action_id [String] Unique ID for the desired `TerminalAction`.
      # @param request_options [square.rb::RequestOptions] 
      # @return [square.rb::CancelTerminalActionResponse]
      # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.terminal.actions.cancel(action_id: "action_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/actions/#{action_id}/cancel"
        ...
        square.rb::CancelTerminalActionResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [square.rb::AsyncRequestClient] 
      ...
      # @param request_client [square.rb::RequestClient] 
      # @return [square.rb::Terminal::AsyncActionsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Creates a Terminal action request and sends it to the specified device.
