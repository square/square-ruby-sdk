...
#  By default, all enabled cards owned by the merchant are returned.
    ...
    # @param sort_order [square.rb::SortOrder] Sorts the returned list by when the card was created with the specified order.
...
#  api.cards.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/cards"
      ...
      square.rb::ListCardsResponse.from_json(json_object: response.body)
    end
...
#  See the [SCA Overview](https://developer.squareup.com/docs/sca-overview).
    # @param card [Hash] Payment details associated with the card to be stored.Request of type square.rb::Card, as a Hash
    #   * :id (String) 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/cards"
      ...
      square.rb::CreateCardResponse.from_json(json_object: response.body)
    end
...
#  api.cards.get(card_id: "card_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/cards/#{card_id}"
      ...
      square.rb::GetCardResponse.from_json(json_object: response.body)
    end
...
#  api.cards.disable(card_id: "card_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/cards/#{card_id}/disable"
      ...
      square.rb::DisableCardResponse.from_json(json_object: response.body)
    end
  end
