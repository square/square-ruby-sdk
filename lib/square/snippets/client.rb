...
#  api.snippets.get(site_id: "site_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/sites/#{site_id}/snippet"
      ...
      square.rb::GetSnippetResponse.from_json(json_object: response.body)
    end
...
#  loper.squareup.com/docs/online-api#early-access-program-for-square-online-apis).
    ...
    # @param snippet [Hash] The snippet for the site.Request of type square.rb::Snippet, as a Hash
    #   * :id (String) 
    #   * :site_id (String) 
    #   * :content (String) 
    #   * :created_at (String) 
    #   * :updated_at (String) 
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::UpsertSnippetResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.snippets.upsert(site_id: "site_id", snippet: { content: "<script>var js = 1;</script>" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/sites/#{site_id}/snippet"
      ...
      square.rb::UpsertSnippetResponse.from_json(json_object: response.body)
    end
...
#  loper.squareup.com/docs/online-api#early-access-program-for-square-online-apis).
    ...
    # @param site_id [String] The ID of the site that contains the snippet.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::DeleteSnippetResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.snippets.delete(site_id: "site_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/sites/#{site_id}/snippet"
      ...
      square.rb::DeleteSnippetResponse.from_json(json_object: response.body)
    end
  end
