...
#  `PaymentRefund`.
#  Default: The current time.
    # @param sort_field [square.rb::ListPaymentRefundsRequestSortField] The field used to sort results by. The default is `CREATED_AT`.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::ListPaymentRefundsResponse]
    # @example
...
#  api.refunds.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/refunds"
      ...
      square.rb::ListPaymentRefundsResponse.from_json(json_object: response.body)
    end
...
#  that is charging the card.Request of type square.rb::Money, as a Hash
    #   * :amount (Long) 
...
#  (`destination_id` is CASH).Request of type square.rb::DestinationDetailsCashRefundDetails, as a Hash
...
#  (`destination_id` is EXTERNAL).Request of type square.rb::DestinationDetailsExternalRefundDetails, as a Hash
    #   * :type (String) 
    #   * :source (String) 
    #   * :source_id (String) 
    # @param request_options [square.rb::RequestOptions] 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/refunds"
      ...
      square.rb::RefundPaymentResponse.from_json(json_object: response.body)
    end
# Retrieves a specific refund using the `refund_id`.
    #
    # @param refund_id [String] The unique ID for the desired `PaymentRefund`.
    # @param request_options [square.rb::RequestOptions] 
    # @return [square.rb::GetPaymentRefundResponse]
    # @example
#  api = square.rb::Client.new(
#    base_url: "https://api.example.com",
#    environment: square.rb::Environment::PRODUCTION,
...
#  api.refunds.get(refund_id: "refund_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/refunds/#{refund_id}"
      ...
      square.rb::GetPaymentRefundResponse.from_json(json_object: response.body)
    end
  end
