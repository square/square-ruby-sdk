...
#  api.customers.custom_attributes.list(customer_id: "customer_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/custom-attributes"
        ...
        SquareApiClient::ListCustomerCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  higher than the current version, Square returns a `BAD_REQUEST` error.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetCustomerCustomAttributeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.custom_attributes.get(customer_id: "customer_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/custom-attributes/#{key}"
        ...
        SquareApiClient::GetCustomerCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpsertCustomerCustomAttributeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/custom-attributes/#{key}"
        ...
        SquareApiClient::UpsertCustomerCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  definition owner, you must use the qualified key.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteCustomerCustomAttributeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.customers.custom_attributes.delete(customer_id: "customer_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/custom-attributes/#{key}"
        ...
        SquareApiClient::DeleteCustomerCustomAttributeResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Customers::AsyncCustomAttributesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Lists the [custom attributes](entity:CustomAttribute) associated with a customer
