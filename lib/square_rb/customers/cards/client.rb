...
#  the postal code encoded in the card nonce.Request of type SquareApiClient::Address, as a Hash
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/cards"
        ...
        SquareApiClient::CreateCustomerCardResponse.from_json(json_object: response.body)
      end
...
#  api.customers.cards.delete(customer_id: "customer_id", card_id: "card_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/customers/#{customer_id}/cards/#{card_id}"
        ...
        SquareApiClient::DeleteCustomerCardResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Customers::AsyncCardsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Adds a card on file to an existing customer.
