...
#  api.labor.team_member_wages.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/team-member-wages"
        ...
        SquareApiClient::ListTeamMemberWagesResponse.from_json(json_object: response.body)
      end
...
#  api.labor.team_member_wages.get(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/labor/team-member-wages/#{id}"
        ...
        SquareApiClient::GetTeamMemberWageResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Labor::AsyncTeamMemberWagesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Returns a paginated list of `TeamMemberWage` instances for a business.
