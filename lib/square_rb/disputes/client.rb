...
module SquareApiClient
  ...
  # @return [SquareApiClient::Disputes::EvidenceClient] 
    ...
    def initialize(request_client:)
      ...
      @evidence = SquareApiClient::Disputes::EvidenceClient.new(request_client: request_client)
    end
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
    # @param states [SquareApiClient::DisputeState] The dispute states used to filter the result. If not specified, the endpoint
...
#  If not specified, the endpoint returns disputes associated with all locations.
    ...
    # @return [SquareApiClient::ListDisputesResponse]
    # @example
...
#  api.disputes.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes"
      ...
      SquareApiClient::ListDisputesResponse.from_json(json_object: response.body)
    end
# Returns details about a specific dispute.
    #
    # @param dispute_id [String] The ID of the dispute you want more details about.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetDisputeResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.disputes.get(dispute_id: "dispute_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}"
      ...
      SquareApiClient::GetDisputeResponse.from_json(json_object: response.body)
    end
...
#  api.disputes.accept(dispute_id: "dispute_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}/accept"
      ...
      SquareApiClient::AcceptDisputeResponse.from_json(json_object: response.body)
    end
...
#  formats.
    ...
    # @param request [Hash] Request of type SquareApiClient::CreateDisputeEvidenceFileRequest, as a Hash
    #   * :idempotency_key (String) 
    #   * :evidence_type (SquareApiClient::DisputeEvidenceType) 
    #   * :content_type (String) 
...
#  api.disputes.create_evidence_file(dispute_id: "dispute_id", image_file: my_file.txt)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}/evidence-files"
      ...
      SquareApiClient::CreateDisputeEvidenceFileResponse.from_json(json_object: response.body)
    end
...
#  Idempotency](https://developer.squareup.com/docs/working-with-apis/idempotency).
    # @param evidence_type [SquareApiClient::DisputeEvidenceType] The type of evidence you are uploading.
#  See [DisputeEvidenceType](#type-disputeevidencetype) for possible values
    # @param evidence_text [String] The evidence string.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::CreateDisputeEvidenceTextResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}/evidence-text"
      ...
      SquareApiClient::CreateDisputeEvidenceTextResponse.from_json(json_object: response.body)
    end
...
#  a dispute after submission.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::SubmitEvidenceResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.disputes.submit_evidence(dispute_id: "dispute_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}/submit-evidence"
      ...
      SquareApiClient::SubmitEvidenceResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [SquareApiClient::Disputes::EvidenceClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @evidence = SquareApiClient::Disputes::AsyncEvidenceClient.new(request_client: request_client)
    end
# Returns a list of disputes associated with a particular account.
    #
    # @param cursor [String] A pagination cursor returned by a previous call to this endpoint.
