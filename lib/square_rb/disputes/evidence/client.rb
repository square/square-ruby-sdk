...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
      ...
      # @return [SquareApiClient::ListDisputeEvidenceResponse]
      # @example
...
#  api.disputes.evidence.list(dispute_id: "dispute_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}/evidence"
        ...
        SquareApiClient::ListDisputeEvidenceResponse.from_json(json_object: response.body)
      end
...
#  later. Evidence cannot be downloaded after you upload it.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetDisputeEvidenceResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.disputes.evidence.get(dispute_id: "dispute_id", evidence_id: "evidence_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}/evidence/#{evidence_id}"
        ...
        SquareApiClient::GetDisputeEvidenceResponse.from_json(json_object: response.body)
      end
...
#  Square does not send the bank any evidence that is removed.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteDisputeEvidenceResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.disputes.evidence.delete(dispute_id: "dispute_id", evidence_id: "evidence_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/disputes/#{dispute_id}/evidence/#{evidence_id}"
        ...
        SquareApiClient::DeleteDisputeEvidenceResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Disputes::AsyncEvidenceClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Returns a list of evidence associated with a dispute.
