...
#  for more information.
      # @param checkout [Hash] The checkout to create.Request of type SquareApiClient::TerminalCheckout, as a Hash
      #   * :id (String) 
      #   * :amount_money (Hash)
      #     * :amount (Long) 
      ...
      #     * :delay_action (SquareApiClient::PaymentOptionsDelayAction) 
      #   * :device_options (Hash)
      #     * :device_id (String) 
      ...
      #   * :app_id (String) 
      #   * :location_id (String) 
      #   * :payment_type (SquareApiClient::CheckoutOptionsPaymentType) 
      ...
      # @return [SquareApiClient::CreateTerminalCheckoutResponse]
      # @example
...
#  api.terminal.checkouts.create(idempotency_key: "28a0c3bc-7839-11ea-bc55-0242ac130003", checkout: { amount_money: { amount: 2610, currency: USD }, reference_id: "id11572", note: "A brief note", device_options: { device_id: "dbb5d83a-7838-11ea-bc55-0242ac130003" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/checkouts"
        ...
        SquareApiClient::CreateTerminalCheckoutResponse.from_json(json_object: response.body)
      end
...
#  Leaving these unset returns all checkouts with the default sort order.Request of type SquareApiClient::TerminalCheckoutQuery, as a Hash
      #   * :filter (Hash)
      #     * :device_id (String) 
      #     * :created_at (Hash)
      #       * :start_at (String) 
...
#  api.terminal.checkouts.search(query: { filter: { status: "COMPLETED" } }, limit: 2)
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/checkouts/search"
        ...
        SquareApiClient::SearchTerminalCheckoutsResponse.from_json(json_object: response.body)
      end
...
#  requests are available for 30 days.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetTerminalCheckoutResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.terminal.checkouts.get(checkout_id: "checkout_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/checkouts/#{checkout_id}"
        ...
        SquareApiClient::GetTerminalCheckoutResponse.from_json(json_object: response.body)
      end
...
#  api.terminal.checkouts.cancel(checkout_id: "checkout_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/terminals/checkouts/#{checkout_id}/cancel"
        ...
        SquareApiClient::CancelTerminalCheckoutResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Terminal::AsyncCheckoutsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Creates a Terminal checkout request and sends it to the specified device to take
