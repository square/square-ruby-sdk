...
#  additional pages using a cursor, you must use the original query.Request of type SquareApiClient::SearchEventsQuery, as a Hash
    #   * :filter (Hash)
    ...
    #       * :end_at (String) 
    #   * :sort (Hash)
    #     * :field (SquareApiClient::SEARCH_EVENTS_SORT_FIELD) 
    #     * :order (SquareApiClient::SortOrder) 
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::SearchEventsResponse]
    # @example
...
#  api.events.search_events
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/events"
      ...
      SquareApiClient::SearchEventsResponse.from_json(json_object: response.body)
    end
...
#  even if you re-enable them later.
    #
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::DisableEventsResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.events.disable_events
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/events/disable"
      ...
      SquareApiClient::DisableEventsResponse.from_json(json_object: response.body)
    end
# Enables events to make them searchable. Only events that occur while in the
#  enabled state are searchable.
    #
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::EnableEventsResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.events.enable_events
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/events/enable"
      ...
      SquareApiClient::EnableEventsResponse.from_json(json_object: response.body)
    end
...
#  default version used by the application.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::ListEventTypesResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.events.list_event_types
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/events/types"
      ...
      SquareApiClient::ListEventTypesResponse.from_json(json_object: response.body)
    end
  end
