...
#  format.  The
#  range is determined using the `updated_at` field for each Payment.
    # @param sort_field [SquareApiClient::ListPaymentsRequestSortField] The field used to sort results by. The default is `CREATED_AT`.
...
#  api.payments.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/payments"
      ...
      SquareApiClient::ListPaymentsResponse.from_json(json_object: response.body)
    end
...
#  that is accepting the payment.Request of type SquareApiClient::Money, as a Hash
    #   * :amount (Long) 
...
#  3. The phone number must contain between 9 and 16 digits.
    # @param billing_address [Hash] The buyer's billing address.Request of type SquareApiClient::Address, as a Hash
    ...
    #   * :first_name (String) 
    #   * :last_name (String) 
    # @param shipping_address [Hash] The buyer's shipping address.Request of type SquareApiClient::Address, as a Hash
    #   * :address_line_1 (String) 
    #   * :address_line_2 (String) 
    #   * :address_line_3 (String) 
    #   * :locality (String) 
...
#  seller taking the payment.
    # @param cash_details [Hash] Additional details required when recording a cash payment (`source_id` is CASH).Request of type SquareApiClient::CashPaymentDetails, as a Hash
...
#  EXTERNAL).Request of type SquareApiClient::ExternalPaymentDetails, as a Hash
    #   * :type (String) 
    #   * :source (String) 
    #   * :source_id (String) 
    ...
    #     * :amount (Long) 
    #     * :currency (SquareApiClient::Currency) 
    # @param customer_details [Hash] Details about the customer making the payment.Request of type SquareApiClient::CustomerDetails, as a Hash
...
#  for
#  internal 1st-party callers only.Request of type SquareApiClient::OfflinePaymentDetails, as a Hash
    #   * :client_created_at (String) 
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::CreatePaymentResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/payments"
      ...
      SquareApiClient::CreatePaymentResponse.from_json(json_object: response.body)
    end
...
#  returns successfully.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::CancelPaymentByIdempotencyKeyResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.payments.cancel_by_idempotency_key(idempotency_key: "a7e36d40-d24b-11e8-b568-0800200c9a66")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/payments/cancel"
      ...
      SquareApiClient::CancelPaymentByIdempotencyKeyResponse.from_json(json_object: response.body)
    end
# Retrieves details for a specific payment.
    #
    # @param payment_id [String] A unique ID for the desired payment.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetPaymentResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.payments.get(payment_id: "payment_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/payments/#{payment_id}"
      ...
      SquareApiClient::GetPaymentResponse.from_json(json_object: response.body)
    end
# Updates a payment with the APPROVED status.
#  You can update the `amount_money` and `tip_money` using this endpoint.
    #
    # @param payment_id [String] The ID of the payment to update.
    # @param payment [Hash] The updated `Payment` object.Request of type SquareApiClient::Payment, as a Hash
    #   * :id (String) 
    #   * :created_at (String) 
    #   * :updated_at (String) 
    #   * :amount_money (Hash)
    ...
    #     * :amount (Long) 
    #     * :currency (SquareApiClient::Currency) 
    #   * :processing_fee (Array<SquareApiClient::ProcessingFee>) 
    #   * :refunded_money (Hash)
    #     * :amount (Long) 
    #     * :currency (SquareApiClient::Currency) 
    #   * :status (String) 
    ...
    #     * :errors (Array<SquareApiClient::Error>) 
    #   * :cash_details (Hash)
    #     * :buyer_supplied_money (Hash)
    #       * :amount (Long) 
    #       * :currency (SquareApiClient::Currency) 
    ...
    #     * :created_at (String) 
    #     * :risk_level (SquareApiClient::RiskEvaluationRiskLevel) 
    ...
    #     * :square_product (SquareApiClient::ApplicationDetailsExternalSquareProduct) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::UpdatePaymentResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/payments/#{payment_id}"
      ...
      SquareApiClient::UpdatePaymentResponse.from_json(json_object: response.body)
    end
...
#  the APPROVED `status`.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::CancelPaymentResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.payments.cancel(payment_id: "payment_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/payments/#{payment_id}/cancel"
      ...
      SquareApiClient::CancelPaymentResponse.from_json(json_object: response.body)
    end
...
#  api.payments.complete(payment_id: "payment_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/payments/#{payment_id}/complete"
      ...
      SquareApiClient::CompletePaymentResponse.from_json(json_object: response.body)
    end
  end
