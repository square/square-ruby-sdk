...
module SquareApiClient
  ...
  # @return [SquareApiClient::GiftCards::ActivitiesClient] 
    ...
    def initialize(request_client:)
      ...
      @activities = SquareApiClient::GiftCards::ActivitiesClient.new(request_client: request_client)
    end
...
#  the specified customer.
    ...
    # @return [SquareApiClient::ListGiftCardsResponse]
    # @example
...
#  api.gift_cards.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards"
      ...
      SquareApiClient::ListGiftCardsResponse.from_json(json_object: response.body)
    end
...
#  from Square,
#  include `gan` and provide the GAN that is printed on the gift card.Request of type SquareApiClient::GiftCard, as a Hash
    #   * :id (String) 
    #   * :type (SquareApiClient::GiftCardType) 
    #   * :gan_source (SquareApiClient::GiftCardGanSource) 
    #   * :state (SquareApiClient::GiftCardStatus) 
    #   * :balance_money (Hash)
    #     * :amount (Long) 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards"
      ...
      SquareApiClient::CreateGiftCardResponse.from_json(json_object: response.body)
    end
...
#  Square-issued gift cards have 16-digit GANs.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetGiftCardFromGanResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.gift_cards.get_from_gan(gan: "7783320001001635")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards/from-gan"
      ...
      SquareApiClient::GetGiftCardFromGanResponse.from_json(json_object: response.body)
    end
...
#  Web Payments SDK or In-App Payments SDK.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetGiftCardFromNonceResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.gift_cards.get_from_nonce(nonce: "cnon:7783322135245171")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards/from-nonce"
      ...
      SquareApiClient::GetGiftCardFromNonceResponse.from_json(json_object: response.body)
    end
...
#  file.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::LinkCustomerToGiftCardResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.gift_cards.link_customer(gift_card_id: "gift_card_id", customer_id: "GKY0FZ3V717AH8Q2D821PNT2ZW")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards/#{gift_card_id}/link-customer"
      ...
      SquareApiClient::LinkCustomerToGiftCardResponse.from_json(json_object: response.body)
    end
...
#  card on file.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::UnlinkCustomerFromGiftCardResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.gift_cards.unlink_customer(gift_card_id: "gift_card_id", customer_id: "GKY0FZ3V717AH8Q2D821PNT2ZW")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards/#{gift_card_id}/unlink-customer"
      ...
      SquareApiClient::UnlinkCustomerFromGiftCardResponse.from_json(json_object: response.body)
    end
# Retrieves a gift card using the gift card ID.
    #
    # @param id [String] The ID of the gift card to retrieve.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetGiftCardResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.gift_cards.get(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/gift-cards/#{id}"
      ...
      SquareApiClient::GetGiftCardResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [SquareApiClient::GiftCards::ActivitiesClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @activities = SquareApiClient::GiftCards::AsyncActivitiesClient.new(request_client: request_client)
    end
# Lists all gift cards. You can specify optional filters to retrieve
#  a subset of the gift cards. Results are sorted by `created_at` in ascending
#  order.
