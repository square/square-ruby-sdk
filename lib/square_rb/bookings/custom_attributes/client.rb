...
#  or *Appointments Premium*.
      #
      # @param values [Hash{String => SquareApiClient::BookingCustomAttributeDeleteRequest}] A map containing 1 to 25 individual Delete requests. For each request, provide
#  an
...
#  information needed to delete a custom attribute.
      ...
      # @return [SquareApiClient::BulkDeleteBookingCustomAttributesResponse]
      # @example
...
#  api.bookings.custom_attributes.batch_delete(values: { "key": { booking_id: "booking_id", key: "key" } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/custom-attributes/bulk-delete"
        ...
        SquareApiClient::BulkDeleteBookingCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  or *Appointments Premium*.
      #
      # @param values [Hash{String => SquareApiClient::BookingCustomAttributeUpsertRequest}] A map containing 1 to 25 individual upsert requests. For each request, provide
#  an
#  arbitrary ID that is unique for this `BulkUpsertBookingCustomAttributes` request
#  and the
#  information needed to create or update a custom attribute.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::BulkUpsertBookingCustomAttributesResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attributes.batch_upsert(values: { "key": { booking_id: "booking_id", custom_attribute: {  } } })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/custom-attributes/bulk-upsert"
        ...
        SquareApiClient::BulkUpsertBookingCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  default value is `false`.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::ListBookingCustomAttributesResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attributes.list(booking_id: "booking_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/#{booking_id}/custom-attributes"
        ...
        SquareApiClient::ListBookingCustomAttributesResponse.from_json(json_object: response.body)
      end
...
#  higher than the current version, Square returns a `BAD_REQUEST` error.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::RetrieveBookingCustomAttributeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attributes.get(booking_id: "booking_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/#{booking_id}/custom-attributes/#{key}"
        ...
        SquareApiClient::RetrieveBookingCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  current version
#  of the custom attribute.Request of type SquareApiClient::CustomAttribute, as a Hash
      #   * :key (String) 
      #   * :value (Object) 
      #   * :version (Integer) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpsertBookingCustomAttributeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/#{booking_id}/custom-attributes/#{key}"
        ...
        SquareApiClient::UpsertBookingCustomAttributeResponse.from_json(json_object: response.body)
      end
...
#  definition owner, you must use the qualified key.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteBookingCustomAttributeResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bookings.custom_attributes.delete(booking_id: "booking_id", key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bookings/#{booking_id}/custom-attributes/#{key}"
        ...
        SquareApiClient::DeleteBookingCustomAttributeResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Bookings::AsyncCustomAttributesClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Bulk deletes bookings custom attributes.
