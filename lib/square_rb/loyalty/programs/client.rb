  ...
  module Loyalty
    ...
    # @return [SquareApiClient::Loyalty::Programs::PromotionsClient] 
      ...
      def initialize(request_client:)
        ...
        @promotions = SquareApiClient::Loyalty::Programs::PromotionsClient.new(request_client: request_client)
      end
...
#  api.loyalty.programs.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/programs"
        ...
        SquareApiClient::ListLoyaltyProgramsResponse.from_json(json_object: response.body)
      end
...
#  retrieve the single loyalty program that belongs to the seller.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetLoyaltyProgramResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.loyalty.programs.get(program_id: "program_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/programs/#{program_id}"
        ...
        SquareApiClient::GetLoyaltyProgramResponse.from_json(json_object: response.body)
      end
...
#  orders.
#  Otherwise, specify the `order_id`.Request of type SquareApiClient::Money, as a Hash
      #   * :amount (Long) 
...
#  for regardless of the trigger limit.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CalculateLoyaltyPointsResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/loyalty/programs/#{program_id}/calculate"
        ...
        SquareApiClient::CalculateLoyaltyPointsResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::Loyalty::Programs::PromotionsClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Loyalty::AsyncProgramsClient]
      def initialize(request_client:)
        @request_client = request_client
        @promotions = SquareApiClient::Loyalty::Programs::AsyncPromotionsClient.new(request_client: request_client)
      end
# Returns a list of loyalty programs in the seller's account.
#  Loyalty programs define how buyers can earn points and redeem points for
#  rewards. Square sellers can have only one loyalty program, which is created and
