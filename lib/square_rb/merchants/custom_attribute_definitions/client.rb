...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
      ...
      # @return [SquareApiClient::ListMerchantCustomAttributeDefinitionsResponse]
      # @example
...
#  api.merchants.custom_attribute_definitions.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/custom-attribute-definitions"
        ...
        SquareApiClient::ListMerchantCustomAttributeDefinitionsResponse.from_json(json_object: response.body)
      end
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CreateMerchantCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.merchants.custom_attribute_definitions.create(custom_attribute_definition: { key: "alternative_seller_name", schema: { "ref": "https://developer-production-s.squarecdn.com/schemas/v1/common.json#squareup.common.String" }, name: "Alternative Merchant Name", description: "This is the other name this merchant goes by.", visibility: VISIBILITY_READ_ONLY })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/custom-attribute-definitions"
        ...
        SquareApiClient::CreateMerchantCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  is higher than the current version, Square returns a `BAD_REQUEST` error.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::RetrieveMerchantCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.merchants.custom_attribute_definitions.get(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::RetrieveMerchantCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  other values, the request fails with a BAD_REQUEST error.Request of type SquareApiClient::CustomAttributeDefinition, as a Hash
      #   * :key (String) 
      #   * :schema (Hash{String => Object}) 
      #   * :name (String) 
      #   * :description (String) 
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::UpdateMerchantCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.merchants.custom_attribute_definitions.update(key: "key", custom_attribute_definition: { description: "Update the description as desired.", visibility: VISIBILITY_READ_ONLY })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::UpdateMerchantCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
...
#  Only the definition owner can delete a custom attribute definition.
      ...
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteMerchantCustomAttributeDefinitionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.merchants.custom_attribute_definitions.delete(key: "key")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/merchants/custom-attribute-definitions/#{key}"
        ...
        SquareApiClient::DeleteMerchantCustomAttributeDefinitionResponse.from_json(json_object: response.body)
      end
    end
    ...
    # @return [SquareApiClient::AsyncRequestClient] 
      ...
      # @param request_client [SquareApiClient::RequestClient] 
      # @return [SquareApiClient::Merchants::AsyncCustomAttributeDefinitionsClient]
      def initialize(request_client:)
        @request_client = request_client
      end
# Lists the merchant-related [custom attribute
