...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogModifier] Structured data for a `CatalogModifier`, set for CatalogObjects of type
#  `MODIFIER`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param modifier_data [SquareApiClient::CatalogModifier] Structured data for a `CatalogModifier`, set for CatalogObjects of type
#  `MODIFIER`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectModifier]
...
# Deserialize a JSON object to an instance of CatalogObjectModifier
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["modifier_data"].nil?
        ...
        modifier_data = SquareApiClient::CatalogModifier.from_json(json_object: modifier_data)
      else
        modifier_data = nil
      end
      id = parsed_json["id"]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.modifier_data.nil? || SquareApiClient::CatalogModifier.validate_raw(obj: obj.modifier_data)
