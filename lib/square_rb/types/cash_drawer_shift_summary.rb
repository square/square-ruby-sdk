...
#  See [CashDrawerShiftState](#type-cashdrawershiftstate) for possible values
  ...
  # @return [SquareApiClient::Money] The amount of money in the cash drawer at the start of the shift. This
...
#  result in an incorrect expected_cash_money amount that can be negative.
  ...
  # @return [SquareApiClient::Money] The amount of money found in the cash drawer at the end of the shift by
...
#  See [CashDrawerShiftState](#type-cashdrawershiftstate) for possible values
    ...
    # @param opened_cash_money [SquareApiClient::Money] The amount of money in the cash drawer at the start of the shift. This
#  must be a positive amount.
...
#  cash drawer shift events. Unrecorded events and events with the wrong amount
#  result in an incorrect expected_cash_money amount that can be negative.
    # @param closed_cash_money [SquareApiClient::Money] The amount of money found in the cash drawer at the end of the shift by
#  an auditing employee. The amount must be greater than or equal to zero.
    ...
    # @return [SquareApiClient::CashDrawerShiftSummary]
