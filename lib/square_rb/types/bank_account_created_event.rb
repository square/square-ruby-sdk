...
require_relative "bank_account_created_event_data"
require "ostruct"
require "json"
...
#  `VERIFICATION_IN_PROGRESS` and publishes the event.
  ...
  # @return [String] The type of event this represents, `"bank_account.created"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::BankAccountCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"bank_account.created"`.
    ...
    # @param data [SquareApiClient::BankAccountCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BankAccountCreatedEvent]
...
# Deserialize a JSON object to an instance of BankAccountCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::BankAccountCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of BankAccountCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::BankAccountCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end