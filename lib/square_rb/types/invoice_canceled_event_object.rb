...
module SquareApiClient
  class InvoiceCanceledEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::InvoiceCanceledEventObject]
...
# Deserialize a JSON object to an instance of InvoiceCanceledEventObject
    #
...
# Serialize an instance of InvoiceCanceledEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
