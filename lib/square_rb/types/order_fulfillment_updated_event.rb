...
require_relative "order_fulfillment_updated_event_data"
require "ostruct"
require "json"
...
#  [UpdateOrder](api-endpoint:Orders-UpdateOrder) endpoint call.
  class OrderFulfillmentUpdatedEvent
  # @return [String] The ID of the target merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event this represents, `"order.fulfillment.updated"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::OrderFulfillmentUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"order.fulfillment.updated"`.
    ...
    # @param data [SquareApiClient::OrderFulfillmentUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderFulfillmentUpdatedEvent]
...
# Deserialize a JSON object to an instance of OrderFulfillmentUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::OrderFulfillmentUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of OrderFulfillmentUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::OrderFulfillmentUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end