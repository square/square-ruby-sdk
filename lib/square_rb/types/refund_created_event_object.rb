...
module SquareApiClient
  ...
  # @return [SquareApiClient::PaymentRefund] The created refund.
    attr_reader :refund
  ...
  # @return [Object] 
    ...
    # @param refund [SquareApiClient::PaymentRefund] The created refund.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::RefundCreatedEventObject]
