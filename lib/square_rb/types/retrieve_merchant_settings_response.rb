...
module SquareApiClient
  class RetrieveMerchantSettingsResponse
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::CheckoutMerchantSettings] The merchant settings.
  ...
  # @return [Object] 
    ...
    # @param merchant_settings [SquareApiClient::CheckoutMerchantSettings] The merchant settings.
...
# Deserialize a JSON object to an instance of RetrieveMerchantSettingsResponse
    #
...
# Serialize an instance of RetrieveMerchantSettingsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
