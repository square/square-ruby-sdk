...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogImage] Structured data for a `CatalogImage`, set for CatalogObjects of type `IMAGE`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param image_data [SquareApiClient::CatalogImage] Structured data for a `CatalogImage`, set for CatalogObjects of type `IMAGE`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectImage]
...
# Deserialize a JSON object to an instance of CatalogObjectImage
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["image_data"].nil?
        ...
        image_data = SquareApiClient::CatalogImage.from_json(json_object: image_data)
      else
        image_data = nil
      end
      id = parsed_json["id"]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.image_data.nil? || SquareApiClient::CatalogImage.validate_raw(obj: obj.image_data)
