...
# Provides metadata when the event `type` is `OTHER`.
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::LoyaltyEventOther]
...
# Deserialize a JSON object to an instance of LoyaltyEventOther
    #
...
# Serialize an instance of LoyaltyEventOther to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
