...
#  request.
  ...
  # @return [Hash{String => SquareApiClient::BatchUpsertCustomerCustomAttributesResponseCustomerCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
...
#  `custom_attribute` or an `errors` field.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => SquareApiClient::BatchUpsertCustomerCustomAttributesResponseCustomerCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
#  same ID as the corresponding request and contains either a `customer_id` and
#  `custom_attribute` or an `errors` field.
...
#  BatchUpsertCustomerCustomAttributesResponse
  ...
  value = value.to_json
  SquareApiClient::BatchUpsertCustomerCustomAttributesResponseCustomerCustomAttributeUpsertResponse.from_json(json_object: value)
end
