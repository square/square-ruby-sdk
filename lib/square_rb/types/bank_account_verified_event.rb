...
require_relative "bank_account_verified_event_data"
require "ostruct"
require "json"
...
#  [BankAccount](entity:BankAccount) to `VERIFIED`.
  ...
  # @return [String] The type of event this represents, `"bank_account.verified"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was verified, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::BankAccountVerifiedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"bank_account.verified"`.
    ...
    # @param data [SquareApiClient::BankAccountVerifiedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BankAccountVerifiedEvent]
...
# Deserialize a JSON object to an instance of BankAccountVerifiedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::BankAccountVerifiedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of BankAccountVerifiedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::BankAccountVerifiedEventData.validate_raw(obj: obj.data)
    end
  end
end