...
#  the transaction.
  ...
  # @return [Array<SquareApiClient::Tender>] The tenders used to pay in the transaction.
    attr_reader :tenders
  # @return [Array<SquareApiClient::Refund>] Refunds that have been applied to any tender in the transaction.
    attr_reader :refunds
...
#  parameter in the request to that endpoint. Otherwise, it is not set.
  ...
  # @return [SquareApiClient::TransactionProduct] The Square product that processed the transaction.
...
#  lookup by this value.
  ...
  # @return [SquareApiClient::Address] The shipping address provided in the request, if any.
...
#  any.
  ...
  # @return [Object] 
    ...
    # @param tenders [Array<SquareApiClient::Tender>] The tenders used to pay in the transaction.
    # @param refunds [Array<SquareApiClient::Refund>] Refunds that have been applied to any tender in the transaction.
    # @param reference_id [String] If the transaction was created with the
#  [Charge](api-endpoint:Transactions-Charge)
#  endpoint, this value is the same as the value provided for the `reference_id`
#  parameter in the request to that endpoint. Otherwise, it is not set.
    # @param product [SquareApiClient::TransactionProduct] The Square product that processed the transaction.
#  See [TransactionProduct](#type-transactionproduct) for possible values
...
#  It is not currently possible with the Connect API to perform a transaction
#  lookup by this value.
    # @param shipping_address [SquareApiClient::Address] The shipping address provided in the request, if any.
...
#  any.
    ...
    # @return [SquareApiClient::Transaction]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.product&.is_a?(SquareApiClient::TransactionProduct) != false || raise("Passed value for field obj.product is not the expected type, validation failed.")
