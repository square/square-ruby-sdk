...
module SquareApiClient
  ...
  # @return [SquareApiClient::CheckoutMerchantSettingsPaymentMethods] The set of payment methods accepted for the merchant's account.
...
#  Pacific Standard Time with UTC offset: 2020-01-25T18:25:34-08:00
  ...
  # @return [Object] 
    ...
    # @param payment_methods [SquareApiClient::CheckoutMerchantSettingsPaymentMethods] The set of payment methods accepted for the merchant's account.
    # @param updated_at [String] The timestamp when the settings were last updated, in RFC 3339 format.
#  Examples for January 25th, 2020 6:25:34pm Pacific Standard Time:
#  UTC: 2020-01-26T02:25:34Z
#  Pacific Standard Time with UTC offset: 2020-01-25T18:25:34-08:00
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CheckoutMerchantSettings]
...
# Deserialize a JSON object to an instance of CheckoutMerchantSettings
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["payment_methods"].nil?
        ...
        payment_methods = SquareApiClient::CheckoutMerchantSettingsPaymentMethods.from_json(json_object: payment_methods)
      else
        payment_methods = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.payment_methods.nil? || SquareApiClient::CheckoutMerchantSettingsPaymentMethods.validate_raw(obj: obj.payment_methods)
