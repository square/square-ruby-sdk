...
require_relative "labor_shift_deleted_event_data"
require "ostruct"
require "json"
...
#  `labor.timecard.deleted`.
  class LaborShiftDeletedEvent
  # @return [String] The ID of the merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event. For this event, the value is `labor.shift.deleted`.
    attr_reader :type
  ...
  # @return [SquareApiClient::LaborShiftDeletedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this event, the value is `labor.shift.deleted`.
    ...
    # @param data [SquareApiClient::LaborShiftDeletedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborShiftDeletedEvent]
...
# Deserialize a JSON object to an instance of LaborShiftDeletedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborShiftDeletedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborShiftDeletedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborShiftDeletedEventData.validate_raw(obj: obj.data)
    end
  end
end