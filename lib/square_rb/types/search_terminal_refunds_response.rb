...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::TerminalRefund>] The requested search result of `TerminalRefund` objects.
    attr_reader :refunds
...
#  for more information.
  ...
  # @return [Object] 
    ...
    # @param refunds [Array<SquareApiClient::TerminalRefund>] The requested search result of `TerminalRefund` objects.
...
#  for more information.
    ...
    def initialize(errors: OMIT, refunds: OMIT, cursor: OMIT, additional_properties: nil)
      @errors = errors if errors != OMIT
      @refunds = refunds if refunds != OMIT
      @cursor = cursor if cursor != OMIT
      @additional_properties = additional_properties
      @_field_set = { "errors": errors, "refunds": refunds, "cursor": cursor }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of SearchTerminalRefundsResponse
    #
  ...
  item = item.to_json
  SquareApiClient::TerminalRefund.from_json(json_object: item)
end
...
# Serialize an instance of SearchTerminalRefundsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
