...
#  present.
  ...
  # @return [Array<SquareApiClient::EventTypeMetadata>] Contains the metadata of a webhook event type. For more information, see
#  [EventTypeMetadata](entity:EventTypeMetadata).
  ...
  # @return [Object] 
    ...
    # @param metadata [Array<SquareApiClient::EventTypeMetadata>] Contains the metadata of a webhook event type. For more information, see
#  [EventTypeMetadata](entity:EventTypeMetadata).
...
# Deserialize a JSON object to an instance of ListWebhookEventTypesResponse
    #
  ...
  item = item.to_json
  SquareApiClient::EventTypeMetadata.from_json(json_object: item)
end
      new(
        errors: errors,
...
# Serialize an instance of ListWebhookEventTypesResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
