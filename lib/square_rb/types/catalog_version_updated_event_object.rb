...
module SquareApiClient
  ...
  # @return [SquareApiClient::CatalogVersionUpdatedEventCatalogVersion] The version of the object.
  ...
  # @return [Object] 
    ...
    # @param catalog_version [SquareApiClient::CatalogVersionUpdatedEventCatalogVersion] The version of the object.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogVersionUpdatedEventObject]
...
# Deserialize a JSON object to an instance of CatalogVersionUpdatedEventObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["catalog_version"].nil?
        ...
        catalog_version = SquareApiClient::CatalogVersionUpdatedEventCatalogVersion.from_json(json_object: catalog_version)
      else
        catalog_version = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.catalog_version.nil? || SquareApiClient::CatalogVersionUpdatedEventCatalogVersion.validate_raw(obj: obj.catalog_version)
    end
  end
end