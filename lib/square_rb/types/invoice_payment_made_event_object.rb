...
module SquareApiClient
  class InvoicePaymentMadeEventObject
  # @return [SquareApiClient::Invoice] The related invoice.
    attr_reader :invoice
  ...
  # @return [Object] 
    ...
    # @param invoice [SquareApiClient::Invoice] The related invoice.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoicePaymentMadeEventObject]
...
# Deserialize a JSON object to an instance of InvoicePaymentMadeEventObject
    #
...
# Serialize an instance of InvoicePaymentMadeEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
