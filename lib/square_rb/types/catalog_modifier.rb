...
#  filters, and its value length is of Unicode code points.
    attr_reader :name
  # @return [SquareApiClient::Money] The modifier price.
...
#  `CatalogModifierListInfo.modifier_overrides`.
  ...
  # @return [Array<SquareApiClient::ModifierLocationOverrides>] Location-specific price overrides.
...
#  filters, and its value length is of Unicode code points.
    # @param price_money [SquareApiClient::Money] The modifier price.
...
#  `CatalogModifierListInfo.modifier_overrides`.
    ...
    # @param location_overrides [Array<SquareApiClient::ModifierLocationOverrides>] Location-specific price overrides.
...
#  `CatalogModifierListInfo.modifier_overrides`.
    ...
    # @return [SquareApiClient::CatalogModifier]
...
# Deserialize a JSON object to an instance of CatalogModifier
  ...
  item = item.to_json
  SquareApiClient::ModifierLocationOverrides.from_json(json_object: item)
end
