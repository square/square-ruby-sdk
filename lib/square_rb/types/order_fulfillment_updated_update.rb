...
# Information about fulfillment updates.
  ...
  # @return [SquareApiClient::FulfillmentState] The state of the fulfillment before the change.
#  The state is not populated if the fulfillment is created with this new `Order`
#  version.
    attr_reader :old_state
  # @return [SquareApiClient::FulfillmentState] The state of the fulfillment after the change. The state might be equal to
...
#  field was changed on the fulfillment (such as the tracking number).
  ...
  # @return [Object] 
    ...
    # @param old_state [SquareApiClient::FulfillmentState] The state of the fulfillment before the change.
#  The state is not populated if the fulfillment is created with this new `Order`
#  version.
    # @param new_state [SquareApiClient::FulfillmentState] The state of the fulfillment after the change. The state might be equal to
#  `old_state` if a non-state
#  field was changed on the fulfillment (such as the tracking number).
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderFulfillmentUpdatedUpdate]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.old_state&.is_a?(SquareApiClient::FulfillmentState) != false || raise("Passed value for field obj.old_state is not the expected type, validation failed.")
      obj.new_state&.is_a?(SquareApiClient::FulfillmentState) != false || raise("Passed value for field obj.new_state is not the expected type, validation failed.")
    end
  end
end