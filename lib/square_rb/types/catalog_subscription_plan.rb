...
#  ns](https://developer.squareup.com/docs/subscriptions-api/plans-and-variations).
  ...
  # @return [String] The name of the plan.
    attr_reader :name
  # @return [Array<SquareApiClient::SubscriptionPhase>] A list of SubscriptionPhase containing the
...
#  REQUIRED_FIELD_MISSING error
    attr_reader :phases
  # @return [Array<SquareApiClient::CatalogObject>] The list of subscription plan variations available for this product
...
#  SubscriptionPlan.
  ...
  # @return [Object] 
    ...
    # @param phases [Array<SquareApiClient::SubscriptionPhase>] A list of SubscriptionPhase containing the
#  [SubscriptionPhase](entity:SubscriptionPhase) for this plan.
#  This field it required. Not including this field will throw a
#  REQUIRED_FIELD_MISSING error
    # @param subscription_plan_variations [Array<SquareApiClient::CatalogObject>] The list of subscription plan variations available for this product
...
#  SubscriptionPlan.
    ...
    # @return [SquareApiClient::CatalogSubscriptionPlan]
