...
#  system.
  ...
  # @return [SquareApiClient::InventoryState] The [inventory state](entity:InventoryState) of the related quantity
...
#  Can support up to 5 digits after the decimal point.
  ...
  # @return [SquareApiClient::Money] The total price paid for goods associated with the
...
#  received.
  ...
  # @return [SquareApiClient::SourceApplication] Information about the application that caused the
...
#  app.
  ...
  # @return [SquareApiClient::InventoryAdjustmentGroup] An adjustment group bundling the related adjustments of item variations through
...
#  `InventoryAdjustment` to an external
#  system.
    # @param from_state [SquareApiClient::InventoryState] The [inventory state](entity:InventoryState) of the related quantity
#  of items before the adjustment.
#  See [InventoryState](#type-inventorystate) for possible values
    # @param to_state [SquareApiClient::InventoryState] The [inventory state](entity:InventoryState) of the related quantity
#  of items after the adjustment.
#  See [InventoryState](#type-inventorystate) for possible values
...
#  Can support up to 5 digits after the decimal point.
    # @param total_price_money [SquareApiClient::Money] The total price paid for goods associated with the
#  adjustment. Present if and only if `to_state` is `SOLD`. Always
#  non-negative.
...
#  received.
    # @param source [SquareApiClient::SourceApplication] Information about the application that caused the
#  inventory adjustment.
...
#  adjustment. Only relevant for state transitions from the Square for Retail
#  app.
    # @param adjustment_group [SquareApiClient::InventoryAdjustmentGroup] An adjustment group bundling the related adjustments of item variations through
#  stock conversions in a single inventory event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InventoryAdjustment]
...
# Deserialize a JSON object to an instance of InventoryAdjustment
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["adjustment_group"].nil?
        ...
        adjustment_group = SquareApiClient::InventoryAdjustmentGroup.from_json(json_object: adjustment_group)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.from_state&.is_a?(SquareApiClient::InventoryState) != false || raise("Passed value for field obj.from_state is not the expected type, validation failed.")
      obj.to_state&.is_a?(SquareApiClient::InventoryState) != false || raise("Passed value for field obj.to_state is not the expected type, validation failed.")
      ...
      obj.adjustment_group.nil? || SquareApiClient::InventoryAdjustmentGroup.validate_raw(obj: obj.adjustment_group)
    end
  end
end