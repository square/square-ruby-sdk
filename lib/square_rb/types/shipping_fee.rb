...
module SquareApiClient
  ...
  # @return [String] The name for the shipping fee.
    attr_reader :name
  # @return [SquareApiClient::Money] The amount and currency for the shipping fee.
    attr_reader :charge
  ...
  # @return [Object] 
    ...
    # @param charge [SquareApiClient::Money] The amount and currency for the shipping fee.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::ShippingFee]
...
# Deserialize a JSON object to an instance of ShippingFee
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["charge"].nil?
        ...
        charge = SquareApiClient::Money.from_json(json_object: charge)
      else
        charge = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      SquareApiClient::Money.validate_raw(obj: obj.charge)
    end
  end
end