...
require_relative "payout_paid_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [Payout](entity:Payout) is complete.
  class PayoutPaidEvent
  ...
  # @return [String] The type of event this represents, `"payout.paid"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was verified, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::PayoutPaidEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"payout.paid"`.
    ...
    # @param data [SquareApiClient::PayoutPaidEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PayoutPaidEvent]
...
# Deserialize a JSON object to an instance of PayoutPaidEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::PayoutPaidEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of PayoutPaidEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::PayoutPaidEventData.validate_raw(obj: obj.data)
    end
  end
end