...
module SquareApiClient
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivitySquareCapitalReversedPaymentDetail]
...
#  PaymentBalanceActivitySquareCapitalReversedPaymentDetail to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
