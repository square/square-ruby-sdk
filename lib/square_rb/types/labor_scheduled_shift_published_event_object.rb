...
module SquareApiClient
  ...
  # @return [SquareApiClient::ScheduledShift] The published `ScheduledShift`.
  ...
  # @return [Object] 
    ...
    # @param scheduled_shift [SquareApiClient::ScheduledShift] The published `ScheduledShift`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborScheduledShiftPublishedEventObject]
