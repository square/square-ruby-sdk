...
# Published when a Team Member is updated.
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"team_member.updated"`.
    ...
    # @param data [SquareApiClient::TeamMemberUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TeamMemberUpdatedEvent]
...
# Deserialize a JSON object to an instance of TeamMemberUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::TeamMemberUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of TeamMemberUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::TeamMemberUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end