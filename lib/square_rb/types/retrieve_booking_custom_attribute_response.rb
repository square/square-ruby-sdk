...
# Represents a
#  mAttribute](api-endpoint:BookingCustomAttributes-RetrieveBookingCustomAttribute)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class RetrieveBookingCustomAttributeResponse
...
# Serialize an instance of RetrieveBookingCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
