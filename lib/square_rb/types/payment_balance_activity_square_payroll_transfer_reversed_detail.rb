...
module SquareApiClient
  class PaymentBalanceActivitySquarePayrollTransferReversedDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivitySquarePayrollTransferReversedDetail]
...
#  PaymentBalanceActivitySquarePayrollTransferReversedDetail to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
