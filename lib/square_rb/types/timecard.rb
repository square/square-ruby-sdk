...
#  truncated.
    attr_reader :end_at
  # @return [SquareApiClient::TimecardWage] Job and pay related information. If the wage is not set on create, it defaults
#  to a wage
#  of zero. If the title is not set on create, it defaults to the name of the role
#  the team member
#  is assigned to, if any.
    attr_reader :wage
  # @return [Array<SquareApiClient::Break>] A list of all the paid or unpaid breaks that were taken during this timecard.
    attr_reader :breaks
  # @return [SquareApiClient::TimecardStatus] Describes the working state of the timecard.
...
#  presented as UTC.
  ...
  # @return [SquareApiClient::Money] The cash tips declared by the team member for this timecard.
...
#  timezone + offset. Precision up to the minute is respected; seconds are
#  truncated.
    # @param wage [SquareApiClient::TimecardWage] Job and pay related information. If the wage is not set on create, it defaults
#  to a wage
#  of zero. If the title is not set on create, it defaults to the name of the role
#  the team member
#  is assigned to, if any.
    # @param breaks [Array<SquareApiClient::Break>] A list of all the paid or unpaid breaks that were taken during this timecard.
    # @param status [SquareApiClient::TimecardStatus] Describes the working state of the timecard.
#  See [TimecardStatus](#type-timecardstatus) for possible values
...
#  presented as UTC.
    ...
    # @param declared_cash_tip_money [SquareApiClient::Money] The cash tips declared by the team member for this timecard.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Timecard]
...
# Deserialize a JSON object to an instance of Timecard
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["wage"].nil?
        ...
        wage = SquareApiClient::TimecardWage.from_json(json_object: wage)
      else
        wage = nil
      end
      breaks = parsed_json["breaks"]&.map do | item |
  item = item.to_json
  SquareApiClient::Break.from_json(json_object: item)
end
      ...
      unless parsed_json["declared_cash_tip_money"].nil?
        ...
        declared_cash_tip_money = SquareApiClient::Money.from_json(json_object: declared_cash_tip_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.wage.nil? || SquareApiClient::TimecardWage.validate_raw(obj: obj.wage)
      obj.breaks&.is_a?(Array) != false || raise("Passed value for field obj.breaks is not the expected type, validation failed.")
      obj.status&.is_a?(SquareApiClient::TimecardStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.declared_cash_tip_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.declared_cash_tip_money)
    end
  end
end