...
module SquareApiClient
  ...
  # @return [SquareApiClient::CheckoutLocationSettingsBrandingHeaderType] Show the location logo on the checkout page.
...
#  "#FFFFFF").
  ...
  # @return [SquareApiClient::CheckoutLocationSettingsBrandingButtonShape] The shape of the button on the checkout page.
#  See [ButtonShape](#type-buttonshape) for possible values
  ...
  # @return [Object] 
    ...
    # @param header_type [SquareApiClient::CheckoutLocationSettingsBrandingHeaderType] Show the location logo on the checkout page.
#  See [HeaderType](#type-headertype) for possible values
    # @param button_color [String] The HTML-supported hex color for the button on the checkout page (for example,
#  "#FFFFFF").
    # @param button_shape [SquareApiClient::CheckoutLocationSettingsBrandingButtonShape] The shape of the button on the checkout page.
#  See [ButtonShape](#type-buttonshape) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CheckoutLocationSettingsBranding]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.header_type&.is_a?(SquareApiClient::CheckoutLocationSettingsBrandingHeaderType) != false || raise("Passed value for field obj.header_type is not the expected type, validation failed.")
      ...
      obj.button_shape&.is_a?(SquareApiClient::CheckoutLocationSettingsBrandingButtonShape) != false || raise("Passed value for field obj.button_shape is not the expected type, validation failed.")
    end
  end
end