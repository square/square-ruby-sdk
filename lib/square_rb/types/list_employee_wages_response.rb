...
#  a set of `EmployeeWage` objects.
  ...
  # @return [Array<SquareApiClient::EmployeeWage>] A page of `EmployeeWage` results.
...
#  of `EmployeeWage` results.
  ...
  # @return [Object] 
    ...
    # @param employee_wages [Array<SquareApiClient::EmployeeWage>] A page of `EmployeeWage` results.
...
# Deserialize a JSON object to an instance of ListEmployeeWagesResponse
  ...
  item = item.to_json
  SquareApiClient::EmployeeWage.from_json(json_object: item)
end
