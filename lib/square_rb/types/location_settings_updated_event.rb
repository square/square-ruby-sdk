...
require_relative "location_settings_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when online checkout location settings are updated
  class LocationSettingsUpdatedEvent
...
#  `"online_checkout.location_settings.updated"`.
  ...
  # @return [SquareApiClient::LocationSettingsUpdatedEventData] Data associated with the event.
    attr_reader :data
...
#  `"online_checkout.location_settings.updated"`.
    ...
    # @param data [SquareApiClient::LocationSettingsUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LocationSettingsUpdatedEvent]
...
# Deserialize a JSON object to an instance of LocationSettingsUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LocationSettingsUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LocationSettingsUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LocationSettingsUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end