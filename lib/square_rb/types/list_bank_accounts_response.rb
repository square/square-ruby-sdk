...
# Response object returned by ListBankAccounts.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::BankAccount>] List of BankAccounts associated with this account.
...
#  [Pagination](https://developer.squareup.com/docs/working-with-apis/pagination).
  ...
  # @return [Object] 
    ...
    # @param bank_accounts [Array<SquareApiClient::BankAccount>] List of BankAccounts associated with this account.
...
# Deserialize a JSON object to an instance of ListBankAccountsResponse
  ...
  item = item.to_json
  SquareApiClient::BankAccount.from_json(json_object: item)
end
