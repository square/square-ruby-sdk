...
require_relative "terminal_refund_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a Terminal API refund is updated.
  class TerminalRefundUpdatedEvent
  # @return [String] The ID of the target merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event this represents, `"terminal.refund.updated"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] RFC 3339 timestamp of when the event was created.
    attr_reader :created_at
  # @return [SquareApiClient::TerminalRefundUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"terminal.refund.updated"`.
    # @param event_id [String] A unique ID for the event.
    # @param created_at [String] RFC 3339 timestamp of when the event was created.
    # @param data [SquareApiClient::TerminalRefundUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalRefundUpdatedEvent]
...
# Deserialize a JSON object to an instance of TerminalRefundUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::TerminalRefundUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of TerminalRefundUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::TerminalRefundUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end