...
# Stores details about a cash refund. Contains only non-confidential information.
  ...
  # @return [SquareApiClient::Money] The amount and currency of the money supplied by the seller.
    attr_reader :seller_supplied_money
  # @return [SquareApiClient::Money] The amount of change due back to the seller.
...
#  from the `amount_money` and `seller_supplied_money` fields.
  ...
  # @return [Object] 
    ...
    # @param seller_supplied_money [SquareApiClient::Money] The amount and currency of the money supplied by the seller.
    # @param change_back_money [SquareApiClient::Money] The amount of change due back to the seller.
#  This read-only field is calculated
#  from the `amount_money` and `seller_supplied_money` fields.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DestinationDetailsCashRefundDetails]
...
# Deserialize a JSON object to an instance of DestinationDetailsCashRefundDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["seller_supplied_money"].nil?
        ...
        seller_supplied_money = SquareApiClient::Money.from_json(json_object: seller_supplied_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      SquareApiClient::Money.validate_raw(obj: obj.seller_supplied_money)
