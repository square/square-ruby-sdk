...
#  respected; seconds are truncated.
    attr_reader :end_at
  # @return [SquareApiClient::ShiftWage] Job and pay related information. If the wage is not set on create, it defaults
#  to a wage
#  of zero. If the title is not set on create, it defaults to the name of the role
#  the employee
#  is assigned to, if any.
    attr_reader :wage
  # @return [Array<SquareApiClient::Break>] A list of all the paid or unpaid breaks that were taken during this shift.
    attr_reader :breaks
  # @return [SquareApiClient::ShiftStatus] Describes the working state of the current `Shift`.
...
#  version "2020-08-26".
  ...
  # @return [SquareApiClient::Money] The tips declared by the team member for the shift.
...
#  respected; seconds are truncated.
    # @param wage [SquareApiClient::ShiftWage] Job and pay related information. If the wage is not set on create, it defaults
#  to a wage
#  of zero. If the title is not set on create, it defaults to the name of the role
#  the employee
#  is assigned to, if any.
    # @param breaks [Array<SquareApiClient::Break>] A list of all the paid or unpaid breaks that were taken during this shift.
    # @param status [SquareApiClient::ShiftStatus] Describes the working state of the current `Shift`.
#  See [ShiftStatus](#type-shiftstatus) for possible values
...
#  version "2020-08-26".
    # @param declared_cash_tip_money [SquareApiClient::Money] The tips declared by the team member for the shift.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Shift]
...
# Deserialize a JSON object to an instance of Shift
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["wage"].nil?
        ...
        wage = SquareApiClient::ShiftWage.from_json(json_object: wage)
      else
        wage = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.wage.nil? || SquareApiClient::ShiftWage.validate_raw(obj: obj.wage)
      obj.breaks&.is_a?(Array) != false || raise("Passed value for field obj.breaks is not the expected type, validation failed.")
      obj.status&.is_a?(SquareApiClient::ShiftStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
