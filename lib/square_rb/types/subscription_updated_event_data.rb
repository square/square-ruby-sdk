...
module SquareApiClient
  ...
  # @return [String] ID of the affected subscription.
    attr_reader :id
  # @return [SquareApiClient::SubscriptionUpdatedEventObject] An object containing the updated subscription.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::SubscriptionUpdatedEventObject] An object containing the updated subscription.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::SubscriptionUpdatedEventData]
...
# Deserialize a JSON object to an instance of SubscriptionUpdatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::SubscriptionUpdatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::SubscriptionUpdatedEventObject.validate_raw(obj: obj.object)
    end
  end
end