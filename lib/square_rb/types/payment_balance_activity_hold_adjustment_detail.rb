...
module SquareApiClient
  class PaymentBalanceActivityHoldAdjustmentDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivityHoldAdjustmentDetail]
...
# Serialize an instance of PaymentBalanceActivityHoldAdjustmentDetail to a JSON
#  object
    #
    # @return [String]
    def to_json
