...
# The search criteria for the loyalty accounts.
  ...
  # @return [Array<SquareApiClient::LoyaltyAccountMapping>] The set of mappings to use in the loyalty account search.
...
#  Max: 30 customer IDs
  ...
  # @return [Object] 
    ...
    # @param mappings [Array<SquareApiClient::LoyaltyAccountMapping>] The set of mappings to use in the loyalty account search.
#  This cannot be combined with `customer_ids`.
#  Max: 30 mappings
...
#  Max: 30 customer IDs
    ...
    # @return [SquareApiClient::SearchLoyaltyAccountsRequestLoyaltyAccountQuery]
...
#  SearchLoyaltyAccountsRequestLoyaltyAccountQuery
  ...
  item = item.to_json
  SquareApiClient::LoyaltyAccountMapping.from_json(json_object: item)
end
