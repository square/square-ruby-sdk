...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::InventoryCount>] The current calculated inventory counts for the requested object and
#  locations.
    attr_reader :counts
...
#  guide for more information.
  ...
  # @return [Object] 
    ...
    # @param counts [Array<SquareApiClient::InventoryCount>] The current calculated inventory counts for the requested object and
#  locations.
