...
#  es](https://developer.squareup.com/docs/labor-api/what-it-does#migration-notes).
  class ShiftQuery
  # @return [SquareApiClient::ShiftFilter] Query filter options.
    attr_reader :filter
  # @return [SquareApiClient::ShiftSort] Sort order details.
    attr_reader :sort
  ...
  # @return [Object] 
    ...
    # @param filter [SquareApiClient::ShiftFilter] Query filter options.
    # @param sort [SquareApiClient::ShiftSort] Sort order details.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::ShiftQuery]
...
# Deserialize a JSON object to an instance of ShiftQuery
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["filter"].nil?
        ...
        filter = SquareApiClient::ShiftFilter.from_json(json_object: filter)
      else
        filter = nil
      end
      unless parsed_json["sort"].nil?
        sort = parsed_json["sort"].to_json
        sort = SquareApiClient::ShiftSort.from_json(json_object: sort)
      else
        sort = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.filter.nil? || SquareApiClient::ShiftFilter.validate_raw(obj: obj.filter)
      obj.sort.nil? || SquareApiClient::ShiftSort.validate_raw(obj: obj.sort)
    end
  end
end