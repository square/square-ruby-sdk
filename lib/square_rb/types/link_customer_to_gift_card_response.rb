...
# A response that contains the linked `GiftCard` object. If the request resulted
#  in errors,
#  the response contains a set of `Error` objects.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::GiftCard] The gift card with the ID of the linked customer listed in the `customer_ids`
#  field.
  ...
  # @return [Object] 
    ...
    # @param gift_card [SquareApiClient::GiftCard] The gift card with the ID of the linked customer listed in the `customer_ids`
#  field.
...
# Deserialize a JSON object to an instance of LinkCustomerToGiftCardResponse
    #
...
# Serialize an instance of LinkCustomerToGiftCardResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
