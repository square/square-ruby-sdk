...
#  a request to the [CloneOrder](api-endpoint:Orders-CloneOrder) endpoint.
  class CloneOrderResponse
  # @return [SquareApiClient::Order] The cloned order.
    attr_reader :order
  ...
  # @return [Object] 
    ...
    # @param order [SquareApiClient::Order] The cloned order.
...
# Deserialize a JSON object to an instance of CloneOrderResponse
    #
...
# Serialize an instance of CloneOrderResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
