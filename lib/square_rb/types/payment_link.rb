...
#  It is primarily for use by your application and is not used anywhere.
  ...
  # @return [SquareApiClient::CheckoutOptions] The checkout options configured for the payment link.
...
#  ps://developer.squareup.com/docs/checkout-api/optional-checkout-configurations).
  ...
  # @return [SquareApiClient::PrePopulatedData] Describes buyer data to prepopulate
...
#  It is primarily for use by your application and is not used anywhere.
    ...
    # @param checkout_options [SquareApiClient::CheckoutOptions] The checkout options configured for the payment link.
#  For more information, see [Optional Checkout
#  ps://developer.squareup.com/docs/checkout-api/optional-checkout-configurations).
    # @param pre_populated_data [SquareApiClient::PrePopulatedData] Describes buyer data to prepopulate
#  on the checkout page.
...
#  resulting `Payment`.
    ...
    # @return [SquareApiClient::PaymentLink]
...
# Deserialize a JSON object to an instance of PaymentLink
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["checkout_options"].nil?
        ...
        checkout_options = SquareApiClient::CheckoutOptions.from_json(json_object: checkout_options)
      else
        checkout_options = nil
      end
      unless parsed_json["pre_populated_data"].nil?
        pre_populated_data = parsed_json["pre_populated_data"].to_json
        pre_populated_data = SquareApiClient::PrePopulatedData.from_json(json_object: pre_populated_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.checkout_options.nil? || SquareApiClient::CheckoutOptions.validate_raw(obj: obj.checkout_options)
      obj.pre_populated_data.nil? || SquareApiClient::PrePopulatedData.validate_raw(obj: obj.pre_populated_data)
