...
#  enabled, this only applies to transactions totaling $10 or more.
  ...
  # @return [Array<SquareApiClient::Money>] Show the Smart Tip Amounts for this location.
    attr_reader :smart_tips
  # @return [SquareApiClient::Money] Set the pre-selected whole amount that appears at checkout when Smart Tip is
...
#  enabled, this only applies to transactions totaling $10 or more.
    # @param smart_tips [Array<SquareApiClient::Money>] Show the Smart Tip Amounts for this location.
    # @param default_smart_tip [SquareApiClient::Money] Set the pre-selected whole amount that appears at checkout when Smart Tip is
#  enabled and the transaction amount is less than $10.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CheckoutLocationSettingsTipping]
...
# Deserialize a JSON object to an instance of CheckoutLocationSettingsTipping
  ...
  item = item.to_json
  SquareApiClient::Money.from_json(json_object: item)
end
      unless parsed_json["default_smart_tip"].nil?
        default_smart_tip = parsed_json["default_smart_tip"].to_json
        default_smart_tip = SquareApiClient::Money.from_json(json_object: default_smart_tip)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.default_smart_tip.nil? || SquareApiClient::Money.validate_raw(obj: obj.default_smart_tip)
    end
  end
end