...
# Represents an
#  tomAttribute](api-endpoint:BookingCustomAttributes-UpsertBookingCustomAttribute)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class UpsertBookingCustomAttributeResponse
...
# Deserialize a JSON object to an instance of UpsertBookingCustomAttributeResponse
    #
...
# Serialize an instance of UpsertBookingCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
