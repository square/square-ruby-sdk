...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogItemVariation] Structured data for a `CatalogItemVariation`, set for CatalogObjects of type
#  `ITEM_VARIATION`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_variation_data [SquareApiClient::CatalogItemVariation] Structured data for a `CatalogItemVariation`, set for CatalogObjects of type
#  `ITEM_VARIATION`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectItemVariation]
...
# Deserialize a JSON object to an instance of CatalogObjectItemVariation
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_variation_data"].nil?
        ...
        item_variation_data = SquareApiClient::CatalogItemVariation.from_json(json_object: item_variation_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_variation_data.nil? || SquareApiClient::CatalogItemVariation.validate_raw(obj: obj.item_variation_data)
