...
# Group of standard measurement units.
  ...
  # @return [Array<SquareApiClient::StandardUnitDescription>] List of standard (non-custom) measurement units in this description group.
  ...
  # @return [Object] 
    ...
    # @param standard_unit_descriptions [Array<SquareApiClient::StandardUnitDescription>] List of standard (non-custom) measurement units in this description group.
    # @param language_code [String] IETF language tag.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::StandardUnitDescriptionGroup]
...
# Deserialize a JSON object to an instance of StandardUnitDescriptionGroup
  ...
  item = item.to_json
  SquareApiClient::StandardUnitDescription.from_json(json_object: item)
end
