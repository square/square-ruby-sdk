...
# Published when a [TerminalCheckout](entity:TerminalCheckout) is created.
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"terminal.checkout.created"`.
    # @param event_id [String] A unique ID for the event.
    # @param created_at [String] RFC 3339 timestamp of when the event was created.
    # @param data [SquareApiClient::TerminalCheckoutCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalCheckoutCreatedEvent]
...
# Deserialize a JSON object to an instance of TerminalCheckoutCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::TerminalCheckoutCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of TerminalCheckoutCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::TerminalCheckoutCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end