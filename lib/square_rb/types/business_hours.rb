...
# The hours of operation for a location.
  class BusinessHours
  # @return [Array<SquareApiClient::BusinessHoursPeriod>] The list of time periods during which the business is open. There can be at most
#  10 periods per day.
    attr_reader :periods
  ...
  # @return [Object] 
    ...
    # @param periods [Array<SquareApiClient::BusinessHoursPeriod>] The list of time periods during which the business is open. There can be at most
#  10 periods per day.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BusinessHours]
...
# Deserialize a JSON object to an instance of BusinessHours
  ...
  item = item.to_json
  SquareApiClient::BusinessHoursPeriod.from_json(json_object: item)
end
