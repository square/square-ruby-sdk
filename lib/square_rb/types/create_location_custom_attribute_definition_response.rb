...
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class CreateLocationCustomAttributeDefinitionResponse
  # @return [SquareApiClient::CustomAttributeDefinition] The new custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [SquareApiClient::CustomAttributeDefinition] The new custom attribute definition.
...
# Serialize an instance of CreateLocationCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
