...
module SquareApiClient
  class CardDisabledEventObject
  # @return [SquareApiClient::Card] The disabled card.
    attr_reader :card
  ...
  # @return [Object] 
    ...
    # @param card [SquareApiClient::Card] The disabled card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardDisabledEventObject]
...
# Deserialize a JSON object to an instance of CardDisabledEventObject
    #
...
# Serialize an instance of CardDisabledEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
