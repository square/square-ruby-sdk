...
module SquareApiClient
  class InvoiceRefundedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::InvoiceRefundedEventObject]
...
# Deserialize a JSON object to an instance of InvoiceRefundedEventObject
    #
...
# Serialize an instance of InvoiceRefundedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
