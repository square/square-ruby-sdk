...
module SquareApiClient
  class InvoiceUpdatedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::InvoiceUpdatedEventObject]
...
# Deserialize a JSON object to an instance of InvoiceUpdatedEventObject
    #
...
# Serialize an instance of InvoiceUpdatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
