...
# Published when a location [custom attribute](entity:CustomAttribute) owned by
#  the
...
#  application.
  class LocationCustomAttributeOwnedUpdatedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::LocationCustomAttributeOwnedUpdatedEvent]
...
# Serialize an instance of LocationCustomAttributeOwnedUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
