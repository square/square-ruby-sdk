...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::TerminalAction] Current state of the action to be dismissed.
    attr_reader :action
  ...
  # @return [Object] 
    ...
    # @param action [SquareApiClient::TerminalAction] Current state of the action to be dismissed.
