...
module SquareApiClient
  ...
  # @return [SquareApiClient::OauthAuthorizationRevokedEventRevokerType] Type of client that performed the revocation, either APPLICATION, MERCHANT, or
#  SQUARE.
#  See
...
#  for possible values
  ...
  # @return [Object] 
    ...
    # @param revoker_type [SquareApiClient::OauthAuthorizationRevokedEventRevokerType] Type of client that performed the revocation, either APPLICATION, MERCHANT, or
#  SQUARE.
#  See
#  izationRevokedEventRevokerType](#type-oauthauthorizationrevokedeventrevokertype)
#  for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OauthAuthorizationRevokedEventRevocationObject]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.revoker_type&.is_a?(SquareApiClient::OauthAuthorizationRevokedEventRevokerType) != false || raise("Passed value for field obj.revoker_type is not the expected type, validation failed.")
    end
  end
end