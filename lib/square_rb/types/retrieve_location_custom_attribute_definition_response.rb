...
# Represents a
#  api-endpoint:LocationCustomAttributes-RetrieveLocationCustomAttributeDefinition)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class RetrieveLocationCustomAttributeDefinitionResponse
...
# Serialize an instance of RetrieveLocationCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
