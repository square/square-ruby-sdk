...
#  Square Online.
  ...
  # @return [String] A unique ID that identifies the fulfillment only within this order.
    attr_reader :uid
  # @return [SquareApiClient::FulfillmentType] The type of the fulfillment.
#  See [FulfillmentType](#type-fulfillmenttype) for possible values
    attr_reader :type
  # @return [SquareApiClient::FulfillmentState] The state of the fulfillment.
#  See [FulfillmentState](#type-fulfillmentstate) for possible values
    attr_reader :state
  # @return [SquareApiClient::FulfillmentFulfillmentLineItemApplication] Describes what order line items this fulfillment applies to.
...
#  for possible values
  ...
  # @return [Array<SquareApiClient::FulfillmentFulfillmentEntry>] A list of entries pertaining to the fulfillment of an order. Each entry must
#  reference
...
#  [Metadata](https://developer.squareup.com/docs/build-basics/metadata).
  ...
  # @return [SquareApiClient::FulfillmentPickupDetails] Contains details for a pickup fulfillment. These details are required when the
#  fulfillment
#  type is `PICKUP`.
    attr_reader :pickup_details
  # @return [SquareApiClient::FulfillmentShipmentDetails] Contains details for a shipment fulfillment. These details are required when the
#  fulfillment type
#  is `SHIPMENT`.
...
#  `FAILED`: Shipment has failed.
  ...
  # @return [SquareApiClient::FulfillmentDeliveryDetails] Describes delivery details of an order fulfillment.
  ...
  # @return [Object] 
    ...
    # @param type [SquareApiClient::FulfillmentType] The type of the fulfillment.
#  See [FulfillmentType](#type-fulfillmenttype) for possible values
    # @param state [SquareApiClient::FulfillmentState] The state of the fulfillment.
#  See [FulfillmentState](#type-fulfillmentstate) for possible values
    # @param line_item_application [SquareApiClient::FulfillmentFulfillmentLineItemApplication] Describes what order line items this fulfillment applies to.
#  It can be `ALL` or `ENTRY_LIST` with a supplied list of fulfillment entries.
#  See
#  FulfillmentLineItemApplication](#type-fulfillmentfulfillmentlineitemapplication)
#  for possible values
    # @param entries [Array<SquareApiClient::FulfillmentFulfillmentEntry>] A list of entries pertaining to the fulfillment of an order. Each entry must
#  reference
#  a valid `uid` for an order line item in the `line_item_uid` field, as well as a
#  `quantity` to
#  fulfill.
...
#  For more information, see
#  [Metadata](https://developer.squareup.com/docs/build-basics/metadata).
    # @param pickup_details [SquareApiClient::FulfillmentPickupDetails] Contains details for a pickup fulfillment. These details are required when the
#  fulfillment
#  type is `PICKUP`.
    # @param shipment_details [SquareApiClient::FulfillmentShipmentDetails] Contains details for a shipment fulfillment. These details are required when the
#  fulfillment type
#  is `SHIPMENT`.
#  A shipment fulfillment's relationship to fulfillment `state`:
#  `PROPOSED`: A shipment is requested.
...
#  `CANCELED`: Shipment has been canceled.
#  `FAILED`: Shipment has failed.
    # @param delivery_details [SquareApiClient::FulfillmentDeliveryDetails] Describes delivery details of an order fulfillment.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Fulfillment]
...
# Deserialize a JSON object to an instance of Fulfillment
  ...
  item = item.to_json
  SquareApiClient::FulfillmentFulfillmentEntry.from_json(json_object: item)
end
      metadata = parsed_json["metadata"]
      unless parsed_json["pickup_details"].nil?
        pickup_details = parsed_json["pickup_details"].to_json
        pickup_details = SquareApiClient::FulfillmentPickupDetails.from_json(json_object: pickup_details)
      else
        pickup_details = nil
      end
      unless parsed_json["shipment_details"].nil?
        shipment_details = parsed_json["shipment_details"].to_json
        shipment_details = SquareApiClient::FulfillmentShipmentDetails.from_json(json_object: shipment_details)
      else
        shipment_details = nil
      end
      unless parsed_json["delivery_details"].nil?
        delivery_details = parsed_json["delivery_details"].to_json
        delivery_details = SquareApiClient::FulfillmentDeliveryDetails.from_json(json_object: delivery_details)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(SquareApiClient::FulfillmentType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.state&.is_a?(SquareApiClient::FulfillmentState) != false || raise("Passed value for field obj.state is not the expected type, validation failed.")
      obj.line_item_application&.is_a?(SquareApiClient::FulfillmentFulfillmentLineItemApplication) != false || raise("Passed value for field obj.line_item_application is not the expected type, validation failed.")
      ...
      obj.pickup_details.nil? || SquareApiClient::FulfillmentPickupDetails.validate_raw(obj: obj.pickup_details)
      obj.shipment_details.nil? || SquareApiClient::FulfillmentShipmentDetails.validate_raw(obj: obj.shipment_details)
      obj.delivery_details.nil? || SquareApiClient::FulfillmentDeliveryDetails.validate_raw(obj: obj.delivery_details)
    end
  end
end