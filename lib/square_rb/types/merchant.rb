...
# Represents a business that sells with Square.
  ...
  # @return [SquareApiClient::Country] The country code associated with the merchant, in the two-letter format of ISO
...
#  `fr-CA`.
  ...
  # @return [SquareApiClient::Currency] The currency associated with the merchant, in ISO 4217 format. For example, the
#  currency code for US dollars is `USD`.
#  See [Currency](#type-currency) for possible values
    attr_reader :currency
  # @return [SquareApiClient::MerchantStatus] The merchant's status.
...
#  Dates](https://developer.squareup.com/docs/build-basics/working-with-dates).
  ...
  # @return [Object] 
    ...
    # @param country [SquareApiClient::Country] The country code associated with the merchant, in the two-letter format of ISO
#  3166. For example, `US` or `JP`.
#  See [Country](#type-country) for possible values
...
#  format](https://tools.ietf.org/html/bcp47#appendix-A). For example, `en-US` or
#  `fr-CA`.
    # @param currency [SquareApiClient::Currency] The currency associated with the merchant, in ISO 4217 format. For example, the
#  currency code for US dollars is `USD`.
#  See [Currency](#type-currency) for possible values
    # @param status [SquareApiClient::MerchantStatus] The merchant's status.
#  See [MerchantStatus](#type-merchantstatus) for possible values
...
#  Dates](https://developer.squareup.com/docs/build-basics/working-with-dates).
    ...
    # @return [SquareApiClient::Merchant]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::MerchantStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
