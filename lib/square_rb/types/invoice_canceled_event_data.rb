...
module SquareApiClient
  ...
  # @return [String] ID of the affected invoice.
    attr_reader :id
  # @return [SquareApiClient::InvoiceCanceledEventObject] An object containing the canceled invoice.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::InvoiceCanceledEventObject] An object containing the canceled invoice.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InvoiceCanceledEventData]
...
# Deserialize a JSON object to an instance of InvoiceCanceledEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::InvoiceCanceledEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::InvoiceCanceledEventObject.validate_raw(obj: obj.object)
    end
  end
end