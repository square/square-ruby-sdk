...
#  to determine if payments are from the same bank account.
  ...
  # @return [SquareApiClient::AchDetails] ACH-specific information about the transfer. The information is only populated
...
#  to determine if payments are from the same bank account.
    ...
    # @param ach_details [SquareApiClient::AchDetails] ACH-specific information about the transfer. The information is only populated
#  if the `transfer_type` is `ACH`.
    # @param errors [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BankAccountPaymentDetails]
...
# Deserialize a JSON object to an instance of BankAccountPaymentDetails
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["ach_details"].nil?
        ...
        ach_details = SquareApiClient::AchDetails.from_json(json_object: ach_details)
      else
        ach_details = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.ach_details.nil? || SquareApiClient::AchDetails.validate_raw(obj: obj.ach_details)
