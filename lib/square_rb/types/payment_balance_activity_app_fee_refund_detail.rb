...
module SquareApiClient
  ...
  # @return [String] The ID of the location of the merchant associated with the payment refund
#  activity
  ...
  # @return [Object] 
    ...
    # @param location_id [String] The ID of the location of the merchant associated with the payment refund
#  activity
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PaymentBalanceActivityAppFeeRefundDetail]
    def initialize(payment_id: OMIT, refund_id: OMIT, location_id: OMIT, additional_properties: nil)
      ...
      @_field_set = { "payment_id": payment_id, "refund_id": refund_id, "location_id": location_id }.reject do | _k, v |
  v == OMIT
end
    end
...
# Serialize an instance of PaymentBalanceActivityAppFeeRefundDetail to a JSON
#  object
    #
    # @return [String]
    def to_json
