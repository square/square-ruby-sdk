...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogTimePeriod] Structured data for a `CatalogTimePeriod`, set for CatalogObjects of type
#  `TIME_PERIOD`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param time_period_data [SquareApiClient::CatalogTimePeriod] Structured data for a `CatalogTimePeriod`, set for CatalogObjects of type
#  `TIME_PERIOD`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectTimePeriod]
...
# Deserialize a JSON object to an instance of CatalogObjectTimePeriod
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["time_period_data"].nil?
        ...
        time_period_data = SquareApiClient::CatalogTimePeriod.from_json(json_object: time_period_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.time_period_data.nil? || SquareApiClient::CatalogTimePeriod.validate_raw(obj: obj.time_period_data)
