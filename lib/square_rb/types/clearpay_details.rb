...
# Additional details about Clearpay payments.
  ...
  # @return [String] Email address on the buyer's Clearpay account.
  ...
  # @return [Object] 
    ...
    # @param email_address [String] Email address on the buyer's Clearpay account.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::ClearpayDetails]
...
# Deserialize a JSON object to an instance of ClearpayDetails
    #
...
# Serialize an instance of ClearpayDetails to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
