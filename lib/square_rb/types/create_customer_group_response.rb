...
#  Either `errors` or `group` is present in a given response (never both).
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::CustomerGroup] The successfully created customer group.
    attr_reader :group
  ...
  # @return [Object] 
    ...
    # @param group [SquareApiClient::CustomerGroup] The successfully created customer group.
...
# Deserialize a JSON object to an instance of CreateCustomerGroupResponse
    #
  ...
  SquareApiClient::Error.from_json(json_object: item)
      ...
      unless parsed_json["group"].nil?
        ...
        group = SquareApiClient::CustomerGroup.from_json(json_object: group)
      else
        group = nil
      end
      new(
...
# Serialize an instance of CreateCustomerGroupResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.group.nil? || SquareApiClient::CustomerGroup.validate_raw(obj: obj.group)
    end
  end
end