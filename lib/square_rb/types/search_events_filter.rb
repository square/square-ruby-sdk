...
# Criteria to filter events by.
  ...
  # @return [SquareApiClient::TimeRange] Filter events by when they were created.
  ...
  # @return [Object] 
    ...
    # @param created_at [SquareApiClient::TimeRange] Filter events by when they were created.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::SearchEventsFilter]
