...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogItemOptionValue] Structured data for a `CatalogItemOptionValue`, set for CatalogObjects of type
#  `ITEM_OPTION_VAL`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_option_value_data [SquareApiClient::CatalogItemOptionValue] Structured data for a `CatalogItemOptionValue`, set for CatalogObjects of type
#  `ITEM_OPTION_VAL`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectItemOptionValue]
...
# Deserialize a JSON object to an instance of CatalogObjectItemOptionValue
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_option_value_data"].nil?
        ...
        item_option_value_data = SquareApiClient::CatalogItemOptionValue.from_json(json_object: item_option_value_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_option_value_data.nil? || SquareApiClient::CatalogItemOptionValue.validate_raw(obj: obj.item_option_value_data)
