...
require_relative "payout_failed_event_data"
require "ostruct"
require "json"
...
# Published when a [Payout](entity:Payout) has failed.
  ...
  # @return [String] The type of event that this represents, `payout.failed`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] The timestamp of when the event was verified, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::PayoutFailedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event that this represents, `payout.failed`.
    # @param event_id [String] A unique ID for the event.
    # @param created_at [String] The timestamp of when the event was verified, in RFC 3339 format.
    # @param data [SquareApiClient::PayoutFailedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PayoutFailedEvent]
...
# Deserialize a JSON object to an instance of PayoutFailedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::PayoutFailedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of PayoutFailedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::PayoutFailedEventData.validate_raw(obj: obj.data)
    end
  end
end