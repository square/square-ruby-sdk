...
#  a request to the [UpdateOrder](api-endpoint:Orders-UpdateOrder) endpoint.
  ...
  # @return [SquareApiClient::Order] The updated order.
    attr_reader :order
  ...
  # @return [Object] 
    ...
    # @param order [SquareApiClient::Order] The updated order.
...
# Deserialize a JSON object to an instance of UpdateOrderResponse
    #
...
# Serialize an instance of UpdateOrderResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
