...
# Represents a
#  s](api-endpoint:CustomerCustomAttributes-ListCustomerCustomAttributeDefinitions)
#  response.
...
# Serialize an instance of ListCustomerCustomAttributeDefinitionsResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
