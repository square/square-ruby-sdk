...
#  DEPRECATED at version 2020-08-26. Replaced by [TeamMember](entity:TeamMember).
  ...
  # @return [SquareApiClient::EmployeeStatus] Specifies the status of the employees being fetched.
...
#  the account.
  ...
  # @return [Object] 
    ...
    # @param status [SquareApiClient::EmployeeStatus] Specifies the status of the employees being fetched.
#  See [EmployeeStatus](#type-employeestatus) for possible values
...
#  the account.
    ...
    # @return [SquareApiClient::Employee]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::EmployeeStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
