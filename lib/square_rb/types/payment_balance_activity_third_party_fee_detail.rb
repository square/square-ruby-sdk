...
module SquareApiClient
  class PaymentBalanceActivityThirdPartyFeeDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivityThirdPartyFeeDetail]
...
# Serialize an instance of PaymentBalanceActivityThirdPartyFeeDetail to a JSON
#  object
    #
    # @return [String]
    def to_json
