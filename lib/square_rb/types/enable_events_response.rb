...
# Deserialize a JSON object to an instance of EnableEventsResponse
    #
...
# Serialize an instance of EnableEventsResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
