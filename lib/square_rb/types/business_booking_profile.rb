...
#  settings, etc.
  ...
  # @return [SquareApiClient::BusinessBookingProfileCustomerTimezoneChoice] The choice of customer's time zone information of a booking.
...
#  for possible values
  ...
  # @return [SquareApiClient::BusinessBookingProfileBookingPolicy] The policy for the seller to automatically accept booking requests
...
#  or not (`false`).
  ...
  # @return [SquareApiClient::BusinessAppointmentSettings] Settings for appointment-type bookings.
...
#  (`false`) using seller permission.
  ...
  # @return [Object] 
    ...
    # @param customer_timezone_choice [SquareApiClient::BusinessBookingProfileCustomerTimezoneChoice] The choice of customer's time zone information of a booking.
#  The Square online booking site and all notifications to customers uses either
#  the seller location’s time zone
#  or the time zone the customer chooses at booking.
#  See
#  ofileCustomerTimezoneChoice](#type-businessbookingprofilecustomertimezonechoice)
#  for possible values
    # @param booking_policy [SquareApiClient::BusinessBookingProfileBookingPolicy] The policy for the seller to automatically accept booking requests
#  (`ACCEPT_ALL`) or not (`REQUIRES_ACCEPTANCE`).
#  See
#  [BusinessBookingProfileBookingPolicy](#type-businessbookingprofilebookingpolicy)
#  for possible values
...
#  or not (`false`).
    # @param business_appointment_settings [SquareApiClient::BusinessAppointmentSettings] Settings for appointment-type bookings.
...
#  (`false`) using seller permission.
    ...
    # @return [SquareApiClient::BusinessBookingProfile]
...
# Deserialize a JSON object to an instance of BusinessBookingProfile
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["business_appointment_settings"].nil?
        ...
        business_appointment_settings = SquareApiClient::BusinessAppointmentSettings.from_json(json_object: business_appointment_settings)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.customer_timezone_choice&.is_a?(SquareApiClient::BusinessBookingProfileCustomerTimezoneChoice) != false || raise("Passed value for field obj.customer_timezone_choice is not the expected type, validation failed.")
      obj.booking_policy&.is_a?(SquareApiClient::BusinessBookingProfileBookingPolicy) != false || raise("Passed value for field obj.booking_policy is not the expected type, validation failed.")
      ...
      obj.business_appointment_settings.nil? || SquareApiClient::BusinessAppointmentSettings.validate_raw(obj: obj.business_appointment_settings)
