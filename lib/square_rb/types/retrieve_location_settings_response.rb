...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::CheckoutLocationSettings] The location settings.
  ...
  # @return [Object] 
    ...
    # @param location_settings [SquareApiClient::CheckoutLocationSettings] The location settings.
