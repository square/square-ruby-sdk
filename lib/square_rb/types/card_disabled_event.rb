...
require_relative "card_disabled_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [card](entity:Card) is disabled.
  class CardDisabledEvent
  # @return [String] The ID of the target seller associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"card.disabled"`.
    attr_reader :type
  ...
  # @return [SquareApiClient::CardDisabledEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"card.disabled"`.
    ...
    # @param data [SquareApiClient::CardDisabledEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardDisabledEvent]
...
# Deserialize a JSON object to an instance of CardDisabledEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CardDisabledEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CardDisabledEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CardDisabledEventData.validate_raw(obj: obj.data)
    end
  end
end