...
#  with `loyalty_promotions`.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::LoyaltyPromotion>] The retrieved loyalty promotions.
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param loyalty_promotions [Array<SquareApiClient::LoyaltyPromotion>] The retrieved loyalty promotions.
...
# Deserialize a JSON object to an instance of ListLoyaltyPromotionsResponse
  ...
  item = item.to_json
  SquareApiClient::LoyaltyPromotion.from_json(json_object: item)
end
