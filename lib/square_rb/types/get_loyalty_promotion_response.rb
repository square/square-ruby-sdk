...
#  response.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::LoyaltyPromotion] The retrieved loyalty promotion.
  ...
  # @return [Object] 
    ...
    # @param loyalty_promotion [SquareApiClient::LoyaltyPromotion] The retrieved loyalty promotion.
