...
# Response payload for bulk retrieval of bookings.
  ...
  # @return [Hash{String => SquareApiClient::GetBookingResponse}] Requested bookings returned as a map containing `booking_id` as the key and
#  `RetrieveBookingResponse` as the value.
  ...
  # @return [Object] 
    ...
    # @param bookings [Hash{String => SquareApiClient::GetBookingResponse}] Requested bookings returned as a map containing `booking_id` as the key and
#  `RetrieveBookingResponse` as the value.
...
# Deserialize a JSON object to an instance of BulkRetrieveBookingsResponse
  ...
  value = value.to_json
  SquareApiClient::GetBookingResponse.from_json(json_object: value)
end
