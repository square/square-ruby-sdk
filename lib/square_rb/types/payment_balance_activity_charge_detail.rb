...
module SquareApiClient
  class PaymentBalanceActivityChargeDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivityChargeDetail]
...
# Deserialize a JSON object to an instance of PaymentBalanceActivityChargeDetail
    #
...
# Serialize an instance of PaymentBalanceActivityChargeDetail to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
