...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::CatalogObject] The `CatalogObject`s returned.
    attr_reader :object
  # @return [Array<SquareApiClient::CatalogObject>] A list of `CatalogObject`s referenced by the object in the `object` field.
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::CatalogObject] The `CatalogObject`s returned.
    # @param related_objects [Array<SquareApiClient::CatalogObject>] A list of `CatalogObject`s referenced by the object in the `object` field.
...
# Deserialize a JSON object to an instance of GetCatalogObjectResponse
  ...
  SquareApiClient::Error.from_json(json_object: item)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::CatalogObject.from_json(json_object: object)
      else
        object = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::CatalogObject.validate_raw(obj: obj.object)
