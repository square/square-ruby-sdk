...
#  endpoint.
  ...
  # @return [Hash{String => SquareApiClient::GetTeamMemberBookingProfileResponse}] The returned team members' booking profiles, as a map with `team_member_id` as
...
#  value.
  ...
  # @return [Object] 
    ...
    # @param team_member_booking_profiles [Hash{String => SquareApiClient::GetTeamMemberBookingProfileResponse}] The returned team members' booking profiles, as a map with `team_member_id` as
#  the key and [TeamMemberBookingProfile](entity:TeamMemberBookingProfile) the
#  value.
...
#  BulkRetrieveTeamMemberBookingProfilesResponse
  ...
  value = value.to_json
  SquareApiClient::GetTeamMemberBookingProfileResponse.from_json(json_object: value)
end
