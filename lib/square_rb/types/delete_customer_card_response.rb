...
#  a request to the `DeleteCustomerCard` endpoint.
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::DeleteCustomerCardResponse]
...
# Deserialize a JSON object to an instance of DeleteCustomerCardResponse
    #
...
# Serialize an instance of DeleteCustomerCardResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
