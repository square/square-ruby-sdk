...
# The food and beverage-specific details of a `FOOD_AND_BEV` item.
  ...
  # @return [Array<SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreference>] The dietary preferences for the `FOOD_AND_BEV` item.
    attr_reader :dietary_preferences
  # @return [Array<SquareApiClient::CatalogItemFoodAndBeverageDetailsIngredient>] The ingredients for the `FOOD_AND_BEV` type item.
  ...
  # @return [Object] 
    ...
    # @param dietary_preferences [Array<SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreference>] The dietary preferences for the `FOOD_AND_BEV` item.
    # @param ingredients [Array<SquareApiClient::CatalogItemFoodAndBeverageDetailsIngredient>] The ingredients for the `FOOD_AND_BEV` type item.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogItemFoodAndBeverageDetails]
...
# Deserialize a JSON object to an instance of CatalogItemFoodAndBeverageDetails
  ...
  item = item.to_json
  SquareApiClient::CatalogItemFoodAndBeverageDetailsDietaryPreference.from_json(json_object: item)
end
      ingredients = parsed_json["ingredients"]&.map do | item |
  item = item.to_json
  SquareApiClient::CatalogItemFoodAndBeverageDetailsIngredient.from_json(json_object: item)
end
      new(
