...
# Contains the details necessary to fulfill a shipment order.
  ...
  # @return [SquareApiClient::FulfillmentRecipient] Information about the person to receive this shipment fulfillment.
...
#  (for example, "2016-09-04T23:59:33.123Z").
  ...
  # @return [Object] 
    ...
    # @param recipient [SquareApiClient::FulfillmentRecipient] Information about the person to receive this shipment fulfillment.
...
#  (for example, "2016-09-04T23:59:33.123Z").
    ...
    # @return [SquareApiClient::FulfillmentShipmentDetails]
