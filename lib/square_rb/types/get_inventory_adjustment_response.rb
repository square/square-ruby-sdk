...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::InventoryAdjustment] The requested [InventoryAdjustment](entity:InventoryAdjustment).
  ...
  # @return [Object] 
    ...
    # @param adjustment [SquareApiClient::InventoryAdjustment] The requested [InventoryAdjustment](entity:InventoryAdjustment).
