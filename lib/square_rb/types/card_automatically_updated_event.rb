...
require_relative "card_automatically_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when Square automatically updates the expiration date or
#  primary account number (PAN) of a [card](entity:Card) or adds or removes an
#  issuer alert.
  class CardAutomaticallyUpdatedEvent
  # @return [String] The ID of the target seller associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"card.automatically_updated"`.
    attr_reader :type
  ...
  # @return [SquareApiClient::CardAutomaticallyUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"card.automatically_updated"`.
    ...
    # @param data [SquareApiClient::CardAutomaticallyUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardAutomaticallyUpdatedEvent]
...
# Deserialize a JSON object to an instance of CardAutomaticallyUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CardAutomaticallyUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CardAutomaticallyUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CardAutomaticallyUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end