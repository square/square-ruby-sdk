...
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class GetCustomerCustomAttributeResponse
...
# Deserialize a JSON object to an instance of GetCustomerCustomAttributeResponse
    #
...
# Serialize an instance of GetCustomerCustomAttributeResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
