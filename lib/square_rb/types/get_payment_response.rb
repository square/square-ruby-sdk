...
# Defines the response returned by [GetPayment](api-endpoint:Payments-GetPayment).
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Payment] The requested `Payment`.
    attr_reader :payment
  ...
  # @return [Object] 
    ...
    # @param payment [SquareApiClient::Payment] The requested `Payment`.
...
# Deserialize a JSON object to an instance of GetPaymentResponse
    #
...
# Serialize an instance of GetPaymentResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
