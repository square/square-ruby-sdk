...
#  [BulkUpdateVendors](api-endpoint:Vendors-BulkUpdateVendors).
  ...
  # @return [Array<SquareApiClient::Error>] Errors encountered when the request fails.
    attr_reader :errors
  # @return [Hash{String => SquareApiClient::UpdateVendorResponse}] A set of [UpdateVendorResponse](entity:UpdateVendorResponse) objects
...
#  `Vendor`-ID/error-object pairs.
  ...
  # @return [Object] 
    ...
    # @param responses [Hash{String => SquareApiClient::UpdateVendorResponse}] A set of [UpdateVendorResponse](entity:UpdateVendorResponse) objects
#  encapsulating successfully created [Vendor](entity:Vendor)
#  objects or error responses for failed attempts. The set is represented by a
#  collection of `Vendor`-ID/`UpdateVendorResponse`-object or
#  `Vendor`-ID/error-object pairs.
...
# Deserialize a JSON object to an instance of BatchUpdateVendorsResponse
  ...
  value = value.to_json
  SquareApiClient::UpdateVendorResponse.from_json(json_object: value)
end
      new(
        errors: errors,
        responses: responses,
