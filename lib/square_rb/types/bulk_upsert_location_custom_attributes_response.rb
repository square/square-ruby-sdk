...
#  request.
  ...
  # @return [Hash{String => SquareApiClient::BulkUpsertLocationCustomAttributesResponseLocationCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
...
#  `custom_attribute` or an `errors` field.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => SquareApiClient::BulkUpsertLocationCustomAttributesResponseLocationCustomAttributeUpsertResponse}] A map of responses that correspond to individual upsert requests. Each response
#  has the
#  same ID as the corresponding request and contains either a `location_id` and
#  `custom_attribute` or an `errors` field.
...
#  BulkUpsertLocationCustomAttributesResponse
  ...
  value = value.to_json
  SquareApiClient::BulkUpsertLocationCustomAttributesResponseLocationCustomAttributeUpsertResponse.from_json(json_object: value)
end
