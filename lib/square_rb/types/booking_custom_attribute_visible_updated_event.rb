...
#  booking custom attribute.
  class BookingCustomAttributeVisibleUpdatedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::BookingCustomAttributeVisibleUpdatedEvent]
...
# Serialize an instance of BookingCustomAttributeVisibleUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
