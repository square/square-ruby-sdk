...
#  [Vendor](entity:Vendor).
    attr_reader :name
  # @return [SquareApiClient::Address] The address of the [Vendor](entity:Vendor).
    attr_reader :address
  # @return [Array<SquareApiClient::VendorContact>] The contacts of the [Vendor](entity:Vendor).
  ...
  # @return [Integer] The version of the [Vendor](entity:Vendor).
    attr_reader :version
  # @return [SquareApiClient::VendorStatus] The status of the [Vendor](entity:Vendor).
...
#  This field is required when attempting to create or update a
#  [Vendor](entity:Vendor).
    # @param address [SquareApiClient::Address] The address of the [Vendor](entity:Vendor).
    # @param contacts [Array<SquareApiClient::VendorContact>] The contacts of the [Vendor](entity:Vendor).
    ...
    # @param status [SquareApiClient::VendorStatus] The status of the [Vendor](entity:Vendor).
#  See [Status](#type-status) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Vendor]
...
# Deserialize a JSON object to an instance of Vendor
  ...
  item = item.to_json
  SquareApiClient::VendorContact.from_json(json_object: item)
end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::VendorStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end