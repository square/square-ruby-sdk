...
#  owned by the subscribing application is deleted. Subscribe to this event to be
#  notified
#  when your application deletes a merchant custom attribute.
  class MerchantCustomAttributeOwnedDeletedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::MerchantCustomAttributeOwnedDeletedEvent]
...
# Serialize an instance of MerchantCustomAttributeOwnedDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
