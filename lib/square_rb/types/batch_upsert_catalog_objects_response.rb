...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::CatalogObject>] The created successfully created CatalogObjects.
    attr_reader :objects
...
#  of this update in RFC 3339 format, e.g., "2016-09-04T23:59:33.123Z".
  ...
  # @return [Object] 
    ...
    # @param objects [Array<SquareApiClient::CatalogObject>] The created successfully created CatalogObjects.
