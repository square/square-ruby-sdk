...
# Represents a
#  s](api-endpoint:MerchantCustomAttributes-ListMerchantCustomAttributeDefinitions)
#  response.
...
#  with `custom_attribute_definitions`.
  class ListMerchantCustomAttributeDefinitionsResponse
...
# Serialize an instance of ListMerchantCustomAttributeDefinitionsResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
