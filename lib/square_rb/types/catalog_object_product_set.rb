...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogProductSet] Structured data for a `CatalogProductSet`, set for CatalogObjects of type
#  `PRODUCT_SET`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param product_set_data [SquareApiClient::CatalogProductSet] Structured data for a `CatalogProductSet`, set for CatalogObjects of type
#  `PRODUCT_SET`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectProductSet]
...
# Deserialize a JSON object to an instance of CatalogObjectProductSet
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["product_set_data"].nil?
        ...
        product_set_data = SquareApiClient::CatalogProductSet.from_json(json_object: product_set_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.product_set_data.nil? || SquareApiClient::CatalogProductSet.validate_raw(obj: obj.product_set_data)
