...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Order>] The order associated with the payment link.
    attr_reader :orders
  # @return [Array<SquareApiClient::CatalogObject>] The subscription plan associated with the payment link.
  ...
  # @return [Object] 
    ...
    # @param orders [Array<SquareApiClient::Order>] The order associated with the payment link.
    # @param subscription_plans [Array<SquareApiClient::CatalogObject>] The subscription plan associated with the payment link.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PaymentLinkRelatedResources]
