...
require_relative "refund_updated_event_data"
require "ostruct"
require "json"
...
#  Typically the `refund.status` changes when a refund is completed.
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"refund.updated"`.
    ...
    # @param data [SquareApiClient::RefundUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::RefundUpdatedEvent]
...
# Deserialize a JSON object to an instance of RefundUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::RefundUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of RefundUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::RefundUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end