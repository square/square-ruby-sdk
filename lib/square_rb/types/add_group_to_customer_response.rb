...
#  a request to the [AddGroupToCustomer](api-endpoint:Customers-AddGroupToCustomer)
#  endpoint.
...
# Deserialize a JSON object to an instance of AddGroupToCustomerResponse
    #
...
# Serialize an instance of AddGroupToCustomerResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
