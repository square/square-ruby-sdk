...
module SquareApiClient
  class DisputeEvidenceAddedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::DisputeEvidenceAddedEventObject]
...
# Deserialize a JSON object to an instance of DisputeEvidenceAddedEventObject
    #
...
# Serialize an instance of DisputeEvidenceAddedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
