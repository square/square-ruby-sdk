...
module SquareApiClient
  ...
  # @return [SquareApiClient::CardForgottenEventCard] The forgotten card.
    attr_reader :card
  ...
  # @return [Object] 
    ...
    # @param card [SquareApiClient::CardForgottenEventCard] The forgotten card.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardForgottenEventObject]
...
# Deserialize a JSON object to an instance of CardForgottenEventObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["card"].nil?
        ...
        card = SquareApiClient::CardForgottenEventCard.from_json(json_object: card)
      else
        card = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.card.nil? || SquareApiClient::CardForgottenEventCard.validate_raw(obj: obj.card)
    end
  end
end