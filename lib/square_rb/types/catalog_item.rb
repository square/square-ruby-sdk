...
#  Taxes may also be added to or deleted from an item using `UpdateItemTaxes`.
    attr_reader :tax_ids
  # @return [Array<SquareApiClient::CatalogItemModifierListInfo>] A set of `CatalogItemModifierListInfo` objects
...
#  may also be added to or deleted from an item using `UpdateItemModifierLists`.
  ...
  # @return [Array<SquareApiClient::CatalogObject>] A list of [CatalogItemVariation](entity:CatalogItemVariation) objects for this
#  item. An item must have
#  at least one variation.
    attr_reader :variations
  # @return [SquareApiClient::CatalogItemProductType] The product type of the item. Once set, the `product_type` value cannot be
#  modified.
...
#  Third-party clients are encouraged to implement similar behaviors.
  ...
  # @return [Array<SquareApiClient::CatalogItemOptionForItem>] List of item options IDs for this item. Used to manage and group item
...
#  It is currently supported for sellers of the Japanese locale only.
  ...
  # @return [Array<SquareApiClient::CatalogObjectCategory>] The list of categories.
...
#  This field is read only and cannot be edited.
  ...
  # @return [SquareApiClient::CatalogEcomSeoData] The SEO data for a seller's Square Online store.
    attr_reader :ecom_seo_data
  # @return [SquareApiClient::CatalogItemFoodAndBeverageDetails] The food and beverage-specific details for the `FOOD_AND_BEV` item.
    attr_reader :food_and_beverage_details
  # @return [SquareApiClient::CatalogObjectCategory] The item's reporting category.
...
#  item.
#  Taxes may also be added to or deleted from an item using `UpdateItemTaxes`.
    # @param modifier_list_info [Array<SquareApiClient::CatalogItemModifierListInfo>] A set of `CatalogItemModifierListInfo` objects
#  representing the modifier lists that apply to this item, along with the
#  overrides and min
#  and max limits that are specific to this item. Modifier lists
#  may also be added to or deleted from an item using `UpdateItemModifierLists`.
    # @param variations [Array<SquareApiClient::CatalogObject>] A list of [CatalogItemVariation](entity:CatalogItemVariation) objects for this
#  item. An item must have
#  at least one variation.
    # @param product_type [SquareApiClient::CatalogItemProductType] The product type of the item. Once set, the `product_type` value cannot be
#  modified.
#  Items of the `LEGACY_SQUARE_ONLINE_SERVICE` and
#  `LEGACY_SQUARE_ONLINE_MEMBERSHIP` product types can be updated
#  but cannot be created using the API.
...
#  details.
#  Third-party clients are encouraged to implement similar behaviors.
    # @param item_options [Array<SquareApiClient::CatalogItemOptionForItem>] List of item options IDs for this item. Used to manage and group item
#  variations in a specified order.
#  Maximum: 6 item options.
...
#  Its value must not be empty.
#  It is currently supported for sellers of the Japanese locale only.
    # @param categories [Array<SquareApiClient::CatalogObjectCategory>] The list of categories.
...
#  This field is read only and cannot be edited.
    ...
    # @param ecom_seo_data [SquareApiClient::CatalogEcomSeoData] The SEO data for a seller's Square Online store.
    # @param food_and_beverage_details [SquareApiClient::CatalogItemFoodAndBeverageDetails] The food and beverage-specific details for the `FOOD_AND_BEV` item.
    # @param reporting_category [SquareApiClient::CatalogObjectCategory] The item's reporting category.
    # @param is_alcoholic [Boolean] Indicates whether this item is alcoholic (`true`) or not (`false`).
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CatalogItem]
...
# Deserialize a JSON object to an instance of CatalogItem
  ...
  item = item.to_json
  SquareApiClient::CatalogItemModifierListInfo.from_json(json_object: item)
end
  ...
  item = item.to_json
  SquareApiClient::CatalogItemOptionForItem.from_json(json_object: item)
end
  ...
  item = item.to_json
  SquareApiClient::CatalogObjectCategory.from_json(json_object: item)
end
      ...
      unless parsed_json["ecom_seo_data"].nil?
        ...
        ecom_seo_data = SquareApiClient::CatalogEcomSeoData.from_json(json_object: ecom_seo_data)
      else
        ecom_seo_data = nil
      end
      unless parsed_json["food_and_beverage_details"].nil?
        food_and_beverage_details = parsed_json["food_and_beverage_details"].to_json
        food_and_beverage_details = SquareApiClient::CatalogItemFoodAndBeverageDetails.from_json(json_object: food_and_beverage_details)
      else
      ...
      unless parsed_json["reporting_category"].nil?
        ...
        reporting_category = SquareApiClient::CatalogObjectCategory.from_json(json_object: reporting_category)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.product_type&.is_a?(SquareApiClient::CatalogItemProductType) != false || raise("Passed value for field obj.product_type is not the expected type, validation failed.")
      ...
      obj.ecom_seo_data.nil? || SquareApiClient::CatalogEcomSeoData.validate_raw(obj: obj.ecom_seo_data)
      obj.food_and_beverage_details.nil? || SquareApiClient::CatalogItemFoodAndBeverageDetails.validate_raw(obj: obj.food_and_beverage_details)
      obj.reporting_category.nil? || SquareApiClient::CatalogObjectCategory.validate_raw(obj: obj.reporting_category)
