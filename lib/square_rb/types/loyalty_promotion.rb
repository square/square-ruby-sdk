...
#  or `SCHEDULED` status.
  ...
  # @return [String] The name of the promotion.
    attr_reader :name
  # @return [SquareApiClient::LoyaltyPromotionIncentive] The points incentive for the promotion. This field defines whether promotion
#  points
#  are earned by multiplying base program points or by adding a specified number of
#  points.
    attr_reader :incentive
  # @return [SquareApiClient::LoyaltyPromotionAvailableTimeData] The scheduling information that defines when purchases can qualify to earn
#  points from an `ACTIVE` promotion.
    attr_reader :available_time
  # @return [SquareApiClient::LoyaltyPromotionTriggerLimit] The number of times a buyer can earn promotion points during a specified
#  interval.
#  If not specified, buyers can trigger the promotion an unlimited number of times.
    attr_reader :trigger_limit
  # @return [SquareApiClient::LoyaltyPromotionStatus] The current status of the promotion.
...
#  promotion.
  ...
  # @return [SquareApiClient::Money] The minimum purchase amount required to earn promotion points. If specified,
...
#  a promotion, but not both.
  ...
  # @return [Object] 
    ...
    # @param incentive [SquareApiClient::LoyaltyPromotionIncentive] The points incentive for the promotion. This field defines whether promotion
#  points
#  are earned by multiplying base program points or by adding a specified number of
#  points.
    # @param available_time [SquareApiClient::LoyaltyPromotionAvailableTimeData] The scheduling information that defines when purchases can qualify to earn
#  points from an `ACTIVE` promotion.
    # @param trigger_limit [SquareApiClient::LoyaltyPromotionTriggerLimit] The number of times a buyer can earn promotion points during a specified
#  interval.
#  If not specified, buyers can trigger the promotion an unlimited number of times.
    # @param status [SquareApiClient::LoyaltyPromotionStatus] The current status of the promotion.
#  See [LoyaltyPromotionStatus](#type-loyaltypromotionstatus) for possible values
...
#  promotion.
    # @param minimum_spend_amount_money [SquareApiClient::Money] The minimum purchase amount required to earn promotion points. If specified,
#  this amount is positive.
...
#  a promotion, but not both.
    ...
    # @return [SquareApiClient::LoyaltyPromotion]
...
# Deserialize a JSON object to an instance of LoyaltyPromotion
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["incentive"].nil?
        ...
        incentive = SquareApiClient::LoyaltyPromotionIncentive.from_json(json_object: incentive)
      else
        incentive = nil
      end
      unless parsed_json["available_time"].nil?
        available_time = parsed_json["available_time"].to_json
        available_time = SquareApiClient::LoyaltyPromotionAvailableTimeData.from_json(json_object: available_time)
      else
        available_time = nil
      end
      unless parsed_json["trigger_limit"].nil?
        trigger_limit = parsed_json["trigger_limit"].to_json
        trigger_limit = SquareApiClient::LoyaltyPromotionTriggerLimit.from_json(json_object: trigger_limit)
      else
        trigger_limit = nil
      end
      ...
      unless parsed_json["minimum_spend_amount_money"].nil?
        ...
        minimum_spend_amount_money = SquareApiClient::Money.from_json(json_object: minimum_spend_amount_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      SquareApiClient::LoyaltyPromotionIncentive.validate_raw(obj: obj.incentive)
      SquareApiClient::LoyaltyPromotionAvailableTimeData.validate_raw(obj: obj.available_time)
      obj.trigger_limit.nil? || SquareApiClient::LoyaltyPromotionTriggerLimit.validate_raw(obj: obj.trigger_limit)
      obj.status&.is_a?(SquareApiClient::LoyaltyPromotionStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.minimum_spend_amount_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.minimum_spend_amount_money)
