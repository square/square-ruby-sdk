...
#  tiers.
  ...
  # @return [SquareApiClient::CatalogObjectReference] A reference to the specific version of a `PRICING_RULE` catalog object that
...
#  //developer.squareup.com/docs/loyalty-api/loyalty-rewards#get-discount-details).
  ...
  # @return [Object] 
    ...
    # @param pricing_rule_reference [SquareApiClient::CatalogObjectReference] A reference to the specific version of a `PRICING_RULE` catalog object that
#  contains information about the reward tier discount.
#  Use `object_id` and `catalog_version` with the
#  [RetrieveCatalogObject](api-endpoint:Catalog-RetrieveCatalogObject) endpoint
#  to get discount details. Make sure to set `include_related_objects` to true in
...
#  //developer.squareup.com/docs/loyalty-api/loyalty-rewards#get-discount-details).
    ...
    # @return [SquareApiClient::LoyaltyProgramRewardTier]
...
# Deserialize a JSON object to an instance of LoyaltyProgramRewardTier
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["pricing_rule_reference"].nil?
        ...
        pricing_rule_reference = SquareApiClient::CatalogObjectReference.from_json(json_object: pricing_rule_reference)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      SquareApiClient::CatalogObjectReference.validate_raw(obj: obj.pricing_rule_reference)
    end
  end
end