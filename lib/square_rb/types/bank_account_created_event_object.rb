...
module SquareApiClient
  class BankAccountCreatedEventObject
  # @return [SquareApiClient::BankAccount] The created bank account.
  ...
  # @return [Object] 
    ...
    # @param bank_account [SquareApiClient::BankAccount] The created bank account.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BankAccountCreatedEventObject]
...
# Deserialize a JSON object to an instance of BankAccountCreatedEventObject
    #
...
# Serialize an instance of BankAccountCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
