...
require_relative "bank_account_disabled_event_data"
require "ostruct"
require "json"
...
#  [BankAccount](entity:BankAccount) to `DISABLED`.
  ...
  # @return [String] The type of event this represents, `"bank_account.disabled"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was disabled, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::BankAccountDisabledEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"bank_account.disabled"`.
    # @param event_id [String] A unique ID for the event.
    # @param created_at [String] Timestamp of when the event was disabled, in RFC 3339 format.
    # @param data [SquareApiClient::BankAccountDisabledEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BankAccountDisabledEvent]
...
# Deserialize a JSON object to an instance of BankAccountDisabledEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::BankAccountDisabledEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of BankAccountDisabledEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::BankAccountDisabledEventData.validate_raw(obj: obj.data)
    end
  end
end