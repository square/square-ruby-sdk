...
module SquareApiClient
  class TerminalCheckoutCreatedEventObject
  # @return [SquareApiClient::TerminalCheckout] The created terminal checkout
  ...
  # @return [Object] 
    ...
    # @param checkout [SquareApiClient::TerminalCheckout] The created terminal checkout
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalCheckoutCreatedEventObject]
...
# Deserialize a JSON object to an instance of TerminalCheckoutCreatedEventObject
    #
...
# Serialize an instance of TerminalCheckoutCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
