...
module SquareApiClient
  ...
  # @return [Object] 
    ...
    # @param employee [SquareApiClient::Employee] 
...
# Deserialize a JSON object to an instance of GetEmployeeResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["employee"].nil?
        ...
        employee = SquareApiClient::Employee.from_json(json_object: employee)
      else
        employee = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.employee.nil? || SquareApiClient::Employee.validate_raw(obj: obj.employee)
