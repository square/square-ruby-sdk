...
module SquareApiClient
  ...
  # @return [SquareApiClient::TerminalCheckout] The updated terminal checkout
  ...
  # @return [Object] 
    ...
    # @param checkout [SquareApiClient::TerminalCheckout] The updated terminal checkout
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalCheckoutUpdatedEventObject]
