...
module SquareApiClient
  ...
  # @return [SquareApiClient::LoyaltyEvent] The loyalty event that was created.
  ...
  # @return [Object] 
    ...
    # @param loyalty_event [SquareApiClient::LoyaltyEvent] The loyalty event that was created.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyEventCreatedEventObject]
...
# Deserialize a JSON object to an instance of LoyaltyEventCreatedEventObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["loyalty_event"].nil?
        ...
        loyalty_event = SquareApiClient::LoyaltyEvent.from_json(json_object: loyalty_event)
      else
        loyalty_event = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.loyalty_event.nil? || SquareApiClient::LoyaltyEvent.validate_raw(obj: obj.loyalty_event)
    end
  end
end