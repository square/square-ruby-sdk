...
require_relative "location_updated_event_data"
require "ostruct"
require "json"
...
# Published when a [Location](entity:Location) is updated.
  ...
  # @return [String] The ID of the [Location](entity:Location) associated with the event.
    attr_reader :location_id
  # @return [String] The type of event this represents, `"location.updated"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::LocationUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param location_id [String] The ID of the [Location](entity:Location) associated with the event.
    # @param type [String] The type of event this represents, `"location.updated"`.
    ...
    # @param data [SquareApiClient::LocationUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LocationUpdatedEvent]
...
# Deserialize a JSON object to an instance of LocationUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LocationUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LocationUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LocationUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end