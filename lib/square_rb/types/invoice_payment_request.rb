...
#  //developer.squareup.com/docs/invoices-api/overview#invoices-plus-subscription).
  ...
  # @return [String] The Square-generated ID of the payment request in an [invoice](entity:Invoice).
    attr_reader :uid
  # @return [SquareApiClient::InvoiceRequestMethod] Indicates how Square processes the payment request. DEPRECATED at version
...
#  See [InvoiceRequestMethod](#type-invoicerequestmethod) for possible values
  ...
  # @return [SquareApiClient::InvoiceRequestType] Identifies the payment request type. This type defines how the payment request
...
#  timestamp of 2021-03-10T08:00:00Z).
  ...
  # @return [SquareApiClient::Money] If the payment request specifies `DEPOSIT` or `INSTALLMENT` as the
#  `request_type`,
...
#  and the payment `request_type` must be `BALANCE` or `INSTALLMENT`.
  ...
  # @return [SquareApiClient::InvoiceAutomaticPaymentSource] The payment method for an automatic payment.
...
#  the invoice recipient.
    attr_reader :card_id
  # @return [Array<SquareApiClient::InvoicePaymentReminder>] A list of one or more reminders to send for the payment request.
    attr_reader :reminders
  # @return [SquareApiClient::Money] The amount of the payment request, computed using the order amount and
...
#  `percentage_requested`).
  ...
  # @return [SquareApiClient::Money] The amount of money already paid for the specific payment request.
...
#  was in cash in a currency that rounds cash payments (such as, `CAD` or `AUD`).
  ...
  # @return [SquareApiClient::Money] If the most recent payment was a cash payment
...
#  might be negative.
  ...
  # @return [Object] 
    ...
    # @param request_method [SquareApiClient::InvoiceRequestMethod] Indicates how Square processes the payment request. DEPRECATED at version
#  2021-01-21. Replaced by the
#  `Invoice.delivery_method` and `InvoicePaymentRequest.automatic_payment_source`
#  fields.
#  One of the following is required when creating an invoice:
...
#  do not include `request_method`.
#  See [InvoiceRequestMethod](#type-invoicerequestmethod) for possible values
    # @param request_type [SquareApiClient::InvoiceRequestType] Identifies the payment request type. This type defines how the payment request
#  amount is determined.
#  This field is required to create a payment request.
#  See [InvoiceRequestType](#type-invoicerequesttype) for possible values
...
#  America/Los\_Angeles (which equals a UTC
#  timestamp of 2021-03-10T08:00:00Z).
    # @param fixed_amount_requested_money [SquareApiClient::Money] If the payment request specifies `DEPOSIT` or `INSTALLMENT` as the
#  `request_type`,
#  this indicates the request amount.
#  You cannot specify this when `request_type` is `BALANCE` or when the
#  payment request includes the `percentage_requested` field.
...
#  This field is allowed only on the final payment request
#  and the payment `request_type` must be `BALANCE` or `INSTALLMENT`.
    # @param automatic_payment_source [SquareApiClient::InvoiceAutomaticPaymentSource] The payment method for an automatic payment.
#  The default value is `NONE`.
#  See [InvoiceAutomaticPaymentSource](#type-invoiceautomaticpaymentsource) for
#  possible values
...
#  call [ListCards](api-endpoint:Cards-ListCards) and include the `customer_id` of
#  the invoice recipient.
    # @param reminders [Array<SquareApiClient::InvoicePaymentReminder>] A list of one or more reminders to send for the payment request.
    # @param computed_amount_money [SquareApiClient::Money] The amount of the payment request, computed using the order amount and
#  information from the various payment
#  request fields (`request_type`, `fixed_amount_requested_money`, and
#  `percentage_requested`).
    # @param total_completed_amount_money [SquareApiClient::Money] The amount of money already paid for the specific payment request.
#  This amount might include a rounding adjustment if the most recent invoice
#  payment
#  was in cash in a currency that rounds cash payments (such as, `CAD` or `AUD`).
    # @param rounding_adjustment_included_money [SquareApiClient::Money] If the most recent payment was a cash payment
#  in a currency that rounds cash payments (such as, `CAD` or `AUD`) and the
#  payment
#  is rounded from `computed_amount_money` in the payment request, then this
#  field specifies the rounding adjustment applied. This amount
#  might be negative.
    ...
    # @return [SquareApiClient::InvoicePaymentRequest]
...
# Deserialize a JSON object to an instance of InvoicePaymentRequest
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["fixed_amount_requested_money"].nil?
        ...
        fixed_amount_requested_money = SquareApiClient::Money.from_json(json_object: fixed_amount_requested_money)
      else
  ...
  item = item.to_json
  SquareApiClient::InvoicePaymentReminder.from_json(json_object: item)
end
      unless parsed_json["computed_amount_money"].nil?
        computed_amount_money = parsed_json["computed_amount_money"].to_json
        computed_amount_money = SquareApiClient::Money.from_json(json_object: computed_amount_money)
      else
      ...
      unless parsed_json["total_completed_amount_money"].nil?
        ...
        total_completed_amount_money = SquareApiClient::Money.from_json(json_object: total_completed_amount_money)
      else
      ...
      unless parsed_json["rounding_adjustment_included_money"].nil?
        ...
        rounding_adjustment_included_money = SquareApiClient::Money.from_json(json_object: rounding_adjustment_included_money)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.request_method&.is_a?(SquareApiClient::InvoiceRequestMethod) != false || raise("Passed value for field obj.request_method is not the expected type, validation failed.")
      obj.request_type&.is_a?(SquareApiClient::InvoiceRequestType) != false || raise("Passed value for field obj.request_type is not the expected type, validation failed.")
      obj.due_date&.is_a?(String) != false || raise("Passed value for field obj.due_date is not the expected type, validation failed.")
      obj.fixed_amount_requested_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.fixed_amount_requested_money)
      ...
      obj.automatic_payment_source&.is_a?(SquareApiClient::InvoiceAutomaticPaymentSource) != false || raise("Passed value for field obj.automatic_payment_source is not the expected type, validation failed.")
      ...
      obj.computed_amount_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.computed_amount_money)
      obj.total_completed_amount_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.total_completed_amount_money)
      obj.rounding_adjustment_included_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.rounding_adjustment_included_money)
    end
  end
end