...
#  for a [team member](entity:TeamMember).
  ...
  # @return [Array<SquareApiClient::JobAssignment>] **Required** The ordered list of jobs that the team member is assigned to.
...
#  ](https://developer.squareup.com/docs/working-with-apis/optimistic-concurrency).
  ...
  # @return [Object] 
    ...
    # @param job_assignments [Array<SquareApiClient::JobAssignment>] **Required** The ordered list of jobs that the team member is assigned to.
#  The first job assignment is considered the team member's primary job.
...
#  ](https://developer.squareup.com/docs/working-with-apis/optimistic-concurrency).
    ...
    # @return [SquareApiClient::WageSetting]
...
# Deserialize a JSON object to an instance of WageSetting
  ...
  item = item.to_json
  SquareApiClient::JobAssignment.from_json(json_object: item)
end
