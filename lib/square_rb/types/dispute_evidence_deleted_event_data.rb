...
module SquareApiClient
  ...
  # @return [String] ID of the affected dispute.
    attr_reader :id
  # @return [SquareApiClient::DisputeEvidenceDeletedEventObject] An object containing fields and values relevant to the event.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::DisputeEvidenceDeletedEventObject] An object containing fields and values relevant to the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputeEvidenceDeletedEventData]
...
# Deserialize a JSON object to an instance of DisputeEvidenceDeletedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::DisputeEvidenceDeletedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::DisputeEvidenceDeletedEventObject.validate_raw(obj: obj.object)
    end
  end
end