...
module SquareApiClient
  ...
  # @return [String] The ID of the event data object.
    attr_reader :id
  # @return [SquareApiClient::BookingCreatedEventObject] An object containing the created booking.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::BookingCreatedEventObject] An object containing the created booking.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BookingCreatedEventData]
...
# Deserialize a JSON object to an instance of BookingCreatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::BookingCreatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::BookingCreatedEventObject.validate_raw(obj: obj.object)
    end
  end
end