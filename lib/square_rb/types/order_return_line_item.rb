...
#  For example, `"1.70000"`.
  ...
  # @return [SquareApiClient::OrderQuantityUnit] The unit and precision that this return line item's quantity is measured in.
...
#  return line item.
  ...
  # @return [SquareApiClient::OrderLineItemItemType] The type of line item: an itemized return, a non-itemized return (custom
#  amount),
...
#  See [OrderLineItemItemType](#type-orderlineitemitemtype) for possible values
  ...
  # @return [Array<SquareApiClient::OrderReturnLineItemModifier>] The [CatalogModifier](entity:CatalogModifier)s applied to this line item.
    attr_reader :return_modifiers
  # @return [Array<SquareApiClient::OrderLineItemAppliedTax>] The list of references to `OrderReturnTax` entities applied to the return line
#  item. Each
...
#  is populated.
  ...
  # @return [Array<SquareApiClient::OrderLineItemAppliedDiscount>] The list of references to `OrderReturnDiscount` entities applied to the return
#  line item. Each
...
#  is populated.
  ...
  # @return [SquareApiClient::Money] The base price for a single unit of the line item.
    attr_reader :base_price_money
  # @return [SquareApiClient::Money] The total price of all item variations returned in this line item.
...
#  does not include modifiers.
  ...
  # @return [SquareApiClient::Money] The gross return amount of money calculated as (item base price + modifiers
#  price) * quantity.
    attr_reader :gross_return_money
  # @return [SquareApiClient::Money] The total amount of tax money to return for the line item.
    attr_reader :total_tax_money
  # @return [SquareApiClient::Money] The total amount of discount money to return for the line item.
    attr_reader :total_discount_money
  # @return [SquareApiClient::Money] The total amount of money to return for this line item.
    attr_reader :total_money
  # @return [Array<SquareApiClient::OrderLineItemAppliedServiceCharge>] The list of references to `OrderReturnServiceCharge` entities applied to the
#  return
...
#  item. On reads, the applied amount is populated.
  ...
  # @return [SquareApiClient::Money] The total amount of apportioned service charge money to return for the line
#  item.
...
#  Line items with a `quantity_unit` can have non-integer quantities.
#  For example, `"1.70000"`.
    # @param quantity_unit [SquareApiClient::OrderQuantityUnit] The unit and precision that this return line item's quantity is measured in.
...
#  return line item.
    ...
    # @param item_type [SquareApiClient::OrderLineItemItemType] The type of line item: an itemized return, a non-itemized return (custom
#  amount),
#  or the return of an unactivated gift card sale.
#  See [OrderLineItemItemType](#type-orderlineitemitemtype) for possible values
    # @param return_modifiers [Array<SquareApiClient::OrderReturnLineItemModifier>] The [CatalogModifier](entity:CatalogModifier)s applied to this line item.
    # @param applied_taxes [Array<SquareApiClient::OrderLineItemAppliedTax>] The list of references to `OrderReturnTax` entities applied to the return line
#  item. Each
#  `OrderLineItemAppliedTax` has a `tax_uid` that references the `uid` of a
#  top-level
#  `OrderReturnTax` applied to the return line item. On reads, the applied amount
#  is populated.
    # @param applied_discounts [Array<SquareApiClient::OrderLineItemAppliedDiscount>] The list of references to `OrderReturnDiscount` entities applied to the return
#  line item. Each
#  `OrderLineItemAppliedDiscount` has a `discount_uid` that references the `uid` of
#  a top-level
#  `OrderReturnDiscount` applied to the return line item. On reads, the applied
#  amount
#  is populated.
    # @param base_price_money [SquareApiClient::Money] The base price for a single unit of the line item.
    # @param variation_total_price_money [SquareApiClient::Money] The total price of all item variations returned in this line item.
#  The price is calculated as `base_price_money` multiplied by `quantity` and
#  does not include modifiers.
    # @param gross_return_money [SquareApiClient::Money] The gross return amount of money calculated as (item base price + modifiers
#  price) * quantity.
    # @param total_tax_money [SquareApiClient::Money] The total amount of tax money to return for the line item.
    # @param total_discount_money [SquareApiClient::Money] The total amount of discount money to return for the line item.
    # @param total_money [SquareApiClient::Money] The total amount of money to return for this line item.
    # @param applied_service_charges [Array<SquareApiClient::OrderLineItemAppliedServiceCharge>] The list of references to `OrderReturnServiceCharge` entities applied to the
#  return
#  line item. Each `OrderLineItemAppliedServiceCharge` has a `service_charge_uid`
#  that
#  references the `uid` of a top-level `OrderReturnServiceCharge` applied to the
#  return line
#  item. On reads, the applied amount is populated.
    # @param total_service_charge_money [SquareApiClient::Money] The total amount of apportioned service charge money to return for the line
#  item.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderReturnLineItem]
...
# Deserialize a JSON object to an instance of OrderReturnLineItem
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["quantity_unit"].nil?
        ...
        quantity_unit = SquareApiClient::OrderQuantityUnit.from_json(json_object: quantity_unit)
      else
        quantity_unit = nil
      end
  ...
  item = item.to_json
  SquareApiClient::OrderReturnLineItemModifier.from_json(json_object: item)
end
  ...
  item = item.to_json
  SquareApiClient::OrderLineItemAppliedDiscount.from_json(json_object: item)
end
      unless parsed_json["base_price_money"].nil?
        base_price_money = parsed_json["base_price_money"].to_json
        base_price_money = SquareApiClient::Money.from_json(json_object: base_price_money)
      else
      ...
      unless parsed_json["variation_total_price_money"].nil?
        ...
        variation_total_price_money = SquareApiClient::Money.from_json(json_object: variation_total_price_money)
      else
      ...
      unless parsed_json["gross_return_money"].nil?
        ...
        gross_return_money = SquareApiClient::Money.from_json(json_object: gross_return_money)
      else
  ...
  item = item.to_json
  SquareApiClient::OrderLineItemAppliedServiceCharge.from_json(json_object: item)
end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.quantity_unit.nil? || SquareApiClient::OrderQuantityUnit.validate_raw(obj: obj.quantity_unit)
      ...
      obj.item_type&.is_a?(SquareApiClient::OrderLineItemItemType) != false || raise("Passed value for field obj.item_type is not the expected type, validation failed.")
      ...
      obj.base_price_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.base_price_money)
      obj.variation_total_price_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.variation_total_price_money)
      obj.gross_return_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.gross_return_money)
