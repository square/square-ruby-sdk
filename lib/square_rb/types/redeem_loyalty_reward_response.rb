...
# A response that includes the `LoyaltyEvent` published for redeeming the reward.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::LoyaltyEvent] The `LoyaltyEvent` for redeeming the reward.
    attr_reader :event
  ...
  # @return [Object] 
    ...
    # @param event [SquareApiClient::LoyaltyEvent] The `LoyaltyEvent` for redeeming the reward.
