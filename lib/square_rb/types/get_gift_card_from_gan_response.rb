...
# A response that contains a `GiftCard`. This response might contain a set of
#  `Error` objects
#  if the request resulted in errors.
  class GetGiftCardFromGanResponse
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::GiftCard] A gift card that was fetched, if present. It returns empty if an error occurred.
  ...
  # @return [Object] 
    ...
    # @param gift_card [SquareApiClient::GiftCard] A gift card that was fetched, if present. It returns empty if an error occurred.
...
# Deserialize a JSON object to an instance of GetGiftCardFromGanResponse
    #
...
# Serialize an instance of GetGiftCardFromGanResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
