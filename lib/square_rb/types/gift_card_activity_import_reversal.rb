...
#  type](entity:GiftCardActivityType).
  ...
  # @return [SquareApiClient::Money] The amount of money cleared from the third-party gift card when
#  the import was reversed.
  ...
  # @return [Object] 
    ...
    # @param amount_money [SquareApiClient::Money] The amount of money cleared from the third-party gift card when
#  the import was reversed.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::GiftCardActivityImportReversal]
