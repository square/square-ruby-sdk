...
#  booking custom attribute.
  class BookingCustomAttributeVisibleDeletedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::BookingCustomAttributeVisibleDeletedEvent]
...
# Serialize an instance of BookingCustomAttributeVisibleDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
