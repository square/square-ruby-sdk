...
# Represents the parameters in a search for `TeamMember` objects.
  ...
  # @return [SquareApiClient::SearchTeamMembersFilter] The options to filter by.
    attr_reader :filter
  ...
  # @return [Object] 
    ...
    # @param filter [SquareApiClient::SearchTeamMembersFilter] The options to filter by.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::SearchTeamMembersQuery]
...
# Deserialize a JSON object to an instance of SearchTeamMembersQuery
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["filter"].nil?
        ...
        filter = SquareApiClient::SearchTeamMembersFilter.from_json(json_object: filter)
      else
        filter = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.filter.nil? || SquareApiClient::SearchTeamMembersFilter.validate_raw(obj: obj.filter)
    end
  end
end