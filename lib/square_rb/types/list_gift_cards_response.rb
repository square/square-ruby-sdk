...
#  the response contains a set of `Error` objects.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::GiftCard>] The requested gift cards or an empty object if none are found.
...
#  [Pagination](https://developer.squareup.com/docs/working-with-apis/pagination).
  ...
  # @return [Object] 
    ...
    # @param gift_cards [Array<SquareApiClient::GiftCard>] The requested gift cards or an empty object if none are found.
...
# Deserialize a JSON object to an instance of ListGiftCardsResponse
  ...
  item = item.to_json
  SquareApiClient::GiftCard.from_json(json_object: item)
end
