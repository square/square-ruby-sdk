...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogAvailabilityPeriod] Structured data for a `CatalogAvailabilityPeriod`, set for CatalogObjects of
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param availability_period_data [SquareApiClient::CatalogAvailabilityPeriod] Structured data for a `CatalogAvailabilityPeriod`, set for CatalogObjects of
#  type `AVAILABILITY_PERIOD`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectAvailabilityPeriod]
...
# Deserialize a JSON object to an instance of CatalogObjectAvailabilityPeriod
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["availability_period_data"].nil?
        ...
        availability_period_data = SquareApiClient::CatalogAvailabilityPeriod.from_json(json_object: availability_period_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.availability_period_data.nil? || SquareApiClient::CatalogAvailabilityPeriod.validate_raw(obj: obj.availability_period_data)
