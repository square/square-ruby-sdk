...
#  `TeamMember` objects.
  ...
  # @return [Array<SquareApiClient::TeamMember>] The filtered list of `TeamMember` objects.
...
#  [pagination](https://developer.squareup.com/docs/working-with-apis/pagination).
  ...
  # @return [Object] 
    ...
    # @param team_members [Array<SquareApiClient::TeamMember>] The filtered list of `TeamMember` objects.
...
# Deserialize a JSON object to an instance of SearchTeamMembersResponse
  ...
  item = item.to_json
  SquareApiClient::TeamMember.from_json(json_object: item)
end
