...
module SquareApiClient
  ...
  # @return [String] ID of the completed payout.
    attr_reader :id
  # @return [SquareApiClient::PayoutPaidEventObject] An object containing the completed payout.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::PayoutPaidEventObject] An object containing the completed payout.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PayoutPaidEventData]
...
# Deserialize a JSON object to an instance of PayoutPaidEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::PayoutPaidEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::PayoutPaidEventObject.validate_raw(obj: obj.object)
    end
  end
end