...
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
    attr_reader :status
  # @return [SquareApiClient::ActionCancelReason] The reason why `TerminalAction` is canceled. Present if the status is
#  `CANCELED`.
#  See [ActionCancelReason](#type-actioncancelreason) for possible values
  ...
  # @return [SquareApiClient::TerminalActionActionType] Represents the type of the action.
#  See [ActionType](#type-actiontype) for possible values
    attr_reader :type
  # @return [SquareApiClient::QrCodeOptions] Describes configuration for the QR code action. Requires `QR_CODE` type.
    attr_reader :qr_code_options
  # @return [SquareApiClient::SaveCardOptions] Describes configuration for the save-card action. Requires `SAVE_CARD` type.
    attr_reader :save_card_options
  # @return [SquareApiClient::SignatureOptions] Describes configuration for the signature capture action. Requires `SIGNATURE`
#  type.
    attr_reader :signature_options
  # @return [SquareApiClient::ConfirmationOptions] Describes configuration for the confirmation action. Requires `CONFIRMATION`
#  type.
    attr_reader :confirmation_options
  # @return [SquareApiClient::ReceiptOptions] Describes configuration for the receipt action. Requires `RECEIPT` type.
    attr_reader :receipt_options
  # @return [SquareApiClient::DataCollectionOptions] Describes configuration for the data collection action. Requires
#  `DATA_COLLECTION` type.
    attr_reader :data_collection_options
  # @return [SquareApiClient::SelectOptions] Describes configuration for the select action. Requires `SELECT` type.
    attr_reader :select_options
  # @return [SquareApiClient::DeviceMetadata] Details about the Terminal that received the action request (such as battery
#  level,
...
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
    # @param cancel_reason [SquareApiClient::ActionCancelReason] The reason why `TerminalAction` is canceled. Present if the status is
#  `CANCELED`.
#  See [ActionCancelReason](#type-actioncancelreason) for possible values
    ...
    # @param type [SquareApiClient::TerminalActionActionType] Represents the type of the action.
#  See [ActionType](#type-actiontype) for possible values
    # @param qr_code_options [SquareApiClient::QrCodeOptions] Describes configuration for the QR code action. Requires `QR_CODE` type.
    # @param save_card_options [SquareApiClient::SaveCardOptions] Describes configuration for the save-card action. Requires `SAVE_CARD` type.
    # @param signature_options [SquareApiClient::SignatureOptions] Describes configuration for the signature capture action. Requires `SIGNATURE`
#  type.
    # @param confirmation_options [SquareApiClient::ConfirmationOptions] Describes configuration for the confirmation action. Requires `CONFIRMATION`
#  type.
    # @param receipt_options [SquareApiClient::ReceiptOptions] Describes configuration for the receipt action. Requires `RECEIPT` type.
    # @param data_collection_options [SquareApiClient::DataCollectionOptions] Describes configuration for the data collection action. Requires
#  `DATA_COLLECTION` type.
    # @param select_options [SquareApiClient::SelectOptions] Describes configuration for the select action. Requires `SELECT` type.
    # @param device_metadata [SquareApiClient::DeviceMetadata] Details about the Terminal that received the action request (such as battery
#  level,
#  operating system version, and network connection settings).
#  Only available for `PING` action type.
...
#  Maximum: 5 minutes
    ...
    # @return [SquareApiClient::TerminalAction]
...
# Deserialize a JSON object to an instance of TerminalAction
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["qr_code_options"].nil?
        ...
        qr_code_options = SquareApiClient::QrCodeOptions.from_json(json_object: qr_code_options)
      else
        qr_code_options = nil
      end
      unless parsed_json["save_card_options"].nil?
        save_card_options = parsed_json["save_card_options"].to_json
        save_card_options = SquareApiClient::SaveCardOptions.from_json(json_object: save_card_options)
      else
        save_card_options = nil
      end
      unless parsed_json["signature_options"].nil?
        signature_options = parsed_json["signature_options"].to_json
        signature_options = SquareApiClient::SignatureOptions.from_json(json_object: signature_options)
      else
      ...
      unless parsed_json["confirmation_options"].nil?
        ...
        confirmation_options = SquareApiClient::ConfirmationOptions.from_json(json_object: confirmation_options)
      else
        confirmation_options = nil
      end
      unless parsed_json["receipt_options"].nil?
        receipt_options = parsed_json["receipt_options"].to_json
        receipt_options = SquareApiClient::ReceiptOptions.from_json(json_object: receipt_options)
      else
        receipt_options = nil
      end
      unless parsed_json["data_collection_options"].nil?
        data_collection_options = parsed_json["data_collection_options"].to_json
        data_collection_options = SquareApiClient::DataCollectionOptions.from_json(json_object: data_collection_options)
      else
        data_collection_options = nil
      end
      unless parsed_json["select_options"].nil?
        select_options = parsed_json["select_options"].to_json
        select_options = SquareApiClient::SelectOptions.from_json(json_object: select_options)
      else
        select_options = nil
      end
      unless parsed_json["device_metadata"].nil?
        device_metadata = parsed_json["device_metadata"].to_json
        device_metadata = SquareApiClient::DeviceMetadata.from_json(json_object: device_metadata)
      else
        device_metadata = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(SquareApiClient::TerminalActionActionType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      obj.qr_code_options.nil? || SquareApiClient::QrCodeOptions.validate_raw(obj: obj.qr_code_options)
      obj.save_card_options.nil? || SquareApiClient::SaveCardOptions.validate_raw(obj: obj.save_card_options)
      obj.signature_options.nil? || SquareApiClient::SignatureOptions.validate_raw(obj: obj.signature_options)
      obj.confirmation_options.nil? || SquareApiClient::ConfirmationOptions.validate_raw(obj: obj.confirmation_options)
      obj.receipt_options.nil? || SquareApiClient::ReceiptOptions.validate_raw(obj: obj.receipt_options)
      obj.data_collection_options.nil? || SquareApiClient::DataCollectionOptions.validate_raw(obj: obj.data_collection_options)
      obj.select_options.nil? || SquareApiClient::SelectOptions.validate_raw(obj: obj.select_options)
      obj.device_metadata.nil? || SquareApiClient::DeviceMetadata.validate_raw(obj: obj.device_metadata)
