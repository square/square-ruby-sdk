...
#  used by Square's servers to apply each filter property specified.
  ...
  # @return [SquareApiClient::TimecardFilterStatus] Fetch a `Timecard` instance by `Timecard.status`.
#  See [TimecardFilterStatus](#type-timecardfilterstatus) for possible values
    attr_reader :status
  # @return [SquareApiClient::TimeRange] Fetch `Timecard` instances that start in the time range - Inclusive.
    attr_reader :start
  # @return [SquareApiClient::TimeRange] Fetch the `Timecard` instances that end in the time range - Inclusive.
    attr_reader :end_
  # @return [SquareApiClient::TimecardWorkday] Fetch the `Timecard` instances based on the workday date range.
    attr_reader :workday
  ...
  # @return [Object] 
    ...
    # @param status [SquareApiClient::TimecardFilterStatus] Fetch a `Timecard` instance by `Timecard.status`.
#  See [TimecardFilterStatus](#type-timecardfilterstatus) for possible values
    # @param start [SquareApiClient::TimeRange] Fetch `Timecard` instances that start in the time range - Inclusive.
    # @param end_ [SquareApiClient::TimeRange] Fetch the `Timecard` instances that end in the time range - Inclusive.
    # @param workday [SquareApiClient::TimecardWorkday] Fetch the `Timecard` instances based on the workday date range.
    # @param team_member_ids [Array<String>] Fetch timecards for the specified team members.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TimecardFilter]
...
# Deserialize a JSON object to an instance of TimecardFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["workday"].nil?
        ...
        workday = SquareApiClient::TimecardWorkday.from_json(json_object: workday)
      else
        workday = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::TimecardFilterStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.workday.nil? || SquareApiClient::TimecardWorkday.validate_raw(obj: obj.workday)
