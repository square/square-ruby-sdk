...
module SquareApiClient
  class DisputeEvidenceDeletedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::DisputeEvidenceDeletedEventObject]
...
# Deserialize a JSON object to an instance of DisputeEvidenceDeletedEventObject
    #
...
# Serialize an instance of DisputeEvidenceDeletedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
