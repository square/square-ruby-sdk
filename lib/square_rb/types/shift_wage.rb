...
#  es](https://developer.squareup.com/docs/labor-api/what-it-does#migration-notes).
  class ShiftWage
  # @return [String] The name of the job performed during this shift.
    attr_reader :title
...
#  wage based on the annual wage and hours worked per week.
  ...
  # @return [String] The id of the job performed during this shift. Square
...
# Deserialize a JSON object to an instance of ShiftWage
    #
...
# Serialize an instance of ShiftWage to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
