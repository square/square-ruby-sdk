...
#  field description to determine the meaning of the sign in a particular case.
    attr_reader :amount
  # @return [SquareApiClient::Currency] The type of currency, in __ISO 4217 format__. For example, the currency
...
#  in cents. Monetary amounts can be positive or negative. See the specific
#  field description to determine the meaning of the sign in a particular case.
    # @param currency [SquareApiClient::Currency] The type of currency, in __ISO 4217 format__. For example, the currency
#  code for US dollars is `USD`.
#  See [Currency](entity:Currency) for possible values.
#  See [Currency](#type-currency) for possible values
