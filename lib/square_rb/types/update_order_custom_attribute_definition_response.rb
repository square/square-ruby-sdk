...
# Represents a response from updating an order custom attribute definition.
  class UpdateOrderCustomAttributeDefinitionResponse
  # @return [SquareApiClient::CustomAttributeDefinition] The updated order custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [SquareApiClient::CustomAttributeDefinition] The updated order custom attribute definition.
...
# Serialize an instance of UpdateOrderCustomAttributeDefinitionResponse to a JSON
#  object
    #
    # @return [String]
    def to_json
