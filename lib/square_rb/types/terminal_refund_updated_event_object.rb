...
module SquareApiClient
  ...
  # @return [SquareApiClient::TerminalRefund] The updated terminal refund.
    attr_reader :refund
  ...
  # @return [Object] 
    ...
    # @param refund [SquareApiClient::TerminalRefund] The updated terminal refund.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalRefundUpdatedEventObject]
