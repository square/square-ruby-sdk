...
#  deactivated location.
  ...
  # @return [SquareApiClient::Money] The overridden price at the specified location. If this is unspecified, the
...
#  deactivated location.
    # @param price_money [SquareApiClient::Money] The overridden price at the specified location. If this is unspecified, the
#  modifier price is not overridden.
#  The modifier becomes free of charge at the specified location, when this
#  `price_money` field is set to 0.
...
#  set this attribute are ignored.
    ...
    # @return [SquareApiClient::ModifierLocationOverrides]
