...
require_relative "labor_scheduled_shift_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [ScheduledShift](entity:ScheduledShift) is updated.
  class LaborScheduledShiftUpdatedEvent
  ...
  # @return [String] The type of event. For this event, the value is `labor.scheduled_shift.updated`.
    attr_reader :type
  ...
  # @return [SquareApiClient::LaborScheduledShiftUpdatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this event, the value is `labor.scheduled_shift.updated`.
    ...
    # @param data [SquareApiClient::LaborScheduledShiftUpdatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborScheduledShiftUpdatedEvent]
...
# Deserialize a JSON object to an instance of LaborScheduledShiftUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborScheduledShiftUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborScheduledShiftUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborScheduledShiftUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end