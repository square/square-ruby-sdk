...
#  when your application updates a booking custom attribute.
  class BookingCustomAttributeOwnedUpdatedEvent
  # @return [String] The ID of the seller associated with the event that triggered the event
#  notification.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"booking.custom_attribute.owned.updated"`.
    attr_reader :type
...
#  notification.
    # @param type [String] The type of this event. The value is `"booking.custom_attribute.owned.updated"`.
...
#  3339 format.
    ...
    # @return [SquareApiClient::BookingCustomAttributeOwnedUpdatedEvent]
...
# Serialize an instance of BookingCustomAttributeOwnedUpdatedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
