...
#  the location of the seller.
  ...
  # @return [SquareApiClient::VendorCreatedEventData] The data associated with this event.
    attr_reader :data
...
#  the location of the seller.
    ...
    # @param data [SquareApiClient::VendorCreatedEventData] The data associated with this event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::VendorCreatedEvent]
...
# Deserialize a JSON object to an instance of VendorCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::VendorCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::VendorCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end