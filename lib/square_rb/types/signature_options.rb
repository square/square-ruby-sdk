...
module SquareApiClient
  ...
  # @return [String] The body text to display in the signature capture flow on the Terminal.
    attr_reader :body
  # @return [Array<SquareApiClient::SignatureImage>] An image representation of the collected signature.
  ...
  # @return [Object] 
    ...
    # @param signature [Array<SquareApiClient::SignatureImage>] An image representation of the collected signature.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::SignatureOptions]
...
# Deserialize a JSON object to an instance of SignatureOptions
  ...
  item = item.to_json
  SquareApiClient::SignatureImage.from_json(json_object: item)
end
      new(
        title: title,
        body: body,
