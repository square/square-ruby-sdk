...
module SquareApiClient
  class PaymentBalanceActivityDisputeDetail
  # @return [String] The ID of the payment associated with this activity.
    attr_reader :payment_id
  # @return [String] The ID of the dispute associated with this activity.
  ...
  # @return [Object] 
    ...
    # @param dispute_id [String] The ID of the dispute associated with this activity.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PaymentBalanceActivityDisputeDetail]
    def initialize(payment_id: OMIT, dispute_id: OMIT, additional_properties: nil)
      @payment_id = payment_id if payment_id != OMIT
      @dispute_id = dispute_id if dispute_id != OMIT
      @additional_properties = additional_properties
      @_field_set = { "payment_id": payment_id, "dispute_id": dispute_id }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of PaymentBalanceActivityDisputeDetail
    #
...
# Serialize an instance of PaymentBalanceActivityDisputeDetail to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
