...
# Published when a [card](entity:Card) is GDPR forgotten or vaulted.
  ...
  # @return [SquareApiClient::CardForgottenEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of this event. The value is `"card.forgotten"`.
    ...
    # @param data [SquareApiClient::CardForgottenEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CardForgottenEvent]
...
# Deserialize a JSON object to an instance of CardForgottenEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CardForgottenEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CardForgottenEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CardForgottenEventData.validate_raw(obj: obj.data)
    end
  end
end