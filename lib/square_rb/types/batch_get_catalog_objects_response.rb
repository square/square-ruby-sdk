...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::CatalogObject>] A list of [CatalogObject](entity:CatalogObject)s returned.
    attr_reader :objects
  # @return [Array<SquareApiClient::CatalogObject>] A list of [CatalogObject](entity:CatalogObject)s referenced by the object in the
#  `objects` field.
  ...
  # @return [Object] 
    ...
    # @param objects [Array<SquareApiClient::CatalogObject>] A list of [CatalogObject](entity:CatalogObject)s returned.
    # @param related_objects [Array<SquareApiClient::CatalogObject>] A list of [CatalogObject](entity:CatalogObject)s referenced by the object in the
#  `objects` field.
