...
#  [CancelPayment](api-endpoint:Payments-CancelPayment).
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Payment] The successfully canceled `Payment` object.
    attr_reader :payment
  ...
  # @return [Object] 
    ...
    # @param payment [SquareApiClient::Payment] The successfully canceled `Payment` object.
...
# Deserialize a JSON object to an instance of CancelPaymentResponse
    #
...
# Serialize an instance of CancelPaymentResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
