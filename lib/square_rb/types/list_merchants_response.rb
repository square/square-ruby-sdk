...
#  [ListMerchant](api-endpoint:Merchants-ListMerchants) endpoint.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::Merchant>] The requested `Merchant` entities.
...
#  set of objects.
  ...
  # @return [Object] 
    ...
    # @param merchant [Array<SquareApiClient::Merchant>] The requested `Merchant` entities.
...
# Deserialize a JSON object to an instance of ListMerchantsResponse
  ...
  item = item.to_json
  SquareApiClient::Merchant.from_json(json_object: item)
end
