...
#  The minimum length is 1 and the maximum length is 45.
  ...
  # @return [SquareApiClient::TeamMember] **Required** The data used to create the `TeamMember` object. If you include
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
#  The minimum length is 1 and the maximum length is 45.
    # @param team_member [SquareApiClient::TeamMember] **Required** The data used to create the `TeamMember` object. If you include
#  `wage_setting`, you must provide
#  `job_id` for each job assignment. To get job IDs, call
#  [ListJobs](api-endpoint:Team-ListJobs).
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CreateTeamMemberRequest]
