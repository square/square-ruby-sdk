...
#  endpoint.
  ...
  # @return [Array<SquareApiClient::Error>] Errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::Subscription] The subscription that has the specified action deleted.
  ...
  # @return [Object] 
    ...
    # @param subscription [SquareApiClient::Subscription] The subscription that has the specified action deleted.
...
# Deserialize a JSON object to an instance of DeleteSubscriptionActionResponse
    #
...
# Serialize an instance of DeleteSubscriptionActionResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
