...
require_relative "dispute_evidence_added_event_data"
require "ostruct"
require "json"
...
#  [CreateDisputeEvidenceText](api-endpoint:Disputes-CreateDisputeEvidenceText).
  ...
  # @return [SquareApiClient::DisputeEvidenceAddedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::DisputeEvidenceAddedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputeEvidenceAddedEvent]
...
# Deserialize a JSON object to an instance of DisputeEvidenceAddedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::DisputeEvidenceAddedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of DisputeEvidenceAddedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::DisputeEvidenceAddedEventData.validate_raw(obj: obj.data)
    end
  end
end