...
#  One of `errors` or `transaction` is present in a given response (never both).
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::Transaction] The requested transaction.
  ...
  # @return [Object] 
    ...
    # @param transaction [SquareApiClient::Transaction] The requested transaction.
...
# Deserialize a JSON object to an instance of GetTransactionResponse
  ...
  SquareApiClient::Error.from_json(json_object: item)
      ...
      unless parsed_json["transaction"].nil?
        ...
        transaction = SquareApiClient::Transaction.from_json(json_object: transaction)
      else
        transaction = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.transaction.nil? || SquareApiClient::Transaction.validate_raw(obj: obj.transaction)
    end
  end
end