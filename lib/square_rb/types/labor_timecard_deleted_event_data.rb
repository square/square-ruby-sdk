...
module SquareApiClient
  class LaborTimecardDeletedEventData
...
#  `timecard`.
    ...
    # @return [SquareApiClient::LaborTimecardDeletedEventData]
...
# Deserialize a JSON object to an instance of LaborTimecardDeletedEventData
    #
...
# Serialize an instance of LaborTimecardDeletedEventData to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
