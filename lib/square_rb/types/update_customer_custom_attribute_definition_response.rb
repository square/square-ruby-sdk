...
# Represents an
#  ](api-endpoint:CustomerCustomAttributes-UpdateCustomerCustomAttributeDefinition)
#  response.
...
# Serialize an instance of UpdateCustomerCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
