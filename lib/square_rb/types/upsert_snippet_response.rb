...
#  `snippet` or `errors`.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::Snippet] The new or updated snippet.
    attr_reader :snippet
  ...
  # @return [Object] 
    ...
    # @param snippet [SquareApiClient::Snippet] The new or updated snippet.
...
# Deserialize a JSON object to an instance of UpsertSnippetResponse
    #
  ...
  SquareApiClient::Error.from_json(json_object: item)
      ...
      unless parsed_json["snippet"].nil?
        ...
        snippet = SquareApiClient::Snippet.from_json(json_object: snippet)
      else
        snippet = nil
      end
      new(
...
# Serialize an instance of UpsertSnippetResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.snippet.nil? || SquareApiClient::Snippet.validate_raw(obj: obj.snippet)
    end
  end
end