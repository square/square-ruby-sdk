...
require_relative "dispute_state_updated_event_data"
require "ostruct"
require "json"
...
#  data includes details of what changed.
  class DisputeStateUpdatedEvent
  ...
  # @return [SquareApiClient::DisputeStateUpdatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::DisputeStateUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputeStateUpdatedEvent]
...
# Deserialize a JSON object to an instance of DisputeStateUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::DisputeStateUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of DisputeStateUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::DisputeStateUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end