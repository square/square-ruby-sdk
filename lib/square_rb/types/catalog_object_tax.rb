...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogTax] Structured data for a `CatalogTax`, set for CatalogObjects of type `TAX`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param tax_data [SquareApiClient::CatalogTax] Structured data for a `CatalogTax`, set for CatalogObjects of type `TAX`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectTax]
...
# Deserialize a JSON object to an instance of CatalogObjectTax
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["tax_data"].nil?
        ...
        tax_data = SquareApiClient::CatalogTax.from_json(json_object: tax_data)
      else
        tax_data = nil
      end
      id = parsed_json["id"]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.tax_data.nil? || SquareApiClient::CatalogTax.validate_raw(obj: obj.tax_data)
