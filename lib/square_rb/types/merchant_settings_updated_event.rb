...
require_relative "merchant_settings_updated_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when online checkout merchant settings are updated
  class MerchantSettingsUpdatedEvent
...
#  `"online_checkout.merchant_settings.updated"`.
  ...
  # @return [SquareApiClient::MerchantSettingsUpdatedEventData] Data associated with the event.
    attr_reader :data
...
#  `"online_checkout.merchant_settings.updated"`.
    ...
    # @param data [SquareApiClient::MerchantSettingsUpdatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::MerchantSettingsUpdatedEvent]
...
# Deserialize a JSON object to an instance of MerchantSettingsUpdatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::MerchantSettingsUpdatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of MerchantSettingsUpdatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::MerchantSettingsUpdatedEventData.validate_raw(obj: obj.data)
    end
  end
end