...
# Response object returned by `GetBankAccount`.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::BankAccount] The requested `BankAccount` object.
  ...
  # @return [Object] 
    ...
    # @param bank_account [SquareApiClient::BankAccount] The requested `BankAccount` object.
...
# Deserialize a JSON object to an instance of GetBankAccountResponse
    #
...
# Serialize an instance of GetBankAccountResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
