...
require_relative "dispute_evidence_removed_event_data"
require "ostruct"
require "json"
...
#  [DeleteDisputeEvidence](api-endpoint:Disputes-DeleteDisputeEvidence).
  class DisputeEvidenceRemovedEvent
  ...
  # @return [SquareApiClient::DisputeEvidenceRemovedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::DisputeEvidenceRemovedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputeEvidenceRemovedEvent]
...
# Deserialize a JSON object to an instance of DisputeEvidenceRemovedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::DisputeEvidenceRemovedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of DisputeEvidenceRemovedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::DisputeEvidenceRemovedEventData.validate_raw(obj: obj.data)
    end
  end
end