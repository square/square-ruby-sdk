...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogItemOption] Structured data for a `CatalogItemOption`, set for CatalogObjects of type
#  `ITEM_OPTION`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param item_option_data [SquareApiClient::CatalogItemOption] Structured data for a `CatalogItemOption`, set for CatalogObjects of type
#  `ITEM_OPTION`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectItemOption]
...
# Deserialize a JSON object to an instance of CatalogObjectItemOption
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["item_option_data"].nil?
        ...
        item_option_data = SquareApiClient::CatalogItemOption.from_json(json_object: item_option_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.item_option_data.nil? || SquareApiClient::CatalogItemOption.validate_raw(obj: obj.item_option_data)
