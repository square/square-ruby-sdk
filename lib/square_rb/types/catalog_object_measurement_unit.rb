...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogMeasurementUnit] Structured data for a `CatalogMeasurementUnit`, set for CatalogObjects of type
#  `MEASUREMENT_UNIT`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param measurement_unit_data [SquareApiClient::CatalogMeasurementUnit] Structured data for a `CatalogMeasurementUnit`, set for CatalogObjects of type
#  `MEASUREMENT_UNIT`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectMeasurementUnit]
...
# Deserialize a JSON object to an instance of CatalogObjectMeasurementUnit
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["measurement_unit_data"].nil?
        ...
        measurement_unit_data = SquareApiClient::CatalogMeasurementUnit.from_json(json_object: measurement_unit_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.measurement_unit_data.nil? || SquareApiClient::CatalogMeasurementUnit.validate_raw(obj: obj.measurement_unit_data)
