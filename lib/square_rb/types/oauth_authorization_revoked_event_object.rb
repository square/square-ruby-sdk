...
module SquareApiClient
  ...
  # @return [SquareApiClient::OauthAuthorizationRevokedEventRevocationObject] The revocation event.
  ...
  # @return [Object] 
    ...
    # @param revocation [SquareApiClient::OauthAuthorizationRevokedEventRevocationObject] The revocation event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OauthAuthorizationRevokedEventObject]
...
# Deserialize a JSON object to an instance of OauthAuthorizationRevokedEventObject
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["revocation"].nil?
        ...
        revocation = SquareApiClient::OauthAuthorizationRevokedEventRevocationObject.from_json(json_object: revocation)
      else
        revocation = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.revocation.nil? || SquareApiClient::OauthAuthorizationRevokedEventRevocationObject.validate_raw(obj: obj.revocation)
    end
  end
end