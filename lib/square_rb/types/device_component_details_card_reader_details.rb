...
module SquareApiClient
  ...
  # @return [String] The version of the card reader.
    attr_reader :version
  ...
  # @return [Object] 
    ...
    # @param version [String] The version of the card reader.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DeviceComponentDetailsCardReaderDetails]
...
# Serialize an instance of DeviceComponentDetailsCardReaderDetails to a JSON
#  object
    #
    # @return [String]
    def to_json
