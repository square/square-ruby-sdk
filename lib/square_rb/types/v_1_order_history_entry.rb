...
# V1OrderHistoryEntry
  ...
  # @return [SquareApiClient::V1OrderHistoryEntryAction] The type of action performed on the order.
...
#  values
  ...
  # @return [Object] 
    ...
    # @param action [SquareApiClient::V1OrderHistoryEntryAction] The type of action performed on the order.
#  See [V1OrderHistoryEntryAction](#type-v1orderhistoryentryaction) for possible
#  values
    # @param created_at [String] The time when the action was performed, in ISO 8601 format.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::V1OrderHistoryEntry]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.action&.is_a?(SquareApiClient::V1OrderHistoryEntryAction) != false || raise("Passed value for field obj.action is not the expected type, validation failed.")
