...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::TeamMemberBookingProfile>] The list of team member booking profiles. The results are returned in the
...
#  not set.
  ...
  # @return [Object] 
    ...
    # @param team_member_booking_profiles [Array<SquareApiClient::TeamMemberBookingProfile>] The list of team member booking profiles. The results are returned in the
#  ascending order of the time
#  when the team member booking profiles were last updated. Multiple booking
#  profiles updated at the same time
#  are further sorted in the ascending order of their IDs.
...
#  ListTeamMemberBookingProfilesResponse
  ...
  item = item.to_json
  SquareApiClient::TeamMemberBookingProfile.from_json(json_object: item)
end
