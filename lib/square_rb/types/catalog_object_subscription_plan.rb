...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogSubscriptionPlan] Structured data for a `CatalogSubscriptionPlan`, set for CatalogObjects of type
#  `SUBSCRIPTION_PLAN`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param subscription_plan_data [SquareApiClient::CatalogSubscriptionPlan] Structured data for a `CatalogSubscriptionPlan`, set for CatalogObjects of type
#  `SUBSCRIPTION_PLAN`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectSubscriptionPlan]
...
# Deserialize a JSON object to an instance of CatalogObjectSubscriptionPlan
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["subscription_plan_data"].nil?
        ...
        subscription_plan_data = SquareApiClient::CatalogSubscriptionPlan.from_json(json_object: subscription_plan_data)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.subscription_plan_data.nil? || SquareApiClient::CatalogSubscriptionPlan.validate_raw(obj: obj.subscription_plan_data)
