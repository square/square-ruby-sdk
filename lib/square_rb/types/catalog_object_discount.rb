...
module SquareApiClient
  ...
  # @return [String] 
    attr_reader :type
  # @return [SquareApiClient::CatalogDiscount] Structured data for a `CatalogDiscount`, set for CatalogObjects of type
#  `DISCOUNT`.
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param discount_data [SquareApiClient::CatalogDiscount] Structured data for a `CatalogDiscount`, set for CatalogObjects of type
#  `DISCOUNT`.
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectDiscount]
...
# Deserialize a JSON object to an instance of CatalogObjectDiscount
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["discount_data"].nil?
        ...
        discount_data = SquareApiClient::CatalogDiscount.from_json(json_object: discount_data)
      else
        discount_data = nil
      end
      id = parsed_json["id"]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.discount_data.nil? || SquareApiClient::CatalogDiscount.validate_raw(obj: obj.discount_data)
