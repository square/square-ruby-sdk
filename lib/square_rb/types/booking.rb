...
#  segments.
  ...
  # @return [Integer] The revision number for the booking used for optimistic concurrency.
    attr_reader :version
  # @return [SquareApiClient::BookingStatus] The status of the booking, describing where the booking stands with respect to
...
#  This field should not be visible to customers.
  ...
  # @return [Array<SquareApiClient::AppointmentSegment>] A list of appointment segments for this booking.
...
#  Applications should not make this field visible to customers of a seller.
  ...
  # @return [Boolean] Whether the booking is of a full business day.
    attr_reader :all_day
  # @return [SquareApiClient::BusinessAppointmentSettingsBookingLocationType] The type of location where the booking is held.
#  See
#  ttingsBookingLocationType](#type-businessappointmentsettingsbookinglocationtype)
#  for possible values
    attr_reader :location_type
  # @return [SquareApiClient::BookingCreatorDetails] Information about the booking creator.
    attr_reader :creator_details
  # @return [SquareApiClient::BookingBookingSource] The source of the booking.
...
#  See [BookingBookingSource](#type-bookingbookingsource) for possible values
    attr_reader :source
  # @return [SquareApiClient::Address] Stores a customer address if the location type is `CUSTOMER_LOCATION`.
    attr_reader :address
  ...
  # @return [Object] 
    ...
    # @param status [SquareApiClient::BookingStatus] The status of the booking, describing where the booking stands with respect to
#  the booking state machine.
#  See [BookingStatus](#type-bookingstatus) for possible values
...
#  attributes of a specific [CatalogObject](entity:CatalogObject) instance.
#  This field should not be visible to customers.
    # @param appointment_segments [Array<SquareApiClient::AppointmentSegment>] A list of appointment segments for this booking.
...
#  Applications should not make this field visible to customers of a seller.
    ...
    # @param location_type [SquareApiClient::BusinessAppointmentSettingsBookingLocationType] The type of location where the booking is held.
#  See
#  ttingsBookingLocationType](#type-businessappointmentsettingsbookinglocationtype)
#  for possible values
    # @param creator_details [SquareApiClient::BookingCreatorDetails] Information about the booking creator.
    # @param source [SquareApiClient::BookingBookingSource] The source of the booking.
#  Access to this field requires seller-level permissions.
#  See [BookingBookingSource](#type-bookingbookingsource) for possible values
    # @param address [SquareApiClient::Address] Stores a customer address if the location type is `CUSTOMER_LOCATION`.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Booking]
...
# Deserialize a JSON object to an instance of Booking
  ...
  SquareApiClient::AppointmentSegment.from_json(json_object: item)
      ...
      unless parsed_json["creator_details"].nil?
        ...
        creator_details = SquareApiClient::BookingCreatorDetails.from_json(json_object: creator_details)
      else
        creator_details = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::BookingStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.location_type&.is_a?(SquareApiClient::BusinessAppointmentSettingsBookingLocationType) != false || raise("Passed value for field obj.location_type is not the expected type, validation failed.")
      obj.creator_details.nil? || SquareApiClient::BookingCreatorDetails.validate_raw(obj: obj.creator_details)
      obj.source&.is_a?(SquareApiClient::BookingBookingSource) != false || raise("Passed value for field obj.source is not the expected type, validation failed.")
