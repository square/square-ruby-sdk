...
# A response that includes loyalty account created.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::LoyaltyAccount] The newly created loyalty account.
  ...
  # @return [Object] 
    ...
    # @param loyalty_account [SquareApiClient::LoyaltyAccount] The newly created loyalty account.
