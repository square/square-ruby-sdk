...
#  by a timestamp field.
  ...
  # @return [SquareApiClient::SearchOrdersSortField] The field to sort by.
...
#  See [SearchOrdersSortField](#type-searchorderssortfield) for possible values
  ...
  # @return [SquareApiClient::SortOrder] The chronological order in which results are returned. Defaults to `DESC`.
#  See [SortOrder](#type-sortorder) for possible values
  ...
  # @return [Object] 
    ...
    # @param sort_field [SquareApiClient::SearchOrdersSortField] The field to sort by.
#  __Important:__ When using a [DateTimeFilter](entity:SearchOrdersFilter),
#  `sort_field` must match the timestamp field that the `DateTimeFilter` uses to
#  filter. For example, if you set your `sort_field` to `CLOSED_AT` and you use a
#  `DateTimeFilter`, your `DateTimeFilter` must filter for orders by their
...
#  Default: `CREATED_AT`.
#  See [SearchOrdersSortField](#type-searchorderssortfield) for possible values
    # @param sort_order [SquareApiClient::SortOrder] The chronological order in which results are returned. Defaults to `DESC`.
#  See [SortOrder](#type-sortorder) for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::SearchOrdersSort]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.sort_field.is_a?(SquareApiClient::SearchOrdersSortField) != false || raise("Passed value for field obj.sort_field is not the expected type, validation failed.")
      obj.sort_order&.is_a?(SquareApiClient::SortOrder) != false || raise("Passed value for field obj.sort_order is not the expected type, validation failed.")
    end
  end
end