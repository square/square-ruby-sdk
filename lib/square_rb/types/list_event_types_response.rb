...
#  present.
  ...
  # @return [Array<SquareApiClient::EventTypeMetadata>] Contains the metadata of an event type. For more information, see
#  [EventTypeMetadata](entity:EventTypeMetadata).
  ...
  # @return [Object] 
    ...
    # @param metadata [Array<SquareApiClient::EventTypeMetadata>] Contains the metadata of an event type. For more information, see
#  [EventTypeMetadata](entity:EventTypeMetadata).
