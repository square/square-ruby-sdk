...
# Represents a
#  api-endpoint:MerchantCustomAttributes-RetrieveMerchantCustomAttributeDefinition)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class RetrieveMerchantCustomAttributeDefinitionResponse
  # @return [SquareApiClient::CustomAttributeDefinition] The retrieved custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [SquareApiClient::CustomAttributeDefinition] The retrieved custom attribute definition.
...
#  RetrieveMerchantCustomAttributeDefinitionResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["custom_attribute_definition"].nil?
        ...
        custom_attribute_definition = SquareApiClient::CustomAttributeDefinition.from_json(json_object: custom_attribute_definition)
      else
...
# Serialize an instance of RetrieveMerchantCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.custom_attribute_definition.nil? || SquareApiClient::CustomAttributeDefinition.validate_raw(obj: obj.custom_attribute_definition)
