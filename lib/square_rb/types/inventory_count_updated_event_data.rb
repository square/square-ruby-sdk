...
#  `inventory_counts`.
  ...
  # @return [String] ID of the affected object.
    attr_reader :id
  # @return [SquareApiClient::InventoryCountUpdatedEventObject] An object containing fields and values relevant to the event. Is absent if
...
#  `inventory_counts`.
    ...
    # @param object [SquareApiClient::InventoryCountUpdatedEventObject] An object containing fields and values relevant to the event. Is absent if
#  affected object was deleted.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::InventoryCountUpdatedEventData]
...
# Deserialize a JSON object to an instance of InventoryCountUpdatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::InventoryCountUpdatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::InventoryCountUpdatedEventObject.validate_raw(obj: obj.object)
    end
  end
end