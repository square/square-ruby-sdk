...
# Defines the fields in a `CreateDisputeEvidenceText` response.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::DisputeEvidence] The newly uploaded dispute evidence metadata.
  ...
  # @return [Object] 
    ...
    # @param evidence [SquareApiClient::DisputeEvidence] The newly uploaded dispute evidence metadata.
