...
#  specified `interval`.
    attr_reader :times
  # @return [SquareApiClient::LoyaltyPromotionTriggerLimitInterval] The time period the limit applies to.
#  See
...
#  specified `interval`.
    # @param interval [SquareApiClient::LoyaltyPromotionTriggerLimitInterval] The time period the limit applies to.
#  See
#  oyaltyPromotionTriggerLimitInterval](#type-loyaltypromotiontriggerlimitinterval)
#  for possible values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LoyaltyPromotionTriggerLimit]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.interval&.is_a?(SquareApiClient::LoyaltyPromotionTriggerLimitInterval) != false || raise("Passed value for field obj.interval is not the expected type, validation failed.")
    end
  end
end