...
#  erview](https://developer.squareup.com/docs/devtools/customattributes/overview).
    attr_reader :version
  # @return [SquareApiClient::CustomAttributeDefinitionVisibility] A copy of the `visibility` field value for the associated custom attribute
#  definition.
#  See
#  [CustomAttributeDefinitionVisibility](#type-customattributedefinitionvisibility)
#  for possible values
    attr_reader :visibility
  # @return [SquareApiClient::CustomAttributeDefinition] A copy of the associated custom attribute definition object. This field is only
#  set when
...
#  see [Custom Attributes
#  erview](https://developer.squareup.com/docs/devtools/customattributes/overview).
    # @param visibility [SquareApiClient::CustomAttributeDefinitionVisibility] A copy of the `visibility` field value for the associated custom attribute
#  definition.
#  See
#  [CustomAttributeDefinitionVisibility](#type-customattributedefinitionvisibility)
#  for possible values
    # @param definition [SquareApiClient::CustomAttributeDefinition] A copy of the associated custom attribute definition object. This field is only
#  set when
#  the optional field is specified on the request.
...
#  format.
    ...
    # @return [SquareApiClient::CustomAttribute]
...
# Deserialize a JSON object to an instance of CustomAttribute
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["definition"].nil?
        ...
        definition = SquareApiClient::CustomAttributeDefinition.from_json(json_object: definition)
      else
        definition = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.definition.nil? || SquareApiClient::CustomAttributeDefinition.validate_raw(obj: obj.definition)
