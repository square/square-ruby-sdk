...
# Represents a
#  on](api-endpoint:BookingCustomAttributes-CreateBookingCustomAttributeDefinition)
#  response.
#  Either `custom_attribute_definition` or `errors` is present in the response.
  class CreateBookingCustomAttributeDefinitionResponse
  # @return [SquareApiClient::CustomAttributeDefinition] The newly created custom attribute definition.
  ...
  # @return [Object] 
    ...
    # @param custom_attribute_definition [SquareApiClient::CustomAttributeDefinition] The newly created custom attribute definition.
...
# Serialize an instance of CreateBookingCustomAttributeDefinitionResponse to a
#  JSON object
    #
    # @return [String]
    def to_json
