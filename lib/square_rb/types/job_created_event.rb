...
require_relative "job_created_event_data"
require "ostruct"
require "json"
...
# Published when a Job is created.
  ...
  # @return [String] The type of event this represents, `"job.created"`.
    attr_reader :type
  # @return [String] A unique ID for the event.
    attr_reader :event_id
  # @return [String] Timestamp of when the event was created, in RFC 3339 format.
    attr_reader :created_at
  # @return [SquareApiClient::JobCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event this represents, `"job.created"`.
    ...
    # @param data [SquareApiClient::JobCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::JobCreatedEvent]
...
# Deserialize a JSON object to an instance of JobCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::JobCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of JobCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::JobCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end