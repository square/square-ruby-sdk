...
module SquareApiClient
  ...
  # @return [SquareApiClient::CatalogObjectType] The type of this object. Each object type has expected
...
#  This can include locations that are deactivated.
  ...
  # @return [Object] 
    ...
    # @param type [SquareApiClient::CatalogObjectType] The type of this object. Each object type has expected
#  properties expressed in a structured format within its corresponding `*_data`
#  field below.
#  See [CatalogObjectType](#type-catalogobjecttype) for possible values
...
#  This can include locations that are deactivated.
    ...
    # @return [SquareApiClient::CatalogObjectBase]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.type.is_a?(SquareApiClient::CatalogObjectType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
