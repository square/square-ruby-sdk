...
module SquareApiClient
  ...
  # @return [String] The public refund id associated with this activity.
  ...
  # @return [Object] 
    ...
    # @param refund_id [String] The public refund id associated with this activity.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PaymentBalanceActivityThirdPartyFeeRefundDetail]
...
# Serialize an instance of PaymentBalanceActivityThirdPartyFeeRefundDetail to a
#  JSON object
    #
    # @return [String]
    def to_json
