...
#  `TerminalAction`s for the merchant will be displayed.
  ...
  # @return [SquareApiClient::TimeRange] Time range for the beginning of the reporting period. Inclusive.
...
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
    attr_reader :status
  # @return [SquareApiClient::TerminalActionActionType] Filter results with the requested ActionType.
...
#  then all
#  `TerminalAction`s for the merchant will be displayed.
    # @param created_at [SquareApiClient::TimeRange] Time range for the beginning of the reporting period. Inclusive.
#  Default value: The current time minus one day.
#  Note that `TerminalAction`s are available for 30 days after creation.
    # @param status [String] Filter results with the desired status of the `TerminalAction`
#  Options: `PENDING`, `IN_PROGRESS`, `CANCEL_REQUESTED`, `CANCELED`, `COMPLETED`
    # @param type [SquareApiClient::TerminalActionActionType] Filter results with the requested ActionType.
#  See [TerminalActionActionType](#type-terminalactionactiontype) for possible
#  values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalActionQueryFilter]
