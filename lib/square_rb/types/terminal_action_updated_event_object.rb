...
module SquareApiClient
  ...
  # @return [SquareApiClient::TerminalAction] The updated terminal action.
    attr_reader :action
  ...
  # @return [Object] 
    ...
    # @param action [SquareApiClient::TerminalAction] The updated terminal action.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::TerminalActionUpdatedEventObject]
