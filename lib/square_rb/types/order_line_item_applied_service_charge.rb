...
#  delete and add a new `OrderLineItemAppliedServiceCharge`.
  ...
  # @return [SquareApiClient::Money] The amount of money applied by the service charge to the line item.
...
#  This field is immutable. To change which service charges apply to a line item,
#  delete and add a new `OrderLineItemAppliedServiceCharge`.
    # @param applied_money [SquareApiClient::Money] The amount of money applied by the service charge to the line item.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::OrderLineItemAppliedServiceCharge]
