...
module SquareApiClient
  class DisputeStateChangedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::DisputeStateChangedEventObject]
...
# Deserialize a JSON object to an instance of DisputeStateChangedEventObject
    #
...
# Serialize an instance of DisputeStateChangedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
