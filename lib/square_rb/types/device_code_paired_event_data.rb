...
module SquareApiClient
  ...
  # @return [String] ID of the paired device code.
    attr_reader :id
  # @return [SquareApiClient::DeviceCodePairedEventObject] An object containing the paired device code.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::DeviceCodePairedEventObject] An object containing the paired device code.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DeviceCodePairedEventData]
...
# Deserialize a JSON object to an instance of DeviceCodePairedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::DeviceCodePairedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::DeviceCodePairedEventObject.validate_raw(obj: obj.object)
    end
  end
end