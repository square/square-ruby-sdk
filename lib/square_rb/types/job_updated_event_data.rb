...
module SquareApiClient
  ...
  # @return [String] ID of the updated job.
    attr_reader :id
  # @return [SquareApiClient::JobUpdatedEventObject] An object containing the updated job.
    attr_reader :object
  ...
  # @return [Object] 
    ...
    # @param object [SquareApiClient::JobUpdatedEventObject] An object containing the updated job.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::JobUpdatedEventData]
...
# Deserialize a JSON object to an instance of JobUpdatedEventData
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["object"].nil?
        ...
        object = SquareApiClient::JobUpdatedEventObject.from_json(json_object: object)
      else
        object = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.nil? || SquareApiClient::JobUpdatedEventObject.validate_raw(obj: obj.object)
    end
  end
end