...
#  this date is then set to May 31.
  ...
  # @return [SquareApiClient::SubscriptionStatus] The current status of the subscription.
...
#  (newest invoices appear first).
  ...
  # @return [SquareApiClient::Money] A custom price which overrides the cost of a subscription plan variation with
#  `STATIC` pricing.
...
#  example, `America/Los_Angeles`).
  ...
  # @return [SquareApiClient::SubscriptionSource] The origination details of the subscription.
    attr_reader :source
  # @return [Array<SquareApiClient::SubscriptionAction>] The list of scheduled actions on this subscription. It is set only in the
#  response from
...
#  orders.
  ...
  # @return [Array<SquareApiClient::Phase>] array of phases for this subscription
    attr_reader :phases
...
#  (or charged the card) on May 1. For the monthly billing scenario,
#  this date is then set to May 31.
    # @param status [SquareApiClient::SubscriptionStatus] The current status of the subscription.
#  See [SubscriptionStatus](#type-subscriptionstatus) for possible values
...
#  subscription, listed in order when the invoices were created
#  (newest invoices appear first).
    # @param price_override_money [SquareApiClient::Money] A custom price which overrides the cost of a subscription plan variation with
#  `STATIC` pricing.
#  This field does not affect itemized subscriptions with `RELATIVE` pricing.
#  Instead,
#  you should edit the Subscription's [order
...
#  Format: the IANA Timezone Database identifier for the location timezone (for
#  example, `America/Los_Angeles`).
    # @param source [SquareApiClient::SubscriptionSource] The origination details of the subscription.
    # @param actions [Array<SquareApiClient::SubscriptionAction>] The list of scheduled actions on this subscription. It is set only in the
#  response from
#  [RetrieveSubscription](api-endpoint:Subscriptions-RetrieveSubscription) with the
#  query parameter
#  of `include=actions` or from
...
#  orders.
    # @param phases [Array<SquareApiClient::Phase>] array of phases for this subscription
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::Subscription]
...
# Deserialize a JSON object to an instance of Subscription
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["price_override_money"].nil?
        ...
        price_override_money = SquareApiClient::Money.from_json(json_object: price_override_money)
      else
      ...
      unless parsed_json["source"].nil?
        ...
        source = SquareApiClient::SubscriptionSource.from_json(json_object: source)
      else
        source = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.status&.is_a?(SquareApiClient::SubscriptionStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.price_override_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.price_override_money)
      ...
      obj.source.nil? || SquareApiClient::SubscriptionSource.validate_raw(obj: obj.source)
