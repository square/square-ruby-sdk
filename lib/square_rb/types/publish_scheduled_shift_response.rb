...
# Represents a [PublishScheduledShift](api-endpoint:Labor-PublishScheduledShift)
#  response.
#  Either `scheduled_shift` or `errors` is present in the response.
  class PublishScheduledShiftResponse
  # @return [SquareApiClient::ScheduledShift] The published scheduled shift.
  ...
  # @return [Object] 
    ...
    # @param scheduled_shift [SquareApiClient::ScheduledShift] The published scheduled shift.
...
# Deserialize a JSON object to an instance of PublishScheduledShiftResponse
    #
...
# Serialize an instance of PublishScheduledShiftResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
