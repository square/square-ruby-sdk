...
#  `bool_filter` must be specified.
  ...
  # @return [SquareApiClient::Range] A query expression to filter items or item variations with their custom
#  attributes
...
#  Exactly one of `string_filter`, `number_filter`, `selection_uids_filter`, or
#  `bool_filter` must be specified.
    # @param number_filter [SquareApiClient::Range] A query expression to filter items or item variations with their custom
#  attributes
#  containing a number value within the specified range.
#  Exactly one of `string_filter`, `number_filter`, `selection_uids_filter`, or
#  `bool_filter` must be specified.
...
#  `bool_filter` must be specified.
    ...
    # @return [SquareApiClient::CustomAttributeFilter]
...
# Deserialize a JSON object to an instance of CustomAttributeFilter
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["number_filter"].nil?
        ...
        number_filter = SquareApiClient::Range.from_json(json_object: number_filter)
      else
        number_filter = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.number_filter.nil? || SquareApiClient::Range.validate_raw(obj: obj.number_filter)
