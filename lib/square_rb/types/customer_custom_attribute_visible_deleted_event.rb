...
# Published when a customer [custom attribute](entity:CustomAttribute) that is
#  visible to the
...
#  Custom attributes set to `VISIBILITY_READ_WRITE_VALUES` can be deleted by any
#  application, but those set to
#  `VISIBILITY_READ_ONLY` or `VISIBILITY_HIDDEN` can only be deleted by the owner.
#  Custom attributes are owned
#  by the application that created the corresponding [custom attribute
#  definition](entity:CustomAttributeDefinition).
  class CustomerCustomAttributeVisibleDeletedEvent
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeVisibleDeletedEvent]
...
# Serialize an instance of CustomerCustomAttributeVisibleDeletedEvent to a JSON
#  object
    #
    # @return [String]
    def to_json
