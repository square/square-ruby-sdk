...
module SquareApiClient
  class PaymentBalanceActivityAutomaticSavingsReversedDetail
  # @return [String] The ID of the payment associated with this activity.
    attr_reader :payment_id
  # @return [String] The ID of the payout associated with this activity.
  ...
  # @return [Object] 
    ...
    # @param payout_id [String] The ID of the payout associated with this activity.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PaymentBalanceActivityAutomaticSavingsReversedDetail]
    def initialize(payment_id: OMIT, payout_id: OMIT, additional_properties: nil)
      @payment_id = payment_id if payment_id != OMIT
      @payout_id = payout_id if payout_id != OMIT
      @additional_properties = additional_properties
      @_field_set = { "payment_id": payment_id, "payout_id": payout_id }.reject do | _k, v |
  v == OMIT
end
    end
...
# Serialize an instance of PaymentBalanceActivityAutomaticSavingsReversedDetail to
#  a JSON object
    #
    # @return [String]
    def to_json
