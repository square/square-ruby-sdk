...
require_relative "customer_created_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a [customer](entity:Customer) is created. Subscribe to this event
#  to track customer profiles affected by a merge operation.
...
#  `segment_ids` field.
  ...
  # @return [String] The type of event. For this object, the value is `customer.created`.
    attr_reader :type
...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
  ...
  # @return [SquareApiClient::CustomerCreatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this object, the value is `customer.created`.
...
#  tps://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices).
    ...
    # @param data [SquareApiClient::CustomerCreatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CustomerCreatedEvent]
...
# Deserialize a JSON object to an instance of CustomerCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::CustomerCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of CustomerCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::CustomerCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end