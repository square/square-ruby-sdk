...
#  displayed terms.
  ...
  # @return [SquareApiClient::ConfirmationDecision] The result of the buyer’s actions when presented with the confirmation screen.
...
#  displayed terms.
    # @param decision [SquareApiClient::ConfirmationDecision] The result of the buyer’s actions when presented with the confirmation screen.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::ConfirmationOptions]
...
# Deserialize a JSON object to an instance of ConfirmationOptions
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["decision"].nil?
        ...
        decision = SquareApiClient::ConfirmationDecision.from_json(json_object: decision)
      else
        decision = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.decision.nil? || SquareApiClient::ConfirmationDecision.validate_raw(obj: obj.decision)
    end
  end
end