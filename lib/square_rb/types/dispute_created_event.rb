...
require_relative "dispute_created_event_data"
require "ostruct"
require "json"
...
# Published when a [Dispute](entity:Dispute) is created.
  ...
  # @return [SquareApiClient::DisputeCreatedEventData] Data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::DisputeCreatedEventData] Data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::DisputeCreatedEvent]
...
# Deserialize a JSON object to an instance of DisputeCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::DisputeCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of DisputeCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::DisputeCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end