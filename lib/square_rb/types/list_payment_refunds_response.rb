...
#  Either `errors` or `refunds` is present in a given response (never both).
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::PaymentRefund>] The list of requested refunds.
    attr_reader :refunds
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param refunds [Array<SquareApiClient::PaymentRefund>] The list of requested refunds.
...
# Deserialize a JSON object to an instance of ListPaymentRefundsResponse
  ...
  item = item.to_json
  SquareApiClient::PaymentRefund.from_json(json_object: item)
end
