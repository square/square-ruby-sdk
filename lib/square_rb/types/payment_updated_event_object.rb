...
module SquareApiClient
  class PaymentUpdatedEventObject
  # @return [SquareApiClient::Payment] The updated payment.
    attr_reader :payment
  ...
  # @return [Object] 
    ...
    # @param payment [SquareApiClient::Payment] The updated payment.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::PaymentUpdatedEventObject]
...
# Deserialize a JSON object to an instance of PaymentUpdatedEventObject
    #
...
# Serialize an instance of PaymentUpdatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
