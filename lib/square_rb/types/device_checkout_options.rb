...
#  false.
  ...
  # @return [SquareApiClient::TipSettings] Tip-specific settings.
...
#  false.
    # @param tip_settings [SquareApiClient::TipSettings] Tip-specific settings.
...
#  checkout includes an order ID. Defaults to true.
    ...
    # @return [SquareApiClient::DeviceCheckoutOptions]
...
# Deserialize a JSON object to an instance of DeviceCheckoutOptions
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["tip_settings"].nil?
        ...
        tip_settings = SquareApiClient::TipSettings.from_json(json_object: tip_settings)
      else
        tip_settings = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.tip_settings.nil? || SquareApiClient::TipSettings.validate_raw(obj: obj.tip_settings)
