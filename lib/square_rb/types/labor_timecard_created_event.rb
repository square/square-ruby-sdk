...
require_relative "labor_timecard_created_event_data"
require "ostruct"
require "json"

module SquareApiClient
# Published when a worker starts a [Timecard](entity:Timecard).
  class LaborTimecardCreatedEvent
  # @return [String] The ID of the target merchant associated with the event.
    attr_reader :merchant_id
  # @return [String] The type of event. For this event, the value is `labor.timecard.created`.
    attr_reader :type
  ...
  # @return [SquareApiClient::LaborTimecardCreatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param type [String] The type of event. For this event, the value is `labor.timecard.created`.
    ...
    # @param data [SquareApiClient::LaborTimecardCreatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::LaborTimecardCreatedEvent]
...
# Deserialize a JSON object to an instance of LaborTimecardCreatedEvent
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::LaborTimecardCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of LaborTimecardCreatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::LaborTimecardCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end