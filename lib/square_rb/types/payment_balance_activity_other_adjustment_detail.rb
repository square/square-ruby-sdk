...
module SquareApiClient
  class PaymentBalanceActivityOtherAdjustmentDetail
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::PaymentBalanceActivityOtherAdjustmentDetail]
...
# Serialize an instance of PaymentBalanceActivityOtherAdjustmentDetail to a JSON
#  object
    #
    # @return [String]
    def to_json
