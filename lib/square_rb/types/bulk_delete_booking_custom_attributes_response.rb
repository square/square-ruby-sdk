...
#  request.
  ...
  # @return [Hash{String => SquareApiClient::BookingCustomAttributeDeleteResponse}] A map of responses that correspond to individual delete requests. Each response
#  has the
...
#  field.
  ...
  # @return [Object] 
    ...
    # @param values [Hash{String => SquareApiClient::BookingCustomAttributeDeleteResponse}] A map of responses that correspond to individual delete requests. Each response
#  has the
#  same ID as the corresponding request and contains `booking_id` and  `errors`
#  field.
...
#  BulkDeleteBookingCustomAttributesResponse
  ...
  value = value.to_json
  SquareApiClient::BookingCustomAttributeDeleteResponse.from_json(json_object: value)
end
