...
#  the request resulted in errors.
  ...
  # @return [SquareApiClient::TeamMemberWage] The requested `TeamMemberWage` object.
  ...
  # @return [Object] 
    ...
    # @param team_member_wage [SquareApiClient::TeamMemberWage] The requested `TeamMemberWage` object.
    # @param errors [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::GetTeamMemberWageResponse]
...
# Deserialize a JSON object to an instance of GetTeamMemberWageResponse
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["team_member_wage"].nil?
        ...
        team_member_wage = SquareApiClient::TeamMemberWage.from_json(json_object: team_member_wage)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.team_member_wage.nil? || SquareApiClient::TeamMemberWage.validate_raw(obj: obj.team_member_wage)
