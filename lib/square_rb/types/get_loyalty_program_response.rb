...
# A response that contains the loyalty program.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::LoyaltyProgram] The loyalty program that was requested.
    attr_reader :program
  ...
  # @return [Object] 
    ...
    # @param program [SquareApiClient::LoyaltyProgram] The loyalty program that was requested.
...
# Deserialize a JSON object to an instance of GetLoyaltyProgramResponse
  ...
  SquareApiClient::Error.from_json(json_object: item)
      ...
      unless parsed_json["program"].nil?
        ...
        program = SquareApiClient::LoyaltyProgram.from_json(json_object: program)
      else
        program = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.program.nil? || SquareApiClient::LoyaltyProgram.validate_raw(obj: obj.program)
    end
  end
end