...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::LocationBookingProfile>] The list of a seller's location booking profiles.
...
#  not set.
  ...
  # @return [Object] 
    ...
    # @param location_booking_profiles [Array<SquareApiClient::LocationBookingProfile>] The list of a seller's location booking profiles.
...
# Deserialize a JSON object to an instance of ListLocationBookingProfilesResponse
  ...
  item = item.to_json
  SquareApiClient::LocationBookingProfile.from_json(json_object: item)
end
