...
#  for more information.
    attr_reader :cursor
  # @return [Array<SquareApiClient::CatalogObject>] The CatalogObjects returned.
    attr_reader :objects
  # @return [Array<SquareApiClient::CatalogObject>] A list of CatalogObjects referenced by the objects in the `objects` field.
...
#  https://developer.squareup.com/docs/build-basics/common-api-patterns/pagination)
#  for more information.
    # @param objects [Array<SquareApiClient::CatalogObject>] The CatalogObjects returned.
    # @param related_objects [Array<SquareApiClient::CatalogObject>] A list of CatalogObjects referenced by the objects in the `objects` field.
