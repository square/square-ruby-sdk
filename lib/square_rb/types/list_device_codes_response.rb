...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::DeviceCode>] The queried DeviceCode.
...
#  more information.
  ...
  # @return [Object] 
    ...
    # @param device_codes [Array<SquareApiClient::DeviceCode>] The queried DeviceCode.
...
# Deserialize a JSON object to an instance of ListDeviceCodesResponse
  ...
  item = item.to_json
  SquareApiClient::DeviceCode.from_json(json_object: item)
end
