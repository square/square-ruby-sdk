...
#  present.
  ...
  # @return [Array<SquareApiClient::Error>] Information on errors encountered during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::Event>] The list of [Event](entity:Event)s returned by the search.
    attr_reader :events
  # @return [Array<SquareApiClient::EventMetadata>] Contains the metadata of an event. For more information, see
#  [Event](entity:Event).
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param events [Array<SquareApiClient::Event>] The list of [Event](entity:Event)s returned by the search.
    # @param metadata [Array<SquareApiClient::EventMetadata>] Contains the metadata of an event. For more information, see
#  [Event](entity:Event).
...
# Deserialize a JSON object to an instance of SearchEventsResponse
  ...
  item = item.to_json
  SquareApiClient::Event.from_json(json_object: item)
end
      metadata = parsed_json["metadata"]&.map do | item |
  item = item.to_json
  SquareApiClient::EventMetadata.from_json(json_object: item)
end
