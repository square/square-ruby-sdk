...
module ChromaApiClient
  class HashMapValue
    # Deserialize a JSON object to an instance of HashMapValue
    #
    # @param json_object [String]
    # @return [ChromaApiClient::HashMapValue]
    def self.from_json(json_object:)
      ...
      begin
        struct.is_a?(Long) != false || raise("Passed value for field struct is not the expected type, validation failed.")
        return struct unless struct.nil?
    ...
    def self.validate_raw(obj:)
      ...
      begin
        return obj.is_a?(Long) != false || raise("Passed value for field obj is not the expected type, validation failed.")
      rescue StandardError
        # noop
      end
      begin
