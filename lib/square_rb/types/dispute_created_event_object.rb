...
module SquareApiClient
  class DisputeCreatedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::DisputeCreatedEventObject]
...
# Deserialize a JSON object to an instance of DisputeCreatedEventObject
    #
...
# Serialize an instance of DisputeCreatedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
