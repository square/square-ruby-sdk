...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::CatalogObject] The newly created `CatalogImage` including a Square-generated
#  URL for the encapsulated image file.
  ...
  # @return [Object] 
    ...
    # @param image [SquareApiClient::CatalogObject] The newly created `CatalogImage` including a Square-generated
#  URL for the encapsulated image file.
