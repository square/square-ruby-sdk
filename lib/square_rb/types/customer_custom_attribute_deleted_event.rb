...
#  corresponding [custom attribute definition](entity:CustomAttributeDefinition).
#  Custom attributes whose
#  `visibility` is `VISIBILITY_READ_WRITE_VALUES` can be deleted by any
#  application.
#  This event is replaced by
#  ustom_attribute.owned.deleted](webhook:customer.custom_attribute.owned.deleted).
  class CustomerCustomAttributeDeletedEvent
  # @return [String] The ID of the seller associated with the event that triggered the event
#  notification.
    attr_reader :merchant_id
  # @return [String] The type of this event. The value is `"customer.custom_attribute.deleted"`.
    attr_reader :type
...
#  notification.
    # @param type [String] The type of this event. The value is `"customer.custom_attribute.deleted"`.
...
#  3339 format.
    ...
    # @return [SquareApiClient::CustomerCustomAttributeDeletedEvent]
...
# Deserialize a JSON object to an instance of CustomerCustomAttributeDeletedEvent
    #
...
# Serialize an instance of CustomerCustomAttributeDeletedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
