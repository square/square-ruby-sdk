...
module SquareApiClient
  class DisputeEvidenceRemovedEventObject
  ...
  # @return [Object] 
    ...
    # @return [SquareApiClient::DisputeEvidenceRemovedEventObject]
...
# Deserialize a JSON object to an instance of DisputeEvidenceRemovedEventObject
    #
...
# Serialize an instance of DisputeEvidenceRemovedEventObject to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
