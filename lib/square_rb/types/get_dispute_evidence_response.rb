...
# Defines the fields in a `RetrieveDisputeEvidence` response.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::DisputeEvidence] Metadata about the dispute evidence file.
  ...
  # @return [Object] 
    ...
    # @param evidence [SquareApiClient::DisputeEvidence] Metadata about the dispute evidence file.
...
# Deserialize a JSON object to an instance of GetDisputeEvidenceResponse
    #
...
# Serialize an instance of GetDisputeEvidenceResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
