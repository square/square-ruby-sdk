...
#  [SearchScheduledShifts](api-endpoint:Labor-SearchScheduledShifts) request.
  ...
  # @return [SquareApiClient::ScheduledShiftFilter] Filtering options for the query.
    attr_reader :filter
  # @return [SquareApiClient::ScheduledShiftSort] Sorting options for the query.
    attr_reader :sort
  ...
  # @return [Object] 
    ...
    # @param filter [SquareApiClient::ScheduledShiftFilter] Filtering options for the query.
    # @param sort [SquareApiClient::ScheduledShiftSort] Sorting options for the query.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::ScheduledShiftQuery]
...
# Deserialize a JSON object to an instance of ScheduledShiftQuery
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["filter"].nil?
        ...
        filter = SquareApiClient::ScheduledShiftFilter.from_json(json_object: filter)
      else
        filter = nil
      end
      unless parsed_json["sort"].nil?
        sort = parsed_json["sort"].to_json
        sort = SquareApiClient::ScheduledShiftSort.from_json(json_object: sort)
      else
        sort = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      obj.filter.nil? || SquareApiClient::ScheduledShiftFilter.validate_raw(obj: obj.filter)
      obj.sort.nil? || SquareApiClient::ScheduledShiftSort.validate_raw(obj: obj.sort)
    end
  end
end