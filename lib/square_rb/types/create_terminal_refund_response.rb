...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Information about errors encountered during the request.
    attr_reader :errors
  # @return [SquareApiClient::TerminalRefund] The created `TerminalRefund`.
    attr_reader :refund
  ...
  # @return [Object] 
    ...
    # @param refund [SquareApiClient::TerminalRefund] The created `TerminalRefund`.
...
# Deserialize a JSON object to an instance of CreateTerminalRefundResponse
    #
...
# Serialize an instance of CreateTerminalRefundResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
