...
#  `APPOINTMENTS_ALL_READ` and `APPOINTMENTS_READ` set for the OAuth scope.
  ...
  # @return [SquareApiClient::BookingCreatedEventData] The data associated with the event.
    attr_reader :data
  ...
  # @return [Object] 
    ...
    # @param data [SquareApiClient::BookingCreatedEventData] The data associated with the event.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BookingCreatedEvent]
...
# Deserialize a JSON object to an instance of BookingCreatedEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = SquareApiClient::BookingCreatedEventData.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.data.nil? || SquareApiClient::BookingCreatedEventData.validate_raw(obj: obj.data)
    end
  end
end