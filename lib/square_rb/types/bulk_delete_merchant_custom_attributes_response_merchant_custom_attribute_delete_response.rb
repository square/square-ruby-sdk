...
#  request.
  class BulkDeleteMerchantCustomAttributesResponseMerchantCustomAttributeDeleteResponse
  # @return [Array<SquareApiClient::Error>] Errors that occurred while processing the individual
#  MerchantCustomAttributeDeleteRequest request
  ...
  # @return [Object] 
    ...
    # @param errors [Array<SquareApiClient::Error>] Errors that occurred while processing the individual
#  MerchantCustomAttributeDeleteRequest request
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::BulkDeleteMerchantCustomAttributesResponseMerchantCustomAttributeDeleteResponse]
