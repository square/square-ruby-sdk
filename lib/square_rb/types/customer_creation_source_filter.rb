...
#  or excluded from, the result if they match at least one of the filter criteria.
  ...
  # @return [Array<SquareApiClient::CustomerCreationSource>] The list of creation sources used as filtering criteria.
#  See [CustomerCreationSource](#type-customercreationsource) for possible values
    attr_reader :values
  # @return [SquareApiClient::CustomerInclusionExclusion] Indicates whether a customer profile matching the filter criteria
...
#  values
  ...
  # @return [Object] 
    ...
    # @param values [Array<SquareApiClient::CustomerCreationSource>] The list of creation sources used as filtering criteria.
#  See [CustomerCreationSource](#type-customercreationsource) for possible values
    # @param rule [SquareApiClient::CustomerInclusionExclusion] Indicates whether a customer profile matching the filter criteria
#  should be included in the result or excluded from the result.
#  Default: `INCLUDE`.
#  See [CustomerInclusionExclusion](#type-customerinclusionexclusion) for possible
#  values
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [SquareApiClient::CustomerCreationSourceFilter]
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.rule&.is_a?(SquareApiClient::CustomerInclusionExclusion) != false || raise("Passed value for field obj.rule is not the expected type, validation failed.")
    end
  end
end