...
module SquareApiClient
  ...
  # @return [String] The unique ID of the event.
    attr_reader :id
  # @return [SquareApiClient::CashDrawerEventType] The type of cash drawer shift event.
#  See [CashDrawerEventType](#type-cashdrawereventtype) for possible values
    attr_reader :event_type
  # @return [SquareApiClient::Money] The amount of money that was added to or removed from the cash drawer
...
#  created the event.
  ...
  # @return [Object] 
    ...
    # @param event_type [SquareApiClient::CashDrawerEventType] The type of cash drawer shift event.
#  See [CashDrawerEventType](#type-cashdrawereventtype) for possible values
    # @param event_money [SquareApiClient::Money] The amount of money that was added to or removed from the cash drawer
#  in the event. The amount can be positive (for added money)
#  or zero (for other tender type payments). The addition or removal of money can
#  be determined by
#  by the event type.
...
#  created the event.
    ...
    # @return [SquareApiClient::CashDrawerShiftEvent]
...
# Deserialize a JSON object to an instance of CashDrawerShiftEvent
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["event_money"].nil?
        ...
        event_money = SquareApiClient::Money.from_json(json_object: event_money)
      else
        event_money = nil
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.event_type&.is_a?(SquareApiClient::CashDrawerEventType) != false || raise("Passed value for field obj.event_type is not the expected type, validation failed.")
      obj.event_money.nil? || SquareApiClient::Money.validate_raw(obj: obj.event_money)
