...
# A response that includes loyalty accounts that satisfy the search criteria.
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [Array<SquareApiClient::LoyaltyAccount>] The loyalty accounts that met the search criteria,
...
#  ttps://developer.squareup.com/docs/build-basics/common-api-patterns/pagination).
  ...
  # @return [Object] 
    ...
    # @param loyalty_accounts [Array<SquareApiClient::LoyaltyAccount>] The loyalty accounts that met the search criteria,
#  in order of creation date.
...
# Deserialize a JSON object to an instance of SearchLoyaltyAccountsResponse
  ...
  item = item.to_json
  SquareApiClient::LoyaltyAccount.from_json(json_object: item)
end
