...
module SquareApiClient
  ...
  # @return [Array<SquareApiClient::Error>] Any errors that occurred during the request.
    attr_reader :errors
  # @return [SquareApiClient::CatalogInfoResponseLimits] Limits that apply to this API.
    attr_reader :limits
  # @return [SquareApiClient::StandardUnitDescriptionGroup] Names and abbreviations for standard units.
  ...
  # @return [Object] 
    ...
    # @param limits [SquareApiClient::CatalogInfoResponseLimits] Limits that apply to this API.
    # @param standard_unit_description_group [SquareApiClient::StandardUnitDescriptionGroup] Names and abbreviations for standard units.
...
# Deserialize a JSON object to an instance of CatalogInfoResponse
  ...
  SquareApiClient::Error.from_json(json_object: item)
      ...
      unless parsed_json["limits"].nil?
        ...
        limits = SquareApiClient::CatalogInfoResponseLimits.from_json(json_object: limits)
      else
        limits = nil
      end
      unless parsed_json["standard_unit_description_group"].nil?
        ...
        standard_unit_description_group = SquareApiClient::StandardUnitDescriptionGroup.from_json(json_object: standard_unit_description_group)
      else
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.limits.nil? || SquareApiClient::CatalogInfoResponseLimits.validate_raw(obj: obj.limits)
      obj.standard_unit_description_group.nil? || SquareApiClient::StandardUnitDescriptionGroup.validate_raw(obj: obj.standard_unit_description_group)
    end
  end
end