...
#  to retrieve only the linked bank accounts belonging to a specific location.
    ...
    # @return [SquareApiClient::ListBankAccountsResponse]
    # @example
...
#  api.bank_accounts.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bank-accounts"
      ...
      SquareApiClient::ListBankAccountsResponse.from_json(json_object: response.body)
    end
...
#  unts-api#retrieve-a-bank-account-by-using-an-id-issued-by-v1-bank-accounts-api).
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetBankAccountByV1IdResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bank_accounts.get_by_v_1_id(v_1_bank_account_id: "v1_bank_account_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bank-accounts/by-v1-id/#{v_1_bank_account_id}"
      ...
      SquareApiClient::GetBankAccountByV1IdResponse.from_json(json_object: response.body)
    end
...
#  linked to a Square account.
    ...
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetBankAccountResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.bank_accounts.get(bank_account_id: "bank_account_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/bank-accounts/#{bank_account_id}"
      ...
      SquareApiClient::GetBankAccountResponse.from_json(json_object: response.body)
    end
  end
