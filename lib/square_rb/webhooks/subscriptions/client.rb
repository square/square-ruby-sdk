...
#  returned.
      # @param sort_order [SquareApiClient::SortOrder] Sorts the returned list by when the [Subscription](entity:WebhookSubscription)
...
#  Default: 100
      ...
      # @return [SquareApiClient::ListWebhookSubscriptionsResponse]
      # @example
...
#  api.webhooks.subscriptions.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/webhooks/subscriptions"
        ...
        SquareApiClient::ListWebhookSubscriptionsResponse.from_json(json_object: response.body)
      end
...
#  request.
      # @param subscription [Hash] The [Subscription](entity:WebhookSubscription) to create.Request of type SquareApiClient::WebhookSubscription, as a Hash
      #   * :id (String) 
      #   * :name (String) 
      #   * :enabled (Boolean) 
      ...
      #   * :updated_at (String) 
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::CreateWebhookSubscriptionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.webhooks.subscriptions.create(idempotency_key: "63f84c6c-2200-4c99-846c-2670a1311fbf", subscription: { name: "Example Webhook Subscription", event_types: ["payment.created", "payment.updated"], notification_url: "https://example-webhook-url.com", api_version: "2021-12-15" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/webhooks/subscriptions"
        ...
        SquareApiClient::CreateWebhookSubscriptionResponse.from_json(json_object: response.body)
      end
# Retrieves a webhook subscription identified by its ID.
      #
      # @param subscription_id [String] [REQUIRED] The ID of the [Subscription](entity:WebhookSubscription) to retrieve.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::GetWebhookSubscriptionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.webhooks.subscriptions.get(subscription_id: "subscription_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/webhooks/subscriptions/#{subscription_id}"
        ...
        SquareApiClient::GetWebhookSubscriptionResponse.from_json(json_object: response.body)
      end
# Updates a webhook subscription.
      #
      # @param subscription_id [String] [REQUIRED] The ID of the [Subscription](entity:WebhookSubscription) to update.
      # @param subscription [Hash] The [Subscription](entity:WebhookSubscription) to update.Request of type SquareApiClient::WebhookSubscription, as a Hash
      #   * :id (String) 
      #   * :name (String) 
      #   * :enabled (Boolean) 
      #   * :event_types (Array<String>) 
...
#  api.webhooks.subscriptions.update(subscription_id: "subscription_id", subscription: { name: "Updated Example Webhook Subscription", enabled: false })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/webhooks/subscriptions/#{subscription_id}"
        ...
        SquareApiClient::UpdateWebhookSubscriptionResponse.from_json(json_object: response.body)
      end
# Deletes a webhook subscription.
      #
      # @param subscription_id [String] [REQUIRED] The ID of the [Subscription](entity:WebhookSubscription) to delete.
      # @param request_options [SquareApiClient::RequestOptions] 
      # @return [SquareApiClient::DeleteWebhookSubscriptionResponse]
      # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.webhooks.subscriptions.delete(subscription_id: "subscription_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/webhooks/subscriptions/#{subscription_id}"
        ...
        SquareApiClient::DeleteWebhookSubscriptionResponse.from_json(json_object: response.body)
      end
...
#  api.webhooks.subscriptions.update_signature_key(subscription_id: "subscription_id", idempotency_key: "ed80ae6b-0654-473b-bbab-a39aee89a60d")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/webhooks/subscriptions/#{subscription_id}/signature-key"
        ...
        SquareApiClient::UpdateWebhookSubscriptionSignatureKeyResponse.from_json(json_object: response.body)
      end
...
#  api.webhooks.subscriptions.test(subscription_id: "subscription_id", event_type: "payment.created")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/webhooks/subscriptions/#{subscription_id}/test"
        ...
        SquareApiClient::TestWebhookSubscriptionResponse.from_json(json_object: response.body)
      end
    end
