...
module SquareApiClient
  ...
  # @return [SquareApiClient::RequestClient] 
    ...
    # @param status [SquareApiClient::EmployeeStatus] Specifies the EmployeeStatus to filter the employee by.
...
#  api.employees.list
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/employees"
      ...
      SquareApiClient::ListEmployeesResponse.from_json(json_object: response.body)
    end
    #
    # @param id [String] UUID for the employee that was requested.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetEmployeeResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.employees.get(id: "id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/employees/#{id}"
      ...
      SquareApiClient::GetEmployeeResponse.from_json(json_object: response.body)
    end
  end
