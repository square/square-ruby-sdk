...
module SquareApiClient
  ...
  # @return [SquareApiClient::Orders::CustomAttributesClient] 
    ...
    def initialize(request_client:)
      ...
      @custom_attribute_definitions = SquareApiClient::Orders::CustomAttributeDefinitionsClient.new(request_client: request_client)
      @custom_attributes = SquareApiClient::Orders::CustomAttributesClient.new(request_client: request_client)
    end
...
#  [UpdateOrder](api-endpoint:Orders-UpdateOrder) endpoint.
    #
    # @param request [Hash] Request of type SquareApiClient::CreateOrderRequest, as a Hash
    #   * :order (Hash)
    #     * :id (String) 
    #     * :location_id (String) 
    #     * :reference_id (String) 
...
#  api.orders.create(request: { order: { location_id: "057P5VYJ4A5X1", reference_id: "my-order-001", line_items: [{ name: "New York Strip Steak", quantity: "1", base_price_money: { amount: 1599, currency: USD } }, { quantity: "2", catalog_object_id: "BEMYCSMIJL46OCDV4KYIKXIB", modifiers: [{ catalog_object_id: "CHQX7Y4KY6N5KINJKZCFURPZ" }], applied_discounts: [{ discount_uid: "one-dollar-off" }] }], taxes: [{ uid: "state-sales-tax", name: "State Sales Tax", percentage: "9", scope: ORDER }], discounts: [{ uid: "labor-day-sale", name: "Labor Day Sale", percentage: "5", scope: ORDER }, { uid: "membership-discount", catalog_object_id: "DB7L55ZH2BGWI4H23ULIWOQ7", scope: ORDER }, { uid: "one-dollar-off", name: "Sale - $1.00 off", amount_money: { amount: 100, currency: USD }, scope: LINE_ITEM }] }, idempotency_key: "8193148c-9586-11e6-99f9-28cfe92138cf" })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders"
      ...
      SquareApiClient::CreateOrderResponse.from_json(json_object: response.body)
    end
...
#  request.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::BatchGetOrdersResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.orders.batch_get(location_id: "057P5VYJ4A5X1", order_ids: ["CAISEM82RcpmcFBM0TfOyiHV3es", "CAISENgvlJ6jLWAzERDzjyHVybY"])
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/batch-retrieve"
      ...
      SquareApiClient::BatchGetOrdersResponse.from_json(json_object: response.body)
    end
# Enables applications to preview order pricing without creating an order.
    #
    # @param order [Hash] The order to be calculated. Expects the entire order, not a sparse update.Request of type SquareApiClient::Order, as a Hash
    #   * :id (String) 
    #   * :location_id (String) 
    #   * :reference_id (String) 
    #   * :source (Hash)
...
#  random strings used only to reference the reward tier.Request of type Array<SquareApiClient::OrderReward>, as a Hash
    #   * :id (String) 
    #   * :reward_tier_id (String) 
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::CalculateOrderResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.orders.calculate(order: { location_id: "D7AVYMEAPJ3A3", line_items: [{ name: "Item 1", quantity: "1", base_price_money: { amount: 500, currency: USD } }, { name: "Item 2", quantity: "2", base_price_money: { amount: 300, currency: USD } }], discounts: [{ name: "50% Off", percentage: "50", scope: ORDER }] })
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/calculate"
      ...
      SquareApiClient::CalculateOrderResponse.from_json(json_object: response.body)
    end
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::CloneOrderResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/clone"
      ...
      SquareApiClient::CloneOrderResponse.from_json(json_object: response.body)
    end
...
#  retrieving additional pages using a cursor, you must use the original query.Request of type SquareApiClient::SearchOrdersQuery, as a Hash
    #   * :filter (Hash)
    #     * :state_filter (Hash)
    #       * :states (Array<SquareApiClient::OrderState>) 
    ...
    #       * :fulfillment_types (Array<SquareApiClient::FulfillmentType>) 
    #       * :fulfillment_states (Array<SquareApiClient::FulfillmentState>) 
    #     * :source_filter (Hash)
    #       * :source_names (Array<String>) 
    #     * :customer_filter (Hash)
    #       * :customer_ids (Array<String>) 
    #   * :sort (Hash)
    #     * :sort_field (SquareApiClient::SearchOrdersSortField) 
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/search"
      ...
      SquareApiClient::SearchOrdersResponse.from_json(json_object: response.body)
    end
# Retrieves an [Order](entity:Order) by ID.
    #
    # @param order_id [String] The ID of the order to retrieve.
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::GetOrderResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  api.orders.get(order_id: "order_id")
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/#{order_id}"
      ...
      SquareApiClient::GetOrderResponse.from_json(json_object: response.body)
    end
...
#  r.squareup.com/docs/orders-api/manage-orders/update-orders#sparse-order-objects)
#  containing only the fields to update and the version to which the update is
#  being applied.Request of type SquareApiClient::Order, as a Hash
    #   * :id (String) 
    #   * :location_id (String) 
    #   * :reference_id (String) 
    #   * :source (Hash)
...
#  tps://developer.squareup.com/docs/build-basics/common-api-patterns/idempotency).
    # @param request_options [SquareApiClient::RequestOptions] 
    # @return [SquareApiClient::UpdateOrderResponse]
    # @example
#  api = SquareApiClient::Client.new(
#    base_url: "https://api.example.com",
#    environment: SquareApiClient::Environment::PRODUCTION,
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/#{order_id}"
      ...
      SquareApiClient::UpdateOrderResponse.from_json(json_object: response.body)
    end
...
#  )
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/v2/orders/#{order_id}/pay"
      ...
      SquareApiClient::PayOrderResponse.from_json(json_object: response.body)
    end
  end
  ...
  # @return [SquareApiClient::Orders::CustomAttributesClient] 
    ...
    def initialize(request_client:)
      @request_client = request_client
      @custom_attribute_definitions = SquareApiClient::Orders::AsyncCustomAttributeDefinitionsClient.new(request_client: request_client)
      @custom_attributes = SquareApiClient::Orders::AsyncCustomAttributesClient.new(request_client: request_client)
    end
# Creates a new [order](entity:Order) that can include information about products
#  for
#  purchase and settings to apply to the purchase.
