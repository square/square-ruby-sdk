...
describe Square::Internal::Types::Utils do
  Utils = Square::Internal::Types::Utils

  module TestUtils
    class M < Square::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Square::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Square::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Square::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Square::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Square::Internal::Types::Array[String]
      ModelArray = -> { Square::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Square::Internal::Types::Array[TestUtils::U] }
