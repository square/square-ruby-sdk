...
describe Square::Internal::Types::Union do
  class Rectangle < Square::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Square::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Square::Internal::Types::Model
