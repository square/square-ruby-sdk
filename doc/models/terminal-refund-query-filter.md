...
| `status` | `String` | Optional | Filtered results with the desired status of the `TerminalRefund`<br>Options: `PENDING`, `IN\_PROGRESS`, `CANCEL\_REQUESTED`, `CANCELED`, `COMPLETED` |
