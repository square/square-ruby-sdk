...
| `schedule_type` | [`String (Order Fulfillment Pickup Details Schedule Type)`]($m/OrderFulfillmentPickupDetailsScheduleType) | Optional | The schedule type of the pickup fulfillment. |
