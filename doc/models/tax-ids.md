...
| `es_nif` | `String` | Optional | The NIF (Numero de Identificacion Fiscal) number is a 9 character tax identifier used in Spain.<br>If it is present, it has been validated. For example, `73628495A`. |
