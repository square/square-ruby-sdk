...
| `type` | [`String (Order Line Item Discount Type)`]($m/OrderLineItemDiscountType) | Optional | Indicates how the discount is applied to the associated line item or order. |
...
| `scope` | [`String (Order Line Item Discount Scope)`]($m/OrderLineItemDiscountScope) | Optional | Indicates whether this is a line item or order level discount. |
