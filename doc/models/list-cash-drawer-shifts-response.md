...
|  --- | --- | --- | --- |
| `items` | [`Array<Cash Drawer Shift Summary Hash>`]($m/CashDrawerShiftSummary) | Optional | A collection of CashDrawerShiftSummary objects for shifts that match<br>the query. |
