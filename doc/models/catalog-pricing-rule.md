...
| `exclude_strategy` | [`String (Exclude Strategy)`]($m/ExcludeStrategy) | Optional | Indicates which products matched by a CatalogPricingRule<br>will be excluded if the pricing rule uses an exclude set. |
