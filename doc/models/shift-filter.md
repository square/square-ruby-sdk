...
|  --- | --- | --- | --- |
| `location_ids` | `Array<String>` |  | Fetch shifts for the specified location. |
...
| `team_member_ids` | `Array<String>` |  | Fetch shifts for the specified team members. Replaced `employee_ids` at version "2020-08-26" |
