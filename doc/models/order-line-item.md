...
| `variation_name` | `String` | Optional | The name of the variation applied to this line item.<br>**Constraints**: *Maximum Length*: `255` |
...
| `modifiers` | [`Array<Order Line Item Modifier Hash>`](/doc/models/order-line-item-modifier.md) | Optional | The [CatalogModifier](/doc/models/catalog-modifier.md)s applied to this line item. |
