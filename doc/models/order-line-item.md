...
| `note` | `String` | Optional | An optional note associated with the line item.<br>**Constraints**: *Maximum Length*: `2000` |
...
| `modifiers` | [`Array<Order Line Item Modifier Hash>`](../../doc/models/order-line-item-modifier.md) | Optional | The [CatalogModifier](entity:CatalogModifier)s applied to this line item. |
