...
| `modifiers` | [`Array<Order Line Item Modifier Hash>`](/doc/models/order-line-item-modifier.md) | Optional | The [CatalogModifier](./models/catalog-modifier.md)s applied to this line item. |
