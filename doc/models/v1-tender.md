...
| `type` | [`String (V1 Tender Type)`]($m/V1TenderType) | Optional | - |
...
| `card_brand` | [`String (V1 Tender Card Brand)`]($m/V1TenderCardBrand) | Optional | The brand of a credit card. |
| `pan_suffix` | `String` | Optional | The last four digits of the provided credit card's account number. |
| `entry_method` | [`String (V1 Tender Entry Method)`]($m/V1TenderEntryMethod) | Optional | - |
...
| `tendered_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
...
| `change_back_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
