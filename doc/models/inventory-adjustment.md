...
| `catalog_object_type` | `String` | Optional | The [type](entity:CatalogObjectType] of the<br>[CatalogObject](/doc/models/catalog-object.md) being tracked. Tracking is only<br>supported for the `ITEM_VARIATION` type.<br>**Constraints**: *Maximum Length*: `14` |
