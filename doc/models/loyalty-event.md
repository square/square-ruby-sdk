...
| `loyalty_account_id` | `String` | Required | The ID of the [loyalty account](#type-LoyaltyAccount) in which the event occurred.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `36` |
