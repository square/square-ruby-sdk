...
| `catalog_object_id` | `String` | Optional | The catalog object ID of the associated [CatalogServiceCharge](#type-catalogservicecharge).<br>**Constraints**: *Maximum Length*: `192` |
