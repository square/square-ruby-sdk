...
| `square_account_details` | [`Square Account Details Hash`](../../doc/models/square-account-details.md) | Optional | Additional details about Square Account payments. |
...
| `terminal_checkout_id` | `String` | Optional | An optional ID for a Terminal checkout that is associated with the payment. |
