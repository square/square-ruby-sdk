...
| `order_id` | `String` | Optional | The reference to the Square order ID for the checkout request. Supported only in the US. |
| `payment_options` | [`Payment Options Hash`](../../doc/models/payment-options.md) | Optional | - |
