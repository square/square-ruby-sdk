...
| `calculation_phase` | [`String (Order Service Charge Calculation Phase)`]($m/OrderServiceChargeCalculationPhase) | Optional | Represents a phase in the process of calculating order totals.<br>Service charges are applied __after__ the indicated phase.<br><br>[Read more about how order totals are calculated.](https://developer.squareup.com/docs/docs/orders-api/how-it-works#how-totals-are-calculated) |
