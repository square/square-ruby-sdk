...
| `status` | [`String (V1 Settlement Status)`]($m/V1SettlementStatus) | Optional | - |
...
| `entries` | [`Array<V1 Settlement Entry Hash>`]($m/V1SettlementEntry) | Optional | The entries included in this settlement. |
