...
|  --- | --- | --- | --- |
| `values` | [`Array<String (Customer Creation Source)>`](/doc/models/customer-creation-source.md) | Optional | The list of creation sources used as filtering criteria.<br>See [CustomerCreationSource](./models/customer-creation-source.md) for possible values |
