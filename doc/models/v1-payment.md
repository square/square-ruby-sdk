...
| `inclusive_tax_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `additive_tax_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `tax_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `tip_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `discount_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `total_collected_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `processing_fee_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `net_total_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `refunded_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `swedish_rounding_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `gross_sales_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `net_sales_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `inclusive_tax` | [`Array<V1 Payment Tax Hash>`]($m/V1PaymentTax) | Optional | All of the inclusive taxes associated with the payment. |
| `additive_tax` | [`Array<V1 Payment Tax Hash>`]($m/V1PaymentTax) | Optional | All of the additive taxes associated with the payment. |
| `tender` | [`Array<V1 Tender Hash>`]($m/V1Tender) | Optional | All of the tenders associated with the payment. |
| `refunds` | [`Array<V1 Refund Hash>`]($m/V1Refund) | Optional | All of the refunds applied to the payment. Note that the value of all refunds on a payment can exceed the value of all tenders if a merchant chooses to refund money to a tender after previously accepting returned goods as part of an exchange. |
| `itemizations` | [`Array<V1 Payment Itemization Hash>`]($m/V1PaymentItemization) | Optional | The items purchased in the payment. |
| `surcharge_money` | [`V1 Money Hash`]($m/V1Money) | Optional | - |
| `surcharges` | [`Array<V1 Payment Surcharge Hash>`]($m/V1PaymentSurcharge) | Optional | A list of all surcharges associated with the payment. |
