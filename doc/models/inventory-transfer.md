...
| `from_location_id` | `String` | Optional | The Square ID of the [Location](/doc/models/location.md) where the related<br>quantity of items were tracked before the transfer.<br>**Constraints**: *Maximum Length*: `100` |
| `to_location_id` | `String` | Optional | The Square ID of the [Location](/doc/models/location.md) where the related<br>quantity of items were tracked after the transfer.<br>**Constraints**: *Maximum Length*: `100` |
...
| `employee_id` | `String` | Optional | The Square ID of the [Employee](/doc/models/employee.md) responsible for the<br>inventory transfer.<br>**Constraints**: *Maximum Length*: `100` |
