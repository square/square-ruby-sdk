...
| `location_id` | `String` |  | The ID of the refund's associated location.<br>**Constraints**: *Maximum Length*: `50` |
| `transaction_id` | `String` |  | The ID of the transaction that the refunded tender is part of.<br>**Constraints**: *Maximum Length*: `192` |
| `tender_id` | `String` |  | The ID of the refunded tender.<br>**Constraints**: *Maximum Length*: `192` |
