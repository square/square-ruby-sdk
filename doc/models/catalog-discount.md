...
| `discount_type` | [`String (Catalog Discount Type)`]($m/CatalogDiscountType) | Optional | How to apply a CatalogDiscount to a CatalogItem. |
...
| `modify_tax_basis` | [`String (Catalog Discount Modify Tax Basis)`]($m/CatalogDiscountModifyTaxBasis) | Optional | - |
