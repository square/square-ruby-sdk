...
|  --- | --- | --- | --- |
| `business_booking_profile` | [`Business Booking Profile Hash`](../../doc/models/business-booking-profile.md) | Optional | A seller's business booking profile, including booking policy, appointment settings, etc. |
