...
| `type` | [`String (Order Fulfillment Type)`]($m/OrderFulfillmentType) | Optional | The type of fulfillment. |
| `state` | [`String (Order Fulfillment State)`]($m/OrderFulfillmentState) | Optional | The current state of this fulfillment. |
...
| `pickup_details` | [`Order Fulfillment Pickup Details Hash`]($m/OrderFulfillmentPickupDetails) | Optional | Contains details necessary to fulfill a pickup order. |
| `shipment_details` | [`Order Fulfillment Shipment Details Hash`]($m/OrderFulfillmentShipmentDetails) | Optional | Contains details necessary to fulfill a shipment order. |
