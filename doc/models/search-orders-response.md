...
|  --- | --- | --- | --- |
| `order_entries` | [`Array<Order Entry Hash>`](/doc/models/order-entry.md) | Optional | A list of [OrderEntries](/doc/models/order-entry.md) that fit the query<br>conditions. The list is populated only if `return_entries` is set to `true` in the request. |
| `orders` | [`Array<Order Hash>`](/doc/models/order.md) | Optional | A list of<br>[Order](/doc/models/order.md) objects that match the query conditions. The list is populated only if<br>`return_entries` is set to `false` in the request. |
