...
| `return_modifiers` | [`Array<Order Return Line Item Modifier Hash>`](../../doc/models/order-return-line-item-modifier.md) | Optional | The [CatalogModifier](entity:CatalogModifier)s applied to this line item. |
